...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function Pl(){return new cn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ba(),fragmentShader:`
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function Il(){return new cn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ba(),fragmentShader:`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      }`}));Ha.frustumCulled=!1;Ha.renderOrder=-1e9;be.add(Ha);function Ah(){Th.uGround.value=Math.max(0,Math.min(1,(Gt.elev+.05)/.1))}be.add(new $r(16777215,.62));var Xe=new Vs(16777215,.78);Xe.castShadow=!0;Xe.shadow.mapSize.set(4096,4096);Xe.shadow.normalBias=.15;Xe.shadow.bias=-2e-4;be.add(Xe);be.add(Xe.target);var Rh=new Vs(16777215,.16);Rh.position.set(-6,5,-7);be.add(Rh);var Gs={tail:60},is=()=>{Gs.tail=30},Ga=new Cn(1,1,1),Ws=new L,no=new L,ox=new Tt("#0f1115"),bh=new Map,Eh=new Map;function Xs(n){let t=bh.get(n);return t||(t=new Tt().setHex(n),bh.set(n,t)),t}function Wa(n){let t=Eh.get(n);return t||(t=new Tt().setHex(n).lerp(ox,.62),Eh.set(n,t)),t}var Xa=new Bs({vertexColors:!0,side:je}),ax=.42,qa=new Bs({vertexColors:!0,transparent:!0,opacity:ax,side:je,depthWrite:!1});qa.shadowSide=sn;var Ch=new Zi({colorWrite:!1,side:je});var fi=new Se(new $i(8e3,8e3),new Zr({opacity:.32}));fi.rotation.x=-Math.PI/2;fi.position.y=0;fi.receiveShadow=!0;fi.renderOrder=-1;be.add(fi);var qn=new wn;be.add(qn);var Pn=new wn;be.add(Pn);var qe=new hi(new ji(Ga),new Xn({color:10994876,depthTest:!1}));qe.visible=!1;qe.renderOrder=999;be.add(qe);var pi=new hi(new Oe,new Xn({vertexColors:!0,transparent:!0,depthTest:!1}));pi.renderOrder=998;pi.visible=!1;be.add(pi);var pn=new Kr,Yn=new Ht,io=new L,qs=new L;var Ya=(n,t,e)=>n+65536+(t+65536)*131072+(e+65536)*131072*131072;var hn=(n,t)=>({x:n.x+t.x,y:n.y+t.y,z:n.z+t.z});function le(n,t){let{x:e,y:i,z:s}=n;switch(t&3){case 1:return{x:-s,y:i,z:e};case 2:return{x:-e,y:i,z:-s};case 3:return{x:s,y:i,z:-e};default:return{x:e,y:i,z:s}}}var ss=(n,t)=>({rot:n.rot+t.rot&3,off:hn(le(t.off,n.rot),n.off)}),Ph=n=>{let t=4-(n.rot&3)&3,e=le(n.off,t);return{rot:t,off:{x:-e.x,y:-e.y,z:-e.z}}},Za=n=>n.slice(1).reduce((t,e)=>ss(t,{off:e.pos,rot:e.rot}),{off:{x:0,y:0,z:0},rot:0}),rs=n=>"#"+(n>>>0).toString(16).padStart(6,"0").slice(-6),Ja=1,so=()=>"n"+Ja++,os=()=>Ja,as=n=>{Ja=n};var ne=(n,t,e,i,s,r,a)=>({x0:n,y0:t,z0:e,x1:i,y1:s,z1:r,c:a}),$a=(n,t)=>n.x0<t.x1&&t.x0<n.x1&&n.y0<t.y1&&t.y0<n.y1&&n.z0<t.z1&&t.z0<n.z1;function Ka(n,t,e){let i=Math.max(n.x0,t.x0),s=Math.max(n.y0,t.y0),r=Math.max(n.z0,t.z0),a=Math.min(n.x1,t.x1),o=Math.min(n.y1,t.y1),c=Math.min(n.z1,t.z1);if(i>=a||s>=o||r>=c){e.push(n);return}let l=n.c;n.x0<i&&e.push({...n,x1:i}),a<n.x1&&e.push({...n,x0:a}),n.y0<s&&e.push({x0:i,y0:n.y0,z0:n.z0,x1:a,y1:s,z1:n.z1,c:l}),o<n.y1&&e.push({x0:i,y0:o,z0:n.z0,x1:a,y1:n.y1,z1:n.z1,c:l}),n.z0<r&&e.push({x0:i,y0:s,z0:n.z0,x1:a,y1:o,z1:r,c:l}),c<n.z1&&e.push({x0:i,y0:s,z0:c,x1:a,y1:o,z1:n.z1,c:l})}function Ih(n,t,e){let i=[];for(let s of n)$a(s,t)?Ka(s,t,i):i.push(s);return i.push({...t,c:e}),i}function cs(n,t){let e=[];for(let i of n)$a(i,t)?Ka(i,t,e):e.push(i);return e}function Lh(n,t,e){let i=[];for(let s of n){if(!$a(s,t)){i.push(s);continue}Ka(s,t,i),i.push({x0:Math.max(s.x0,t.x0),y0:Math.max(s.y0,t.y0),z0:Math.max(s.z0,t.z0),x1:Math.min(s.x1,t.x1),y1:Math.min(s.y1,t.y1),z1:Math.min(s.z1,t.z1),c:e})}return i}function Dh(n,t){for(let e of n){let i=(e.x1-e.x0)*(e.y1-e.y0)*(e.z1-e.z0);t.set(e.c,(t.get(e.c)||0)+i)}}function Zn(n,t){for(let e of n)e.x0<t.min.x&&(t.min.x=e.x0),e.y0<t.min.y&&(t.min.y=e.y0),e.z0<t.min.z&&(t.min.z=e.z0),e.x1>t.max.x&&(t.max.x=e.x1),e.y1>t.max.y&&(t.max.y=e.y1),e.z1>t.max.z&&(t.max.z=e.z1)}function mn(n,t,e){let i=le({x:n.x0,y:n.y0,z:n.z0},t),s=le({x:n.x1-1,y:n.y1-1,z:n.z1-1},t);return{x0:Math.min(i.x,s.x)+e.x,y0:Math.min(i.y,s.y)+e.y,z0:Math.min(i.z,s.z)+e.z,x1:Math.max(i.x,s.x)+e.x+1,y1:Math.max(i.y,s.y)+e.y+1,z1:Math.max(i.z,s.z)+e.z+1,c:n.c}}var Fe=16,ze=Math.floor;function ro(n){if(!n.length)return()=>!1;let t=1/0,e=1/0,i=1/0,s=-1/0,r=-1/0,a=-1/0;for(let x of n)x.x0<t&&(t=x.x0),x.y0<e&&(e=x.y0),x.z0<i&&(i=x.z0),x.x1>s&&(s=x.x1),x.y1>r&&(r=x.y1),x.z1>a&&(a=x.z1);let o=ze(t/Fe),c=ze(e/Fe),l=ze(i/Fe),h=ze((s-1)/Fe)-o+1,d=ze((r-1)/Fe)-c+1,f=ze((a-1)/Fe)-l+1,m=Array.from({length:h*d*f},()=>[]),_=(x,p,u)=>((x-o)*d+(p-c))*f+(u-l);for(let x of n)for(let p=ze(x.x0/Fe);p<=ze((x.x1-1)/Fe);p++)for(let u=ze(x.y0/Fe);u<=ze((x.y1-1)/Fe);u++)for(let b=ze(x.z0/Fe);b<=ze((x.z1-1)/Fe);b++)m[_(p,u,b)].push(x);return(x,p,u)=>{let b=ze(x/Fe),v=ze(p/Fe),T=ze(u/Fe);if(b<o||v<c||T<l||b-o>=h||v-c>=d||T-l>=f)return!1;for(let I of m[_(b,v,T)])if(x>=I.x0&&x<I.x1&&p>=I.y0&&p<I.y1&&u>=I.z0&&u<I.z1)return!0;return!1}}var Uh=(n,t,e,i)=>{for(let s of n)if(t>=s.x0&&t<s.x1&&e>=s.y0&&e<s.y1&&i>=s.z0&&i<s.z1)return!0;return!1};var Nh=(n,t,e,i,s)=>n.some(r=>t.some(a=>r.x0+e<a.x1&&a.x0<r.x1+e&&r.y0+i<a.y1&&a.y0<r.y1+i&&r.z0+s<a.z1&&a.z0<r.z1+s));var Oh=[7041116,10855821,12040100,14472900,13343102,14532265,15787730,9268835,13935475,10249796,11895693,7170165,8226199,6055805,6986062,10994876],Fh={visible:0,transparent:1,invisible:2},zh={visible:"transparent",transparent:"invisible",invisible:"visible"},Ys=()=>({type:"object",id:so(),name:"",pos:{x:0,y:0,z:0},rot:0,vis:"visible",boxes:[]}),ls=()=>({type:"scene",id:so(),name:"",pos:{x:0,y:0,z:0},rot:0,vis:"visible",children:[]});function oo(n){let t={id:so(),name:n.name,pos:{...n.pos},rot:n.rot,vis:n.vis};return n.type==="object"?{type:"object",...t,boxes:n.boxes.map(e=>({...e}))}:{type:"scene",...t,children:n.children.map(oo)}}var mi=n=>g.context.children.find(t=>t.id===n);function hs(n,t=g.root,e=[]){if(e.push(t),t===n)return e.slice();if(t.type==="scene")for(let i of t.children){let s=hs(n,i,e);if(s)return s}return e.pop(),null}function us(n,t=g.root){if(t.id===n)return t;if(t.type==="scene")for(let e of t.children){let i=us(n,e);if(i)return i}return null}function gi(n){let t=hs(n);return t&&t.length>1?t[t.length-2]:null}function ds(n,t){return n===t?!0:n.type!=="scene"?!1:n.children.some(e=>ds(e,t))}var fs=()=>Za(g.path),Zs=n=>Za(hs(n)||[g.root]),gn=()=>({min:{x:1e9,y:1e9,z:1e9},max:{x:-1e9,y:-1e9,z:-1e9}});function Jn(n,t,e,i){if(n.type==="object")Zn(n.boxes.map(s=>mn(s,e,t)),i);else for(let s of n.children)Jn(s,hn(t,le(s.pos,e)),e+s.rot&3,i);return i}function ao(n,t){let e=ee.getBoundingClientRect();Yn.x=(n-e.left)/e.width*2-1,Yn.y=-((t-e.top)/e.height)*2+1}function ja(){pn.setFromCamera(Yn,Wt);let n=pn.intersectObjects(g.pickMeshes,!1);return n.length?n[0].object.userData.childId??null:null}var Bh=new nn(new L(0,1,0),0);function ps(n){return pn.setFromCamera(Yn,Wt),Bh.constant=-n,pn.ray.intersectPlane(Bh,io)?{x:Math.floor(io.x),y:n,z:Math.floor(io.z)}:null}function ms(){if(!g.pickMeshes.length)return null;pn.setFromCamera(Yn,Wt);let n=pn.intersectObjects(g.pickMeshes,!1);if(!n.length)return null;let t=n[0],e=g.editXform.off,i=4-g.editXform.rot&3,s=le({x:t.point.x-e.x,y:t.point.y-e.y,z:t.point.z-e.z},i),r=t.face?t.face.normal:{x:0,y:1,z:0},a=Math.floor(s.x-r.x*.5),o=Math.floor(s.y-r.y*.5),c=Math.floor(s.z-r.z*.5);return{cell:{x:a,y:o,z:c},addCell:{x:a+Math.round(r.x),y:o+Math.round(r.y),z:c+Math.round(r.z)}}}function Js(n){let t=ps(n+g.editXform.off.y);if(!t)return null;let e=le({x:t.x-g.editXform.off.x,y:0,z:t.z-g.editXform.off.z},4-g.editXform.rot&3);return{x:Math.round(e.x),y:n,z:Math.round(e.z)}}var gs=(n,t,e)=>{let i=le({x:n,y:t,z:e},g.editXform.rot);return new L(i.x+g.editXform.off.x,i.y+g.editXform.off.y,i.z+g.editXform.off.z)};function co(n=ms()){return g.tool==="add"?n?n.addCell:Js(0):n?n.cell:null}var cx=new Tt(10994876),lx=new Tt(6055805),xs=()=>g.editObject?g.tool==="measure":g.measMode,Qa=()=>{g.measFieldCache=null};function un(){g.liveMeas=null,g.frozenMeas=[],_s()}function kh(){if(g.measFieldCache)return g.measFieldCache;let n=[],t;g.editObject?(n.push(...g.editObject.boxes),t=gs):(xi(g.root,{x:0,y:0,z:0},0,null,0,(o,c,l,h)=>{if(h)for(let d of o.boxes)n.push(mn(d,l,c))}),t=(o,c,l)=>new L(o,c,l));let e=gn();Zn(n,e);let i=n.length===0,s={x:e.min.x,y:e.min.y,z:e.min.z},r={x:e.max.x-1,y:e.max.y-1,z:e.max.z-1},a=n.length>64?ro(n):(o,c,l)=>Uh(n,o,c,l);return g.measFieldCache={has:a,mn:s,mx:r,toW:t,empty:i},g.measFieldCache}function hx(){let n=kh();if(n.empty)return null;let t=null;if(g.editObject){let e=ms();t=e?{...e.cell}:Js(0)}else{pn.setFromCamera(Yn,Wt);let e=g.pickMeshes.length?pn.intersectObjects(g.pickMeshes,!1):[];if(e.length){let i=e[0],s=i.face?i.face.normal:{x:0,y:0,z:0};t={x:Math.floor(i.point.x-s.x*.5),y:Math.floor(i.point.y-s.y*.5),z:Math.floor(i.point.z-s.z*.5)}}else t=ps(0)}return t?{x:Math.max(n.mn.x,Math.min(n.mx.x,t.x)),y:Math.max(n.mn.y,Math.min(n.mx.y,t.y)),z:Math.max(n.mn.z,Math.min(n.mx.z,t.z))}:null}function ux(n){let t=kh(),e=["x","y","z"],i=[];for(let s=0;s<3;s++){let r=e[s],a=e[(s+1)%3],o=e[(s+2)%3],c=t.mn[r],l=t.mx[r],h=[n.x,n.y,n.z],d=m=>(h[s]=m,t.has(h[0],h[1],h[2])),f=c;for(;f<=l;){let m=d(f),_=f;for(;_+1<=l&&d(_+1)===m;)_++;let x=p=>{let u={};return u[r]=p,u[a]=n[a]+.5,u[o]=n[o]+.5,t.toW(u.x,u.y,u.z)};i.push({a:x(f),b:x(_+1),mid:x((f+_+1)/2),len:_-f+1,filled:m}),f=_+1}}return i}function Vh(){let n=hx();g.liveMeas=n?ux(n):null,_s()}function Hh(){g.liveMeas&&g.liveMeas.length&&(g.frozenMeas.push(g.liveMeas),_s())}function _s(){let n=document.getElementById("measure");n.innerHTML="",g.measLabels=[];let t=[];g.liveMeas&&t.push({s:g.liveMeas,fz:!1});for(let r of g.frozenMeas)t.push({s:r,fz:!0});let e=[],i=[];for(let r of t)for(let a of r.s){let o=a.filled?cx:lx;if(e.push(a.a.x,a.a.y,a.a.z,a.b.x,a.b.y,a.b.z),i.push(o.r,o.g,o.b,o.r,o.g,o.b),a.nolabel)continue;let c=document.createElement("div");c.className="mlab"+(a.filled?"":" empty")+(r.fz?" frozen":""),c.textContent=String(a.len),n.appendChild(c),g.measLabels.push({el:c,w:a.mid})}pi.geometry.dispose();let s=new Oe;s.setAttribute("position",new pe(e,3)),s.setAttribute("color",new pe(i,3)),pi.geometry=s,pi.visible=e.length>0}function Gh(){if(!g.measLabels.length)return;let n=ee.getBoundingClientRect();for(let t of g.measLabels){if(qs.copy(t.w).project(Wt),qs.z>1){t.el.style.display="none";continue}t.el.style.display="",t.el.style.left=(qs.x*.5+.5)*n.width+"px",t.el.style.top=(-qs.y*.5+.5)*n.height+"px"}}var tc=new L(50,110,38).normalize();function dx(n){if(n.max.x<n.min.x)return;let t=(n.min.x+n.max.x)/2,e=(n.min.y+n.max.y)/2,i=(n.min.z+n.max.z)/2,s=.5*Math.hypot(n.max.x-n.min.x,n.max.y-n.min.y,n.max.z-n.min.z)+8,r=s+130;Xe.position.set(t+tc.x*r,e+tc.y*r,i+tc.z*r),Xe.target.position.set(t,e,i),Xe.target.updateMatrixWorld();let a=Xe.shadow.camera;a.left=-s,a.right=s,a.top=s,a.bottom=-s,a.near=Math.max(1,r-s-20),a.far=r+s+20,a.updateProjectionMatrix(),Xe.shadow.normalBias=2*s/Xe.shadow.mapSize.x}function fx(){for(let n of g.meshes)be.remove(n),n.geometry&&n.geometry!==Ga&&n.geometry.dispose();g.meshes=[],qn.clear(),g.editRemesh&&(cancelAnimationFrame(g.editRemesh),g.editRemesh=0),g.editMesh=null}var px=[{a:0,hi:!0,u:1,v:2,n:[1,0,0]},{a:0,hi:!1,u:2,v:1,n:[-1,0,0]},{a:1,hi:!0,u:2,v:0,n:[0,1,0]},{a:1,hi:!1,u:0,v:2,n:[0,-1,0]},{a:2,hi:!0,u:0,v:1,n:[0,0,1]},{a:2,hi:!1,u:1,v:0,n:[0,0,-1]}],mx=[1,.88,.74,.5];function Wh(n,t){let e=[n];return n+1<t&&e.push(n+1),t-1>n+1&&e.push(t-1),e.push(t),e}function qh(n,t,e){let i=[],s=[],r=[],a=n.map(h=>[h.x0,h.y0,h.z0]),o=n.map(h=>[h.x1,h.y1,h.z1]),c=e?ro(n):null;for(let h=0;h<n.length;h++){let d=t(n[h].c),f=d.r,m=d.g,_=d.b,x=a[h],p=o[h];for(let u of px){let{a:b,u:v,v:T}=u,I=u.hi?p[b]:x[b],R=u.hi?I:I-1,A=[];for(let N=0;N<n.length;N++){if(N===h||(u.hi?a[N][b]:o[N][b])!==I)continue;let W=Math.max(a[N][v],x[v]),X=Math.min(o[N][v],p[v]),P=Math.max(a[N][T],x[T]),U=Math.min(o[N][T],p[T]);W<X&&P<U&&A.push([W,P,X,U])}let q=[[x[v],x[T],p[v],p[T]]];for(let N of A){let W=[];for(let X of q){let P=Math.max(X[0],N[0]),U=Math.max(X[1],N[1]),V=Math.min(X[2],N[2]),Z=Math.min(X[3],N[3]);if(P>=V||U>=Z){W.push(X);continue}X[0]<P&&W.push([X[0],X[1],P,X[3]]),V<X[2]&&W.push([V,X[1],X[2],X[3]]),X[1]<U&&W.push([P,X[1],V,U]),Z<X[3]&&W.push([P,Z,V,X[3]])}if(q=W,!q.length)break}let S=(N,W)=>{if(!c)return 1;let X=0,P=[0,0,0];P[b]=R;for(let U=-1;U<=0;U++)for(let V=-1;V<=0;V++)P[v]=N+U,P[T]=W+V,c(P[0],P[1],P[2])&&X++;return mx[X<3?X:3]},w=(N,W)=>{let X=[0,0,0];X[b]=I,X[v]=N,X[T]=W;let P=S(N,W);i.push(X[0],X[1],X[2]),s.push(u.n[0],u.n[1],u.n[2]),r.push(f*P,m*P,_*P)};for(let N of q){let W=Wh(N[0],N[2]),X=Wh(N[1],N[3]);for(let P=0;P<W.length-1;P++)for(let U=0;U<X.length-1;U++){let V=W[P],Z=W[P+1],Y=X[U],G=X[U+1];w(V,Y),w(Z,Y),w(Z,G),w(V,Y),w(Z,G),w(V,G)}}}}if(!i.length)return null;let l=new Oe;return l.setAttribute("position",new pe(i,3)),l.setAttribute("normal",new pe(s,3)),l.setAttribute("color",new pe(r,3)),l}function $s(n,t,{transparent:e=!1,pick:i=!1,childId:s=null}={}){if(!n.length)return null;let r=qh(n,t,!e);if(!r)return null;let a=new Se(r,e?qa:Xa);if(a.castShadow=!0,a.receiveShadow=!0,be.add(a),g.meshes.push(a),e){a.renderOrder=2;let o=new Se(r,Ch);o.renderOrder=1,o.castShadow=!1,o.receiveShadow=!1,be.add(o),g.meshes.push(o)}return i&&(a.userData.childId=s,a.userData.emph=!e,g.pickMeshes.push(a),(g.childMeshes[s]||(g.childMeshes[s]=[])).push(a)),a}function xi(n,t,e,i,s,r){let a=Math.max(s,Fh[n.vis||"visible"]);if(!(n===g.editObject||a>=2))if(n.type==="object")r(n,t,e,i,a===1);else for(let o of n.children)xi(o,hn(t,le(o.pos,e)),e+o.rot&3,n===g.context?o.id:i,a,r)}var Xh=(n,t,e,i)=>{for(let s of n.boxes)i.push(mn(s,e,t));return i};function Yh(){let{off:n,rot:t}=g.editXform;if(qn.position.set(n.x,n.y,n.z),qn.rotation.set(0,-t*Math.PI/2,0),qn.updateMatrixWorld(!0),g.editMesh){qn.remove(g.editMesh),g.editMesh.geometry.dispose();let i=g.meshes.indexOf(g.editMesh);i>=0&&g.meshes.splice(i,1)}let e=qh(g.editObject.boxes,Xs,!0);g.editMesh=e?new Se(e,Xa):null,g.editMesh&&(g.editMesh.castShadow=g.editMesh.receiveShadow=!0,qn.add(g.editMesh),g.meshes.push(g.editMesh)),g.pickMeshes=g.editMesh?[g.editMesh]:[]}function gx(){g.editRemesh||(g.editRemesh=requestAnimationFrame(()=>{g.editRemesh=0,Yh(),is()}))}function ec(){g.voxVer++,Qa(),gx()}function Zh(n,t){g.editObject.boxes=Ih(g.editObject.boxes,n,t),ec()}function Jh(n){g.editObject.boxes=cs(g.editObject.boxes,n),ec()}function $h(n,t){g.editObject.boxes=Lh(g.editObject.boxes,n,t),ec()}function ke(){fx(),g.pickMeshes=[],g.childMeshes={},g.childBox={},g.voxVer++,Qa();let n={x:0,y:0,z:0},t=gn();if(g.editObject){g.editXform=ss(fs(),{off:g.editObject.pos,rot:g.editObject.rot});let e=[];xi(g.root,n,0,null,0,(i,s,r)=>Xh(i,s,r,e)),Zn(e,t),$s(e,i=>Xs(i),{transparent:!0}),Yh(),Jn(g.editObject,g.editXform.off,g.editXform.rot,t)}else{let e=new Map,i=new Map,s=[],r=[];xi(g.root,n,0,null,0,(a,o,c,l,h)=>{let d=Xh(a,o,c,[]);if(Zn(d,t),l){let f=h?i:e,m=f.get(l);m?m.push(...d):f.set(l,d),Zn(d,g.childBox[l]||(g.childBox[l]=gn()))}else(h?r:s).push(...d)}),$s(s,a=>Wa(a)),$s(r,a=>Wa(a),{transparent:!0});for(let a of new Set([...e.keys(),...i.keys()])){let o=e.get(a);o&&$s(o,l=>Xs(l),{pick:!0,childId:a});let c=i.get(a);c&&$s(c,l=>Xs(l),{transparent:!0})}}g.sceneBox=t,dx(t),nc(),is()}function xx(n,t,e){let i=new Cn(t.x-n.x,t.y-n.y,t.z-n.z),s=new hi(new ji(i),new Xn({color:e,depthTest:!1}));return s.position.set((n.x+t.x)/2,(n.y+t.y)/2,(n.z+t.z)/2),s.renderOrder=999,i.dispose(),s}function nc(){for(let n of Pn.children)n.geometry?.dispose?.();if(Pn.clear(),Pn.position.set(0,0,0),!g.editObject)for(let n of g.selection){let t=g.childBox[n];t&&Pn.add(xx(t.min,t.max,15787730))}}var Ks=new L,ic=new L,sc=new L,Kh=new L,_x=new L(0,1,0);function jh(n,t){let e=ee.getBoundingClientRect(),i=(Wt.top-Wt.bottom)/e.height;Wt.getWorldDirection(ic),sc.crossVectors(ic,_x).normalize(),Kh.crossVectors(sc,ic).normalize(),Jt.target.addScaledVector(sc,-n*i),Jt.target.addScaledVector(Kh,t*i)}function Qh(n,t){Jt.azim-=n*.012,Jt.elev=Math.max(-.35,Math.min(Math.PI/2,Jt.elev+t*.012))}function tu(n){n.max.x<n.min.x||(Jt.target.set((n.min.x+n.max.x)/2,(n.min.y+n.max.y)/2,(n.min.z+n.max.z)/2),Jt.zoom=Math.max(8,Math.min(eo,Math.max(n.max.x-n.min.x,n.max.y-n.min.y,n.max.z-n.min.z)*1.5+8)))}function In(){let n=gn();if(g.editObject){if(Jn(g.editObject,g.editXform.off,g.editXform.rot,n),n.max.x<n.min.x){let t=g.editXform.off;Jt.target.set(t.x,t.y+6,t.z),Jt.zoom=41;return}}else for(let t in g.childBox){let e=g.childBox[t];n.min.x=Math.min(n.min.x,e.min.x),n.min.y=Math.min(n.min.y,e.min.y),n.min.z=Math.min(n.min.z,e.min.z),n.max.x=Math.max(n.max.x,e.max.x),n.max.y=Math.max(n.max.y,e.max.y),n.max.z=Math.max(n.max.z,e.max.z)}if(n.max.x<n.min.x){Jt.target.set(0,1,0),Jt.zoom=23;return}tu(n)}function rc(n){if(n===g.root){In();return}let t=Zs(n);tu(Jn(n,t.off,t.rot,gn()))}function eu(){Gt.azim+=(Jt.azim-Gt.azim)*.22,Gt.elev+=(Jt.elev-Gt.elev)*.22,Gt.zoom+=(Jt.zoom-Gt.zoom)*.25,Gt.target.lerp(Jt.target,.25);let n=Math.cos(Gt.elev),t=Math.sin(Gt.elev);Ks.set(n*Math.sin(Gt.azim),t,n*Math.cos(Gt.azim)),Wt.position.copy(Gt.target).addScaledVector(Ks,wh);let e=fh.clamp((Gt.elev-1.45)/(Math.PI/2-1.45),0,1);no.set(-Math.sin(Gt.azim),0,-Math.cos(Gt.azim)),Ws.set(0,1,0).lerp(no,e),Ws.lengthSq()<1e-6&&Ws.copy(no),Wt.up.copy(Ws.normalize()),Wt.lookAt(Gt.target);let i=ee.getBoundingClientRect(),s=i.width/i.height,r=Gt.zoom,a=r*s;Wt.left=-a/2,Wt.right=a/2,Wt.top=r/2,Wt.bottom=-r/2;let o=Wt.position,c=1/0,l=-1/0,h=(x,p,u)=>{let b=(o.x-x)*Ks.x+(o.y-p)*Ks.y+(o.z-u)*Ks.z;b<c&&(c=b),b>l&&(l=b)},d=g.sceneBox;if(d&&d.max.x>=d.min.x)for(let x of[d.min.x,d.max.x])for(let p of[d.min.y,d.max.y])for(let u of[d.min.z,d.max.z])h(x,p,u);let f=Gt.target.x,m=Gt.target.z,_=4e3;for(let x of[-_,_])for(let p of[-_,_])h(f+x,0,m+p);c>l&&(c=.1,l=4e3),Wt.near=c-10,Wt.far=l+10,Wt.zoom=1,Wt.updateProjectionMatrix(),fi.position.set(Gt.target.x,0,Gt.target.z),Ah()}var lo=()=>{ke(),Ee()};function vx(){if(g.path.length>1){let n=g.path.pop();g.context=g.path[g.path.length-1],g.selection=new Set([n.id]),g.editObject=null,un(),lo()}}function yx(){let n=g.editObject;g.editObject=null,g.selection=new Set([n.id]),un(),lo()}function nu(){g.editObject?yx():vx()}function _i(n){let t=hs(n);t&&(g.path=t.slice(0,-1),g.context=g.path[g.path.length-1],g.selection=new Set([n.id]),g.editObject=null,lo())}function iu(n){return n.type==="object"?g.editObject===n:g.context===n&&!g.editObject}function vi(n,t){let e=hs(n);e&&(n.type==="scene"?(g.path=e,g.context=n,g.selection.clear(),g.editObject=null,g.tool="add"):(g.path=e.slice(0,-1),g.context=g.path[g.path.length-1],g.editObject=n,g.selection.clear(),g.tool="add"),un(),lo(),t&&In())}var Mx=200,Ln=[],yi=-1,oc=!1,Sx=n=>({rootJSON:n,uid:os(),pathIds:g.path.map(t=>t.id),selection:[...g.selection],editId:g.editObject?g.editObject.id:null,collapsed:[...g.collapsed]});function su(n){if(oc)return;let t=Sx(n),e=Ln[yi];e&&e.rootJSON===t.rootJSON&&e.editId===t.editId||(Ln.length=yi+1,Ln.push(t),Ln.length>Mx&&Ln.shift(),yi=Ln.length-1)}function ru(n){oc=!0,as(n.uid),g.root=vs(JSON.parse(n.rootJSON)),g.path=[];let t=g.root;for(let e of n.pathIds){let i=t.id===e?t:t.type==="scene"?t.children.find(s=>s.id===e):null;if(!i)break;t=i,g.path.push(t)}g.path.length||(g.path=[g.root]),g.context=g.path[g.path.length-1],g.editObject=n.editId?us(n.editId):null,g.selection=new Set(n.selection.filter(e=>g.context.children.some(i=>i.id===e))),g.collapsed=new Set(n.collapsed),g.drag=null,g.painting=!1,g.lastVox=null,ke(),Ee(),he(),oc=!1}function ou(){ys(),yi>0&&ru(Ln[--yi])}function ac(){ys(),yi<Ln.length-1&&ru(Ln[++yi])}var au="voxelier-v11";function ho(n){let t={id:n.id,nm:n.name||"",p:n.pos,r:n.rot,vs:n.vis||"visible"};return n.type==="object"?{t:"o",...t,b:n.boxes.map(e=>[e.x0,e.y0,e.z0,e.x1,e.y1,e.z1,e.c])}:{t:"s",...t,c:n.children.map(ho)}}function vs(n){let t={id:n.id,name:n.nm||"",pos:n.p,rot:n.r,vis:n.vs||"visible"};return n.t==="o"?{type:"object",...t,boxes:n.b.map(e=>({x0:e[0],y0:e[1],z0:e[2],x1:e[3],y1:e[4],z1:e[5],c:e[6]}))}:{type:"scene",...t,children:n.c.map(vs)}}function ys(){clearTimeout(g.saveT??void 0),g.saveT=null;let n=JSON.stringify(ho(g.root));su(n);try{localStorage.setItem(au,`{"uid":${os()},"root":${n}}`)}catch{}}function he(){clearTimeout(g.saveT??void 0),g.saveT=setTimeout(ys,250)}function cu(){try{let n=JSON.parse(localStorage.getItem(au));return!n||!n.root?!1:(as(n.uid||1),g.root=vs(n.root),!0)}catch{return!1}}var Ms=()=>{ke(),Ee(),he()};function lu(n){n.vis=zh[n.vis||"visible"],Ms()}function cc(n){let t=prompt("Name",n.name||"");t!=null&&(n.name=t.trim(),Ee(),he())}var hu=()=>[...g.selection].map(n=>mi(n)).filter(n=>!!n),lc=n=>{let t=oo(n);return t.pos={x:n.pos.x+5,y:n.pos.y,z:n.pos.z+5},t};function uu(){let n=Ys();n.pos={x:Math.round(Jt.target.x),y:0,z:Math.round(Jt.target.z)},g.context.children.push(n),vi(n,!0),he()}function hc(){g.selection.size&&(g.context.children=g.context.children.filter(n=>!g.selection.has(n.id)),g.selection.clear(),Ms())}function du(){let n=hu().map(lc);n.length&&(g.context.children.push(...n),g.selection=new Set(n.map(t=>t.id)),Ms())}function uc(){g.clipboard=hu().map(oo)}function fu(){uc(),hc()}function pu(){if(!g.clipboard.length)return;let n=g.clipboard.map(lc);g.context.children.push(...n),g.selection=new Set(n.map(t=>t.id)),Ms()}function dc(n,t,e){if(n===t||ds(n,t))return!1;let i=gi(n);if(!i)return!1;let s=ss(Zs(i),{off:{...n.pos},rot:n.rot}),r=ss(Ph(Zs(t)),s),a=i.children.indexOf(n);return i.children.splice(a,1),i===t&&a<e&&e--,n.pos={x:Math.round(r.off.x),y:Math.round(r.off.y),z:Math.round(r.off.z)},n.rot=r.rot&3,t.children.splice(Math.max(0,Math.min(e,t.children.length)),0,n),!0}function fc(n){let t=gi(n);if(!t)return null;let e=t.children.indexOf(n),i=ls();return i.name="Group",i.pos={...n.pos},i.rot=n.rot,t.children.splice(e,1,i),n.pos={x:0,y:0,z:0},n.rot=0,i.children=[n],i}function mu(n,t){if(t===n||ds(t,n))return!1;let e=fc(n);return e?(dc(t,e,e.children.length),g.collapsed.delete(e.id),g.selection=new Set([e.id]),Ms(),!0):!1}function gu(n){let t=gi(n);if(!t)return;let e=lc(n);t.children.splice(t.children.indexOf(n)+1,0,e),_i(e),he()}function xu(n){let t=gi(n);t&&(t.children=t.children.filter(e=>e!==n),g.selection.delete(n.id),g.editObject===n&&(g.editObject=null),Ms())}function _u(n){let t=Ys();n.children.push(t),g.collapsed.delete(n.id),vi(t,!0),he()}function vu(n){let t=ls();t.name="Group",n.children.push(t),g.collapsed.delete(n.id),_i(t),he()}function pc(n){let t=n<0?-1:1;for(let e=0;e<Math.abs(n);e++){let i=fs(),s=r=>Jn(r,hn(i.off,le(r.pos,i.rot)),i.rot+r.rot&3,gn());for(let r of g.selection){let a=mi(r);if(!a)continue;let o=s(a);a.rot=a.rot+t&3;let c=s(a),l={x:(o.min.x+o.max.x)/2-(c.min.x+c.max.x)/2,z:(o.min.z+o.max.z)/2-(c.min.z+c.max.z)/2},h=le({x:Math.round(l.x),y:0,z:Math.round(l.z)},4-i.rot&3);a.pos.x+=h.x,a.pos.z+=h.z}}g.selection.size&&ke()}function yu(){g.selection.size&&(pc(1),he())}function mc(n){for(let t of g.selection){let e=mi(t);e&&(e.pos.y+=n)}g.selection.size&&(ke(),he())}function Mu(){let n=JSON.stringify({uid:os(),root:ho(g.root)}),t=URL.createObjectURL(new Blob([n],{type:"application/json"})),e=g.root.name||"Project",i=new Date,[s,r]=new Date(i.getTime()-i.getTimezoneOffset()*6e4).toISOString().slice(0,19).split("T"),a=`${s} ${r.replace(/:/,"h").replace(/:/,"m")}s`,o=document.createElement("a");o.href=t,o.download=`${e} -- ${a}.voxelier.json`,o.click(),URL.revokeObjectURL(t)}function Su(){let n=document.createElement("input");n.type="file",n.accept="application/json,.json",n.onchange=()=>{let t=n.files&&n.files[0];if(!t)return;let e=new FileReader;e.onload=()=>{try{let i=JSON.parse(e.result);if(!i||!i.root)throw new Error("not a Voxelier scene file");as(i.uid||1),g.root=vs(i.root),g.path=[g.root],g.context=g.root,g.editObject=null,g.selection.clear(),un(),ke(),Ee(),In(),he()}catch(i){alert("Import failed: "+i.message)}},e.readAsText(t)},n.click()}function ue(n,t={},...e){let i=document.createElement(n);return Object.assign(i,t),e.length&&i.append(...e),i}var bx=[{id:"add",ic:"\uFF0B",label:"Add"},{id:"erase",ic:"\uFF0D",label:"Erase"},{id:"paint",ic:"\u2756",label:"Paint"},{id:"measure",ic:"\u{1F4CF}",label:"Measure"}],Ex={visible:"\u25C9",transparent:"\u25D0",invisible:"\u29B0"};function Ee(){let n=document.getElementById("tools");if(n.innerHTML="",g.editObject)for(let e of bx)n.appendChild(ue("button",{className:"tool"+(g.tool===e.id?" active":""),innerHTML:`<span class="ic">${e.ic}</span>${e.label}`,onclick:()=>{g.tool=e.id,un(),qe.visible=!1,Ee()}}));else n.appendChild(ue("button",{className:"tool"+(g.measMode?" active":""),innerHTML:'<span class="ic">\u{1F4CF}</span>Measure',onclick:()=>{g.measMode=!g.measMode,g.measMode||un(),Ee()}}));let t=ue("div");t.style.flex="1",n.appendChild(t);for(let[e,i,s]of[["\u{1F4C2}","Import",Su],["\u{1F4BE}","Export",Mu]])n.appendChild(ue("button",{className:"tool",innerHTML:`<span class="ic">${e}</span>${i}`,onclick:s}));Au(),Ss(),document.getElementById("statHint").textContent=xs()?"Measure \u2014 hover to read voxel/gap runs on all 3 axes \xB7 left-click freezes \xB7 right-click clears":g.editObject?g.tool==="paint"?"Paint \u2014 click/drag to recolour voxels \xB7 right-drag orbits \xB7 middle-drag pans \xB7 Esc to finish":`${g.tool==="add"?"Add":"Erase"} \u2014 drag a box in the floor plane (Shift = height) \xB7 right-drag orbits \xB7 middle-drag pans \xB7 Esc to finish`:g.selection.size?`${g.selection.size} selected \u2014 drag to move (Shift: up/down \xB7 Alt: allow overlap) \xB7 right-drag rotate \xB7 R rotate \xB7 Del`:"Tree: click a row to enter it \xB7 double-click to fit \xB7 right-click for actions \xB7 N new object"}var uo={ver:-1,cols:[]};function Eu(){if(uo.ver===g.voxVer)return uo.cols;let n=new Map;return function t(e){e.type==="object"?Dh(e.boxes,n):e.children.forEach(t)}(g.root),uo={ver:g.voxVer,cols:[...n.entries()].sort((t,e)=>e[1]-t[1]).map(t=>t[0])},uo.cols}function Ss(){let n=document.getElementById("swatches");n.innerHTML="";let t=Eu().slice();t.includes(g.selColor)||t.unshift(g.selColor);let e=i=>{let s=ue("div",{className:"sw"+(i===g.selColor?" active":""),title:rs(i),onclick:()=>{g.selColor=i,Ss()}});return s.style.background=rs(i),s};if(t.length>15){for(let i=0;i<14;i++)n.appendChild(e(t[i]));n.appendChild(ue("div",{className:"sw more",textContent:"\u2026",title:"All used colours",onclick:Tx}))}else for(let i=0;i<15;i++)n.appendChild(i<t.length?e(t[i]):ue("div",{className:"sw empty"}));n.appendChild(ue("div",{className:"sw more",textContent:"\u{1F3A8}",title:"Use colour picker",onclick:wx}))}function wx(){let n=ue("input",{type:"color",value:rs(g.selColor)});n.style.cssText="position:fixed;left:-9999px;top:0";let t=()=>{g.selColor=parseInt(n.value.slice(1),16),Ss()};n.addEventListener("input",t),n.addEventListener("change",()=>{t(),n.remove()}),document.body.appendChild(n),n.click()}function Tx(){fo();let n=ue("div",{id:"palback"});n.onclick=s=>{s.target===n&&fo()};let t=ue("div",{id:"palpop"});t.appendChild(ue("div",{className:"pophead",textContent:"Used colours"}));let e=ue("div",{className:"popgrid"}),i=Eu();if(!i.length){let s=ue("div",{textContent:"No colours yet."});s.style.cssText="color:var(--ink-dim);font-size:12px",e.appendChild(s)}for(let s of i){let r=ue("div",{className:"sw"+(s===g.selColor?" active":""),title:rs(s),onclick:()=>{g.selColor=s,Ss(),fo()}});r.style.background=rs(s),e.appendChild(r)}t.appendChild(e),n.appendChild(t),document.body.appendChild(n)}function fo(){let n=document.getElementById("palback");return n?(n.remove(),!0):!1}function wu(n,t,e,i){if(n.type==="object")for(let s of n.boxes)i.push(mn(s,e,t));else for(let s of n.children)wu(s,hn(t,le(s.pos,e)),e+s.rot&3,i);return i}var gc=(n,t)=>{let e=Math.min(255,(n>>16&255)*t)|0,i=Math.min(255,(n>>8&255)*t)|0,s=Math.min(255,(n&255)*t)|0;return`rgb(${e},${i},${s})`},bu=new Map;function Tu(n){return n.type==="object"?"o"+n.boxes.map(t=>`${t.x0},${t.y0},${t.z0},${t.x1},${t.y1},${t.z1},${t.c}`).join(";"):"s"+n.children.map(t=>t.id+Tu(t)).join()}function Ax(n){let t=bu.get(n.id);if(n===g.editObject&&t)return t.cv;let e=Tu(n);if(t&&t.sig===e)return t.cv;let i=document.createElement("canvas");i.width=i.height=52,i.style.width=i.style.height="26px";let s=i.getContext("2d");s.fillStyle="#0f1115",s.fillRect(0,0,52,52);let r=wu(n,{x:0,y:0,z:0},0,[]);if(r.length){let a=1e9,o=1e9,c=1e9,l=-1e9,h=-1e9,d=-1e9;for(let u of r)a=Math.min(a,u.x0),o=Math.min(o,u.y0),c=Math.min(c,u.z0),l=Math.max(l,u.x1),h=Math.max(h,u.y1),d=Math.max(d,u.z1);let f=40/Math.max(l-a,h-o,d-c,1),m=26-((a+l)/2-(c+d)/2)*f*.5,_=28+(o+h)/2*f*.6-((a+l)/2+(c+d)/2)*f*.28,x=(u,b,v)=>[m+(u-v)*f*.5,_-b*f*.6+(u+v)*f*.28],p=(u,b)=>{s.fillStyle=u,s.beginPath(),s.moveTo(b[0][0],b[0][1]);for(let v=1;v<b.length;v++)s.lineTo(b[v][0],b[v][1]);s.closePath(),s.fill()};r.sort((u,b)=>u.x0+u.x1+u.y0+u.y1+u.z0+u.z1-(b.x0+b.x1+b.y0+b.y1+b.z0+b.z1));for(let u of r)p(gc(u.c,.78),[x(u.x1,u.y0,u.z0),x(u.x1,u.y1,u.z0),x(u.x1,u.y1,u.z1),x(u.x1,u.y0,u.z1)]),p(gc(u.c,.6),[x(u.x0,u.y0,u.z1),x(u.x1,u.y0,u.z1),x(u.x1,u.y1,u.z1),x(u.x0,u.y1,u.z1)]),p(gc(u.c,1),[x(u.x0,u.y1,u.z0),x(u.x1,u.y1,u.z0),x(u.x1,u.y1,u.z1),x(u.x0,u.y1,u.z1)])}return bu.set(n.id,{sig:e,cv:i}),i}function Rx(n){if(g.pending&&g.pending.node===n){clearTimeout(g.pending.timer),g.pending=null,rc(n);return}g.pending&&clearTimeout(g.pending.timer);let t=e=>{g.pending={node:n,timer:setTimeout(()=>{g.pending=null,e&&e()},300)}};iu(n)?t(()=>cc(n)):(vi(n),t())}function Au(){let n=document.getElementById("tree");n.innerHTML="";let t=(e,i)=>{let s=e===g.root,r=!s&&g.context.children.includes(e)&&g.selection.has(e.id),a=e.vis||"visible",o=ue("div",{className:"trow"+(s?" root":"")+(r?" sel":"")+(e===g.context&&!g.editObject?" ctx":"")+(e===g.editObject?" edit":"")+(!s&&a!=="visible"?" dim":"")});o.style.paddingLeft=4+i*13+"px";let c=Ax(e);if(c.className="thumb",c.onclick=null,c.title="",!s&&e.type==="scene"&&e.children.length){let h=g.collapsed.has(e.id);c.classList.add("group"),h&&c.classList.add("collapsed"),c.title=h?"Expand group":"Collapse group",c.onclick=d=>{d.stopPropagation(),h?g.collapsed.delete(e.id):g.collapsed.add(e.id),Au()}}let l=ue("span",{className:"nm"});if(s?l.textContent=e.name||"Project":e.name?l.textContent=e.name:l.innerHTML='<span class="ph">'+(e.type==="scene"?"group":"object")+"</span>",o.append(c,l),s||o.append(ue("button",{className:"tb"+(a==="visible"?" on":""),textContent:Ex[a],title:"visible \u2192 transparent \u2192 invisible",onclick:h=>{h.stopPropagation(),lu(e)}})),o.onclick=()=>Rx(e),o.oncontextmenu=h=>{h.preventDefault(),h.stopPropagation(),s||_i(e),Cx(e,h.clientX,h.clientY)},o.draggable=!s,s||o.addEventListener("dragstart",h=>{if(h.stopPropagation(),g.dragId=e.id,h.dataTransfer){h.dataTransfer.effectAllowed="move";try{h.dataTransfer.setData("text/plain",e.id)}catch{}}}),o.addEventListener("dragend",js),o.addEventListener("dragover",h=>{h.preventDefault(),h.stopPropagation(),Px(h,e,o)}),o.addEventListener("drop",h=>{h.preventDefault(),h.stopPropagation(),Cu()}),n.appendChild(o),e.type==="scene"&&(s||!g.collapsed.has(e.id)))for(let h of e.children)t(h,i+1)};t(g.root,0)}function xc(){g.ctxMenuEl&&(g.ctxMenuEl.remove(),g.ctxMenuEl=null,window.removeEventListener("pointerdown",Ru,!0))}function Ru(n){g.ctxMenuEl&&!g.ctxMenuEl.contains(n.target)&&xc()}function Cx(n,t,e){xc();let i=ue("div",{className:"ctxmenu"}),s=(o,c,l)=>i.appendChild(ue("div",{className:"ctxitem"+(l?" "+l:""),textContent:o,onclick:()=>{xc(),c()}})),r=()=>i.appendChild(ue("div",{className:"ctxdiv"}));s("Rename",()=>cc(n)),s("Fit",()=>rc(n)),r(),n!==g.root&&(s("Duplicate",()=>gu(n)),s("Delete",()=>xu(n),"danger"),r()),n.type==="scene"?(s("New object",()=>_u(n)),s("New group",()=>vu(n))):s("New group",()=>{let o=fc(n);o&&(g.collapsed.delete(o.id),_i(o),he())}),document.body.appendChild(i),g.ctxMenuEl=i;let a=i.getBoundingClientRect();i.style.left=Math.min(t,innerWidth-a.width-4)+"px",i.style.top=Math.min(e,innerHeight-a.height-4)+"px",setTimeout(()=>window.addEventListener("pointerdown",Ru,!0),0)}function js(){g.dropRow&&g.dropRow.classList.remove("drop-into","drop-before","drop-after"),g.dropRow=null,g.dropInfo=null}function Px(n,t,e){let i=g.dragId&&us(g.dragId);if(!i||i===t||ds(i,t)){js();return}if(js(),g.dropRow=e,t===g.root){g.dropInfo={parent:g.root,index:g.root.children.length},e.classList.add("drop-into");return}let s=e.getBoundingClientRect(),r=n.clientY-s.top,a=s.height,o=gi(t),c=o?o.children.indexOf(t):0;r>a*.28&&r<a*.72?(t.type==="scene"?g.dropInfo={parent:t,index:t.children.length}:g.dropInfo={wrap:t},e.classList.add("drop-into")):r<a*.5?(g.dropInfo={parent:o,index:c},e.classList.add("drop-before")):(g.dropInfo={parent:o,index:c+1},e.classList.add("drop-after"))}function Cu(){let n=g.dragId&&us(g.dragId);n&&g.dropInfo&&(g.dropInfo.wrap?mu(g.dropInfo.wrap,n):g.dropInfo.parent&&dc(n,g.dropInfo.parent,g.dropInfo.index)&&(g.collapsed.delete(g.dropInfo.parent.id),_i(n),he())),js(),g.dragId=null}{let n=document.getElementById("tree");n.addEventListener("dragover",t=>{t.target===n&&g.dragId&&(t.preventDefault(),js(),g.dropInfo={parent:g.root,index:g.root.children.length})}),n.addEventListener("drop",t=>{t.target===n&&(t.preventDefault(),Cu())})}window.addEventListener("keydown",n=>{if(n.target.tagName==="INPUT")return;let t=n.key.toLowerCase(),e=n.ctrlKey||n.metaKey;if(!(t==="escape"&&fo())){if(e){if(t==="z"){n.preventDefault(),n.shiftKey?ac():ou();return}if(t==="y"){n.preventDefault(),ac();return}if(t==="c"){g.editObject||(uc(),n.preventDefault());return}if(t==="x"){g.editObject||(fu(),n.preventDefault());return}if(t==="v"){g.editObject||(pu(),n.preventDefault());return}if(t==="d"){g.editObject||(du(),n.preventDefault());return}return}switch(t){case"f":In();break;case"escape":nu();break;case"n":g.editObject||uu();break;case"r":g.editObject||yu();break;case"[":g.editObject||mc(-1);break;case"]":g.editObject||mc(1);break;case"delete":case"backspace":g.editObject||(n.preventDefault(),hc());break}}});var qt=n=>Math.floor(n/10),re=Oh,bs=(n,t)=>{let e=Ys();return e.name=n,e.boxes=t,e},_c=(n,t,e,i,s,r)=>({x0:n,y0:t,z0:e,x1:i,y1:s,z1:r});function Pu(){let n=qt(4465),t=qt(2985),e=qt(2700),i=qt(150),s=bs("Floor",[ne(0,0,0,n,1,t,re[9])]),r=qt(800),a=qt(2100),o=n-qt(515)-r,c=n-qt(900)-r,l=[ne(0,1,0,n,e+1,i,re[5]),ne(0,1,t-i,n,e+1,t,re[5]),ne(0,1,i,i,e+1,t-i,re[5]),ne(n-i,1,i,n,e+1,t-i,re[5])];l=cs(l,_c(o,1,0,o+r,a+1,i)),l=cs(l,_c(c,1,t-i,c+r,a+1,t)),l=cs(l,_c(0,qt(900),qt(600),i,qt(2100),t-qt(600)));let h=bs("Walls",l);h.vis="transparent";let d=qt(1500),f=qt(2e3),m=bs("Bed",[ne(0,0,0,8,14,8,re[7]),ne(d-8,0,0,d,14,8,re[7]),ne(0,0,f-8,8,14,f,re[7]),ne(d-8,0,f-8,d,14,f,re[7]),ne(0,14,0,d,20,f,re[6]),ne(2,20,0,d-2,24,f-qt(400),re[10])]);m.pos={x:i+3,y:1,z:t-i-f};let _=qt(1400),x=qt(700),p=qt(740),u=bs("Desk",[ne(0,p-4,0,_,p,x,re[8]),ne(0,0,0,6,p-4,6,re[7]),ne(_-6,0,0,_,p-4,6,re[7]),ne(0,0,x-6,6,p-4,x,re[7]),ne(_-6,0,x-6,_,p-4,x,re[7])]),b=qt(600),v=b-30>>1,T=b>>1,I=bs("Computer",[ne(v,0,0,v+30,2,18,re[11]),ne(T-2,2,7,T+2,qt(160),11,re[11]),ne(0,qt(160),6,b,qt(520),9,re[13])]);I.pos={x:qt(400),y:p,z:qt(420)};let R=ls();R.name="Desk + Computer",R.pos={x:n-i,y:1,z:qt(900)},R.rot=1,R.children=[u,I];let A=N=>bs(N,[ne(-10,0,-10,11,30,11,re[4]),ne(-2,30,-2,3,54,3,re[14]),ne(-16,54,-16,17,78,17,re[14]),ne(-12,78,-12,13,92,13,re[14])]),q=A("Plant"),S=A("Plant");q.pos={x:n-i-qt(300),y:1,z:i+qt(300)},S.pos={x:i+qt(300),y:1,z:i+qt(300)};let w=ls();return w.children=[s,h,m,R,q,S],w}var Iu=n=>Math.abs(n.clientX-g.drag.sx)+Math.abs(n.clientY-g.drag.sy)>3;function Lu(n){let t=g.drag;if(!t||t.mode!=="pan"&&t.mode!=="orbit")return!1;let e=n.clientX-t.x,i=n.clientY-t.y;return t.x=n.clientX,t.y=n.clientY,(t.mode==="pan"?jh:Qh)(e,i),!0}function Ix(){let n=[],t=[];return xi(g.root,{x:0,y:0,z:0},0,null,0,(e,i,s,r)=>{let a=r&&g.selection.has(r)?t:n;for(let o of e.boxes)a.push(mn(o,s,i))}),{occ:n,sel:t}}var Lx=(n,t,e,i)=>Nh(n.sel??[],n.occ??[],t,e,i);function Dx(n){let t=g.drag,e=t.dx,i=t.dy,s=t.dz;if(n.shiftKey){t.shiftAnchorY==null&&(t.shiftAnchorY=n.clientY,t.dyBase=t.dy);let a=(Wt.top-Wt.bottom)/ee.getBoundingClientRect().height;i=t.dyBase+Math.round((t.shiftAnchorY-n.clientY)*a)}else{t.shiftAnchorY=null;let a=ps(0);a&&t.start&&(e=a.x-t.start.x,s=a.z-t.start.z)}let r=(a,o,c)=>n.altKey||!Lx(t,a,o,c);r(e,t.dy,t.dz)&&(t.dx=e),r(t.dx,i,t.dz)&&(t.dy=i),r(t.dx,t.dy,s)&&(t.dz=s);for(let a of g.selection)for(let o of g.childMeshes[a]||[])o.position.set(t.dx,t.dy,t.dz);Pn.position.set(t.dx,t.dy,t.dz)}function Ux(){let n=g.drag,t=fs(),e=le({x:Math.round(n.dx),y:0,z:Math.round(n.dz)},4-t.rot&3),i=Math.round(n.dy);for(let s of g.selection){let r=mi(s);r&&(r.pos.x+=e.x,r.pos.y+=i,r.pos.z+=e.z)}Pn.position.set(0,0,0),ke(),he()}function Nx(n){let t=Math.round((g.drag.sx-n.clientX)/70);t!==g.drag.steps&&(pc(t-g.drag.steps),g.drag.steps=t)}function Du(){let n=ms(),t=co(n);if(!t)return;let e=Ya(t.x,t.y,t.z);e!==g.lastVox&&($h({x0:t.x,y0:t.y,z0:t.z,x1:t.x+1,y1:t.y+1,z1:t.z+1},g.selColor),g.lastVox=e),Uu(n)}function Uu(n=ms()){let t=null;if(g.tool==="add"?t=n?n.addCell:co(n):t=n?n.cell:null,!t){qe.visible=!1;return}let e=hn(le(t,g.editXform.rot),g.editXform.off);qe.visible=!0,qe.material.color.set(g.tool==="erase"?11895693:10994876),qe.position.set(e.x+.5,e.y+.5,e.z+.5)}function Ox(n,t){let e=co();e&&(g.drag={...t,mode:"box",shiftAnchorY:null,hyBase:0,box:{x0:e.x,y0:e.y,z0:e.z,x1:e.x,z1:e.z,hy:0}},qe.visible=!1,Ou())}function Fx(n){let t=g.drag,e=t.box;if(n.shiftKey){let i=(Wt.top-Wt.bottom)/ee.getBoundingClientRect().height;t.shiftAnchorY===null&&(t.shiftAnchorY=n.clientY,t.hyBase=e.hy),e.hy=t.hyBase+Math.round((t.shiftAnchorY-n.clientY)*i)}else{t.shiftAnchorY=null;let i=Js(e.y0);i&&(e.x1=i.x,e.z1=i.z)}Ou()}function Nu(){let n=g.drag.box;return{x0:Math.min(n.x0,n.x1),x1:Math.max(n.x0,n.x1),z0:Math.min(n.z0,n.z1),z1:Math.max(n.z0,n.z1),y0:Math.min(n.y0,n.y0+n.hy),y1:Math.max(n.y0,n.y0+n.hy)}}function zx(){let n=Nu(),t={x0:n.x0,y0:n.y0,z0:n.z0,x1:n.x1+1,y1:n.y1+1,z1:n.z1+1};g.tool==="add"?Zh(t,g.selColor):Jh(t),g.liveMeas=null,_s(),Ee(),he()}function Ou(){let n=Nu(),t=n.x0,e=n.x1+1,i=n.y0,s=n.y1+1,r=n.z0,a=n.z1+1,o=e-t,c=s-i,l=a-r,h=(f,m,_,x,p,u,b,v)=>({a:gs(f,m,_),b:gs(x,p,u),mid:gs((f+x)/2,(m+p)/2,(_+u)/2),len:b,filled:!0,nolabel:!v}),d=[];d.push(h(t,i,r,e,i,r,o,o>=2)),d.push(h(t,i,r,t,i,a,l,l>=2)),d.push(h(t,i,r,t,s,r,c,c>=2)),d.push(h(e,i,r,e,i,a,0,!1),h(t,i,a,e,i,a,0,!1)),d.push(h(t,s,r,e,s,r,0,!1),h(t,s,r,t,s,a,0,!1),h(e,s,r,e,s,a,0,!1),h(t,s,a,e,s,a,0,!1)),d.push(h(e,i,r,e,s,r,0,!1),h(t,i,a,t,s,a,0,!1),h(e,i,a,e,s,a,0,!1)),g.liveMeas=d,_s()}ee.addEventListener("pointerdown",n=>{ee.setPointerCapture(n.pointerId),ao(n.clientX,n.clientY);let t={x:n.clientX,y:n.clientY,sx:n.clientX,sy:n.clientY};if(xs()){n.button===0?g.drag={...t,mode:"pan",meas:"freeze"}:n.button===2?g.drag={...t,mode:"orbit",meas:"clear"}:n.button===1&&(g.drag={...t,mode:"pan",sx:-1e9});return}if(g.editObject){n.button===0?g.tool==="add"||g.tool==="erase"?Ox(n,t):(g.painting=!0,g.lastVox=null,Du()):n.button===2?g.drag={...t,mode:"orbit"}:n.button===1&&(g.drag={...t,mode:"pan"});return}let e=ja(),i=e&&g.selection.has(e);n.button===0?i?g.drag={...t,mode:"move",start:ps(0),dx:0,dy:0,dz:0,shiftAnchorY:null,...Ix()}:g.drag={...t,mode:"pan",clickId:e}:n.button===2?i?g.drag={...t,mode:"rotobj",steps:0}:g.drag={...t,mode:"orbit"}:n.button===1&&(g.drag={...t,mode:"pan",clickId:null,sx:-1e9})});ee.addEventListener("pointermove",n=>{if(ao(n.clientX,n.clientY),xs()){Lu(n),Vh();return}if(g.editObject&&g.painting){Du();return}if(!g.drag){g.editObject?Uu():qe.visible=!1;return}Lu(n)||(g.drag.mode==="move"?Dx(n):g.drag.mode==="rotobj"?Nx(n):g.drag.mode==="box"&&Fx(n))});ee.addEventListener("pointerup",n=>{try{ee.releasePointerCapture(n.pointerId)}catch{}if(xs()){g.drag&&!Iu(n)&&(g.drag.meas==="freeze"?Hh():g.drag.meas==="clear"&&un()),g.drag=null;return}if(g.editObject){g.painting?(g.painting=!1,Ee(),he()):g.drag&&g.drag.mode==="box"&&zx(),g.drag=null;return}if(g.drag)if(g.drag.mode==="pan"&&!Iu(n)){let t=g.drag.clickId;t?n.shiftKey?g.selection.has(t)?g.selection.delete(t):g.selection.add(t):g.selection=new Set([t]):n.shiftKey||g.selection.clear(),nc(),Ee()}else g.drag.mode==="move"?Ux():g.drag.mode==="rotobj"&&g.drag.steps&&he();g.drag=null});ee.addEventListener("pointerleave",()=>{qe.visible=!1});ee.addEventListener("contextmenu",n=>n.preventDefault());ee.addEventListener("wheel",n=>{n.preventDefault(),Jt.zoom*=n.deltaY>0?1/.95:.95,Jt.zoom=Math.max(6,Math.min(eo,Jt.zoom))},{passive:!1});ee.addEventListener("dblclick",n=>{if(g.editObject)return;ao(n.clientX,n.clientY);let t=ja();t&&vi(mi(t),!0)});for(let n of["pointerdown","pointermove","pointerup","pointerleave","wheel","keydown","dblclick"])window.addEventListener(n,is,{passive:!0,capture:!0});var Bx=()=>Math.abs(Jt.azim-Gt.azim)<.001&&Math.abs(Jt.elev-Gt.elev)<.001&&Math.abs(Jt.zoom-Gt.zoom)<.001&&Gt.target.distanceToSquared(Jt.target)<1e-6;function Fu(){let n=ee.getBoundingClientRect(),t=Math.max(1,Math.round(n.width)),e=Math.max(1,Math.round(n.height)),i=Math.min(devicePixelRatio,2);(ee.width!==Math.round(t*i)||ee.height!==Math.round(e*i))&&(ns.setSize(t,e,!1),is())}window.addEventListener("resize",Fu);function zu(){requestAnimationFrame(zu),Fu(),eu(),(Gs.tail>0||!Bx())&&(ns.render(be,Wt),Gh(),Gs.tail>0&&Gs.tail--)}function kx(){cu()||(g.root=Pu()),g.path=[g.root],g.context=g.root,g.editObject=null,g.selection.clear(),Ss(),ke(),Ee(),In(),ys(),zu()}kx();
/**
 * @license
