...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function Il(){return new cn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Va(),fragmentShader:`
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function Ll(){return new cn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Va(),fragmentShader:`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      }`}));Wa.frustumCulled=!1;Wa.renderOrder=-1e9;be.add(Wa);function Rh(){Ah.uGround.value=Math.max(0,Math.min(1,(Gt.elev+.05)/.1))}be.add(new $r(16777215,.62));var Xe=new Vs(16777215,.78);Xe.castShadow=!0;Xe.shadow.mapSize.set(4096,4096);Xe.shadow.normalBias=.15;Xe.shadow.bias=-2e-4;be.add(Xe);be.add(Xe.target);var Ch=new Vs(16777215,.16);Ch.position.set(-6,5,-7);be.add(Ch);var Gs={tail:60},is=()=>{Gs.tail=30},Xa=new Cn(1,1,1),Ws=new L,no=new L,cx=new Tt("#0f1115"),Eh=new Map,wh=new Map;function Xs(n){let t=Eh.get(n);return t||(t=new Tt().setHex(n),Eh.set(n,t)),t}function Ya(n){let t=wh.get(n);return t||(t=new Tt().setHex(n).lerp(cx,.62),wh.set(n,t)),t}var qa=new Bs({vertexColors:!0,side:je}),lx=.42,Za=new Bs({vertexColors:!0,transparent:!0,opacity:lx,side:je,depthWrite:!1});Za.shadowSide=sn;var Ph=new Zi({colorWrite:!1,side:je});var fi=new Se(new $i(8e3,8e3),new Zr({opacity:.32}));fi.rotation.x=-Math.PI/2;fi.position.y=0;fi.receiveShadow=!0;fi.renderOrder=-1;be.add(fi);var Yn=new wn;be.add(Yn);var Pn=new wn;be.add(Pn);var Ye=new hi(new ji(Xa),new Xn({color:10994876,depthTest:!1}));Ye.visible=!1;Ye.renderOrder=999;be.add(Ye);var pi=new hi(new Oe,new Xn({vertexColors:!0,transparent:!0,depthTest:!1}));pi.renderOrder=998;pi.visible=!1;be.add(pi);var pn=new Kr,qn=new Ht,io=new L,Ys=new L;var Ja=(n,t,e)=>n+65536+(t+65536)*131072+(e+65536)*131072*131072;var hn=(n,t)=>({x:n.x+t.x,y:n.y+t.y,z:n.z+t.z});function le(n,t){let{x:e,y:i,z:s}=n;switch(t&3){case 1:return{x:-s,y:i,z:e};case 2:return{x:-e,y:i,z:-s};case 3:return{x:s,y:i,z:-e};default:return{x:e,y:i,z:s}}}var ss=(n,t)=>({rot:n.rot+t.rot&3,off:hn(le(t.off,n.rot),n.off)}),Ih=n=>{let t=4-(n.rot&3)&3,e=le(n.off,t);return{rot:t,off:{x:-e.x,y:-e.y,z:-e.z}}},$a=n=>n.slice(1).reduce((t,e)=>ss(t,{off:e.pos,rot:e.rot}),{off:{x:0,y:0,z:0},rot:0}),rs=n=>"#"+(n>>>0).toString(16).padStart(6,"0").slice(-6),Ka=1,so=()=>"n"+Ka++,os=()=>Ka,as=n=>{Ka=n};var ee=(n,t,e,i,s,r,a)=>({x0:n,y0:t,z0:e,x1:i,y1:s,z1:r,c:a}),ja=(n,t)=>n.x0<t.x1&&t.x0<n.x1&&n.y0<t.y1&&t.y0<n.y1&&n.z0<t.z1&&t.z0<n.z1;function ro(n,t,e){let i=Math.max(n.x0,t.x0),s=Math.max(n.y0,t.y0),r=Math.max(n.z0,t.z0),a=Math.min(n.x1,t.x1),o=Math.min(n.y1,t.y1),c=Math.min(n.z1,t.z1);if(i>=a||s>=o||r>=c){e.push(n);return}let l=n.c;n.x0<i&&e.push({...n,x1:i}),a<n.x1&&e.push({...n,x0:a}),n.y0<s&&e.push({x0:i,y0:n.y0,z0:n.z0,x1:a,y1:s,z1:n.z1,c:l}),o<n.y1&&e.push({x0:i,y0:o,z0:n.z0,x1:a,y1:n.y1,z1:n.z1,c:l}),n.z0<r&&e.push({x0:i,y0:s,z0:n.z0,x1:a,y1:o,z1:r,c:l}),c<n.z1&&e.push({x0:i,y0:s,z0:c,x1:a,y1:o,z1:n.z1,c:l})}function Lh(n,t,e){let i=[];for(let s of n)ja(s,t)?ro(s,t,i):i.push(s);return i.push({...t,c:e}),i}function Dh(n,t,e){let i=[{...t,c:e}];for(let s of n){if(!i.length)break;let r=[];for(let a of i)ro(a,s,r);i=r}return i.length?n.concat(i):n.slice()}function cs(n,t){let e=[];for(let i of n)ja(i,t)?ro(i,t,e):e.push(i);return e}function Uh(n,t,e){let i=[];for(let s of n){if(!ja(s,t)){i.push(s);continue}ro(s,t,i),i.push({x0:Math.max(s.x0,t.x0),y0:Math.max(s.y0,t.y0),z0:Math.max(s.z0,t.z0),x1:Math.min(s.x1,t.x1),y1:Math.min(s.y1,t.y1),z1:Math.min(s.z1,t.z1),c:e})}return i}function Nh(n,t){for(let e of n){let i=(e.x1-e.x0)*(e.y1-e.y0)*(e.z1-e.z0);t.set(e.c,(t.get(e.c)||0)+i)}}function Zn(n,t){for(let e of n)e.x0<t.min.x&&(t.min.x=e.x0),e.y0<t.min.y&&(t.min.y=e.y0),e.z0<t.min.z&&(t.min.z=e.z0),e.x1>t.max.x&&(t.max.x=e.x1),e.y1>t.max.y&&(t.max.y=e.y1),e.z1>t.max.z&&(t.max.z=e.z1)}function mn(n,t,e){let i=le({x:n.x0,y:n.y0,z:n.z0},t),s=le({x:n.x1-1,y:n.y1-1,z:n.z1-1},t);return{x0:Math.min(i.x,s.x)+e.x,y0:Math.min(i.y,s.y)+e.y,z0:Math.min(i.z,s.z)+e.z,x1:Math.max(i.x,s.x)+e.x+1,y1:Math.max(i.y,s.y)+e.y+1,z1:Math.max(i.z,s.z)+e.z+1,c:n.c}}var Fe=16,ze=Math.floor;function oo(n){if(!n.length)return()=>!1;let t=1/0,e=1/0,i=1/0,s=-1/0,r=-1/0,a=-1/0;for(let x of n)x.x0<t&&(t=x.x0),x.y0<e&&(e=x.y0),x.z0<i&&(i=x.z0),x.x1>s&&(s=x.x1),x.y1>r&&(r=x.y1),x.z1>a&&(a=x.z1);let o=ze(t/Fe),c=ze(e/Fe),l=ze(i/Fe),h=ze((s-1)/Fe)-o+1,d=ze((r-1)/Fe)-c+1,f=ze((a-1)/Fe)-l+1,m=Array.from({length:h*d*f},()=>[]),_=(x,p,u)=>((x-o)*d+(p-c))*f+(u-l);for(let x of n)for(let p=ze(x.x0/Fe);p<=ze((x.x1-1)/Fe);p++)for(let u=ze(x.y0/Fe);u<=ze((x.y1-1)/Fe);u++)for(let b=ze(x.z0/Fe);b<=ze((x.z1-1)/Fe);b++)m[_(p,u,b)].push(x);return(x,p,u)=>{let b=ze(x/Fe),v=ze(p/Fe),T=ze(u/Fe);if(b<o||v<c||T<l||b-o>=h||v-c>=d||T-l>=f)return!1;for(let I of m[_(b,v,T)])if(x>=I.x0&&x<I.x1&&p>=I.y0&&p<I.y1&&u>=I.z0&&u<I.z1)return!0;return!1}}var Oh=(n,t,e,i)=>{for(let s of n)if(t>=s.x0&&t<s.x1&&e>=s.y0&&e<s.y1&&i>=s.z0&&i<s.z1)return!0;return!1};var Fh=(n,t,e,i,s)=>n.some(r=>t.some(a=>r.x0+e<a.x1&&a.x0<r.x1+e&&r.y0+i<a.y1&&a.y0<r.y1+i&&r.z0+s<a.z1&&a.z0<r.z1+s));var zh=[7041116,10855821,12040100,14472900,13343102,14532265,15787730,9268835,13935475,10249796,11895693,7170165,8226199,6055805,6986062,10994876],Bh={visible:0,transparent:1,invisible:2},kh={visible:"transparent",transparent:"invisible",invisible:"visible"},qs=()=>({type:"object",id:so(),name:"",pos:{x:0,y:0,z:0},rot:0,vis:"visible",boxes:[]}),ls=()=>({type:"scene",id:so(),name:"",pos:{x:0,y:0,z:0},rot:0,vis:"visible",children:[]});function ao(n){let t={id:so(),name:n.name,pos:{...n.pos},rot:n.rot,vis:n.vis};return n.type==="object"?{type:"object",...t,boxes:n.boxes.map(e=>({...e}))}:{type:"scene",...t,children:n.children.map(ao)}}var mi=n=>g.context.children.find(t=>t.id===n);function hs(n,t=g.root,e=[]){if(e.push(t),t===n)return e.slice();if(t.type==="scene")for(let i of t.children){let s=hs(n,i,e);if(s)return s}return e.pop(),null}function us(n,t=g.root){if(t.id===n)return t;if(t.type==="scene")for(let e of t.children){let i=us(n,e);if(i)return i}return null}function gi(n){let t=hs(n);return t&&t.length>1?t[t.length-2]:null}function ds(n,t){return n===t?!0:n.type!=="scene"?!1:n.children.some(e=>ds(e,t))}var fs=()=>$a(g.path),Zs=n=>$a(hs(n)||[g.root]),gn=()=>({min:{x:1e9,y:1e9,z:1e9},max:{x:-1e9,y:-1e9,z:-1e9}});function Jn(n,t,e,i){if(n.type==="object")Zn(n.boxes.map(s=>mn(s,e,t)),i);else for(let s of n.children)Jn(s,hn(t,le(s.pos,e)),e+s.rot&3,i);return i}function co(n,t){let e=se.getBoundingClientRect();qn.x=(n-e.left)/e.width*2-1,qn.y=-((t-e.top)/e.height)*2+1}function Qa(){pn.setFromCamera(qn,Yt);let n=pn.intersectObjects(g.pickMeshes,!1);return n.length?n[0].object.userData.childId??null:null}var Vh=new nn(new L(0,1,0),0);function ps(n){return pn.setFromCamera(qn,Yt),Vh.constant=-n,pn.ray.intersectPlane(Vh,io)?{x:Math.floor(io.x),y:n,z:Math.floor(io.z)}:null}function ms(){if(!g.pickMeshes.length)return null;pn.setFromCamera(qn,Yt);let n=pn.intersectObjects(g.pickMeshes,!1);if(!n.length)return null;let t=n[0],e=g.editXform.off,i=4-g.editXform.rot&3,s=le({x:t.point.x-e.x,y:t.point.y-e.y,z:t.point.z-e.z},i),r=t.face?t.face.normal:{x:0,y:1,z:0},a=Math.floor(s.x-r.x*.5),o=Math.floor(s.y-r.y*.5),c=Math.floor(s.z-r.z*.5);return{cell:{x:a,y:o,z:c},addCell:{x:a+Math.round(r.x),y:o+Math.round(r.y),z:c+Math.round(r.z)}}}function Js(n){let t=ps(n+g.editXform.off.y);if(!t)return null;let e=le({x:t.x-g.editXform.off.x,y:0,z:t.z-g.editXform.off.z},4-g.editXform.rot&3);return{x:Math.round(e.x),y:n,z:Math.round(e.z)}}var gs=(n,t,e)=>{let i=le({x:n,y:t,z:e},g.editXform.rot);return new L(i.x+g.editXform.off.x,i.y+g.editXform.off.y,i.z+g.editXform.off.z)};function lo(n=ms()){return g.tool==="add"?n?n.addCell:Js(0):n?n.cell:null}var hx=new Tt(10994876),ux=new Tt(6055805),xs=()=>g.editObject?g.tool==="measure":g.measMode,tc=()=>{g.measFieldCache=null};function un(){g.liveMeas=null,g.frozenMeas=[],_s()}function Hh(){if(g.measFieldCache)return g.measFieldCache;let n=[],t;g.editObject?(n.push(...g.editObject.boxes),t=gs):(xi(g.root,{x:0,y:0,z:0},0,null,0,(o,c,l,h)=>{if(h)for(let d of o.boxes)n.push(mn(d,l,c))}),t=(o,c,l)=>new L(o,c,l));let e=gn();Zn(n,e);let i=n.length===0,s={x:e.min.x,y:e.min.y,z:e.min.z},r={x:e.max.x-1,y:e.max.y-1,z:e.max.z-1},a=n.length>64?oo(n):(o,c,l)=>Oh(n,o,c,l);return g.measFieldCache={has:a,mn:s,mx:r,toW:t,empty:i},g.measFieldCache}function dx(){let n=Hh();if(n.empty)return null;let t=null;if(g.editObject){let e=ms();t=e?{...e.cell}:Js(0)}else{pn.setFromCamera(qn,Yt);let e=g.pickMeshes.length?pn.intersectObjects(g.pickMeshes,!1):[];if(e.length){let i=e[0],s=i.face?i.face.normal:{x:0,y:0,z:0};t={x:Math.floor(i.point.x-s.x*.5),y:Math.floor(i.point.y-s.y*.5),z:Math.floor(i.point.z-s.z*.5)}}else t=ps(0)}return t?{x:Math.max(n.mn.x,Math.min(n.mx.x,t.x)),y:Math.max(n.mn.y,Math.min(n.mx.y,t.y)),z:Math.max(n.mn.z,Math.min(n.mx.z,t.z))}:null}function fx(n){let t=Hh(),e=["x","y","z"],i=[];for(let s=0;s<3;s++){let r=e[s],a=e[(s+1)%3],o=e[(s+2)%3],c=t.mn[r],l=t.mx[r],h=[n.x,n.y,n.z],d=m=>(h[s]=m,t.has(h[0],h[1],h[2])),f=c;for(;f<=l;){let m=d(f),_=f;for(;_+1<=l&&d(_+1)===m;)_++;let x=p=>{let u={};return u[r]=p,u[a]=n[a]+.5,u[o]=n[o]+.5,t.toW(u.x,u.y,u.z)};i.push({a:x(f),b:x(_+1),mid:x((f+_+1)/2),len:_-f+1,filled:m}),f=_+1}}return i}function Gh(){let n=dx();g.liveMeas=n?fx(n):null,_s()}function Wh(){g.liveMeas&&g.liveMeas.length&&(g.frozenMeas.push(g.liveMeas),_s())}function _s(){let n=document.getElementById("measure");n.innerHTML="",g.measLabels=[];let t=[];g.liveMeas&&t.push({s:g.liveMeas,fz:!1});for(let r of g.frozenMeas)t.push({s:r,fz:!0});let e=[],i=[];for(let r of t)for(let a of r.s){let o=a.filled?hx:ux;if(e.push(a.a.x,a.a.y,a.a.z,a.b.x,a.b.y,a.b.z),i.push(o.r,o.g,o.b,o.r,o.g,o.b),a.nolabel)continue;let c=document.createElement("div");c.className="mlab"+(a.filled?"":" empty")+(r.fz?" frozen":""),c.textContent=String(a.len),n.appendChild(c),g.measLabels.push({el:c,w:a.mid})}pi.geometry.dispose();let s=new Oe;s.setAttribute("position",new pe(e,3)),s.setAttribute("color",new pe(i,3)),pi.geometry=s,pi.visible=e.length>0}function Xh(){if(!g.measLabels.length)return;let n=se.getBoundingClientRect();for(let t of g.measLabels){if(Ys.copy(t.w).project(Yt),Ys.z>1){t.el.style.display="none";continue}t.el.style.display="",t.el.style.left=(Ys.x*.5+.5)*n.width+"px",t.el.style.top=(-Ys.y*.5+.5)*n.height+"px"}}var ec=new L(40,150,30).normalize();function px(n){if(n.max.x<n.min.x)return;let t=(n.min.x+n.max.x)/2,e=(n.min.y+n.max.y)/2,i=(n.min.z+n.max.z)/2,s=.5*Math.hypot(n.max.x-n.min.x,n.max.y-n.min.y,n.max.z-n.min.z)+8,r=s+130;Xe.position.set(t+ec.x*r,e+ec.y*r,i+ec.z*r),Xe.target.position.set(t,e,i),Xe.target.updateMatrixWorld();let a=Xe.shadow.camera;a.left=-s,a.right=s,a.top=s,a.bottom=-s,a.near=Math.max(1,r-s-20),a.far=r+s+20,a.updateProjectionMatrix(),Xe.shadow.normalBias=s/Xe.shadow.mapSize.x}function mx(){for(let n of g.meshes)be.remove(n),n.geometry&&n.geometry!==Xa&&n.geometry.dispose();g.meshes=[],Yn.clear(),g.editRemesh&&(cancelAnimationFrame(g.editRemesh),g.editRemesh=0),g.editMesh=null}var gx=[{a:0,hi:!0,u:1,v:2,n:[1,0,0]},{a:0,hi:!1,u:2,v:1,n:[-1,0,0]},{a:1,hi:!0,u:2,v:0,n:[0,1,0]},{a:1,hi:!1,u:0,v:2,n:[0,-1,0]},{a:2,hi:!0,u:0,v:1,n:[0,0,1]},{a:2,hi:!1,u:1,v:0,n:[0,0,-1]}],ho=[1,.88,.74,.5];function qh(n,t,e){let i=[],s=[],r=[],a=n.map(h=>[h.x0,h.y0,h.z0]),o=n.map(h=>[h.x1,h.y1,h.z1]),c=e?oo(n):null;for(let h=0;h<n.length;h++){let d=t(n[h].c),f=d.r,m=d.g,_=d.b,x=a[h],p=o[h];for(let u of gx){let{a:b,u:v,v:T}=u,I=u.hi?p[b]:x[b],C=u.hi?I:I-1,R=[];for(let W=0;W<n.length;W++){if(W===h||(u.hi?a[W][b]:o[W][b])!==I)continue;let Z=Math.max(a[W][v],x[v]),A=Math.min(o[W][v],p[v]),D=Math.max(a[W][T],x[T]),B=Math.min(o[W][T],p[T]);Z<A&&D<B&&R.push([Z,D,A,B])}let q=[[x[v],x[T],p[v],p[T]]];for(let W of R){let Z=[];for(let A of q){let D=Math.max(A[0],W[0]),B=Math.max(A[1],W[1]),X=Math.min(A[2],W[2]),H=Math.min(A[3],W[3]);if(D>=X||B>=H){Z.push(A);continue}A[0]<D&&Z.push([A[0],A[1],D,A[3]]),X<A[2]&&Z.push([X,A[1],A[2],A[3]]),A[1]<B&&Z.push([D,A[1],X,B]),H<A[3]&&Z.push([D,H,X,A[3]])}if(q=Z,!q.length)break}let S=(W,Z)=>{let A=0,D=[0,0,0];D[b]=C;for(let B=-1;B<=0;B++)for(let X=-1;X<=0;X++)D[v]=W+B,D[T]=Z+X,c(D[0],D[1],D[2])&&A++;return A},w=(W,Z)=>(ho[Math.min(S(W,Z),3)]+ho[Math.min(S(W+1,Z),3)]+ho[Math.min(S(W+1,Z+1),3)]+ho[Math.min(S(W,Z+1),3)])/4,V=(W,Z,A,D,B)=>{let X=[0,0,0],H=(dt,ft)=>(X[b]=I,X[v]=dt,X[T]=ft,[X[0],X[1],X[2]]),Y=H(W,Z),$=H(A,Z),Q=H(A,D),ct=H(W,D),G=f*B,J=m*B,at=_*B;for(let dt of[Y,$,Q,Y,Q,ct])i.push(dt[0],dt[1],dt[2]),s.push(u.n[0],u.n[1],u.n[2]),r.push(G,J,at)};for(let W of q){let[Z,A,D,B]=W;if(!c){V(Z,A,D,B,1);continue}let X=(H,Y)=>V(H,Y,H+1,Y+1,w(H,Y));for(let H=Z;H<D;H++)X(H,A),B-1>A&&X(H,B-1);for(let H=A+1;H<B-1;H++)X(Z,H),D-1>Z&&X(D-1,H);Z+1<D-1&&A+1<B-1&&V(Z+1,A+1,D-1,B-1,1)}}}if(!i.length)return null;let l=new Oe;return l.setAttribute("position",new pe(i,3)),l.setAttribute("normal",new pe(s,3)),l.setAttribute("color",new pe(r,3)),l}function $s(n,t,{transparent:e=!1,pick:i=!1,childId:s=null}={}){if(!n.length)return null;let r=qh(n,t,!e);if(!r)return null;let a=new Se(r,e?Za:qa);if(a.castShadow=!0,a.receiveShadow=!0,be.add(a),g.meshes.push(a),e){a.renderOrder=2;let o=new Se(r,Ph);o.renderOrder=1,o.castShadow=!1,o.receiveShadow=!1,be.add(o),g.meshes.push(o)}return i&&(a.userData.childId=s,a.userData.emph=!e,g.pickMeshes.push(a),(g.childMeshes[s]||(g.childMeshes[s]=[])).push(a)),a}function xi(n,t,e,i,s,r){let a=Math.max(s,Bh[n.vis||"visible"]);if(!(n===g.editObject||a>=2))if(n.type==="object")r(n,t,e,i,a===1);else for(let o of n.children)xi(o,hn(t,le(o.pos,e)),e+o.rot&3,n===g.context?o.id:i,a,r)}var Yh=(n,t,e,i)=>{for(let s of n.boxes)i.push(mn(s,e,t));return i};function Zh(){let{off:n,rot:t}=g.editXform;if(Yn.position.set(n.x,n.y,n.z),Yn.rotation.set(0,-t*Math.PI/2,0),Yn.updateMatrixWorld(!0),g.editMesh){Yn.remove(g.editMesh),g.editMesh.geometry.dispose();let i=g.meshes.indexOf(g.editMesh);i>=0&&g.meshes.splice(i,1)}let e=qh(g.editObject.boxes,Xs,!0);g.editMesh=e?new Se(e,qa):null,g.editMesh&&(g.editMesh.castShadow=g.editMesh.receiveShadow=!0,Yn.add(g.editMesh),g.meshes.push(g.editMesh)),g.pickMeshes=g.editMesh?[g.editMesh]:[]}function xx(){g.editRemesh||(g.editRemesh=requestAnimationFrame(()=>{g.editRemesh=0,Zh(),is()}))}function nc(){g.voxVer++,tc(),xx()}function Jh(n,t,e=!1){g.editObject.boxes=e?Dh(g.editObject.boxes,n,t):Lh(g.editObject.boxes,n,t),nc()}function $h(n){g.editObject.boxes=cs(g.editObject.boxes,n),nc()}function Kh(n,t){g.editObject.boxes=Uh(g.editObject.boxes,n,t),nc()}function ke(){mx(),g.pickMeshes=[],g.childMeshes={},g.childBox={},g.voxVer++,tc();let n={x:0,y:0,z:0},t=gn();if(g.editObject){g.editXform=ss(fs(),{off:g.editObject.pos,rot:g.editObject.rot});let e=[];xi(g.root,n,0,null,0,(i,s,r)=>Yh(i,s,r,e)),Zn(e,t),$s(e,i=>Xs(i),{transparent:!0}),Zh(),Jn(g.editObject,g.editXform.off,g.editXform.rot,t)}else{let e=new Map,i=new Map,s=[],r=[];xi(g.root,n,0,null,0,(a,o,c,l,h)=>{let d=Yh(a,o,c,[]);if(Zn(d,t),l){let f=h?i:e,m=f.get(l);m?m.push(...d):f.set(l,d),Zn(d,g.childBox[l]||(g.childBox[l]=gn()))}else(h?r:s).push(...d)}),$s(s,a=>Ya(a)),$s(r,a=>Ya(a),{transparent:!0});for(let a of new Set([...e.keys(),...i.keys()])){let o=e.get(a);o&&$s(o,l=>Xs(l),{pick:!0,childId:a});let c=i.get(a);c&&$s(c,l=>Xs(l),{transparent:!0})}}g.sceneBox=t,px(t),ic(),is()}function _x(n,t,e){let i=new Cn(t.x-n.x,t.y-n.y,t.z-n.z),s=new hi(new ji(i),new Xn({color:e,depthTest:!1}));return s.position.set((n.x+t.x)/2,(n.y+t.y)/2,(n.z+t.z)/2),s.renderOrder=999,i.dispose(),s}function ic(){for(let n of Pn.children)n.geometry?.dispose?.();if(Pn.clear(),Pn.position.set(0,0,0),!g.editObject)for(let n of g.selection){let t=g.childBox[n];t&&Pn.add(_x(t.min,t.max,15787730))}}var Ks=new L,sc=new L,rc=new L,jh=new L,vx=new L(0,1,0);function Qh(n,t){let e=se.getBoundingClientRect(),i=(Yt.top-Yt.bottom)/e.height;Yt.getWorldDirection(sc),rc.crossVectors(sc,vx).normalize(),jh.crossVectors(rc,sc).normalize(),Wt.target.addScaledVector(rc,-n*i),Wt.target.addScaledVector(jh,t*i)}function tu(n,t){Wt.azim-=n*.012,Wt.elev=Math.max(-.35,Math.min(Math.PI/2,Wt.elev+t*.012))}function eu(n){n.max.x<n.min.x||(Wt.target.set((n.min.x+n.max.x)/2,(n.min.y+n.max.y)/2,(n.min.z+n.max.z)/2),Wt.zoom=Math.max(8,Math.min(eo,Math.max(n.max.x-n.min.x,n.max.y-n.min.y,n.max.z-n.min.z)*1.5+8)))}function In(){let n=gn();if(g.editObject){if(Jn(g.editObject,g.editXform.off,g.editXform.rot,n),n.max.x<n.min.x){let t=g.editXform.off;Wt.target.set(t.x,t.y+6,t.z),Wt.zoom=41;return}}else for(let t in g.childBox){let e=g.childBox[t];n.min.x=Math.min(n.min.x,e.min.x),n.min.y=Math.min(n.min.y,e.min.y),n.min.z=Math.min(n.min.z,e.min.z),n.max.x=Math.max(n.max.x,e.max.x),n.max.y=Math.max(n.max.y,e.max.y),n.max.z=Math.max(n.max.z,e.max.z)}if(n.max.x<n.min.x){Wt.target.set(0,1,0),Wt.zoom=23;return}eu(n)}function oc(n){if(n===g.root){In();return}let t=Zs(n);eu(Jn(n,t.off,t.rot,gn()))}function nu(){Gt.azim+=(Wt.azim-Gt.azim)*.22,Gt.elev+=(Wt.elev-Gt.elev)*.22,Gt.zoom+=(Wt.zoom-Gt.zoom)*.25,Gt.target.lerp(Wt.target,.25);let n=Math.cos(Gt.elev),t=Math.sin(Gt.elev);Ks.set(n*Math.sin(Gt.azim),t,n*Math.cos(Gt.azim)),Yt.position.copy(Gt.target).addScaledVector(Ks,Th);let e=ph.clamp((Gt.elev-1.45)/(Math.PI/2-1.45),0,1);no.set(-Math.sin(Gt.azim),0,-Math.cos(Gt.azim)),Ws.set(0,1,0).lerp(no,e),Ws.lengthSq()<1e-6&&Ws.copy(no),Yt.up.copy(Ws.normalize()),Yt.lookAt(Gt.target);let i=se.getBoundingClientRect(),s=i.width/i.height,r=Gt.zoom,a=r*s;Yt.left=-a/2,Yt.right=a/2,Yt.top=r/2,Yt.bottom=-r/2;let o=Yt.position,c=1/0,l=-1/0,h=(x,p,u)=>{let b=(o.x-x)*Ks.x+(o.y-p)*Ks.y+(o.z-u)*Ks.z;b<c&&(c=b),b>l&&(l=b)},d=g.sceneBox;if(d&&d.max.x>=d.min.x)for(let x of[d.min.x,d.max.x])for(let p of[d.min.y,d.max.y])for(let u of[d.min.z,d.max.z])h(x,p,u);let f=Gt.target.x,m=Gt.target.z,_=4e3;for(let x of[-_,_])for(let p of[-_,_])h(f+x,0,m+p);c>l&&(c=.1,l=4e3),Yt.near=c-10,Yt.far=l+10,Yt.zoom=1,Yt.updateProjectionMatrix(),fi.position.set(Gt.target.x,0,Gt.target.z),Rh()}var uo=()=>{ke(),Ee()};function yx(){if(g.path.length>1){let n=g.path.pop();g.context=g.path[g.path.length-1],g.selection=new Set([n.id]),g.editObject=null,un(),uo()}}function Mx(){let n=g.editObject;g.editObject=null,g.selection=new Set([n.id]),un(),uo()}function iu(){g.editObject?Mx():yx()}function _i(n){let t=hs(n);t&&(g.path=t.slice(0,-1),g.context=g.path[g.path.length-1],g.selection=new Set([n.id]),g.editObject=null,uo())}function su(n){return n.type==="object"?g.editObject===n:g.context===n&&!g.editObject}function vi(n,t){let e=hs(n);e&&(n.type==="scene"?(g.path=e,g.context=n,g.selection.clear(),g.editObject=null,g.tool="add"):(g.path=e.slice(0,-1),g.context=g.path[g.path.length-1],g.editObject=n,g.selection.clear(),g.tool="add"),un(),uo(),t&&In())}var Sx=200,Ln=[],yi=-1,ac=!1,bx=n=>({rootJSON:n,uid:os(),pathIds:g.path.map(t=>t.id),selection:[...g.selection],editId:g.editObject?g.editObject.id:null,collapsed:[...g.collapsed]});function ru(n){if(ac)return;let t=bx(n),e=Ln[yi];e&&e.rootJSON===t.rootJSON&&e.editId===t.editId||(Ln.length=yi+1,Ln.push(t),Ln.length>Sx&&Ln.shift(),yi=Ln.length-1)}function ou(n){ac=!0,as(n.uid),g.root=vs(JSON.parse(n.rootJSON)),g.path=[];let t=g.root;for(let e of n.pathIds){let i=t.id===e?t:t.type==="scene"?t.children.find(s=>s.id===e):null;if(!i)break;t=i,g.path.push(t)}g.path.length||(g.path=[g.root]),g.context=g.path[g.path.length-1],g.editObject=n.editId?us(n.editId):null,g.selection=new Set(n.selection.filter(e=>g.context.children.some(i=>i.id===e))),g.collapsed=new Set(n.collapsed),g.drag=null,g.painting=!1,g.lastVox=null,ke(),Ee(),he(),ac=!1}function au(){ys(),yi>0&&ou(Ln[--yi])}function cc(){ys(),yi<Ln.length-1&&ou(Ln[++yi])}var cu="voxelier-v11";function fo(n){let t={id:n.id,nm:n.name||"",p:n.pos,r:n.rot,vs:n.vis||"visible"};return n.type==="object"?{t:"o",...t,b:n.boxes.map(e=>[e.x0,e.y0,e.z0,e.x1,e.y1,e.z1,e.c])}:{t:"s",...t,c:n.children.map(fo)}}function vs(n){let t={id:n.id,name:n.nm||"",pos:n.p,rot:n.r,vis:n.vs||"visible"};return n.t==="o"?{type:"object",...t,boxes:n.b.map(e=>({x0:e[0],y0:e[1],z0:e[2],x1:e[3],y1:e[4],z1:e[5],c:e[6]}))}:{type:"scene",...t,children:n.c.map(vs)}}function ys(){clearTimeout(g.saveT??void 0),g.saveT=null;let n=JSON.stringify(fo(g.root));ru(n);try{localStorage.setItem(cu,`{"uid":${os()},"root":${n}}`)}catch{}}function he(){clearTimeout(g.saveT??void 0),g.saveT=setTimeout(ys,250)}function lu(){try{let n=JSON.parse(localStorage.getItem(cu));return!n||!n.root?!1:(as(n.uid||1),g.root=vs(n.root),!0)}catch{return!1}}var Ms=()=>{ke(),Ee(),he()};function hu(n){n.vis=kh[n.vis||"visible"],Ms()}function lc(n){let t=prompt("Name",n.name||"");t!=null&&(n.name=t.trim(),Ee(),he())}var uu=()=>[...g.selection].map(n=>mi(n)).filter(n=>!!n),hc=n=>{let t=ao(n);return t.pos={x:n.pos.x+5,y:n.pos.y,z:n.pos.z+5},t};function du(){let n=qs();n.pos={x:Math.round(Wt.target.x),y:0,z:Math.round(Wt.target.z)},g.context.children.push(n),vi(n,!0),he()}function uc(){g.selection.size&&(g.context.children=g.context.children.filter(n=>!g.selection.has(n.id)),g.selection.clear(),Ms())}function fu(){let n=uu().map(hc);n.length&&(g.context.children.push(...n),g.selection=new Set(n.map(t=>t.id)),Ms())}function dc(){g.clipboard=uu().map(ao)}function pu(){dc(),uc()}function mu(){if(!g.clipboard.length)return;let n=g.clipboard.map(hc);g.context.children.push(...n),g.selection=new Set(n.map(t=>t.id)),Ms()}function fc(n,t,e){if(n===t||ds(n,t))return!1;let i=gi(n);if(!i)return!1;let s=ss(Zs(i),{off:{...n.pos},rot:n.rot}),r=ss(Ih(Zs(t)),s),a=i.children.indexOf(n);return i.children.splice(a,1),i===t&&a<e&&e--,n.pos={x:Math.round(r.off.x),y:Math.round(r.off.y),z:Math.round(r.off.z)},n.rot=r.rot&3,t.children.splice(Math.max(0,Math.min(e,t.children.length)),0,n),!0}function pc(n){let t=gi(n);if(!t)return null;let e=t.children.indexOf(n),i=ls();return i.name="Group",i.pos={...n.pos},i.rot=n.rot,t.children.splice(e,1,i),n.pos={x:0,y:0,z:0},n.rot=0,i.children=[n],i}function gu(n,t){if(t===n||ds(t,n))return!1;let e=pc(n);return e?(fc(t,e,e.children.length),g.collapsed.delete(e.id),g.selection=new Set([e.id]),Ms(),!0):!1}function xu(n){let t=gi(n);if(!t)return;let e=hc(n);t.children.splice(t.children.indexOf(n)+1,0,e),_i(e),he()}function _u(n){let t=gi(n);t&&(t.children=t.children.filter(e=>e!==n),g.selection.delete(n.id),g.editObject===n&&(g.editObject=null),Ms())}function vu(n){let t=qs();t.pos={x:Math.round(Wt.target.x),y:0,z:Math.round(Wt.target.z)},n.children.push(t),g.collapsed.delete(n.id),vi(t),he()}function yu(n){let t=ls();t.name="Group",n.children.push(t),g.collapsed.delete(n.id),_i(t),he()}function mc(n){let t=n<0?-1:1;for(let e=0;e<Math.abs(n);e++){let i=fs(),s=r=>Jn(r,hn(i.off,le(r.pos,i.rot)),i.rot+r.rot&3,gn());for(let r of g.selection){let a=mi(r);if(!a)continue;let o=s(a);a.rot=a.rot+t&3;let c=s(a),l={x:(o.min.x+o.max.x)/2-(c.min.x+c.max.x)/2,z:(o.min.z+o.max.z)/2-(c.min.z+c.max.z)/2},h=le({x:Math.round(l.x),y:0,z:Math.round(l.z)},4-i.rot&3);a.pos.x+=h.x,a.pos.z+=h.z}}g.selection.size&&ke()}function Mu(){g.selection.size&&(mc(1),he())}function gc(n){for(let t of g.selection){let e=mi(t);e&&(e.pos.y+=n)}g.selection.size&&(ke(),he())}function Su(){let n=JSON.stringify({uid:os(),root:fo(g.root)}),t=URL.createObjectURL(new Blob([n],{type:"application/json"})),e=g.root.name||"Project",i=new Date,[s,r]=new Date(i.getTime()-i.getTimezoneOffset()*6e4).toISOString().slice(0,19).split("T"),a=`${s} ${r.replace(/:/,"h").replace(/:/,"m")}s`,o=document.createElement("a");o.href=t,o.download=`${e} -- ${a}.voxelier.json`,o.click(),URL.revokeObjectURL(t)}function bu(){let n=document.createElement("input");n.type="file",n.accept="application/json,.json",n.onchange=()=>{let t=n.files&&n.files[0];if(!t)return;let e=new FileReader;e.onload=()=>{try{let i=JSON.parse(e.result);if(!i||!i.root)throw new Error("not a Voxelier scene file");as(i.uid||1),g.root=vs(i.root),g.path=[g.root],g.context=g.root,g.editObject=null,g.selection.clear(),un(),ke(),Ee(),In(),he()}catch(i){alert("Import failed: "+i.message)}},e.readAsText(t)},n.click()}function ue(n,t={},...e){let i=document.createElement(n);return Object.assign(i,t),e.length&&i.append(...e),i}var Ex=[{id:"add",ic:"\uFF0B",label:"Add"},{id:"erase",ic:"\uFF0D",label:"Erase"},{id:"paint",ic:"\u2756",label:"Paint"},{id:"measure",ic:"\u{1F4CF}",label:"Measure"}],wx={visible:"\u25C9",transparent:"\u25D0",invisible:"\u29B0"};function Ee(){let n=document.getElementById("tools");if(n.innerHTML="",g.editObject)for(let e of Ex)n.appendChild(ue("button",{className:"tool"+(g.tool===e.id?" active":""),innerHTML:`<span class="ic">${e.ic}</span>${e.label}`,onclick:()=>{g.tool=e.id,un(),Ye.visible=!1,Ee()}}));else n.appendChild(ue("button",{className:"tool"+(g.measMode?" active":""),innerHTML:'<span class="ic">\u{1F4CF}</span>Measure',onclick:()=>{g.measMode=!g.measMode,g.measMode||un(),Ee()}}));let t=ue("div");t.style.flex="1",n.appendChild(t);for(let[e,i,s]of[["\u{1F4C2}","Import",bu],["\u{1F4BE}","Export",Su]])n.appendChild(ue("button",{className:"tool",innerHTML:`<span class="ic">${e}</span>${i}`,onclick:s}));Ru(),Ss(),document.getElementById("statHint").textContent=xs()?"Measure \u2014 hover to read voxel/gap runs on all 3 axes \xB7 left-click freezes \xB7 right-click clears":g.editObject?g.tool==="paint"?"Paint \u2014 click/drag to recolour voxels \xB7 right-drag orbits \xB7 middle-drag pans \xB7 Esc to finish":`${g.tool==="add"?"Add":"Erase"} \u2014 drag a box in the floor plane (Shift = height) \xB7 right-drag orbits \xB7 middle-drag pans \xB7 Esc to finish`:g.selection.size?`${g.selection.size} selected \u2014 drag to move (Shift: up/down \xB7 Alt: allow overlap) \xB7 right-drag rotate \xB7 R rotate \xB7 Del`:"Tree: click a row to enter it \xB7 double-click to fit \xB7 right-click for actions \xB7 N new object"}var po={ver:-1,cols:[]};function wu(){if(po.ver===g.voxVer)return po.cols;let n=new Map;return function t(e){e.type==="object"?Nh(e.boxes,n):e.children.forEach(t)}(g.root),po={ver:g.voxVer,cols:[...n.entries()].sort((t,e)=>e[1]-t[1]).map(t=>t[0])},po.cols}function Ss(){let n=document.getElementById("swatches");n.innerHTML="";let t=wu().slice();t.includes(g.selColor)||t.unshift(g.selColor);let e=i=>{let s=ue("div",{className:"sw"+(i===g.selColor?" active":""),title:rs(i),onclick:()=>{g.selColor=i,Ss()}});return s.style.background=rs(i),s};if(t.length>15){for(let i=0;i<14;i++)n.appendChild(e(t[i]));n.appendChild(ue("div",{className:"sw more",textContent:"\u2026",title:"All used colours",onclick:Ax}))}else for(let i=0;i<15;i++)n.appendChild(i<t.length?e(t[i]):ue("div",{className:"sw empty"}));n.appendChild(ue("div",{className:"sw more",textContent:"\u{1F3A8}",title:"Use colour picker",onclick:Tx}))}function Tx(){let n=ue("input",{type:"color",value:rs(g.selColor)});n.style.cssText="position:fixed;left:-9999px;top:0";let t=()=>{g.selColor=parseInt(n.value.slice(1),16),Ss()};n.addEventListener("input",t),n.addEventListener("change",()=>{t(),n.remove()}),document.body.appendChild(n),n.click()}function Ax(){mo();let n=ue("div",{id:"palback"});n.onclick=s=>{s.target===n&&mo()};let t=ue("div",{id:"palpop"});t.appendChild(ue("div",{className:"pophead",textContent:"Used colours"}));let e=ue("div",{className:"popgrid"}),i=wu();if(!i.length){let s=ue("div",{textContent:"No colours yet."});s.style.cssText="color:var(--ink-dim);font-size:12px",e.appendChild(s)}for(let s of i){let r=ue("div",{className:"sw"+(s===g.selColor?" active":""),title:rs(s),onclick:()=>{g.selColor=s,Ss(),mo()}});r.style.background=rs(s),e.appendChild(r)}t.appendChild(e),n.appendChild(t),document.body.appendChild(n)}function mo(){let n=document.getElementById("palback");return n?(n.remove(),!0):!1}function Tu(n,t,e,i){if(n.type==="object")for(let s of n.boxes)i.push(mn(s,e,t));else for(let s of n.children)Tu(s,hn(t,le(s.pos,e)),e+s.rot&3,i);return i}var xc=(n,t)=>{let e=Math.min(255,(n>>16&255)*t)|0,i=Math.min(255,(n>>8&255)*t)|0,s=Math.min(255,(n&255)*t)|0;return`rgb(${e},${i},${s})`},Eu=new Map;function Au(n){return n.type==="object"?"o"+n.boxes.map(t=>`${t.x0},${t.y0},${t.z0},${t.x1},${t.y1},${t.z1},${t.c}`).join(";"):"s"+n.children.map(t=>t.id+Au(t)).join()}function Rx(n){let t=Eu.get(n.id);if(n===g.editObject&&t)return t.cv;let e=Au(n);if(t&&t.sig===e)return t.cv;let i=document.createElement("canvas");i.width=i.height=52,i.style.width=i.style.height="26px";let s=i.getContext("2d");s.fillStyle="#0f1115",s.fillRect(0,0,52,52);let r=Tu(n,{x:0,y:0,z:0},0,[]);if(r.length){let a=1e9,o=1e9,c=1e9,l=-1e9,h=-1e9,d=-1e9;for(let u of r)a=Math.min(a,u.x0),o=Math.min(o,u.y0),c=Math.min(c,u.z0),l=Math.max(l,u.x1),h=Math.max(h,u.y1),d=Math.max(d,u.z1);let f=40/Math.max(l-a,h-o,d-c,1),m=26-((a+l)/2-(c+d)/2)*f*.5,_=28+(o+h)/2*f*.6-((a+l)/2+(c+d)/2)*f*.28,x=(u,b,v)=>[m+(u-v)*f*.5,_-b*f*.6+(u+v)*f*.28],p=(u,b)=>{s.fillStyle=u,s.beginPath(),s.moveTo(b[0][0],b[0][1]);for(let v=1;v<b.length;v++)s.lineTo(b[v][0],b[v][1]);s.closePath(),s.fill()};r.sort((u,b)=>u.x0+u.x1+u.y0+u.y1+u.z0+u.z1-(b.x0+b.x1+b.y0+b.y1+b.z0+b.z1));for(let u of r)p(xc(u.c,.78),[x(u.x1,u.y0,u.z0),x(u.x1,u.y1,u.z0),x(u.x1,u.y1,u.z1),x(u.x1,u.y0,u.z1)]),p(xc(u.c,.6),[x(u.x0,u.y0,u.z1),x(u.x1,u.y0,u.z1),x(u.x1,u.y1,u.z1),x(u.x0,u.y1,u.z1)]),p(xc(u.c,1),[x(u.x0,u.y1,u.z0),x(u.x1,u.y1,u.z0),x(u.x1,u.y1,u.z1),x(u.x0,u.y1,u.z1)])}return Eu.set(n.id,{sig:e,cv:i}),i}function Cx(n){if(g.pending&&g.pending.node===n){clearTimeout(g.pending.timer),g.pending=null,oc(n);return}g.pending&&clearTimeout(g.pending.timer);let t=e=>{g.pending={node:n,timer:setTimeout(()=>{g.pending=null,e&&e()},300)}};su(n)?t(()=>lc(n)):(vi(n),t())}function Ru(){let n=document.getElementById("tree");n.innerHTML="";let t=(e,i)=>{let s=e===g.root,r=!s&&g.context.children.includes(e)&&g.selection.has(e.id),a=e.vis||"visible",o=ue("div",{className:"trow"+(s?" root":"")+(r?" sel":"")+(e===g.context&&!g.editObject?" ctx":"")+(e===g.editObject?" edit":"")+(!s&&a!=="visible"?" dim":"")});o.style.paddingLeft=4+i*13+"px";let c=Rx(e);if(c.className="thumb",c.onclick=null,c.title="",!s&&e.type==="scene"&&e.children.length){let h=g.collapsed.has(e.id);c.classList.add("group"),h&&c.classList.add("collapsed"),c.title=h?"Expand group":"Collapse group",c.onclick=d=>{d.stopPropagation(),h?g.collapsed.delete(e.id):g.collapsed.add(e.id),Ru()}}let l=ue("span",{className:"nm"});if(s?l.textContent=e.name||"Project":e.name?l.textContent=e.name:l.innerHTML='<span class="ph">'+(e.type==="scene"?"group":"object")+"</span>",o.append(c,l),s||o.append(ue("button",{className:"tb"+(a==="visible"?" on":""),textContent:wx[a],title:"visible \u2192 transparent \u2192 invisible",onclick:h=>{h.stopPropagation(),hu(e)}})),o.onclick=()=>Cx(e),o.oncontextmenu=h=>{h.preventDefault(),h.stopPropagation(),s||_i(e),Px(e,h.clientX,h.clientY)},o.draggable=!s,s||o.addEventListener("dragstart",h=>{if(h.stopPropagation(),g.dragId=e.id,h.dataTransfer){h.dataTransfer.effectAllowed="move";try{h.dataTransfer.setData("text/plain",e.id)}catch{}}}),o.addEventListener("dragend",js),o.addEventListener("dragover",h=>{h.preventDefault(),h.stopPropagation(),Ix(h,e,o)}),o.addEventListener("drop",h=>{h.preventDefault(),h.stopPropagation(),Pu()}),n.appendChild(o),e.type==="scene"&&(s||!g.collapsed.has(e.id)))for(let h of e.children)t(h,i+1)};t(g.root,0)}function _c(){g.ctxMenuEl&&(g.ctxMenuEl.remove(),g.ctxMenuEl=null,window.removeEventListener("pointerdown",Cu,!0))}function Cu(n){g.ctxMenuEl&&!g.ctxMenuEl.contains(n.target)&&_c()}function Px(n,t,e){_c();let i=ue("div",{className:"ctxmenu"}),s=(o,c,l)=>i.appendChild(ue("div",{className:"ctxitem"+(l?" "+l:""),textContent:o,onclick:()=>{_c(),c()}})),r=()=>i.appendChild(ue("div",{className:"ctxdiv"}));s("Rename",()=>lc(n)),s("Fit",()=>oc(n)),r(),n!==g.root&&(s("Duplicate",()=>xu(n)),s("Delete",()=>_u(n),"danger"),r()),n.type==="scene"?(s("New object",()=>vu(n)),s("New group",()=>yu(n))):s("New group",()=>{let o=pc(n);o&&(g.collapsed.delete(o.id),_i(o),he())}),document.body.appendChild(i),g.ctxMenuEl=i;let a=i.getBoundingClientRect();i.style.left=Math.min(t,innerWidth-a.width-4)+"px",i.style.top=Math.min(e,innerHeight-a.height-4)+"px",setTimeout(()=>window.addEventListener("pointerdown",Cu,!0),0)}function js(){g.dropRow&&g.dropRow.classList.remove("drop-into","drop-before","drop-after"),g.dropRow=null,g.dropInfo=null}function Ix(n,t,e){let i=g.dragId&&us(g.dragId);if(!i||i===t||ds(i,t)){js();return}if(js(),g.dropRow=e,t===g.root){g.dropInfo={parent:g.root,index:g.root.children.length},e.classList.add("drop-into");return}let s=e.getBoundingClientRect(),r=n.clientY-s.top,a=s.height,o=gi(t),c=o?o.children.indexOf(t):0;r>a*.28&&r<a*.72?(t.type==="scene"?g.dropInfo={parent:t,index:t.children.length}:g.dropInfo={wrap:t},e.classList.add("drop-into")):r<a*.5?(g.dropInfo={parent:o,index:c},e.classList.add("drop-before")):(g.dropInfo={parent:o,index:c+1},e.classList.add("drop-after"))}function Pu(){let n=g.dragId&&us(g.dragId);n&&g.dropInfo&&(g.dropInfo.wrap?gu(g.dropInfo.wrap,n):g.dropInfo.parent&&fc(n,g.dropInfo.parent,g.dropInfo.index)&&(g.collapsed.delete(g.dropInfo.parent.id),_i(n),he())),js(),g.dragId=null}{let n=document.getElementById("tree");n.addEventListener("dragover",t=>{t.target===n&&g.dragId&&(t.preventDefault(),js(),g.dropInfo={parent:g.root,index:g.root.children.length})}),n.addEventListener("drop",t=>{t.target===n&&(t.preventDefault(),Pu())})}window.addEventListener("keydown",n=>{if(n.target.tagName==="INPUT")return;let t=n.key.toLowerCase(),e=n.ctrlKey||n.metaKey;if(!(t==="escape"&&mo())){if(e){if(t==="z"){n.preventDefault(),n.shiftKey?cc():au();return}if(t==="y"){n.preventDefault(),cc();return}if(t==="c"){g.editObject||(dc(),n.preventDefault());return}if(t==="x"){g.editObject||(pu(),n.preventDefault());return}if(t==="v"){g.editObject||(mu(),n.preventDefault());return}if(t==="d"){g.editObject||(fu(),n.preventDefault());return}return}switch(t){case"f":In();break;case"escape":iu();break;case"n":g.editObject||du();break;case"r":g.editObject||Mu();break;case"[":g.editObject||gc(-1);break;case"]":g.editObject||gc(1);break;case"delete":case"backspace":g.editObject||(n.preventDefault(),uc());break}}});var qt=n=>Math.floor(n/10),re=zh,bs=(n,t)=>{let e=qs();return e.name=n,e.boxes=t,e},vc=(n,t,e,i,s,r)=>({x0:n,y0:t,z0:e,x1:i,y1:s,z1:r});function Iu(){let n=qt(4465),t=qt(2985),e=qt(2700),i=qt(150),s=bs("Floor",[ee(0,0,0,n,1,t,re[9])]),r=qt(800),a=qt(2100),o=n-qt(515)-r,c=n-qt(900)-r,l=[ee(0,1,0,n,e+1,i,re[5]),ee(0,1,t-i,n,e+1,t,re[5]),ee(0,1,i,i,e+1,t-i,re[5]),ee(n-i,1,i,n,e+1,t-i,re[5])];l=cs(l,vc(o,1,0,o+r,a+1,i)),l=cs(l,vc(c,1,t-i,c+r,a+1,t)),l=cs(l,vc(0,qt(900),qt(600),i,qt(2100),t-qt(600)));let h=bs("Walls",l);h.vis="transparent";let d=qt(1500),f=qt(2e3),m=bs("Bed",[ee(0,0,0,8,14,8,re[7]),ee(d-8,0,0,d,14,8,re[7]),ee(0,0,f-8,8,14,f,re[7]),ee(d-8,0,f-8,d,14,f,re[7]),ee(0,14,0,d,20,f,re[6]),ee(2,20,0,d-2,24,f-qt(400),re[10])]);m.pos={x:i+3,y:1,z:t-i-f};let _=qt(1400),x=qt(700),p=qt(740),u=bs("Desk",[ee(0,p-4,0,_,p,x,re[8]),ee(0,0,0,6,p-4,6,re[7]),ee(_-6,0,0,_,p-4,6,re[7]),ee(0,0,x-6,6,p-4,x,re[7]),ee(_-6,0,x-6,_,p-4,x,re[7])]),b=qt(600),v=b-30>>1,T=b>>1,I=bs("Computer",[ee(v,0,0,v+30,2,18,re[11]),ee(T-2,2,7,T+2,qt(160),11,re[11]),ee(0,qt(160),6,b,qt(520),9,re[13])]);I.pos={x:qt(400),y:p,z:qt(420)};let C=ls();C.name="Desk + Computer",C.pos={x:n-i,y:1,z:qt(900)},C.rot=1,C.children=[u,I];let R=V=>bs(V,[ee(-10,0,-10,11,30,11,re[4]),ee(-2,30,-2,3,54,3,re[14]),ee(-16,54,-16,17,78,17,re[14]),ee(-12,78,-12,13,92,13,re[14])]),q=R("Plant"),S=R("Plant");q.pos={x:n-i-qt(300),y:1,z:i+qt(300)},S.pos={x:i+qt(300),y:1,z:i+qt(300)};let w=ls();return w.children=[s,h,m,C,q,S],w}var Lu=n=>Math.abs(n.clientX-g.drag.sx)+Math.abs(n.clientY-g.drag.sy)>3;function Uu(){let n=(Yt.top-Yt.bottom)/se.getBoundingClientRect().height,t=Math.abs(Yt.matrixWorldInverse.elements[5]);return n/Math.max(t,.15)}function Du(n){let t=g.drag;if(!t||t.mode!=="pan"&&t.mode!=="orbit")return!1;let e=n.clientX-t.x,i=n.clientY-t.y;return t.x=n.clientX,t.y=n.clientY,(t.mode==="pan"?Qh:tu)(e,i),!0}function Lx(){let n=[],t=[];return xi(g.root,{x:0,y:0,z:0},0,null,0,(e,i,s,r)=>{let a=r&&g.selection.has(r)?t:n;for(let o of e.boxes)a.push(mn(o,s,i))}),{occ:n,sel:t}}var Dx=(n,t,e,i)=>Fh(n.sel??[],n.occ??[],t,e,i);function Ux(n){let t=g.drag,e=t.dx,i=t.dy,s=t.dz;if(n.shiftKey)t.shiftAnchorY==null&&(t.shiftAnchorY=n.clientY,t.dyBase=t.dy),i=t.dyBase+Math.round((t.shiftAnchorY-n.clientY)*Uu());else{t.shiftAnchorY=null;let a=ps(0);a&&t.start&&(e=a.x-t.start.x,s=a.z-t.start.z)}let r=(a,o,c)=>n.altKey||!Dx(t,a,o,c);r(e,t.dy,t.dz)&&(t.dx=e),r(t.dx,i,t.dz)&&(t.dy=i),r(t.dx,t.dy,s)&&(t.dz=s);for(let a of g.selection)for(let o of g.childMeshes[a]||[])o.position.set(t.dx,t.dy,t.dz);Pn.position.set(t.dx,t.dy,t.dz)}function Nx(){let n=g.drag,t=fs(),e=le({x:Math.round(n.dx),y:0,z:Math.round(n.dz)},4-t.rot&3),i=Math.round(n.dy);for(let s of g.selection){let r=mi(s);r&&(r.pos.x+=e.x,r.pos.y+=i,r.pos.z+=e.z)}Pn.position.set(0,0,0),ke(),he()}function Ox(n){let t=Math.round((g.drag.sx-n.clientX)/70);t!==g.drag.steps&&(mc(t-g.drag.steps),g.drag.steps=t)}function Nu(){let n=ms(),t=lo(n);if(!t)return;let e=Ja(t.x,t.y,t.z);e!==g.lastVox&&(Kh({x0:t.x,y0:t.y,z0:t.z,x1:t.x+1,y1:t.y+1,z1:t.z+1},g.selColor),g.lastVox=e),Ou(n)}function Ou(n=ms()){let t=null;if(g.tool==="add"?t=n?n.addCell:lo(n):t=n?n.cell:null,!t){Ye.visible=!1;return}let e=hn(le(t,g.editXform.rot),g.editXform.off);Ye.visible=!0,Ye.material.color.set(g.tool==="erase"?11895693:10994876),Ye.position.set(e.x+.5,e.y+.5,e.z+.5)}function Fx(n,t){let e=lo();e&&(g.drag={...t,mode:"box",shiftAnchorY:null,hyBase:0,box:{x0:e.x,y0:e.y,z0:e.z,x1:e.x,z1:e.z,hy:0}},Ye.visible=!1,zu())}function zx(n){let t=g.drag,e=t.box;if(n.shiftKey)t.shiftAnchorY===null&&(t.shiftAnchorY=n.clientY,t.hyBase=e.hy),e.hy=t.hyBase+Math.round((t.shiftAnchorY-n.clientY)*Uu());else{t.shiftAnchorY=null;let i=Js(e.y0);i&&(e.x1=i.x,e.z1=i.z)}zu()}function Fu(){let n=g.drag.box;return{x0:Math.min(n.x0,n.x1),x1:Math.max(n.x0,n.x1),z0:Math.min(n.z0,n.z1),z1:Math.max(n.z0,n.z1),y0:Math.min(n.y0,n.y0+n.hy),y1:Math.max(n.y0,n.y0+n.hy)}}function Bx(n){let t=Fu(),e={x0:t.x0,y0:t.y0,z0:t.z0,x1:t.x1+1,y1:t.y1+1,z1:t.z1+1};g.tool==="add"?Jh(e,g.selColor,!n):$h(e),g.liveMeas=null,_s(),Ee(),he()}function zu(){let n=Fu(),t=n.x0,e=n.x1+1,i=n.y0,s=n.y1+1,r=n.z0,a=n.z1+1,o=e-t,c=s-i,l=a-r,h=(f,m,_,x,p,u,b,v)=>({a:gs(f,m,_),b:gs(x,p,u),mid:gs((f+x)/2,(m+p)/2,(_+u)/2),len:b,filled:!0,nolabel:!v}),d=[];d.push(h(t,i,r,e,i,r,o,o>=2)),d.push(h(t,i,r,t,i,a,l,l>=2)),d.push(h(t,i,r,t,s,r,c,c>=2)),d.push(h(e,i,r,e,i,a,0,!1),h(t,i,a,e,i,a,0,!1)),d.push(h(t,s,r,e,s,r,0,!1),h(t,s,r,t,s,a,0,!1),h(e,s,r,e,s,a,0,!1),h(t,s,a,e,s,a,0,!1)),d.push(h(e,i,r,e,s,r,0,!1),h(t,i,a,t,s,a,0,!1),h(e,i,a,e,s,a,0,!1)),g.liveMeas=d,_s()}se.addEventListener("pointerdown",n=>{se.setPointerCapture(n.pointerId),co(n.clientX,n.clientY);let t={x:n.clientX,y:n.clientY,sx:n.clientX,sy:n.clientY};if(xs()){n.button===0?g.drag={...t,mode:"pan",meas:"freeze"}:n.button===2?g.drag={...t,mode:"orbit",meas:"clear"}:n.button===1&&(g.drag={...t,mode:"pan",sx:-1e9});return}if(g.editObject){n.button===0?g.tool==="add"||g.tool==="erase"?Fx(n,t):(g.painting=!0,g.lastVox=null,Nu()):n.button===2?g.drag={...t,mode:"orbit"}:n.button===1&&(g.drag={...t,mode:"pan"});return}let e=Qa(),i=e&&g.selection.has(e);n.button===0?i?g.drag={...t,mode:"move",start:ps(0),dx:0,dy:0,dz:0,shiftAnchorY:null,...Lx()}:g.drag={...t,mode:"pan",clickId:e}:n.button===2?i?g.drag={...t,mode:"rotobj",steps:0}:g.drag={...t,mode:"orbit"}:n.button===1&&(g.drag={...t,mode:"pan",clickId:null,sx:-1e9})});se.addEventListener("pointermove",n=>{if(co(n.clientX,n.clientY),xs()){Du(n),Gh();return}if(g.editObject&&g.painting){Nu();return}if(!g.drag){g.editObject?Ou():Ye.visible=!1;return}Du(n)||(g.drag.mode==="move"?Ux(n):g.drag.mode==="rotobj"?Ox(n):g.drag.mode==="box"&&zx(n))});se.addEventListener("pointerup",n=>{try{se.releasePointerCapture(n.pointerId)}catch{}if(xs()){g.drag&&!Lu(n)&&(g.drag.meas==="freeze"?Wh():g.drag.meas==="clear"&&un()),g.drag=null;return}if(g.editObject){g.painting?(g.painting=!1,Ee(),he()):g.drag&&g.drag.mode==="box"&&Bx(n.altKey),g.drag=null;return}if(g.drag)if(g.drag.mode==="pan"&&!Lu(n)){let t=g.drag.clickId;t?n.shiftKey?g.selection.has(t)?g.selection.delete(t):g.selection.add(t):g.selection=new Set([t]):n.shiftKey||g.selection.clear(),ic(),Ee()}else g.drag.mode==="move"?Nx():g.drag.mode==="rotobj"&&g.drag.steps&&he();g.drag=null});se.addEventListener("pointerleave",()=>{Ye.visible=!1});se.addEventListener("contextmenu",n=>n.preventDefault());se.addEventListener("wheel",n=>{n.preventDefault(),Wt.zoom*=n.deltaY>0?1/.95:.95,Wt.zoom=Math.max(6,Math.min(eo,Wt.zoom))},{passive:!1});se.addEventListener("dblclick",n=>{if(g.editObject)return;co(n.clientX,n.clientY);let t=Qa();t&&vi(mi(t),!0)});for(let n of["pointerdown","pointermove","pointerup","pointerleave","wheel","keydown","dblclick"])window.addEventListener(n,is,{passive:!0,capture:!0});var kx=()=>Math.abs(Wt.azim-Gt.azim)<.001&&Math.abs(Wt.elev-Gt.elev)<.001&&Math.abs(Wt.zoom-Gt.zoom)<.001&&Gt.target.distanceToSquared(Wt.target)<1e-6;function Bu(){let n=se.getBoundingClientRect(),t=Math.max(1,Math.round(n.width)),e=Math.max(1,Math.round(n.height)),i=Math.min(devicePixelRatio,2);(se.width!==Math.round(t*i)||se.height!==Math.round(e*i))&&(ns.setSize(t,e,!1),is())}window.addEventListener("resize",Bu);function ku(){requestAnimationFrame(ku),Bu(),nu(),(Gs.tail>0||!kx())&&(ns.render(be,Yt),Xh(),Gs.tail>0&&Gs.tail--)}function Vx(){lu()||(g.root=Iu()),g.path=[g.root],g.context=g.root,g.editObject=null,g.selection.clear(),Ss(),ke(),Ee(),In(),ys(),ku()}Vx();
/**
 * @license
