...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function ql(){return new dn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qa(),fragmentShader:`
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function Zl(){return new dn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qa(),fragmentShader:`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      }`}));nc.frustumCulled=!1;nc.renderOrder=-1e9;Ee.add(nc);function Wh(){Gh.uGround.value=Math.max(0,Math.min(1,(Gt.elev+.05)/.1))}Ee.add(new io(16777215,.62));var Ye=new Xs(16777215,.78);Ye.castShadow=!0;Ye.shadow.mapSize.set(4096,4096);Ye.shadow.normalBias=.15;Ye.shadow.bias=-2e-4;Ee.add(Ye);Ee.add(Ye.target);var Xh=new Xs(16777215,.16);Xh.position.set(-6,5,-7);Ee.add(Xh);var qs={tail:0},gs=()=>{qs.tail=30},ic=new I,lo=new I,Fx=new Rt("#0f1115"),kh=new Map,Vh=new Map;function Zs(n){let t=kh.get(n);return t||(t=new Rt().setHex(n),kh.set(n,t)),t}function sc(n){let t=Vh.get(n);return t||(t=new Rt().setHex(n).lerp(Fx,.62),Vh.set(n,t)),t}var rc=new Gs({vertexColors:!0,side:nn}),zx=.42,oc=new Gs({vertexColors:!0,transparent:!0,opacity:zx,side:nn,depthWrite:!1});oc.shadowSide=cn;var Yh=new cs({colorWrite:!1,side:nn}),Ei=new be(new hs(8e3,8e3),new eo({opacity:.32}));Ei.rotation.x=-Math.PI/2;Ei.position.y=-.1;Ei.receiveShadow=!0;Ei.renderOrder=-1;Ee.add(Ei);var Kn=new Rn;Ee.add(Kn);var Un=new Rn;Ee.add(Un);var qe=new Mi(new ds(new In(1,1,1)),new Jn({color:10994876,depthTest:!1}));qe.visible=!1;qe.renderOrder=999;Ee.add(qe);var wi=new Mi(new Oe,new Jn({vertexColors:!0,transparent:!0,depthTest:!1}));wi.renderOrder=998;wi.visible=!1;Ee.add(wi);var pn=new so,jn=new Ht,Qn=new I,Js=new I;var qh=(n,t,e)=>n+65536+(t+65536)*131072+(e+65536)*131072*131072,Ze=(n,t)=>({x:n.x+t.x,y:n.y+t.y,z:n.z+t.z});function ee(n,t){let{x:e,y:i,z:s}=n;switch(t&3){case 1:return{x:-s,y:i,z:e};case 2:return{x:-e,y:i,z:-s};case 3:return{x:s,y:i,z:-e};default:return{x:e,y:i,z:s}}}var xs=(n,t)=>({rot:n.rot+t.rot&3,off:Ze(ee(t.off,n.rot),n.off)}),Zh=n=>{let t=4-(n.rot&3)&3,e=ee(n.off,t);return{rot:t,off:{x:-e.x,y:-e.y,z:-e.z}}},ac=n=>n.slice(1).reduce((t,e)=>xs(t,{off:e.pos,rot:e.rot}),{off:{x:0,y:0,z:0},rot:0}),$s=n=>"#"+(n&16777215).toString(16).padStart(6,"0"),cc=1,ho=()=>"n"+cc++,_s=()=>cc,uo=n=>{cc=n};var ne=(n,t,e,i,s,r,a)=>({x0:n,y0:t,z0:e,x1:i,y1:s,z1:r,c:a}),lc=(n,t,e,i)=>t>=n.x0&&t<n.x1&&e>=n.y0&&e<n.y1&&i>=n.z0&&i<n.z1;function Bx(n,t,e){let i=Math.max(n.x0,t.x0),s=Math.max(n.y0,t.y0),r=Math.max(n.z0,t.z0),a=Math.min(n.x1,t.x1),o=Math.min(n.y1,t.y1),c=Math.min(n.z1,t.z1);if(i>=a||s>=o||r>=c){e.push(n);return}let l=n.c;n.x0<i&&e.push({...n,x1:i}),a<n.x1&&e.push({...n,x0:a}),n.y0<s&&e.push({x0:i,y0:n.y0,z0:n.z0,x1:a,y1:s,z1:n.z1,c:l}),o<n.y1&&e.push({x0:i,y0:o,z0:n.z0,x1:a,y1:n.y1,z1:n.z1,c:l}),n.z0<r&&e.push({x0:i,y0:s,z0:n.z0,x1:a,y1:o,z1:r,c:l}),c<n.z1&&e.push({x0:i,y0:s,z0:c,x1:a,y1:o,z1:n.z1,c:l})}function Ti(n,t){let e=[];for(let i of n)Bx(i,t,e);return e}function Jh(n,t,e){let i=Ti(n,t);return i.push({...t,c:e}),i}function $h(n,t,e,i,s){let r=-1;for(let h=0;h<n.length;h++)if(lc(n[h],t,e,i)){r=h;break}if(r===-1)return null;let a=n[r].c;if(a===s)return null;let o=(h,u)=>{let f=h.x0<u.x1&&u.x0<h.x1,m=h.y0<u.y1&&u.y0<h.y1,g=h.z0<u.z1&&u.z0<h.z1;return m&&g&&(h.x1===u.x0||u.x1===h.x0)||f&&g&&(h.y1===u.y0||u.y1===h.y0)||f&&m&&(h.z1===u.z0||u.z1===h.z0)},c=new Set([r]),l=[r];for(;l.length;){let h=n[l.pop()];for(let u=0;u<n.length;u++)!c.has(u)&&n[u].c===a&&o(h,n[u])&&(c.add(u),l.push(u))}return n.map((h,u)=>c.has(u)?{...h,c:s}:h)}function Kh(n,t){for(let e of n){let i=(e.x1-e.x0)*(e.y1-e.y0)*(e.z1-e.z0);t.set(e.c,(t.get(e.c)||0)+i)}}function _n(n,t){for(let e of n)e.x0<t.min.x&&(t.min.x=e.x0),e.y0<t.min.y&&(t.min.y=e.y0),e.z0<t.min.z&&(t.min.z=e.z0),e.x1>t.max.x&&(t.max.x=e.x1),e.y1>t.max.y&&(t.max.y=e.y1),e.z1>t.max.z&&(t.max.z=e.z1)}function mn(n,t,e){let i=ee({x:n.x0,y:n.y0,z:n.z0},t),s=ee({x:n.x1-1,y:n.y1-1,z:n.z1-1},t);return{x0:Math.min(i.x,s.x)+e.x,y0:Math.min(i.y,s.y)+e.y,z0:Math.min(i.z,s.z)+e.z,x1:Math.max(i.x,s.x)+e.x+1,y1:Math.max(i.y,s.y)+e.y+1,z1:Math.max(i.z,s.z)+e.z+1,c:n.c}}var kx=16,Fe=n=>Math.floor(n/kx);function fo(n){if(!n.length)return()=>!1;let t=1/0,e=1/0,i=1/0,s=-1/0,r=-1/0,a=-1/0;for(let x of n)x.x0<t&&(t=x.x0),x.y0<e&&(e=x.y0),x.z0<i&&(i=x.z0),x.x1>s&&(s=x.x1),x.y1>r&&(r=x.y1),x.z1>a&&(a=x.z1);let o=Fe(t),c=Fe(e),l=Fe(i),h=Fe(s-1)-o+1,u=Fe(r-1)-c+1,f=Fe(a-1)-l+1,m=Array.from({length:h*u*f},()=>[]),g=(x,p,d)=>((x-o)*u+(p-c))*f+(d-l);for(let x of n)for(let p=Fe(x.x0);p<=Fe(x.x1-1);p++)for(let d=Fe(x.y0);d<=Fe(x.y1-1);d++)for(let y=Fe(x.z0);y<=Fe(x.z1-1);y++)m[g(p,d,y)].push(x);return(x,p,d)=>{let y=Fe(x),_=Fe(p),T=Fe(d);if(y<o||_<c||T<l||y-o>=h||_-c>=u||T-l>=f)return!1;for(let P of m[g(y,_,T)])if(lc(P,x,p,d))return!0;return!1}}var jh=(n,t,e,i)=>n.some(s=>lc(s,t,e,i)),hc=(n,t,e,i,s)=>n.some(r=>t.some(a=>r.x0+e<a.x1&&a.x0<r.x1+e&&r.y0+i<a.y1&&a.y0<r.y1+i&&r.z0+s<a.z1&&a.z0<r.z1+s));var po=[7041116,10855821,12040100,14472900,13343102,14532265,15787730,9268835,13935475,10249796,11895693,7170165,8226199,6055805,6986062,10994876],Qh={visible:0,transparent:1,invisible:2},tu={visible:"transparent",transparent:"invisible",invisible:"visible"},mo=()=>({type:"object",id:ho(),name:"",pos:{x:0,y:0,z:0},rot:0,vis:"visible",boxes:[]}),vs=(n="")=>({type:"scene",id:ho(),name:n,pos:{x:0,y:0,z:0},rot:0,vis:"visible",children:[]});function go(n){let t={id:ho(),name:n.name,pos:{...n.pos},rot:n.rot,vis:n.vis};return n.type==="object"?{type:"object",...t,boxes:n.boxes.map(e=>({...e}))}:{type:"scene",...t,children:n.children.map(go)}}var Ai=n=>M.context.children.find(t=>t.id===n);function ys(n,t=M.root,e=[]){if(e.push(t),t===n)return e.slice();if(t.type==="scene")for(let i of t.children){let s=ys(n,i,e);if(s)return s}return e.pop(),null}function Ms(n,t=M.root){if(t.id===n)return t;if(t.type==="scene")for(let e of t.children){let i=Ms(n,e);if(i)return i}return null}function Ri(n){let t=ys(n);return t&&t.length>1?t[t.length-2]:null}function Ss(n,t){return n===t?!0:n.type!=="scene"?!1:n.children.some(e=>Ss(e,t))}var bs=()=>ac(M.path),Ks=n=>ac(ys(n)||[M.root]),sn=()=>({min:{x:1e9,y:1e9,z:1e9},max:{x:-1e9,y:-1e9,z:-1e9}}),ti=n=>n.max.x<n.min.x;function ei(n,t,e,i){if(n.type==="object")_n(n.boxes.map(s=>mn(s,e,t)),i);else for(let s of n.children)ei(s,Ze(t,ee(s.pos,e)),e+s.rot&3,i);return i}function xo(n,t){jn.x=(n-he.x)/he.w*2-1,jn.y=-((t-he.y)/he.h)*2+1}var uc=()=>M.pickMeshes.length?(pn.setFromCamera(jn,Xt),pn.intersectObjects(M.pickMeshes,!1)[0]??null):null;function dc(){let n=uc();return n?n.object.userData.childId??null:null}var eu=new Qe(new I(0,1,0),0);function js(n){return pn.setFromCamera(jn,Xt),eu.constant=-n,pn.ray.intersectPlane(eu,Qn)?{x:Math.floor(Qn.x),y:n,z:Math.floor(Qn.z)}:null}var su=(n,t)=>({x:Math.floor(n.x-t.x*.5),y:Math.floor(n.y-t.y*.5),z:Math.floor(n.z-t.z*.5)});function Ci(){let n=uc();if(!n)return null;let t=M.editXform.off,e=ee({x:n.point.x-t.x,y:n.point.y-t.y,z:n.point.z-t.z},-M.editXform.rot),i=n.face?n.face.normal:{x:0,y:1,z:0},s=su(e,i);return{cell:s,addCell:{x:s.x+Math.round(i.x),y:s.y+Math.round(i.y),z:s.z+Math.round(i.z)}}}function ru(){let n=uc();return n?su(n.point,n.face?n.face.normal:{x:0,y:1,z:0}):js(0)}function Qs(n){let t=js(n+M.editXform.off.y);if(!t)return null;let e=ee({x:t.x-M.editXform.off.x,y:0,z:t.z-M.editXform.off.z},-M.editXform.rot);return{x:Math.round(e.x),y:n,z:Math.round(e.z)}}var nu=(n,t)=>({x:n===0?t:0,y:n===1?t:0,z:n===2?t:0}),iu=new Qe;function ou(n,t){let e=M.editXform.off,i=M.editXform.rot,s=ee(nu(n,1),i),r=Ze(ee(nu(n,t),i),e);if(pn.setFromCamera(jn,Xt),iu.setComponents(s.x,s.y,s.z,-(s.x*r.x+s.y*r.y+s.z*r.z)),!pn.ray.intersectPlane(iu,Qn))return null;let a=ee({x:Qn.x-e.x,y:Qn.y-e.y,z:Qn.z-e.z},-i),o={x:Math.round(a.x),y:Math.round(a.y),z:Math.round(a.z)};return n===0?o.x=t:n===1?o.y=t:o.z=t,o}var Es=(n,t,e)=>{let i=ee({x:n,y:t,z:e},M.editXform.rot);return new I(i.x+M.editXform.off.x,i.y+M.editXform.off.y,i.z+M.editXform.off.z)};function fc(n=Ci()){return M.tool==="add"?n?n.addCell:Qs(0):n?n.cell:null}var Vx=new Rt(10994876),Hx=new Rt(6055805),tr=null,pc=[],_o=[],vo=()=>M.editObject?M.tool==="measure":M.measMode,mc=()=>{tr=null};function vn(){M.liveMeas=null,pc=[],Pi()}function au(){if(tr)return tr;let n=[],t;M.editObject?(n.push(...M.editObject.boxes),t=Es):(ni(M.root,{x:0,y:0,z:0},0,null,0,(o,c,l,h)=>{if(h)for(let u of o.boxes)n.push(mn(u,l,c))}),t=(o,c,l)=>new I(o,c,l));let e=sn();_n(n,e);let i=n.length===0,s={x:e.min.x,y:e.min.y,z:e.min.z},r={x:e.max.x-1,y:e.max.y-1,z:e.max.z-1};return tr={has:n.length>64?fo(n):(o,c,l)=>jh(n,o,c,l),mn:s,mx:r,toW:t,empty:i},tr}function Gx(){let n=au();if(n.empty)return null;let t=null;if(M.editObject){let e=Ci();t=e?{...e.cell}:Qs(0)}else t=ru();return t?{x:Math.max(n.mn.x,Math.min(n.mx.x,t.x)),y:Math.max(n.mn.y,Math.min(n.mx.y,t.y)),z:Math.max(n.mn.z,Math.min(n.mx.z,t.z))}:null}function Wx(n){let t=au(),e=["x","y","z"],i=[];for(let s=0;s<3;s++){let r=e[s],a=e[(s+1)%3],o=e[(s+2)%3],c=t.mn[r],l=t.mx[r],h=[n.x,n.y,n.z],u=m=>(h[s]=m,t.has(h[0],h[1],h[2])),f=c;for(;f<=l;){let m=u(f),g=f;for(;g+1<=l&&u(g+1)===m;)g++;let x=p=>{let d={};return d[r]=p,d[a]=n[a]+.5,d[o]=n[o]+.5,t.toW(d.x,d.y,d.z)};i.push({a:x(f),b:x(g+1),mid:x((f+g+1)/2),len:g-f+1,filled:m}),f=g+1}}return i}function cu(){let n=Gx();M.liveMeas=n?Wx(n):null,Pi()}function lu(){M.liveMeas&&M.liveMeas.length&&(pc.push(M.liveMeas),Pi())}function Pi(){let n=document.getElementById("measure");n.innerHTML="",_o=[];let t=[];M.liveMeas&&t.push({s:M.liveMeas,fz:!1});for(let r of pc)t.push({s:r,fz:!0});let e=[],i=[];for(let r of t)for(let a of r.s){let o=a.filled?Vx:Hx;if(e.push(a.a.x,a.a.y,a.a.z,a.b.x,a.b.y,a.b.z),i.push(o.r,o.g,o.b,o.r,o.g,o.b),a.nolabel)continue;let c=document.createElement("div");c.className="mlab"+(a.filled?"":" empty")+(r.fz?" frozen":""),c.textContent=String(a.len),n.appendChild(c),_o.push({el:c,w:a.mid})}wi.geometry.dispose();let s=new Oe;s.setAttribute("position",new pe(e,3)),s.setAttribute("color",new pe(i,3)),wi.geometry=s,wi.visible=e.length>0}function hu(){if(_o.length)for(let n of _o){if(Js.copy(n.w).project(Xt),Js.z>1){n.el.style.display="none";continue}n.el.style.display="",n.el.style.left=(Js.x*.5+.5)*he.w+"px",n.el.style.top=(-Js.y*.5+.5)*he.h+"px"}}var gc=new I(40,150,30).normalize();function Xx(n){if(ti(n))return;let t=(n.min.x+n.max.x)/2,e=(n.min.y+n.max.y)/2,i=(n.min.z+n.max.z)/2,s=.5*Math.hypot(n.max.x-n.min.x,n.max.y-n.min.y,n.max.z-n.min.z)+8,r=s+130;Ye.position.set(t+gc.x*r,e+gc.y*r,i+gc.z*r),Ye.target.position.set(t,e,i),Ye.target.updateMatrixWorld();let a=Ye.shadow.camera;a.left=-s,a.right=s,a.top=s,a.bottom=-s,a.near=Math.max(1,r-s-20),a.far=r+s+20,a.updateProjectionMatrix(),Ye.shadow.normalBias=4*s/Ye.shadow.mapSize.x}var Dn=[];function Yx(){let n=new Set;for(let t of Dn){Ee.remove(t);let e=t.geometry;e&&!n.has(e)&&(e.dispose(),n.add(e))}Dn=[],Kn.clear(),ws&&(cancelAnimationFrame(ws),ws=0),Je=null}var Je=null,ws=0,qx=[{a:0,hi:!0,u:1,v:2,n:[1,0,0]},{a:0,hi:!1,u:2,v:1,n:[-1,0,0]},{a:1,hi:!0,u:2,v:0,n:[0,1,0]},{a:1,hi:!1,u:0,v:2,n:[0,-1,0]},{a:2,hi:!0,u:0,v:1,n:[0,0,1]},{a:2,hi:!1,u:1,v:0,n:[0,0,-1]}],pu=3,nr=2,ii=pu*nr,uu=.5;function du(n,t,e,i,s,r){let a=2*nr+1;for(let o=0;o<e;o++){let c=o*s,l=0;for(let h=0;h<=nr&&h<i;h++)l+=n[c+h*r];for(let h=0;h<i;h++){t[c+h*r]=l/a;let u=h+nr+1,f=h-nr;u<i&&(l+=n[c+u*r]),f>=0&&(l-=n[c+f*r])}}}function mu(n,t,e){let i=[],s=[],r=[],a=n.map(u=>[u.x0,u.y0,u.z0]),o=n.map(u=>[u.x1,u.y1,u.z1]),c=e?fo(n):null,l=[0,0,0];for(let u=0;u<n.length;u++){let f=t(n[u].c),m=f.r,g=f.g,x=f.b,p=a[u],d=o[u];for(let y of qx){let{a:_,u:T,v:P}=y,A=y.hi?d[_]:p[_],R=y.hi?A:A-1,Z=[];for(let F=0;F<n.length;F++){if(F===u||(y.hi?a[F][_]:o[F][_])!==A)continue;let W=Math.max(a[F][T],p[T]),G=Math.min(o[F][T],d[T]),Q=Math.max(a[F][P],p[P]),N=Math.min(o[F][P],d[P]);W<G&&Q<N&&Z.push([W,Q,G,N])}let b=[[p[T],p[P],d[T],d[P]]];for(let F of Z){let W=[];for(let G of b){let Q=Math.max(G[0],F[0]),N=Math.max(G[1],F[1]),q=Math.min(G[2],F[2]),nt=Math.min(G[3],F[3]);if(Q>=q||N>=nt){W.push(G);continue}G[0]<Q&&W.push([G[0],G[1],Q,G[3]]),q<G[2]&&W.push([q,G[1],G[2],G[3]]),G[1]<N&&W.push([Q,G[1],q,N]),nt<G[3]&&W.push([Q,nt,q,G[3]])}if(b=W,!b.length)break}let w=[0,0,0],H=(F,W)=>(w[_]=A,w[T]=F,w[P]=W,[w[0],w[1],w[2]]),$=null,rt=0,L=0,D=0,X=()=>{rt=p[T]-ii,L=p[P]-ii;let F=d[T]-p[T]+2*ii+1;D=d[P]-p[P]+2*ii+1;let W=new Float32Array(F*D),G=l;G[_]=R;for(let N=0;N<F;N++){G[T]=rt+N;let q=N*D;for(let nt=0;nt<D;nt++)G[P]=L+nt,c(G[0],G[1],G[2])&&(W[q+nt]=1)}let Q=new Float32Array(F*D);for(let N=0;N<pu;N++)du(W,Q,F,D,D,1),du(Q,W,D,F,1,D);return $=W},J=(F,W)=>{if(!c)return 1;let Q=($??X())[(F-rt)*D+(W-L)];return uu+(1-uu)*(1-Q)},Y=(F,W,G,Q)=>{let N=H(F,W),q=H(G,W),nt=H(G,Q),mt=H(F,Q),ut=J(F,W),dt=J(G,W),lt=J(G,Q),St=J(F,Q),Vt=[[N,ut],[q,dt],[nt,lt],[N,ut],[nt,lt],[mt,St]];for(let[O,de]of Vt)i.push(O[0],O[1],O[2]),s.push(y.n[0],y.n[1],y.n[2]),r.push(m*de,g*de,x*de)};for(let F of b){let[W,G,Q,N]=F;if(!c){Y(W,G,Q,N);continue}let q=W+ii,nt=Q-ii,mt=G+ii,ut=N-ii;if(q>=nt||mt>=ut){for(let dt=W;dt<Q;dt++)for(let lt=G;lt<N;lt++)Y(dt,lt,dt+1,lt+1);continue}for(let dt=W;dt<Q;dt++){for(let lt=G;lt<mt;lt++)Y(dt,lt,dt+1,lt+1);for(let lt=ut;lt<N;lt++)Y(dt,lt,dt+1,lt+1)}for(let dt=mt;dt<ut;dt++){for(let lt=W;lt<q;lt++)Y(lt,dt,lt+1,dt+1);for(let lt=nt;lt<Q;lt++)Y(lt,dt,lt+1,dt+1)}Y(q,mt,nt,ut)}}}if(!i.length)return null;let h=new Oe;return h.setAttribute("position",new pe(i,3)),h.setAttribute("normal",new pe(s,3)),h.setAttribute("color",new pe(r,3)),h}function er(n,t,{transparent:e=!1,childId:i}={}){if(!n.length)return;let s=mu(n,t,!e);if(!s)return;let r=new be(s,e?oc:rc);if(r.castShadow=!0,r.receiveShadow=!0,Ee.add(r),Dn.push(r),e){r.renderOrder=2;let a=new be(s,Yh);a.renderOrder=1,a.castShadow=!1,a.receiveShadow=!1,Ee.add(a),Dn.push(a)}i!=null&&(r.userData.childId=i,M.pickMeshes.push(r),(M.childMeshes[i]||(M.childMeshes[i]=[])).push(r))}function ni(n,t,e,i,s,r){let a=Math.max(s,Qh[n.vis]);if(!(n===M.editObject||a>=2))if(n.type==="object")r(n,t,e,i,a===1);else for(let o of n.children)ni(o,Ze(t,ee(o.pos,e)),e+o.rot&3,n===M.context?o.id:i,a,r)}var fu=(n,t,e,i)=>{for(let s of n.boxes)i.push(mn(s,e,t));return i};function gu(){let{off:n,rot:t}=M.editXform;if(Kn.position.set(n.x,n.y,n.z),Kn.rotation.set(0,-t*Math.PI/2,0),Kn.updateMatrixWorld(!0),Je){Kn.remove(Je),Je.geometry.dispose();let i=Dn.indexOf(Je);i>=0&&Dn.splice(i,1)}let e=mu(M.editObject.boxes,Zs,!0);Je=e?new be(e,rc):null,Je&&(Je.castShadow=Je.receiveShadow=!0,Kn.add(Je),Dn.push(Je)),M.pickMeshes=Je?[Je]:[]}function Zx(){ws||(ws=requestAnimationFrame(()=>{ws=0,gu(),gs()}))}function xc(){M.voxVer++,mc(),Zx()}function xu(n,t){M.editObject.boxes=Jh(M.editObject.boxes,n,t),xc()}function _u(n){M.editObject.boxes=Ti(M.editObject.boxes,n),xc()}function vu(n,t){let e=$h(M.editObject.boxes,n.x,n.y,n.z,t);e&&(M.editObject.boxes=e,xc())}function yu(){if(!Dn.length)return null;pn.setFromCamera(jn,Xt);let n=pn.intersectObjects(Dn,!1)[0];if(!n)return null;let t=pn.ray.direction,e=Math.floor(n.point.x+t.x*.5),i=Math.floor(n.point.y+t.y*.5),s=Math.floor(n.point.z+t.z*.5),r=(o,c,l)=>{for(let h of o){let u=mn(h,l,c);if(e>=u.x0&&e<u.x1&&i>=u.y0&&i<u.y1&&s>=u.z0&&s<u.z1)return u.c}return null};if(M.editObject){let o=r(M.editObject.boxes,M.editXform.off,M.editXform.rot);if(o!=null)return o}let a=null;return ni(M.root,{x:0,y:0,z:0},0,null,0,(o,c,l)=>{a==null&&(a=r(o.boxes,c,l))}),a}function ze(){Yx(),M.pickMeshes=[],M.childMeshes={},M.childBox={},M.voxVer++,mc();let n={x:0,y:0,z:0},t=sn();if(M.editObject){M.editXform=xs(bs(),{off:M.editObject.pos,rot:M.editObject.rot});let e=[];ni(M.root,n,0,null,0,(i,s,r)=>fu(i,s,r,e)),_n(e,t),er(e,Zs,{transparent:!0}),gu(),ei(M.editObject,M.editXform.off,M.editXform.rot,t)}else{let e=new Map,i=new Map,s=[],r=[];ni(M.root,n,0,null,0,(a,o,c,l,h)=>{let u=fu(a,o,c,[]);if(_n(u,t),l){let f=h?i:e,m=f.get(l);m?m.push(...u):f.set(l,u),_n(u,M.childBox[l]||(M.childBox[l]=sn()))}else(h?r:s).push(...u)}),er(s,sc),er(r,sc,{transparent:!0});for(let a of new Set([...e.keys(),...i.keys()])){let o=e.get(a);o&&er(o,Zs,{childId:a});let c=i.get(a);c&&er(c,Zs,{transparent:!0})}}M.sceneBox=t,Xx(t),ir(),gs()}function Jx(n,t,e){let i=new In(t.x-n.x,t.y-n.y,t.z-n.z),s=new Mi(new ds(i),new Jn({color:e,depthTest:!1}));return s.position.set((n.x+t.x)/2,(n.y+t.y)/2,(n.z+t.z)/2),s.renderOrder=999,i.dispose(),s}function ir(){for(let n of Un.children)n.geometry?.dispose?.();if(Un.clear(),Un.position.set(0,0,0),!M.editObject)for(let n of M.selection){let t=M.childBox[n];t&&!ti(t)&&Un.add(Jx(t.min,t.max,15787730))}}var sr=new I,_c=new I,vc=new I,Mu=new I,$x=new I(0,1,0);function Su(n,t){let e=(Xt.top-Xt.bottom)/he.h;Xt.getWorldDirection(_c),vc.crossVectors(_c,$x).normalize(),Mu.crossVectors(vc,_c).normalize(),Jt.target.addScaledVector(vc,-n*e),Jt.target.addScaledVector(Mu,t*e)}function bu(n,t){Jt.azim-=n*.012,Jt.elev=Math.max(-Math.PI/2,Math.min(Math.PI/2,Jt.elev+t*.012))}function Eu(n){ti(n)||(Jt.target.set((n.min.x+n.max.x)/2,(n.min.y+n.max.y)/2,(n.min.z+n.max.z)/2),Jt.zoom=Math.max(8,Math.min(co,Math.max(n.max.x-n.min.x,n.max.y-n.min.y,n.max.z-n.min.z)*1.5+8)))}function Nn(){let n=sn();if(M.editObject){if(ei(M.editObject,M.editXform.off,M.editXform.rot,n),ti(n)){let t=M.editXform.off;Jt.target.set(t.x,t.y+6,t.z),Jt.zoom=41;return}}else for(let t in M.childBox){let e=M.childBox[t];n.min.x=Math.min(n.min.x,e.min.x),n.min.y=Math.min(n.min.y,e.min.y),n.min.z=Math.min(n.min.z,e.min.z),n.max.x=Math.max(n.max.x,e.max.x),n.max.y=Math.max(n.max.y,e.max.y),n.max.z=Math.max(n.max.z,e.max.z)}if(ti(n)){Jt.target.set(0,1,0),Jt.zoom=23;return}Eu(n)}function wu(n){if(n===M.root){Nn();return}let t=Ks(n);Eu(ei(n,t.off,t.rot,sn()))}function Tu(){Gt.azim+=(Jt.azim-Gt.azim)*.22,Gt.elev+=(Jt.elev-Gt.elev)*.22,Gt.zoom+=(Jt.zoom-Gt.zoom)*.25,Gt.target.lerp(Jt.target,.25);let n=Math.cos(Gt.elev),t=Math.sin(Gt.elev);sr.set(n*Math.sin(Gt.azim),t,n*Math.cos(Gt.azim)),Xt.position.copy(Gt.target).addScaledVector(sr,Hh);let e=Ph.clamp((Math.abs(Gt.elev)-1.45)/(Math.PI/2-1.45),0,1);lo.set(-Math.sin(Gt.azim),0,-Math.cos(Gt.azim)),Gt.elev<0&&lo.negate(),ic.set(0,1,0).lerp(lo,e),Xt.up.copy(ic.normalize()),Xt.lookAt(Gt.target);let i=he.w/he.h,s=Gt.zoom,r=s*i;Xt.left=-r/2,Xt.right=r/2,Xt.top=s/2,Xt.bottom=-s/2;let a=Xt.position,o=1/0,c=-1/0,l=(g,x,p)=>{let d=(a.x-g)*sr.x+(a.y-x)*sr.y+(a.z-p)*sr.z;d<o&&(o=d),d>c&&(c=d)},h=M.sceneBox;if(h&&!ti(h))for(let g of[h.min.x,h.max.x])for(let x of[h.min.y,h.max.y])for(let p of[h.min.z,h.max.z])l(g,x,p);let u=Gt.target.x,f=Gt.target.z,m=4e3;for(let g of[-m,m])for(let x of[-m,m])l(u+g,0,f+x);o>c&&(o=.1,c=4e3),Xt.near=o-10,Xt.far=c+10,Xt.updateProjectionMatrix(),Ei.position.set(Gt.target.x,-.1,Gt.target.z),Wh()}var yc=(n,t,e)=>{M.selection=new Set([n]),M.editObject=null,vn(),M.context!==t||e?ze():ir(),ce()};function Kx(){if(M.path.length<=1)return;let n=M.context,t=M.editObject;yc(M.path.pop().id,n,t)}function jx(){yc(M.editObject.id,M.context,M.editObject)}function Au(){M.editObject?jx():Kx()}function si(n){let t=ys(n);if(!t)return;let e=M.context,i=M.editObject;M.path=t.slice(0,-1),yc(n.id,e,i)}function Li(n,t){let e=ys(n);e&&(n.type==="scene"?(M.path=e,M.editObject=null):(M.path=e.slice(0,-1),M.editObject=n),M.selection.clear(),M.tool="add",vn(),ze(),ce(),t&&Nn())}var Qx=200,On=[],Ii=-1,Mc=!1,t_=n=>({rootJSON:n,uid:_s(),pathIds:M.path.map(t=>t.id),selection:[...M.selection],editId:M.editObject?M.editObject.id:null,collapsed:[...M.collapsed]});function Ru(n){if(Mc)return;let t=t_(n),e=On[Ii];e&&e.rootJSON===t.rootJSON||(On.length=Ii+1,On.push(t),On.length>Qx&&On.shift(),Ii=On.length-1)}function Cu(n){Mc=!0,uo(n.uid),M.root=yo(JSON.parse(n.rootJSON)),M.path=[];let t=M.root;for(let e of n.pathIds){let i=t.id===e?t:t.type==="scene"?t.children.find(s=>s.id===e):null;if(!i)break;t=i,M.path.push(t)}M.path.length||(M.path=[M.root]),M.editObject=n.editId?Ms(n.editId):null,M.selection=new Set(n.selection.filter(e=>M.context.children.some(i=>i.id===e))),M.collapsed=new Set(n.collapsed),M.drag=null,M.painting=!1,M.lastVox=null,ze(),ce(),Me(),Mc=!1}function Pu(){ri(),Ii>0&&Cu(On[--Ii])}function Sc(){ri(),Ii<On.length-1&&Cu(On[++Ii])}var Lu="voxelier-v11";function So(n){let t={id:n.id,nm:n.name,p:n.pos,r:n.rot,vs:n.vis};return n.type==="object"?{t:"o",...t,b:n.boxes.map(e=>[e.x0,e.y0,e.z0,e.x1,e.y1,e.z1,e.c])}:{t:"s",...t,c:n.children.map(So)}}function yo(n){let t={id:n.id,name:n.nm||"",pos:n.p,rot:n.r,vis:n.vs||"visible"};return n.t==="o"?{type:"object",...t,boxes:n.b.map(e=>({x0:e[0],y0:e[1],z0:e[2],x1:e[3],y1:e[4],z1:e[5],c:e[6]}))}:{type:"scene",...t,children:n.c.map(yo)}}var Mo;function ri(){clearTimeout(Mo),Mo=void 0;let n=JSON.stringify(So(M.root));Ru(n);try{localStorage.setItem(Lu,`{"uid":${_s()},"root":${n}}`)}catch{}}function Me(){clearTimeout(Mo),Mo=setTimeout(ri,250)}function bc(n){return!n||!n.root?!1:(uo(n.uid||1),M.root=yo(n.root),!0)}function Iu(){try{return bc(JSON.parse(localStorage.getItem(Lu)))}catch{return!1}}var Ui=()=>{ze(),ce(),Me()},Uu=n=>n<0?-Math.round(-n):Math.round(n);function Du(n){n.vis=tu[n.vis],Ui()}function Nu(n){let t=prompt("Name",n.name||"");t!=null&&(n.name=t.trim(),ce(),Me())}var Ec=[],Ou=()=>[...M.selection].map(n=>Ai(n)).filter(n=>!!n),wc=n=>{let t=go(n);return t.pos={x:n.pos.x+5,y:n.pos.y,z:n.pos.z+5},t},Fu=(n,t)=>{let e=mo();e.pos={x:Math.round(Jt.target.x),y:0,z:Math.round(Jt.target.z)},n.children.push(e),M.collapsed.delete(n.id),Li(e,t),Me()};function zu(){Fu(M.context,!0)}function Tc(){M.selection.size&&(M.context.children=M.context.children.filter(n=>!M.selection.has(n.id)),M.selection.clear(),Ui())}function Bu(){let n=Ou().map(wc);n.length&&(M.context.children.push(...n),M.selection=new Set(n.map(t=>t.id)),Ui())}function Ac(){Ec=Ou().map(go)}function ku(){Ac(),Tc()}function Vu(){if(!Ec.length)return;let n=Ec.map(wc);M.context.children.push(...n),M.selection=new Set(n.map(t=>t.id)),Ui()}function Rc(n,t,e){if(n===t||Ss(n,t))return!1;let i=Ri(n);if(!i)return!1;let s=xs(Ks(i),{off:{...n.pos},rot:n.rot}),r=xs(Zh(Ks(t)),s),a=i.children.indexOf(n);return i.children.splice(a,1),i===t&&a<e&&e--,n.pos={x:Math.round(r.off.x),y:Math.round(r.off.y),z:Math.round(r.off.z)},n.rot=r.rot&3,t.children.splice(Math.max(0,Math.min(e,t.children.length)),0,n),!0}function Hu(n){let t=Ri(n);if(!t)return null;let e=t.children.indexOf(n),i=vs("Group");return i.pos={...n.pos},i.rot=n.rot,t.children.splice(e,1,i),n.pos={x:0,y:0,z:0},n.rot=0,i.children=[n],i}function Gu(n,t){if(t===n||Ss(t,n))return!1;let e=Hu(n);return e?(Rc(t,e,e.children.length),M.collapsed.delete(e.id),M.selection=new Set([e.id]),Ui(),!0):!1}function Wu(n){let t=Hu(n);t&&(M.collapsed.delete(t.id),si(t),Me())}function Xu(n){let t=Ri(n);if(!t)return;let e=wc(n);t.children.splice(t.children.indexOf(n)+1,0,e),si(e),Me()}function Yu(n){let t=Ri(n);t&&(t.children=t.children.filter(e=>e!==n),M.selection.delete(n.id),M.editObject===n&&(M.editObject=null),Ui())}function qu(n){Fu(n,!1)}function Zu(n){let t=vs("Group");n.children.push(t),M.collapsed.delete(n.id),si(t),Me()}function Cc(n){let t=n<0?-1:1,e=bs(),i=s=>ei(s,Ze(e.off,ee(s.pos,e.rot)),e.rot+s.rot&3,sn());for(let s=0;s<Math.abs(n);s++)for(let r of M.selection){let a=Ai(r);if(!a)continue;let o=i(a);a.rot=a.rot+t&3;let c=i(a),l={x:(o.min.x+o.max.x)/2-(c.min.x+c.max.x)/2,z:(o.min.z+o.max.z)/2-(c.min.z+c.max.z)/2},h=ee({x:Uu(l.x),y:0,z:Uu(l.z)},-e.rot);a.pos.x+=h.x,a.pos.z+=h.z}M.selection.size&&ze()}function Ju(){M.selection.size&&(Cc(1),ce(),Me())}function Pc(n){for(let t of M.selection){let e=Ai(t);e&&(e.pos.y+=n)}M.selection.size&&Ui()}function $u(){let n=JSON.stringify({uid:_s(),root:So(M.root)}),t=URL.createObjectURL(new Blob([n],{type:"application/json"})),e=M.root.name||"Project",i=o=>String(o).padStart(2,"0"),s=new Date,r=`${s.getFullYear()}-${i(s.getMonth()+1)}-${i(s.getDate())} ${i(s.getHours())}h${i(s.getMinutes())}m${i(s.getSeconds())}s`,a=document.createElement("a");a.href=t,a.download=`${e} -- ${r}.voxelier.json`,a.click(),URL.revokeObjectURL(t)}function Ku(){let n=document.createElement("input");n.type="file",n.accept="application/json,.json",n.onchange=()=>{let t=n.files&&n.files[0];if(!t)return;let e=new FileReader;e.onload=()=>{try{if(!bc(JSON.parse(e.result)))throw new Error("not a Voxelier scene file");M.path=[M.root],M.editObject=null,M.selection.clear(),M.measMode=!1,vn(),ze(),ce(),Nn(),ri()}catch(i){alert("Import failed: "+i.message)}},e.readAsText(t)},n.click()}var Di=null,Ve=null,wo=null,Ts=null,oi=null;function Be(n,t={},...e){let i=document.createElement(n);return Object.assign(i,t),e.length&&i.append(...e),i}var e_=[{id:"add",ic:"\uFF0B",label:"Add"},{id:"erase",ic:"\uFF0D",label:"Erase"},{id:"paint",ic:"\u{1FAA3}",label:"Fill"},{id:"eyedropper",ic:"\u{1F4A7}",label:"Pick"},{id:"measure",ic:"\u{1F4CF}",label:"Measure"}],n_={visible:"\u25C9",transparent:"\u25D0",invisible:"\u29B0"},bo=(n,t,e,i)=>Be("button",{className:"tool"+(e?" active":""),innerHTML:`<span class="ic">${n}</span>${t}`,onclick:i});function ce(){let n=document.getElementById("tools");n.innerHTML="";let t=Be("div",{className:"toolgroup"});if(M.editObject){for(let i of e_)t.appendChild(bo(i.ic,i.label,M.tool===i.id,()=>{M.tool=i.id,vn(),qe.visible=!1,ce()}));t.appendChild(o_())}else t.appendChild(bo("\u{1F4CF}","Measure",M.measMode,()=>{M.measMode=!M.measMode,M.measMode||vn(),ce()}));let e=Be("div",{className:"toolgroup"});e.appendChild(bo("\u{1F4C2}","Import",!1,Ku)),e.appendChild(bo("\u{1F4BE}","Export",!1,$u)),n.append(t,e),td()}var Eo={ver:-1,cols:[]};function i_(){if(Eo.ver===M.voxVer)return Eo.cols;let n=new Map;return function t(e){e.type==="object"?Kh(e.boxes,n):e.children.forEach(t)}(M.root),Eo={ver:M.voxVer,cols:[...n.entries()].sort((t,e)=>e[1]-t[1]).map(t=>t[0])},Eo.cols}var Ic=[];function Ao(n){M.selColor=n,Ic=[n,...Ic.filter(t=>t!==n)].slice(0,4),ce()}function s_(){let n=[];for(let t of[...Ic,...i_(),...po])if(n.includes(t)||n.push(t),n.length>=4)break;return n}var r_=n=>{let t=Be("div",{className:"sw"+(n===M.selColor?" active":""),title:$s(n),onclick:()=>Ao(n)});return t.style.background=$s(n),t};function o_(){let n=Be("div",{className:"colorctl"}),t=Be("div",{className:"colorbtn",title:"Draw colour \u2014 hover for recent colours / picker"});t.style.background=$s(M.selColor);let e=Be("div",{className:"colorflyout"});for(let i of s_())e.appendChild(r_(i));return e.appendChild(Be("div",{className:"sw more",textContent:"\u{1F3A8}",title:"Colour picker",onclick:a_})),n.append(t,e),n}function a_(){let n=Be("input",{type:"color",value:$s(M.selColor)});n.style.cssText="position:fixed;left:-9999px;top:0";let t=()=>Ao(parseInt(n.value.slice(1),16)),e=()=>n.remove();n.addEventListener("input",t),n.addEventListener("change",()=>{t(),e()}),window.addEventListener("focus",e,{once:!0}),document.body.appendChild(n),n.click()}function ju(n,t,e,i){if(n.type==="object")for(let s of n.boxes)i.push(mn(s,e,t));else for(let s of n.children)ju(s,Ze(t,ee(s.pos,e)),e+s.rot&3,i);return i}var Lc=(n,t)=>{let e=Math.min(255,(n>>16&255)*t)|0,i=Math.min(255,(n>>8&255)*t)|0,s=Math.min(255,(n&255)*t)|0;return`rgb(${e},${i},${s})`},To=new Map;function Qu(n){return n.type==="object"?"o"+n.boxes.map(t=>`${t.x0},${t.y0},${t.z0},${t.x1},${t.y1},${t.z1},${t.c}`).join(";"):"s"+n.children.map(t=>`${t.id}@${t.pos.x},${t.pos.y},${t.pos.z}/${t.rot};${Qu(t)}`).join()}function c_(n){let t=To.get(n.id);if(n===M.editObject&&t)return t.cv;let e=Qu(n);if(t&&t.sig===e)return t.cv;let i=document.createElement("canvas");i.width=i.height=52,i.style.width=i.style.height="26px";let s=i.getContext("2d");s.fillStyle="#0f1115",s.fillRect(0,0,52,52);let r=ju(n,{x:0,y:0,z:0},0,[]);if(r.length){let a=sn();_n(r,a);let{x:o,y:c,z:l}=a.min,{x:h,y:u,z:f}=a.max,m=40/Math.max(h-o,u-c,f-l,1),g=26-((o+h)/2-(l+f)/2)*m*.5,x=28+(c+u)/2*m*.6-((o+h)/2+(l+f)/2)*m*.28,p=(y,_,T)=>[g+(y-T)*m*.5,x-_*m*.6+(y+T)*m*.28],d=(y,_)=>{s.fillStyle=y,s.beginPath(),s.moveTo(_[0][0],_[0][1]);for(let T=1;T<_.length;T++)s.lineTo(_[T][0],_[T][1]);s.closePath(),s.fill()};r.sort((y,_)=>y.x0+y.x1+y.y0+y.y1+y.z0+y.z1-(_.x0+_.x1+_.y0+_.y1+_.z0+_.z1));for(let y of r)d(Lc(y.c,.78),[p(y.x1,y.y0,y.z0),p(y.x1,y.y1,y.z0),p(y.x1,y.y1,y.z1),p(y.x1,y.y0,y.z1)]),d(Lc(y.c,.6),[p(y.x0,y.y0,y.z1),p(y.x1,y.y0,y.z1),p(y.x1,y.y1,y.z1),p(y.x0,y.y1,y.z1)]),d(Lc(y.c,1),[p(y.x0,y.y1,y.z0),p(y.x1,y.y1,y.z0),p(y.x1,y.y1,y.z1),p(y.x0,y.y1,y.z1)])}return To.set(n.id,{sig:e,cv:i}),i}function l_(n){if(oi&&oi.node===n){clearTimeout(oi.timer),oi=null,Li(n,!0);return}oi&&clearTimeout(oi.timer),n===M.root?Li(n):si(n),oi={node:n,timer:setTimeout(()=>oi=null,300)}}function h_(n){let t=c_(n);if(t.className="thumb",t.onclick=null,t.title="",n!==M.root&&n.type==="scene"&&n.children.length){let e=M.collapsed.has(n.id);t.classList.add("group"),e&&t.classList.add("collapsed"),t.title=e?"Expand group":"Collapse group",t.onclick=i=>{i.stopPropagation(),e?M.collapsed.delete(n.id):M.collapsed.add(n.id),td()}}return t}function u_(n,t){n.draggable=t!==M.root,t!==M.root&&n.addEventListener("dragstart",e=>{if(e.stopPropagation(),Di=t.id,e.dataTransfer){e.dataTransfer.effectAllowed="move";try{e.dataTransfer.setData("text/plain",t.id)}catch{}}}),n.addEventListener("dragend",rr),n.addEventListener("dragover",e=>{e.preventDefault(),e.stopPropagation(),f_(e,t,n)}),n.addEventListener("drop",e=>{e.preventDefault(),e.stopPropagation(),nd()})}function td(){let n=document.getElementById("tree");n.innerHTML="";let t=(i,s)=>{let r=i===M.root,a=!r&&M.context.children.includes(i)&&M.selection.has(i.id),o=i.vis,c=Be("div",{className:"trow"+(r?" root":"")+(a?" sel":"")+(i===M.context&&!M.editObject?" ctx":"")+(i===M.editObject?" edit":"")+(!r&&o!=="visible"?" dim":"")});c.style.paddingLeft=4+s*13+"px";let l=h_(i),h=Be("span",{className:"nm"});if(r?h.textContent=i.name||"Project":i.name?h.textContent=i.name:h.innerHTML='<span class="ph">'+(i.type==="scene"?"group":"object")+"</span>",c.append(l,h),r||c.append(Be("button",{className:"tb"+(o==="visible"?" on":""),textContent:n_[o],title:"visible \u2192 transparent \u2192 invisible",onclick:u=>{u.stopPropagation(),Du(i)}})),c.onclick=()=>l_(i),c.oncontextmenu=u=>{u.preventDefault(),u.stopPropagation(),r||si(i),d_(i,u.clientX,u.clientY)},u_(c,i),n.appendChild(c),i.type==="scene"&&(r||!M.collapsed.has(i.id)))for(let u of i.children)t(u,s+1)};t(M.root,0);let e=new Set;(function i(s){e.add(s.id),s.type==="scene"&&s.children.forEach(i)})(M.root);for(let i of To.keys())e.has(i)||To.delete(i)}function Uc(){Ts&&(Ts.remove(),Ts=null,window.removeEventListener("pointerdown",ed,!0))}function ed(n){Ts&&!Ts.contains(n.target)&&Uc()}function d_(n,t,e){Uc();let i=Be("div",{className:"ctxmenu"}),s=(o,c,l)=>i.appendChild(Be("div",{className:"ctxitem"+(l?" "+l:""),textContent:o,onclick:()=>{Uc(),c()}})),r=()=>i.appendChild(Be("div",{className:"ctxdiv"}));s("Rename",()=>Nu(n)),s("Fit",()=>wu(n)),r(),n!==M.root&&(s("Duplicate",()=>Xu(n)),s("Delete",()=>Yu(n),"danger"),r()),n.type==="scene"?(s("New object",()=>qu(n)),s("New group",()=>Zu(n))):s("New group",()=>Wu(n)),document.body.appendChild(i),Ts=i;let a=i.getBoundingClientRect();i.style.left=Math.min(t,innerWidth-a.width-4)+"px",i.style.top=Math.min(e,innerHeight-a.height-4)+"px",setTimeout(()=>window.addEventListener("pointerdown",ed,!0),0)}function rr(){wo&&wo.classList.remove("drop-into","drop-before","drop-after"),wo=null,Ve=null}function f_(n,t,e){let i=Di&&Ms(Di);if(!i||i===t||Ss(i,t)){rr();return}if(rr(),wo=e,t===M.root){Ve={parent:M.root,index:M.root.children.length},e.classList.add("drop-into");return}let s=e.getBoundingClientRect(),r=n.clientY-s.top,a=s.height,o=Ri(t),c=o?o.children.indexOf(t):0;r>a*.28&&r<a*.72?(t.type==="scene"?Ve={parent:t,index:t.children.length}:Ve={wrap:t},e.classList.add("drop-into")):r<a*.5?(Ve={parent:o,index:c},e.classList.add("drop-before")):(Ve={parent:o,index:c+1},e.classList.add("drop-after"))}function nd(){let n=Di&&Ms(Di);n&&Ve&&(Ve.wrap?Gu(Ve.wrap,n):Ve.parent&&Rc(n,Ve.parent,Ve.index)&&(M.collapsed.delete(Ve.parent.id),si(n),Me())),rr(),Di=null}{let n=document.getElementById("tree");n.addEventListener("dragover",t=>{t.target===n&&Di&&(t.preventDefault(),rr(),Ve={parent:M.root,index:M.root.children.length})}),n.addEventListener("drop",t=>{t.target===n&&(t.preventDefault(),nd())})}window.addEventListener("keydown",n=>{if(n.target.tagName==="INPUT")return;let t=n.key.toLowerCase();if(n.ctrlKey||n.metaKey){if(t==="z"){n.preventDefault(),n.shiftKey?Sc():Pu();return}if(t==="y"){n.preventDefault(),Sc();return}let i={c:Ac,x:ku,v:Vu,d:Bu}[t];i&&!M.editObject&&(i(),n.preventDefault());return}switch(t){case"f":Nn();break;case"escape":Au();break;case"n":M.editObject||zu();break;case"r":M.editObject||Ju();break;case"[":M.editObject||Pc(-1);break;case"]":M.editObject||Pc(1);break;case"delete":case"backspace":M.editObject||(n.preventDefault(),Tc());break}});var Yt=n=>Math.floor(n/10),re=po,As=(n,t)=>{let e=mo();return e.name=n,e.boxes=t,e},Dc=(n,t,e,i,s,r)=>({x0:n,y0:t,z0:e,x1:i,y1:s,z1:r});function id(){let n=Yt(4465),t=Yt(2985),e=Yt(2700),i=Yt(150),s=As("Floor",[ne(0,0,0,n,1,t,re[9])]),r=Yt(800),a=Yt(2100),o=n-Yt(515)-r,c=n-Yt(900)-r,l=[ne(0,1,0,n,e+1,i,re[5]),ne(0,1,t-i,n,e+1,t,re[5]),ne(0,1,i,i,e+1,t-i,re[5]),ne(n-i,1,i,n,e+1,t-i,re[5])];l=Ti(l,Dc(o,1,0,o+r,a+1,i)),l=Ti(l,Dc(c,1,t-i,c+r,a+1,t)),l=Ti(l,Dc(0,Yt(900),Yt(600),i,Yt(2100),t-Yt(600)));let h=As("Walls",l);h.vis="transparent";let u=Yt(1500),f=Yt(2e3),m=As("Bed",[ne(0,0,0,8,14,8,re[7]),ne(u-8,0,0,u,14,8,re[7]),ne(0,0,f-8,8,14,f,re[7]),ne(u-8,0,f-8,u,14,f,re[7]),ne(0,14,0,u,20,f,re[6]),ne(2,20,0,u-2,24,f-Yt(400),re[10])]);m.pos={x:i+3,y:1,z:t-i-f};let g=Yt(1400),x=Yt(700),p=Yt(740),d=As("Desk",[ne(0,p-4,0,g,p,x,re[8]),ne(0,0,0,6,p-4,6,re[7]),ne(g-6,0,0,g,p-4,6,re[7]),ne(0,0,x-6,6,p-4,x,re[7]),ne(g-6,0,x-6,g,p-4,x,re[7])]),y=Yt(600),_=y-30>>1,T=y>>1,P=As("Computer",[ne(_,0,0,_+30,2,18,re[11]),ne(T-2,2,7,T+2,Yt(160),11,re[11]),ne(0,Yt(160),6,y,Yt(520),9,re[13])]);P.pos={x:Yt(400),y:p,z:Yt(420)};let A=vs();A.name="Desk + Computer",A.pos={x:n-i,y:1,z:Yt(900)},A.rot=1,A.children=[d,P];let R=H=>As(H,[ne(-10,0,-10,11,30,11,re[4]),ne(-2,30,-2,3,54,3,re[14]),ne(-16,54,-16,17,78,17,re[14]),ne(-12,78,-12,13,92,13,re[14])]),Z=R("Plant"),b=R("Plant");Z.pos={x:n-i-Yt(300),y:1,z:i+Yt(300)},b.pos={x:i+Yt(300),y:1,z:i+Yt(300)};let w=vs();return w.children=[s,h,m,A,Z,b],w}var sd=n=>Math.abs(n.clientX-M.drag.sx)+Math.abs(n.clientY-M.drag.sy)>3,rd=-1e9;function ad(){let n=(Xt.top-Xt.bottom)/he.h,t=Math.abs(Xt.matrixWorldInverse.elements[5]);return n/Math.max(t,.15)}function od(n){let t=M.drag;if(!t||t.mode!=="pan"&&t.mode!=="orbit")return!1;let e=n.clientX-t.x,i=n.clientY-t.y;return t.x=n.clientX,t.y=n.clientY,(t.mode==="pan"?Su:bu)(e,i),!0}function p_(){let n=[],t=[];ni(M.root,{x:0,y:0,z:0},0,null,0,(s,r,a,o)=>{let c=o&&M.selection.has(o)?t:n;for(let l of s.boxes)c.push(mn(l,a,r))});let e=1/0,i=-1/0;for(let s of t)s.y0<e&&(e=s.y0),s.y1>i&&(i=s.y1);return{occ:n,sel:t,minY:e,hgt:t.length?i-e:0}}var m_=(n,t,e,i)=>{if(hc(n.sel??[],n.occ??[],t,e,i))return!0;let s=n.minY??1/0;return s+e<Math.min(0,s)};function g_(n){let t=M.drag,e=(i,s,r)=>n.altKey||!m_(t,i,s,r);if(n.shiftKey){t.shiftAnchorY==null&&(t.shiftAnchorY=n.clientY,t.dyBase=t.dyUser??0);let i=t.dyBase+Math.round((t.shiftAnchorY-n.clientY)*ad());e(t.dx,i,t.dz)&&(t.dyUser=i,t.dy=i)}else{t.shiftAnchorY=null;let i=t.dx,s=t.dz,r=js(0);r&&t.start&&(i=r.x-t.start.x,s=r.z-t.start.z);let a=t.dyUser??0,o=Math.floor(.1*(t.hgt??0)),c=!1;for(let l=0;l<=o;l++)if(e(i,a+l,s)){t.dx=i,t.dz=s,t.dy=a+l,c=!0;break}c||(e(i,a,t.dz)&&(t.dx=i),e(t.dx,a,s)&&(t.dz=s),t.dy=a)}for(let i of M.selection)for(let s of M.childMeshes[i]||[])s.position.set(t.dx,t.dy,t.dz);Un.position.set(t.dx,t.dy,t.dz)}function x_(){let n=M.drag,t=bs(),e=ee({x:Math.round(n.dx),y:0,z:Math.round(n.dz)},-t.rot),i=Math.round(n.dy);for(let s of M.selection){let r=Ai(s);r&&(r.pos.x+=e.x,r.pos.y+=i,r.pos.z+=e.z)}Un.position.set(0,0,0),ze(),Me()}function __(n){let t=M.drag,e=Math.round((t.sx-n.clientX)/70);e!==t.steps&&(Cc(e-t.steps),t.steps=e,t.dirty=!0)}function v_(){let n=yu();n!=null&&Ao(n)}function cd(){let n=Ci(),t=fc(n);if(!t)return;let e=qh(t.x,t.y,t.z);e!==M.lastVox&&(vu(t,M.selColor),M.lastVox=e),ld(n)}function ld(n=Ci()){let t=fc(n);if(!t){qe.visible=!1;return}let e=Ze(ee(t,M.editXform.rot),M.editXform.off);qe.visible=!0,qe.material.color.set(M.tool==="erase"?11895693:10994876),qe.position.set(e.x+.5,e.y+.5,e.z+.5)}var Nc=n=>n===0?[1,2]:n===1?[0,2]:[0,1];function hd(n,t,e,i){let[s,r]=Nc(n.na),a=[0,0,0],o=[0,0,0],c=(l,h,u)=>{a[l]=Math.min(h,u),o[l]=Math.max(h,u)};return c(n.na,n.s[n.na],n.s[n.na]+i),c(s,n.s[s],t),c(r,n.s[r],e),{x0:a[0],y0:a[1],z0:a[2],x1:o[0]+1,y1:o[1]+1,z1:o[2]+1,c:0}}var ud=n=>{let[t,e]=Nc(n.na);return hd(n,n.c[t],n.c[e],n.hy)};function y_(n){let t=Ci(),e,i;if(t)i=t.addCell.x!==t.cell.x?0:t.addCell.y!==t.cell.y?1:2,e=M.tool==="add"?t.addCell:t.cell;else{let s=Qs(0);if(!s)return;e=s,i=1}M.drag={...n,mode:"box",shiftAnchorY:null,box:{s:[e.x,e.y,e.z],c:[e.x,e.y,e.z],na:i,hy:0},occ:M.tool==="add"?M.editObject.boxes.slice():void 0},qe.visible=!1,dd()}function M_(n){let t=M.drag,e=t.box,[i,s]=Nc(e.na),r=M.tool==="add"&&!n.altKey,a=(o,c,l)=>!r||!hc([hd(e,o,c,l)],t.occ??[],0,0,0);if(n.shiftKey){t.shiftAnchorY===null&&(t.shiftAnchorY=n.clientY,t.hyBase=e.hy);let o=t.hyBase+Math.round((t.shiftAnchorY-n.clientY)*ad());a(e.c[i],e.c[s],o)&&(e.hy=o)}else{t.shiftAnchorY=null;let o=ou(e.na,e.s[e.na]);if(o){let c=[o.x,o.y,o.z];a(c[i],e.c[s],e.hy)&&(e.c[i]=c[i]),a(e.c[i],c[s],e.hy)&&(e.c[s]=c[s])}}dd()}function S_(){let n=ud(M.drag.box);M.tool==="add"?xu(n,M.selColor):_u(n),M.liveMeas=null,Pi(),ce(),Me()}function dd(){let n=ud(M.drag.box),t=n.x0,e=n.x1,i=n.y0,s=n.y1,r=n.z0,a=n.z1,o=e-t,c=s-i,l=a-r,h=(f,m,g,x,p,d,y,_)=>({a:Es(f,m,g),b:Es(x,p,d),mid:Es((f+x)/2,(m+p)/2,(g+d)/2),len:y,filled:!0,nolabel:!_}),u=[];u.push(h(t,i,r,e,i,r,o,o>=2)),u.push(h(t,i,r,t,i,a,l,l>=2)),u.push(h(t,i,r,t,s,r,c,c>=2)),u.push(h(e,i,r,e,i,a,0,!1),h(t,i,a,e,i,a,0,!1)),u.push(h(t,s,r,e,s,r,0,!1),h(t,s,r,t,s,a,0,!1),h(e,s,r,e,s,a,0,!1),h(t,s,a,e,s,a,0,!1)),u.push(h(e,i,r,e,s,r,0,!1),h(t,i,a,t,s,a,0,!1),h(e,i,a,e,s,a,0,!1)),M.liveMeas=u,Pi()}Re.addEventListener("pointerdown",n=>{if(M.drag||M.painting)return;Re.setPointerCapture(n.pointerId),xo(n.clientX,n.clientY);let t={x:n.clientX,y:n.clientY,sx:n.clientX,sy:n.clientY};if(vo()){n.button===0?M.drag={...t,mode:"pan",meas:"freeze"}:n.button===2?M.drag={...t,mode:"orbit",meas:"clear"}:n.button===1&&(M.drag={...t,mode:"pan",sx:rd});return}if(M.editObject){n.button===0?M.tool==="add"||M.tool==="erase"?y_(t):M.tool==="eyedropper"?v_():(M.painting=!0,M.lastVox=null,cd()):n.button===2?M.drag={...t,mode:"orbit"}:n.button===1&&(M.drag={...t,mode:"pan"});return}let e=dc(),i=e&&M.selection.has(e);n.button===0?i?M.drag={...t,mode:"move",start:js(0),dx:0,dy:0,dz:0,shiftAnchorY:null,...p_()}:M.drag={...t,mode:"pan",clickId:e}:n.button===2?i?M.drag={...t,mode:"rotobj",steps:0}:M.drag={...t,mode:"orbit"}:n.button===1&&(M.drag={...t,mode:"pan",sx:rd})});Re.addEventListener("pointermove",n=>{if(xo(n.clientX,n.clientY),vo()){od(n),cu();return}if(M.editObject&&M.painting){cd();return}if(!M.drag){M.editObject?ld():qe.visible=!1;return}od(n)||(M.drag.mode==="move"?g_(n):M.drag.mode==="rotobj"?__(n):M.drag.mode==="box"&&M_(n))});Re.addEventListener("pointerup",n=>{try{Re.releasePointerCapture(n.pointerId)}catch{}if(vo()){M.drag&&!sd(n)&&(M.drag.meas==="freeze"?lu():M.drag.meas==="clear"&&vn()),M.drag=null;return}if(M.editObject){M.painting?(M.painting=!1,ce(),Me()):M.drag&&M.drag.mode==="box"&&S_(),M.drag=null;return}if(M.drag)if(M.drag.mode==="pan"&&!sd(n)){let t=M.drag.clickId;t?n.shiftKey?M.selection.has(t)?M.selection.delete(t):M.selection.add(t):M.selection=new Set([t]):n.shiftKey||M.selection.clear(),ir(),ce()}else M.drag.mode==="move"?x_():M.drag.mode==="rotobj"&&M.drag.dirty&&(ce(),Me());M.drag=null});Re.addEventListener("pointercancel",()=>{if(!M.drag&&!M.painting)return;let n=M.painting;M.drag=null,M.painting=!1,M.liveMeas=null,Pi(),ze(),n&&(ce(),Me())});Re.addEventListener("pointerleave",()=>{qe.visible=!1});Re.addEventListener("contextmenu",n=>n.preventDefault());Re.addEventListener("wheel",n=>{n.preventDefault(),Jt.zoom*=n.deltaY>0?1/.95:.95,Jt.zoom=Math.max(6,Math.min(co,Jt.zoom))},{passive:!1});Re.addEventListener("dblclick",n=>{if(M.editObject)return;xo(n.clientX,n.clientY);let t=dc();t&&Li(Ai(t),!0)});for(let n of["pointerdown","pointermove","pointerup","pointerleave","wheel","keydown","dblclick"])window.addEventListener(n,gs,{passive:!0,capture:!0});var b_=()=>Math.abs(Jt.azim-Gt.azim)<.001&&Math.abs(Jt.elev-Gt.elev)<.001&&Math.abs(Jt.zoom-Gt.zoom)<.001&&Gt.target.distanceToSquared(Jt.target)<1e-6;function fd(){let n=Re.getBoundingClientRect();he.w=n.width,he.h=n.height,he.x=n.left,he.y=n.top}function pd(){let n=Math.max(1,Math.round(he.w)),t=Math.max(1,Math.round(he.h)),e=Math.min(devicePixelRatio,2);$n.getPixelRatio()!==e&&$n.setPixelRatio(e),(Re.width!==Math.floor(n*e)||Re.height!==Math.floor(t*e))&&($n.setSize(n,t,!1),gs())}window.addEventListener("resize",()=>{fd(),pd()});function md(){requestAnimationFrame(md),pd(),Tu(),(qs.tail>0||!b_())&&($n.render(Ee,Xt),hu(),qs.tail>0&&qs.tail--)}function E_(){Iu()||(M.root=id()),M.path=[M.root],M.editObject=null,M.selection.clear(),ze(),ce(),Nn(),ri(),fd(),md()}E_();
/**
 * @license
