...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function ql(){return new dn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ja(),fragmentShader:`
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function Zl(){return new dn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ja(),fragmentShader:`
...
`].filter(Qi).join(`
`)),a=Ea(a),a=ih(a,e),a=sh(a,e),o=Ea(o),o=ih(o,e),o=sh(o,e),a=rh(a),o=rh(o),e.isWebGL2&&e.isRawShaderMaterial!==!0&&(_=`#version 300 es
