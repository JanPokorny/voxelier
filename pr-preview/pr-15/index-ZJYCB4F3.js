...
#endif`,Dp="gl_FragColor = linearToOutputTexel( gl_FragColor );",Np=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function Jl(){return new dn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ja(),fragmentShader:`
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function $l(){return new dn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ja(),fragmentShader:`
	...
	`}function Xg(n){let t=new WeakMap,e=null;function i(o){if(o&&o.isTexture){let c=o.mapping,l=c===ua||c===da,h=c===is||c===ss;if(l||h)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let u=t.get(o);return e===null&&(e=new Kr(n)),u=l?e.fromEquirectangular(o,u):e.fromCubemap(o,u),t.set(o,u),u.texture}else{if(t.has(o))return t.get(o).texture;{let u=o.image;if(l&&u&&u.height>0||h&&u&&s(u)){e===null&&(e=new Kr(n));let f=l?e.fromEquirectangular(o):e.fromCubemap(o);return t.set(o,f),o.addEventListener("dispose",r),f.texture}else return null}}}return o}function s(o){let c=0,l=6;for(let h=0;h<l;h++)o[h]!==void 0&&c++;return c===l}function r(o){let c=o.target;c.removeEventListener("dispose",r);let l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:i,dispose:a}}function Yg(n){let t={};function e(i){if(t[i]!==void 0)return t[i];let s;switch(i){case"WEBGL_depth_texture":s=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=n.getExtension(i)}return t[i]=s,s}return{has:function(i){return e(i)!==null},init:function(i){i.isWebGL2?(e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance")):(e("WEBGL_depth_texture"),e("OES_texture_float"),e("OES_texture_half_float"),e("OES_texture_half_float_linear"),e("OES_standard_derivatives"),e("OES_element_index_uint"),e("OES_vertex_array_object"),e("ANGLE_instanced_arrays")),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture")},get:function(i){let s=e(i);return s===null&&console.warn("THREE.WebGLRenderer: "+i+" extension not supported."),s}}}function qg(n,t,e,i){let s={},r=new WeakMap;function a(u){let f=u.target;f.index!==null&&t.remove(f.index);for(let g in f.attributes)t.remove(f.attributes[g]);for(let g in f.morphAttributes){let x=f.morphAttributes[g];for(let p=0,d=x.length;p<d;p++)t.remove(x[p])}f.removeEventListener("dispose",a),delete s[f.id];let m=r.get(f);m&&(t.remove(m),r.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(u,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,e.memory.geometries++),f}function c(u){let f=u.attributes;for(let g in f)t.update(f[g],n.ARRAY_BUFFER);let m=u.morphAttributes;for(let g in m){let x=m[g];for(let p=0,d=x.length;p<d;p++)t.update(x[p],n.ARRAY_BUFFER)}}function l(u){let f=[],m=u.index,g=u.attributes.position,x=0;if(m!==null){let y=m.array;x=m.version;for(let _=0,T=y.length;_<T;_+=3){let P=y[_+0],A=y[_+1],R=y[_+2];f.push(P,A,A,R,R,P)}}else if(g!==void 0){let y=g.array;x=g.version;for(let _=0,T=y.length/3-1;_<T;_+=3){let P=_+0,A=_+1,R=_+2;f.push(P,A,A,R,R,P)}}else return;let p=new(Uh(f)?Zr:qr)(f,1);p.version=x;let d=r.get(u);d&&t.remove(d),r.set(u,p)}function h(u){let f=r.get(u);if(f){let m=u.index;m!==null&&f.version<m.version&&l(u)}else l(u);return r.get(u)}return{get:o,update:c,getWireframeAttribute:h}}function Zg(n,t,e,i){let s=i.isWebGL2,r;function a(m){r=m}let o,c;function l(m){o=m.type,c=m.bytesPerElement}function h(m,g){n.drawElements(r,g,o,m*c),e.update(g,r,1)}function u(m,g,x){if(x===0)return;let p,d;if(s)p=n,d="drawElementsInstanced";else if(p=t.get("ANGLE_instanced_arrays"),d="drawElementsInstancedANGLE",p===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}p[d](r,g,o,m*c,x),e.update(g,r,x)}function f(m,g,x){if(x===0)return;let p=t.get("WEBGL_multi_draw");if(p===null)for(let d=0;d<x;d++)this.render(m[d]/c,g[d]);else{p.multiDrawElementsWEBGL(r,g,0,o,m,0,x);let d=0;for(let y=0;y<x;y++)d+=g[y];e.update(d,r,1)}}this.setMode=a,this.setIndex=l,this.render=h,this.renderInstances=u,this.renderMultiDraw=f}function Jg(n){let t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,a,o){switch(e.calls++,a){case n.TRIANGLES:e.triangles+=o*(r/3);break;case n.LINES:e.lines+=o*(r/2);break;case n.LINE_STRIP:e.lines+=o*(r-1);break;case n.LINE_LOOP:e.lines+=o*r;break;case n.POINTS:e.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:i}}function $g(n,t){return n[0]-t[0]}function Kg(n,t){return Math.abs(t[1])-Math.abs(n[1])}function jg(n,t,e){let i={},s=new Float32Array(8),r=new WeakMap,a=new ye,o=[];for(let l=0;l<8;l++)o[l]=[l,0];function c(l,h,u){let f=l.morphTargetInfluences;if(t.isWebGL2===!0){let m=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,g=m!==void 0?m.length:0,x=r.get(h);if(x===void 0||x.count!==g){let L=function(){$.dispose(),r.delete(h),h.removeEventListener("dispose",L)};x!==void 0&&x.texture.dispose();let y=h.morphAttributes.position!==void 0,_=h.morphAttributes.normal!==void 0,T=h.morphAttributes.color!==void 0,P=h.morphAttributes.position||[],A=h.morphAttributes.normal||[],R=h.morphAttributes.color||[],Z=0;y===!0&&(Z=1),_===!0&&(Z=2),T===!0&&(Z=3);let b=h.attributes.position.count*Z,w=1;b>t.maxTextureSize&&(w=Math.ceil(b/t.maxTextureSize),b=t.maxTextureSize);let H=new Float32Array(b*w*4*g),$=new Xr(H,b,w,g);$.type=Gn,$.needsUpdate=!0;let rt=Z*4;for(let D=0;D<g;D++){let X=P[D],J=A[D],Y=R[D],F=b*w*4*D;for(let W=0;W<X.count;W++){let G=W*rt;y===!0&&(a.fromBufferAttribute(X,W),H[F+G+0]=a.x,H[F+G+1]=a.y,H[F+G+2]=a.z,H[F+G+3]=0),_===!0&&(a.fromBufferAttribute(J,W),H[F+G+4]=a.x,H[F+G+5]=a.y,H[F+G+6]=a.z,H[F+G+7]=0),T===!0&&(a.fromBufferAttribute(Y,W),H[F+G+8]=a.x,H[F+G+9]=a.y,H[F+G+10]=a.z,H[F+G+11]=Y.itemSize===4?a.w:1)}}x={count:g,texture:$,size:new Ht(b,w)},r.set(h,x),h.addEventListener("dispose",L)}let p=0;for(let y=0;y<f.length;y++)p+=f[y];let d=h.morphTargetsRelative?1:1-p;u.getUniforms().setValue(n,"morphTargetBaseInfluence",d),u.getUniforms().setValue(n,"morphTargetInfluences",f),u.getUniforms().setValue(n,"morphTargetsTexture",x.texture,e),u.getUniforms().setValue(n,"morphTargetsTextureSize",x.size)}else{let m=f===void 0?0:f.length,g=i[h.id];if(g===void 0||g.length!==m){g=[];for(let _=0;_<m;_++)g[_]=[_,0];i[h.id]=g}for(let _=0;_<m;_++){let T=g[_];T[0]=_,T[1]=f[_]}g.sort(Kg);for(let _=0;_<8;_++)_<m&&g[_][1]?(o[_][0]=g[_][0],o[_][1]=g[_][1]):(o[_][0]=Number.MAX_SAFE_INTEGER,o[_][1]=0);o.sort($g);let x=h.morphAttributes.position,p=h.morphAttributes.normal,d=0;for(let _=0;_<8;_++){let T=o[_],P=T[0],A=T[1];P!==Number.MAX_SAFE_INTEGER&&A?(x&&h.getAttribute("morphTarget"+_)!==x[P]&&h.setAttribute("morphTarget"+_,x[P]),p&&h.getAttribute("morphNormal"+_)!==p[P]&&h.setAttribute("morphNormal"+_,p[P]),s[_]=A,d+=A):(x&&h.hasAttribute("morphTarget"+_)===!0&&h.deleteAttribute("morphTarget"+_),p&&h.hasAttribute("morphNormal"+_)===!0&&h.deleteAttribute("morphNormal"+_),s[_]=0)}let y=h.morphTargetsRelative?1:1-d;u.getUniforms().setValue(n,"morphTargetBaseInfluence",y),u.getUniforms().setValue(n,"morphTargetInfluences",s)}}return{update:c}}function Qg(n,t,e,i){let s=new WeakMap;function r(c){let l=i.render.frame,h=c.geometry,u=t.get(c,h);if(s.get(u)!==l&&(t.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),s.get(c)!==l&&(e.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,n.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){let f=c.skeleton;s.get(f)!==l&&(f.update(),s.set(f,l))}return u}function a(){s=new WeakMap}function o(c){let l=c.target;l.removeEventListener("dispose",o),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:a}}var jr=class extends un{constructor(t,e,i,s,r,a,o,c,l,h){if(h=h!==void 0?h:xi,h!==xi&&h!==rs)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&h===xi&&(i=Hn),i===void 0&&h===rs&&(i=gi),super(null,s,r,a,o,c,h,i,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=o!==void 0?o:Ue,this.minFilter=c!==void 0?c:Ue,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){let e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}},Fh=new un,zh=new jr(1,1);zh.compareFunction=Lh;var Bh=new Xr,kh=new _a,Vh=new $r,Kl=[],jl=[],Ql=new Float32Array(16),th=new Float32Array(9),eh=new Float32Array(4);function ps(n,t,e){let i=n[0];if(i<=0||i>0)return n;let s=t*e,r=Kl[s];if(r===void 0&&(r=new Float32Array(s),Kl[s]=r),t!==0){i.toArray(r,0);for(let a=1,o=0;a!==t;++a)o+=e,n[a].toArray(r,o)}return r}function me(n,t){if(n.length!==t.length)return!1;for(let e=0,i=n.length;e<i;e++)if(n[e]!==t[e])return!1;return!0}function ge(n,t){for(let e=0,i=t.length;e<i;e++)n[e]=t[e]}function oo(n,t){let e=jl[t];e===void 0&&(e=new Int32Array(t),jl[t]=e);for(let i=0;i!==t;++i)e[i]=n.allocateTextureUnit();return e}function t0(n,t){let e=this.cache;e[0]!==t&&(n.uniform1f(this.addr,t),e[0]=t)}function e0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(me(e,t))return;n.uniform2fv(this.addr,t),ge(e,t)}}function n0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(n.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(me(e,t))return;n.uniform3fv(this.addr,t),ge(e,t)}}function i0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(me(e,t))return;n.uniform4fv(this.addr,t),ge(e,t)}}function s0(n,t){let e=this.cache,i=t.elements;if(i===void 0){if(me(e,t))return;n.uniformMatrix2fv(this.addr,!1,t),ge(e,t)}else{if(me(e,i))return;eh.set(i),n.uniformMatrix2fv(this.addr,!1,eh),ge(e,i)}}function r0(n,t){let e=this.cache,i=t.elements;if(i===void 0){if(me(e,t))return;n.uniformMatrix3fv(this.addr,!1,t),ge(e,t)}else{if(me(e,i))return;th.set(i),n.uniformMatrix3fv(this.addr,!1,th),ge(e,i)}}function o0(n,t){let e=this.cache,i=t.elements;if(i===void 0){if(me(e,t))return;n.uniformMatrix4fv(this.addr,!1,t),ge(e,t)}else{if(me(e,i))return;Ql.set(i),n.uniformMatrix4fv(this.addr,!1,Ql),ge(e,i)}}function a0(n,t){let e=this.cache;e[0]!==t&&(n.uniform1i(this.addr,t),e[0]=t)}function c0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(me(e,t))return;n.uniform2iv(this.addr,t),ge(e,t)}}function l0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(me(e,t))return;n.uniform3iv(this.addr,t),ge(e,t)}}function h0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(me(e,t))return;n.uniform4iv(this.addr,t),ge(e,t)}}function u0(n,t){let e=this.cache;e[0]!==t&&(n.uniform1ui(this.addr,t),e[0]=t)}function d0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(me(e,t))return;n.uniform2uiv(this.addr,t),ge(e,t)}}function f0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(me(e,t))return;n.uniform3uiv(this.addr,t),ge(e,t)}}function p0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(me(e,t))return;n.uniform4uiv(this.addr,t),ge(e,t)}}function m0(n,t,e){let i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r=this.type===n.SAMPLER_2D_SHADOW?zh:Fh;e.setTexture2D(t||r,s)}function g0(n,t,e){let i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTexture3D(t||kh,s)}function x0(n,t,e){let i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTextureCube(t||Vh,s)}function _0(n,t,e){let i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTexture2DArray(t||Bh,s)}function v0(n){switch(n){case 5126:return t0;case 35664:return e0;case 35665:return n0;case 35666:return i0;case 35674:return s0;case 35675:return r0;case 35676:return o0;case 5124:case 35670:return a0;case 35667:case 35671:return c0;case 35668:case 35672:return l0;case 35669:case 35673:return h0;case 5125:return u0;case 36294:return d0;case 36295:return f0;case 36296:return p0;case 35678:case 36198:case 36298:case 36306:case 35682:return m0;case 35679:case 36299:case 36307:return g0;case 35680:case 36300:case 36308:case 36293:return x0;case 36289:case 36303:case 36311:case 36292:return _0}}function y0(n,t){n.uniform1fv(this.addr,t)}function M0(n,t){let e=ps(t,this.size,2);n.uniform2fv(this.addr,e)}function S0(n,t){let e=ps(t,this.size,3);n.uniform3fv(this.addr,e)}function b0(n,t){let e=ps(t,this.size,4);n.uniform4fv(this.addr,e)}function E0(n,t){let e=ps(t,this.size,4);n.uniformMatrix2fv(this.addr,!1,e)}function w0(n,t){let e=ps(t,this.size,9);n.uniformMatrix3fv(this.addr,!1,e)}function T0(n,t){let e=ps(t,this.size,16);n.uniformMatrix4fv(this.addr,!1,e)}function A0(n,t){n.uniform1iv(this.addr,t)}function R0(n,t){n.uniform2iv(this.addr,t)}function C0(n,t){n.uniform3iv(this.addr,t)}function P0(n,t){n.uniform4iv(this.addr,t)}function L0(n,t){n.uniform1uiv(this.addr,t)}function I0(n,t){n.uniform2uiv(this.addr,t)}function U0(n,t){n.uniform3uiv(this.addr,t)}function D0(n,t){n.uniform4uiv(this.addr,t)}function N0(n,t,e){let i=this.cache,s=t.length,r=oo(e,s);me(i,r)||(n.uniform1iv(this.addr,r),ge(i,r));for(let a=0;a!==s;++a)e.setTexture2D(t[a]||Fh,r[a])}function O0(n,t,e){let i=this.cache,s=t.length,r=oo(e,s);me(i,r)||(n.uniform1iv(this.addr,r),ge(i,r));for(let a=0;a!==s;++a)e.setTexture3D(t[a]||kh,r[a])}function F0(n,t,e){let i=this.cache,s=t.length,r=oo(e,s);me(i,r)||(n.uniform1iv(this.addr,r),ge(i,r));for(let a=0;a!==s;++a)e.setTextureCube(t[a]||Vh,r[a])}function z0(n,t,e){let i=this.cache,s=t.length,r=oo(e,s);me(i,r)||(n.uniform1iv(this.addr,r),ge(i,r));for(let a=0;a!==s;++a)e.setTexture2DArray(t[a]||Bh,r[a])}function B0(n){switch(n){case 5126:return y0;case 35664:return M0;case 35665:return S0;case 35666:return b0;case 35674:return E0;case 35675:return w0;case 35676:return T0;case 5124:case 35670:return A0;case 35667:case 35671:return R0;case 35668:case 35672:return C0;case 35669:case 35673:return P0;case 5125:return L0;case 36294:return I0;case 36295:return U0;case 36296:return D0;case 35678:case 36198:case 36298:case 36306:case 35682:return N0;case 35679:case 36299:case 36307:return O0;case 35680:case 36300:case 36308:case 36293:return F0;case 36289:case 36303:case 36311:case 36292:return z0}}var Ma=class{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.setValue=v0(e.type)}},Sa=class{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=B0(e.type)}},ba=class{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,i){let s=this.seq;for(let r=0,a=s.length;r!==a;++r){let o=s[r];o.setValue(t,e[o.id],i)}}},ra=/(\w+)(\])?(\[|\.)?/g;function nh(n,t){n.seq.push(t),n.map[t.id]=t}function k0(n,t,e){let i=n.name,s=i.length;for(ra.lastIndex=0;;){let r=ra.exec(i),a=ra.lastIndex,o=r[1],c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){nh(e,l===void 0?new Ma(o,n,t):new Sa(o,n,t));break}else{let u=e.map[o];u===void 0&&(u=new ba(o),nh(e,u)),e=u}}}var ns=class{constructor(t,e){this.seq=[],this.map={};let i=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<i;++s){let r=t.getActiveUniform(e,s),a=t.getUniformLocation(e,r.name);k0(r,a,this)}}setValue(t,e,i,s){let r=this.map[e];r!==void 0&&r.setValue(t,i,s)}setOptional(t,e,i){let s=e[i];s!==void 0&&this.setValue(t,i,s)}static upload(t,e,i,s){for(let r=0,a=e.length;r!==a;++r){let o=e[r],c=i[o.id];c.needsUpdate!==!1&&o.setValue(t,c.value,s)}}static seqWithValue(t,e){let i=[];for(let s=0,r=t.length;s!==r;++s){let a=t[s];a.id in e&&i.push(a)}return i}};function ih(n,t,e){let i=n.createShader(t);return n.shaderSource(i,e),n.compileShader(i),i}var V0=37297,H0=0;function G0(n,t){let e=n.split(`
`),i=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let a=s;a<r;a++){let o=a+1;i.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return i.join(`
`)}function W0(n){let t=Zt.getPrimaries(Zt.workingColorSpace),e=Zt.getPrimaries(n),i;switch(t===e?i="":t===Br&&e===zr?i="LinearDisplayP3ToLinearSRGB":t===zr&&e===Br&&(i="LinearSRGBToLinearDisplayP3"),n){case Cn:case ro:return[i,"LinearTransferOETF"];case Se:case $a:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[i,"LinearTransferOETF"]}}function sh(n,t,e){let i=n.getShaderParameter(t,n.COMPILE_STATUS),s=n.getShaderInfoLog(t).trim();if(i&&s==="")return"";let r=/ERROR: 0:(\d+)/.exec(s);if(r){let a=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+G0(n.getShaderSource(t),a)}else return s}function X0(n,t){let e=W0(t);return`vec4 ${n}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function Y0(n,t){let e;switch(t){case $d:e="Linear";break;case Kd:e="Reinhard";break;case jd:e="OptimizedCineon";break;case Qd:e="ACESFilmic";break;case ef:e="AgX";break;case tf:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function q0(n){return[n.extensionDerivatives||n.envMapCubeUVHeight||n.bumpMap||n.normalMapTangentSpace||n.clearcoatNormalMap||n.flatShading||n.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(n.extensionFragDepth||n.logarithmicDepthBuffer)&&n.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",n.extensionDrawBuffers&&n.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(n.extensionShaderTextureLOD||n.envMap||n.transmission)&&n.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(ji).join(`
`)}function Z0(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(ji).join(`
`)}function J0(n){let t=[];for(let e in n){let i=n[e];i!==!1&&t.push("#define "+e+" "+i)}return t.join(`
`)}function $0(n,t){let e={},i=n.getProgramParameter(t,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){let r=n.getActiveAttrib(t,s),a=r.name,o=1;r.type===n.FLOAT_MAT2&&(o=2),r.type===n.FLOAT_MAT3&&(o=3),r.type===n.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:n.getAttribLocation(t,a),locationSize:o}}return e}function ji(n){return n!==""}function rh(n,t){let e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function oh(n,t){return n.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}var K0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ea(n){return n.replace(K0,Q0)}var j0=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Q0(n,t){let e=Ut[t];if(e===void 0){let i=j0.get(t);if(i!==void 0)e=Ut[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,i);else throw new Error("Can not resolve #include <"+t+">")}return Ea(e)}var tx=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ah(n){return n.replace(tx,ex)}function ex(n,t,e,i){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function ch(n){let t="precision "+n.precision+` float;
precision `+n.precision+" int;";return n.precision==="highp"?t+=`
#define HIGH_PRECISION`:n.precision==="mediump"?t+=`
#define MEDIUM_PRECISION`:n.precision==="lowp"&&(t+=`
#define LOW_PRECISION`),t}function nx(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===yh?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===qa?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Tn&&(t="SHADOWMAP_TYPE_VSM"),t}function ix(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case is:case ss:t="ENVMAP_TYPE_CUBE";break;case so:t="ENVMAP_TYPE_CUBE_UV";break}return t}function sx(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case ss:t="ENVMAP_MODE_REFRACTION";break}return t}function rx(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Za:t="ENVMAP_BLENDING_MULTIPLY";break;case Zd:t="ENVMAP_BLENDING_MIX";break;case Jd:t="ENVMAP_BLENDING_ADD";break}return t}function ox(n){let t=n.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function ax(n,t,e,i){let s=n.getContext(),r=e.defines,a=e.vertexShader,o=e.fragmentShader,c=nx(e),l=ix(e),h=sx(e),u=rx(e),f=ox(e),m=e.isWebGL2?"":q0(e),g=Z0(e),x=J0(r),p=s.createProgram(),d,y,_=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      }`}));ec.frustumCulled=!1;ec.renderOrder=-1e9;Ee.add(ec);function Yh(){Xh.uGround.value=Math.max(0,Math.min(1,(Gt.elev+.05)/.1))}Ee.add(new no(16777215,.62));var Ye=new Xs(16777215,.78);Ye.castShadow=!0;Ye.shadow.mapSize.set(4096,4096);Ye.shadow.normalBias=.15;Ye.shadow.bias=-2e-4;Ee.add(Ye);Ee.add(Ye.target);var qh=new Xs(16777215,.16);qh.position.set(-6,5,-7);Ee.add(qh);var qs={tail:0},ms=()=>{qs.tail=30},nc=new I,co=new I,Bx=new Rt("#0f1115"),Hh=new Map,Gh=new Map;function Zs(n){let t=Hh.get(n);return t||(t=new Rt().setHex(n),Hh.set(n,t)),t}function ic(n){let t=Gh.get(n);return t||(t=new Rt().setHex(n).lerp(Bx,.62),Gh.set(n,t)),t}var sc=new Gs({vertexColors:!0,side:nn}),kx=.42,rc=new Gs({vertexColors:!0,transparent:!0,opacity:kx,side:nn,depthWrite:!1});rc.shadowSide=cn;var Zh=new as({colorWrite:!1,side:nn}),bi=new be(new ls(8e3,8e3),new to({opacity:.32}));bi.rotation.x=-Math.PI/2;bi.position.y=-.1;bi.receiveShadow=!0;bi.renderOrder=-1;Ee.add(bi);var Kn=new Rn;Ee.add(Kn);var Un=new Rn;Ee.add(Un);var qe=new yi(new us(new In(1,1,1)),new Jn({color:10994876,depthTest:!1}));qe.visible=!1;qe.renderOrder=999;Ee.add(qe);var Ei=new yi(new Oe,new Jn({vertexColors:!0,transparent:!0,depthTest:!1}));Ei.renderOrder=998;Ei.visible=!1;Ee.add(Ei);var pn=new io,jn=new Ht,Qn=new I,Js=new I;var Jh=(n,t,e)=>n+65536+(t+65536)*131072+(e+65536)*131072*131072,Ze=(n,t)=>({x:n.x+t.x,y:n.y+t.y,z:n.z+t.z});function ee(n,t){let{x:e,y:i,z:s}=n;switch(t&3){case 1:return{x:-s,y:i,z:e};case 2:return{x:-e,y:i,z:-s};case 3:return{x:s,y:i,z:-e};default:return{x:e,y:i,z:s}}}var gs=(n,t)=>({rot:n.rot+t.rot&3,off:Ze(ee(t.off,n.rot),n.off)}),$h=n=>{let t=4-(n.rot&3)&3,e=ee(n.off,t);return{rot:t,off:{x:-e.x,y:-e.y,z:-e.z}}},oc=n=>n.slice(1).reduce((t,e)=>gs(t,{off:e.pos,rot:e.rot}),{off:{x:0,y:0,z:0},rot:0}),$s=n=>"#"+(n&16777215).toString(16).padStart(6,"0"),ac=1,lo=()=>"n"+ac++,xs=()=>ac,ho=n=>{ac=n};var ne=(n,t,e,i,s,r,a)=>({x0:n,y0:t,z0:e,x1:i,y1:s,z1:r,c:a}),cc=(n,t,e,i)=>t>=n.x0&&t<n.x1&&e>=n.y0&&e<n.y1&&i>=n.z0&&i<n.z1;function Vx(n,t,e){let i=Math.max(n.x0,t.x0),s=Math.max(n.y0,t.y0),r=Math.max(n.z0,t.z0),a=Math.min(n.x1,t.x1),o=Math.min(n.y1,t.y1),c=Math.min(n.z1,t.z1);if(i>=a||s>=o||r>=c){e.push(n);return}let l=n.c;n.x0<i&&e.push({...n,x1:i}),a<n.x1&&e.push({...n,x0:a}),n.y0<s&&e.push({x0:i,y0:n.y0,z0:n.z0,x1:a,y1:s,z1:n.z1,c:l}),o<n.y1&&e.push({x0:i,y0:o,z0:n.z0,x1:a,y1:n.y1,z1:n.z1,c:l}),n.z0<r&&e.push({x0:i,y0:s,z0:n.z0,x1:a,y1:o,z1:r,c:l}),c<n.z1&&e.push({x0:i,y0:s,z0:c,x1:a,y1:o,z1:n.z1,c:l})}function wi(n,t){let e=[];for(let i of n)Vx(i,t,e);return e}function Kh(n,t,e){let i=wi(n,t);return i.push({...t,c:e}),i}function jh(n,t,e,i,s){let r=-1;for(let h=0;h<n.length;h++)if(cc(n[h],t,e,i)){r=h;break}if(r===-1)return null;let a=n[r].c;if(a===s)return null;let o=(h,u)=>{let f=h.x0<u.x1&&u.x0<h.x1,m=h.y0<u.y1&&u.y0<h.y1,g=h.z0<u.z1&&u.z0<h.z1;return m&&g&&(h.x1===u.x0||u.x1===h.x0)||f&&g&&(h.y1===u.y0||u.y1===h.y0)||f&&m&&(h.z1===u.z0||u.z1===h.z0)},c=new Set([r]),l=[r];for(;l.length;){let h=n[l.pop()];for(let u=0;u<n.length;u++)!c.has(u)&&n[u].c===a&&o(h,n[u])&&(c.add(u),l.push(u))}return n.map((h,u)=>c.has(u)?{...h,c:s}:h)}function Qh(n,t){for(let e of n){let i=(e.x1-e.x0)*(e.y1-e.y0)*(e.z1-e.z0);t.set(e.c,(t.get(e.c)||0)+i)}}function _n(n,t){for(let e of n)e.x0<t.min.x&&(t.min.x=e.x0),e.y0<t.min.y&&(t.min.y=e.y0),e.z0<t.min.z&&(t.min.z=e.z0),e.x1>t.max.x&&(t.max.x=e.x1),e.y1>t.max.y&&(t.max.y=e.y1),e.z1>t.max.z&&(t.max.z=e.z1)}function mn(n,t,e){let i=ee({x:n.x0,y:n.y0,z:n.z0},t),s=ee({x:n.x1-1,y:n.y1-1,z:n.z1-1},t);return{x0:Math.min(i.x,s.x)+e.x,y0:Math.min(i.y,s.y)+e.y,z0:Math.min(i.z,s.z)+e.z,x1:Math.max(i.x,s.x)+e.x+1,y1:Math.max(i.y,s.y)+e.y+1,z1:Math.max(i.z,s.z)+e.z+1,c:n.c}}var Hx=16,Fe=n=>Math.floor(n/Hx);function uo(n){if(!n.length)return()=>!1;let t=1/0,e=1/0,i=1/0,s=-1/0,r=-1/0,a=-1/0;for(let x of n)x.x0<t&&(t=x.x0),x.y0<e&&(e=x.y0),x.z0<i&&(i=x.z0),x.x1>s&&(s=x.x1),x.y1>r&&(r=x.y1),x.z1>a&&(a=x.z1);let o=Fe(t),c=Fe(e),l=Fe(i),h=Fe(s-1)-o+1,u=Fe(r-1)-c+1,f=Fe(a-1)-l+1,m=Array.from({length:h*u*f},()=>[]),g=(x,p,d)=>((x-o)*u+(p-c))*f+(d-l);for(let x of n)for(let p=Fe(x.x0);p<=Fe(x.x1-1);p++)for(let d=Fe(x.y0);d<=Fe(x.y1-1);d++)for(let y=Fe(x.z0);y<=Fe(x.z1-1);y++)m[g(p,d,y)].push(x);return(x,p,d)=>{let y=Fe(x),_=Fe(p),T=Fe(d);if(y<o||_<c||T<l||y-o>=h||_-c>=u||T-l>=f)return!1;for(let P of m[g(y,_,T)])if(cc(P,x,p,d))return!0;return!1}}var tu=(n,t,e,i)=>n.some(s=>cc(s,t,e,i)),lc=(n,t,e,i,s)=>n.some(r=>t.some(a=>r.x0+e<a.x1&&a.x0<r.x1+e&&r.y0+i<a.y1&&a.y0<r.y1+i&&r.z0+s<a.z1&&a.z0<r.z1+s));var fo=[7041116,10855821,12040100,14472900,13343102,14532265,15787730,9268835,13935475,10249796,11895693,7170165,8226199,6055805,6986062,10994876],eu={visible:0,transparent:1,invisible:2},nu={visible:"transparent",transparent:"invisible",invisible:"visible"},po=()=>({type:"object",id:lo(),name:"",pos:{x:0,y:0,z:0},rot:0,vis:"visible",boxes:[]}),_s=(n="")=>({type:"scene",id:lo(),name:n,pos:{x:0,y:0,z:0},rot:0,vis:"visible",children:[]});function mo(n){let t={id:lo(),name:n.name,pos:{...n.pos},rot:n.rot,vis:n.vis};return n.type==="object"?{type:"object",...t,boxes:n.boxes.map(e=>({...e}))}:{type:"scene",...t,children:n.children.map(mo)}}var Ti=n=>M.context.children.find(t=>t.id===n);function vs(n,t=M.root,e=[]){if(e.push(t),t===n)return e.slice();if(t.type==="scene")for(let i of t.children){let s=vs(n,i,e);if(s)return s}return e.pop(),null}function ys(n,t=M.root){if(t.id===n)return t;if(t.type==="scene")for(let e of t.children){let i=ys(n,e);if(i)return i}return null}function Ai(n){let t=vs(n);return t&&t.length>1?t[t.length-2]:null}function Ms(n,t){return n===t?!0:n.type!=="scene"?!1:n.children.some(e=>Ms(e,t))}var Ss=()=>oc(M.path),Ks=n=>oc(vs(n)||[M.root]),sn=()=>({min:{x:1e9,y:1e9,z:1e9},max:{x:-1e9,y:-1e9,z:-1e9}}),ti=n=>n.max.x<n.min.x;function ei(n,t,e,i){if(n.type==="object")_n(n.boxes.map(s=>mn(s,e,t)),i);else for(let s of n.children)ei(s,Ze(t,ee(s.pos,e)),e+s.rot&3,i);return i}function go(n,t){jn.x=(n-le.x)/le.w*2-1,jn.y=-((t-le.y)/le.h)*2+1}var hc=()=>M.pickMeshes.length?(pn.setFromCamera(jn,Xt),pn.intersectObjects(M.pickMeshes,!1)[0]??null):null;function uc(){let n=hc();return n?n.object.userData.childId??null:null}var iu=new Qe(new I(0,1,0),0);function js(n){return pn.setFromCamera(jn,Xt),iu.constant=-n,pn.ray.intersectPlane(iu,Qn)?{x:Math.floor(Qn.x),y:n,z:Math.floor(Qn.z)}:null}var ou=(n,t)=>({x:Math.floor(n.x-t.x*.5),y:Math.floor(n.y-t.y*.5),z:Math.floor(n.z-t.z*.5)});function Ri(){let n=hc();if(!n)return null;let t=M.editXform.off,e=ee({x:n.point.x-t.x,y:n.point.y-t.y,z:n.point.z-t.z},-M.editXform.rot),i=n.face?n.face.normal:{x:0,y:1,z:0},s=ou(e,i);return{cell:s,addCell:{x:s.x+Math.round(i.x),y:s.y+Math.round(i.y),z:s.z+Math.round(i.z)}}}function au(){let n=hc();return n?ou(n.point,n.face?n.face.normal:{x:0,y:1,z:0}):js(0)}function Qs(n){let t=js(n+M.editXform.off.y);if(!t)return null;let e=ee({x:t.x-M.editXform.off.x,y:0,z:t.z-M.editXform.off.z},-M.editXform.rot);return{x:Math.round(e.x),y:n,z:Math.round(e.z)}}var su=(n,t)=>({x:n===0?t:0,y:n===1?t:0,z:n===2?t:0}),ru=new Qe;function cu(n,t){let e=M.editXform.off,i=M.editXform.rot,s=ee(su(n,1),i),r=Ze(ee(su(n,t),i),e);if(pn.setFromCamera(jn,Xt),ru.setComponents(s.x,s.y,s.z,-(s.x*r.x+s.y*r.y+s.z*r.z)),!pn.ray.intersectPlane(ru,Qn))return null;let a=ee({x:Qn.x-e.x,y:Qn.y-e.y,z:Qn.z-e.z},-i),o={x:Math.round(a.x),y:Math.round(a.y),z:Math.round(a.z)};return n===0?o.x=t:n===1?o.y=t:o.z=t,o}var bs=(n,t,e)=>{let i=ee({x:n,y:t,z:e},M.editXform.rot);return new I(i.x+M.editXform.off.x,i.y+M.editXform.off.y,i.z+M.editXform.off.z)};function dc(n=Ri()){return M.tool==="add"?n?n.addCell:Qs(0):n?n.cell:null}var Gx=new Rt(10994876),Wx=new Rt(6055805),tr=null,fc=[],xo=[],_o=()=>M.editObject?M.tool==="measure":M.measMode,pc=()=>{tr=null};function vn(){M.liveMeas=null,fc=[],Ci()}function lu(){if(tr)return tr;let n=[],t;M.editObject?(n.push(...M.editObject.boxes),t=bs):(ni(M.root,{x:0,y:0,z:0},0,null,0,(o,c,l,h)=>{if(h)for(let u of o.boxes)n.push(mn(u,l,c))}),t=(o,c,l)=>new I(o,c,l));let e=sn();_n(n,e);let i=n.length===0,s={x:e.min.x,y:e.min.y,z:e.min.z},r={x:e.max.x-1,y:e.max.y-1,z:e.max.z-1};return tr={has:n.length>64?uo(n):(o,c,l)=>tu(n,o,c,l),mn:s,mx:r,toW:t,empty:i},tr}function Xx(){let n=lu();if(n.empty)return null;let t=null;if(M.editObject){let e=Ri();t=e?{...e.cell}:Qs(0)}else t=au();return t?{x:Math.max(n.mn.x,Math.min(n.mx.x,t.x)),y:Math.max(n.mn.y,Math.min(n.mx.y,t.y)),z:Math.max(n.mn.z,Math.min(n.mx.z,t.z))}:null}function Yx(n){let t=lu(),e=["x","y","z"],i=[];for(let s=0;s<3;s++){let r=e[s],a=e[(s+1)%3],o=e[(s+2)%3],c=t.mn[r],l=t.mx[r],h=[n.x,n.y,n.z],u=m=>(h[s]=m,t.has(h[0],h[1],h[2])),f=c;for(;f<=l;){let m=u(f),g=f;for(;g+1<=l&&u(g+1)===m;)g++;let x=p=>{let d={};return d[r]=p,d[a]=n[a]+.5,d[o]=n[o]+.5,t.toW(d.x,d.y,d.z)};i.push({a:x(f),b:x(g+1),mid:x((f+g+1)/2),len:g-f+1,filled:m}),f=g+1}}return i}function hu(){let n=Xx();M.liveMeas=n?Yx(n):null,Ci()}function uu(){M.liveMeas&&M.liveMeas.length&&(fc.push(M.liveMeas),Ci())}function Ci(){let n=document.getElementById("measure");n.innerHTML="",xo=[];let t=[];M.liveMeas&&t.push({s:M.liveMeas,fz:!1});for(let r of fc)t.push({s:r,fz:!0});let e=[],i=[];for(let r of t)for(let a of r.s){let o=a.filled?Gx:Wx;if(e.push(a.a.x,a.a.y,a.a.z,a.b.x,a.b.y,a.b.z),i.push(o.r,o.g,o.b,o.r,o.g,o.b),a.nolabel)continue;let c=document.createElement("div");c.className="mlab"+(a.filled?"":" empty")+(r.fz?" frozen":""),c.textContent=String(a.len),n.appendChild(c),xo.push({el:c,w:a.mid})}Ei.geometry.dispose();let s=new Oe;s.setAttribute("position",new pe(e,3)),s.setAttribute("color",new pe(i,3)),Ei.geometry=s,Ei.visible=e.length>0}function du(){if(xo.length)for(let n of xo){if(Js.copy(n.w).project(Xt),Js.z>1){n.el.style.display="none";continue}n.el.style.display="",n.el.style.left=(Js.x*.5+.5)*le.w+"px",n.el.style.top=(-Js.y*.5+.5)*le.h+"px"}}var mc=new I(40,150,30).normalize();function qx(n){if(ti(n))return;let t=(n.min.x+n.max.x)/2,e=(n.min.y+n.max.y)/2,i=(n.min.z+n.max.z)/2,s=.5*Math.hypot(n.max.x-n.min.x,n.max.y-n.min.y,n.max.z-n.min.z)+8,r=s+130;Ye.position.set(t+mc.x*r,e+mc.y*r,i+mc.z*r),Ye.target.position.set(t,e,i),Ye.target.updateMatrixWorld();let a=Ye.shadow.camera;a.left=-s,a.right=s,a.top=s,a.bottom=-s,a.near=Math.max(1,r-s-20),a.far=r+s+20,a.updateProjectionMatrix(),Ye.shadow.normalBias=4*s/Ye.shadow.mapSize.x}var Dn=[];function Zx(){let n=new Set;for(let t of Dn){Ee.remove(t);let e=t.geometry;e&&!n.has(e)&&(e.dispose(),n.add(e))}Dn=[],Kn.clear(),Es&&(cancelAnimationFrame(Es),Es=0),Je=null}var Je=null,Es=0,Jx=[{a:0,hi:!0,u:1,v:2,n:[1,0,0]},{a:0,hi:!1,u:2,v:1,n:[-1,0,0]},{a:1,hi:!0,u:2,v:0,n:[0,1,0]},{a:1,hi:!1,u:0,v:2,n:[0,-1,0]},{a:2,hi:!0,u:0,v:1,n:[0,0,1]},{a:2,hi:!1,u:1,v:0,n:[0,0,-1]}],gu=3,nr=2,ii=gu*nr,fu=.5;function pu(n,t,e,i,s,r){let a=2*nr+1;for(let o=0;o<e;o++){let c=o*s,l=0;for(let h=0;h<=nr&&h<i;h++)l+=n[c+h*r];for(let h=0;h<i;h++){t[c+h*r]=l/a;let u=h+nr+1,f=h-nr;u<i&&(l+=n[c+u*r]),f>=0&&(l-=n[c+f*r])}}}function xu(n,t,e){let i=[],s=[],r=[],a=n.map(u=>[u.x0,u.y0,u.z0]),o=n.map(u=>[u.x1,u.y1,u.z1]),c=e?uo(n):null,l=[0,0,0];for(let u=0;u<n.length;u++){let f=t(n[u].c),m=f.r,g=f.g,x=f.b,p=a[u],d=o[u];for(let y of Jx){let{a:_,u:T,v:P}=y,A=y.hi?d[_]:p[_],R=y.hi?A:A-1,Z=[];for(let F=0;F<n.length;F++){if(F===u||(y.hi?a[F][_]:o[F][_])!==A)continue;let W=Math.max(a[F][T],p[T]),G=Math.min(o[F][T],d[T]),Q=Math.max(a[F][P],p[P]),N=Math.min(o[F][P],d[P]);W<G&&Q<N&&Z.push([W,Q,G,N])}let b=[[p[T],p[P],d[T],d[P]]];for(let F of Z){let W=[];for(let G of b){let Q=Math.max(G[0],F[0]),N=Math.max(G[1],F[1]),q=Math.min(G[2],F[2]),nt=Math.min(G[3],F[3]);if(Q>=q||N>=nt){W.push(G);continue}G[0]<Q&&W.push([G[0],G[1],Q,G[3]]),q<G[2]&&W.push([q,G[1],G[2],G[3]]),G[1]<N&&W.push([Q,G[1],q,N]),nt<G[3]&&W.push([Q,nt,q,G[3]])}if(b=W,!b.length)break}let w=[0,0,0],H=(F,W)=>(w[_]=A,w[T]=F,w[P]=W,[w[0],w[1],w[2]]),$=null,rt=0,L=0,D=0,X=()=>{rt=p[T]-ii,L=p[P]-ii;let F=d[T]-p[T]+2*ii+1;D=d[P]-p[P]+2*ii+1;let W=new Float32Array(F*D),G=l;G[_]=R;for(let N=0;N<F;N++){G[T]=rt+N;let q=N*D;for(let nt=0;nt<D;nt++)G[P]=L+nt,c(G[0],G[1],G[2])&&(W[q+nt]=1)}let Q=new Float32Array(F*D);for(let N=0;N<gu;N++)pu(W,Q,F,D,D,1),pu(Q,W,D,F,1,D);return $=W},J=(F,W)=>{if(!c)return 1;let Q=($??X())[(F-rt)*D+(W-L)];return fu+(1-fu)*(1-Q)},Y=(F,W,G,Q)=>{let N=H(F,W),q=H(G,W),nt=H(G,Q),mt=H(F,Q),ut=J(F,W),dt=J(G,W),lt=J(G,Q),St=J(F,Q),Vt=[[N,ut],[q,dt],[nt,lt],[N,ut],[nt,lt],[mt,St]];for(let[O,de]of Vt)i.push(O[0],O[1],O[2]),s.push(y.n[0],y.n[1],y.n[2]),r.push(m*de,g*de,x*de)};for(let F of b){let[W,G,Q,N]=F;if(!c){Y(W,G,Q,N);continue}let q=W+ii,nt=Q-ii,mt=G+ii,ut=N-ii;if(q>=nt||mt>=ut){for(let dt=W;dt<Q;dt++)for(let lt=G;lt<N;lt++)Y(dt,lt,dt+1,lt+1);continue}for(let dt=W;dt<Q;dt++){for(let lt=G;lt<mt;lt++)Y(dt,lt,dt+1,lt+1);for(let lt=ut;lt<N;lt++)Y(dt,lt,dt+1,lt+1)}for(let dt=mt;dt<ut;dt++){for(let lt=W;lt<q;lt++)Y(lt,dt,lt+1,dt+1);for(let lt=nt;lt<Q;lt++)Y(lt,dt,lt+1,dt+1)}Y(q,mt,nt,ut)}}}if(!i.length)return null;let h=new Oe;return h.setAttribute("position",new pe(i,3)),h.setAttribute("normal",new pe(s,3)),h.setAttribute("color",new pe(r,3)),h}function er(n,t,{transparent:e=!1,childId:i}={}){if(!n.length)return;let s=xu(n,t,!e);if(!s)return;let r=new be(s,e?rc:sc);if(r.castShadow=!0,r.receiveShadow=!0,Ee.add(r),Dn.push(r),e){r.renderOrder=2;let a=new be(s,Zh);a.renderOrder=1,a.castShadow=!1,a.receiveShadow=!1,Ee.add(a),Dn.push(a)}i!=null&&(r.userData.childId=i,M.pickMeshes.push(r),(M.childMeshes[i]||(M.childMeshes[i]=[])).push(r))}function ni(n,t,e,i,s,r){let a=Math.max(s,eu[n.vis]);if(!(n===M.editObject||a>=2))if(n.type==="object")r(n,t,e,i,a===1);else for(let o of n.children)ni(o,Ze(t,ee(o.pos,e)),e+o.rot&3,n===M.context?o.id:i,a,r)}var mu=(n,t,e,i)=>{for(let s of n.boxes)i.push(mn(s,e,t));return i};function _u(){let{off:n,rot:t}=M.editXform;if(Kn.position.set(n.x,n.y,n.z),Kn.rotation.set(0,-t*Math.PI/2,0),Kn.updateMatrixWorld(!0),Je){Kn.remove(Je),Je.geometry.dispose();let i=Dn.indexOf(Je);i>=0&&Dn.splice(i,1)}let e=xu(M.editObject.boxes,Zs,!0);Je=e?new be(e,sc):null,Je&&(Je.castShadow=Je.receiveShadow=!0,Kn.add(Je),Dn.push(Je)),M.pickMeshes=Je?[Je]:[]}function $x(){Es||(Es=requestAnimationFrame(()=>{Es=0,_u(),ms()}))}function gc(){M.voxVer++,pc(),$x()}function vu(n,t){M.editObject.boxes=Kh(M.editObject.boxes,n,t),gc()}function yu(n){M.editObject.boxes=wi(M.editObject.boxes,n),gc()}function Mu(n,t){let e=jh(M.editObject.boxes,n.x,n.y,n.z,t);e&&(M.editObject.boxes=e,gc())}function Su(){if(!Dn.length)return null;pn.setFromCamera(jn,Xt);let n=pn.intersectObjects(Dn,!1)[0];if(!n)return null;let t=pn.ray.direction,e=Math.floor(n.point.x+t.x*.5),i=Math.floor(n.point.y+t.y*.5),s=Math.floor(n.point.z+t.z*.5),r=(o,c,l)=>{for(let h of o){let u=mn(h,l,c);if(e>=u.x0&&e<u.x1&&i>=u.y0&&i<u.y1&&s>=u.z0&&s<u.z1)return u.c}return null};if(M.editObject){let o=r(M.editObject.boxes,M.editXform.off,M.editXform.rot);if(o!=null)return o}let a=null;return ni(M.root,{x:0,y:0,z:0},0,null,0,(o,c,l)=>{a==null&&(a=r(o.boxes,c,l))}),a}function ke(){Zx(),M.pickMeshes=[],M.childMeshes={},M.childBox={},M.voxVer++,pc();let n={x:0,y:0,z:0},t=sn();if(M.editObject){M.editXform=gs(Ss(),{off:M.editObject.pos,rot:M.editObject.rot});let e=[];ni(M.root,n,0,null,0,(i,s,r)=>mu(i,s,r,e)),_n(e,t),er(e,Zs,{transparent:!0}),_u(),ei(M.editObject,M.editXform.off,M.editXform.rot,t)}else{let e=new Map,i=new Map,s=[],r=[];ni(M.root,n,0,null,0,(a,o,c,l,h)=>{let u=mu(a,o,c,[]);if(_n(u,t),l){let f=h?i:e,m=f.get(l);m?m.push(...u):f.set(l,u),_n(u,M.childBox[l]||(M.childBox[l]=sn()))}else(h?r:s).push(...u)}),er(s,ic),er(r,ic,{transparent:!0});for(let a of new Set([...e.keys(),...i.keys()])){let o=e.get(a);o&&er(o,Zs,{childId:a});let c=i.get(a);c&&er(c,Zs,{transparent:!0})}}M.sceneBox=t,qx(t),xc(),ms()}function Kx(n,t,e){let i=new In(t.x-n.x,t.y-n.y,t.z-n.z),s=new yi(new us(i),new Jn({color:e,depthTest:!1}));return s.position.set((n.x+t.x)/2,(n.y+t.y)/2,(n.z+t.z)/2),s.renderOrder=999,i.dispose(),s}function xc(){for(let n of Un.children)n.geometry?.dispose?.();if(Un.clear(),Un.position.set(0,0,0),!M.editObject)for(let n of M.selection){let t=M.childBox[n];t&&!ti(t)&&Un.add(Kx(t.min,t.max,15787730))}}var ir=new I,_c=new I,vc=new I,bu=new I,jx=new I(0,1,0);function Eu(n,t){let e=(Xt.top-Xt.bottom)/le.h;Xt.getWorldDirection(_c),vc.crossVectors(_c,jx).normalize(),bu.crossVectors(vc,_c).normalize(),Jt.target.addScaledVector(vc,-n*e),Jt.target.addScaledVector(bu,t*e)}function wu(n,t){Jt.azim-=n*.012,Jt.elev=Math.max(-Math.PI/2,Math.min(Math.PI/2,Jt.elev+t*.012))}function Tu(n){ti(n)||(Jt.target.set((n.min.x+n.max.x)/2,(n.min.y+n.max.y)/2,(n.min.z+n.max.z)/2),Jt.zoom=Math.max(8,Math.min(ao,Math.max(n.max.x-n.min.x,n.max.y-n.min.y,n.max.z-n.min.z)*1.5+8)))}function Nn(){let n=sn();if(M.editObject){if(ei(M.editObject,M.editXform.off,M.editXform.rot,n),ti(n)){let t=M.editXform.off;Jt.target.set(t.x,t.y+6,t.z),Jt.zoom=41;return}}else for(let t in M.childBox){let e=M.childBox[t];n.min.x=Math.min(n.min.x,e.min.x),n.min.y=Math.min(n.min.y,e.min.y),n.min.z=Math.min(n.min.z,e.min.z),n.max.x=Math.max(n.max.x,e.max.x),n.max.y=Math.max(n.max.y,e.max.y),n.max.z=Math.max(n.max.z,e.max.z)}if(ti(n)){Jt.target.set(0,1,0),Jt.zoom=23;return}Tu(n)}function yc(n){if(n===M.root){Nn();return}let t=Ks(n);Tu(ei(n,t.off,t.rot,sn()))}function Au(){Gt.azim+=(Jt.azim-Gt.azim)*.22,Gt.elev+=(Jt.elev-Gt.elev)*.22,Gt.zoom+=(Jt.zoom-Gt.zoom)*.25,Gt.target.lerp(Jt.target,.25);let n=Math.cos(Gt.elev),t=Math.sin(Gt.elev);ir.set(n*Math.sin(Gt.azim),t,n*Math.cos(Gt.azim)),Xt.position.copy(Gt.target).addScaledVector(ir,Wh);let e=Ih.clamp((Math.abs(Gt.elev)-1.45)/(Math.PI/2-1.45),0,1);co.set(-Math.sin(Gt.azim),0,-Math.cos(Gt.azim)),Gt.elev<0&&co.negate(),nc.set(0,1,0).lerp(co,e),Xt.up.copy(nc.normalize()),Xt.lookAt(Gt.target);let i=le.w/le.h,s=Gt.zoom,r=s*i;Xt.left=-r/2,Xt.right=r/2,Xt.top=s/2,Xt.bottom=-s/2;let a=Xt.position,o=1/0,c=-1/0,l=(g,x,p)=>{let d=(a.x-g)*ir.x+(a.y-x)*ir.y+(a.z-p)*ir.z;d<o&&(o=d),d>c&&(c=d)},h=M.sceneBox;if(h&&!ti(h))for(let g of[h.min.x,h.max.x])for(let x of[h.min.y,h.max.y])for(let p of[h.min.z,h.max.z])l(g,x,p);let u=Gt.target.x,f=Gt.target.z,m=4e3;for(let g of[-m,m])for(let x of[-m,m])l(u+g,0,f+x);o>c&&(o=.1,c=4e3),Xt.near=o-10,Xt.far=c+10,Xt.updateProjectionMatrix(),bi.position.set(Gt.target.x,-.1,Gt.target.z),Yh()}var Ru=()=>{ke(),he()},Mc=n=>{M.selection=new Set([n]),M.editObject=null,vn(),Ru()};function Qx(){M.path.length>1&&Mc(M.path.pop().id)}function t_(){Mc(M.editObject.id)}function Cu(){M.editObject?t_():Qx()}function Pi(n){let t=vs(n);t&&(M.path=t.slice(0,-1),Mc(n.id))}function Pu(n){return n.type==="object"?M.editObject===n:M.context===n&&!M.editObject}function ws(n,t){let e=vs(n);e&&(n.type==="scene"?(M.path=e,M.editObject=null):(M.path=e.slice(0,-1),M.editObject=n),M.selection.clear(),M.tool="add",vn(),Ru(),t&&Nn())}var e_=200,On=[],Li=-1,Sc=!1,n_=n=>({rootJSON:n,uid:xs(),pathIds:M.path.map(t=>t.id),selection:[...M.selection],editId:M.editObject?M.editObject.id:null,collapsed:[...M.collapsed]});function Lu(n){if(Sc)return;let t=n_(n),e=On[Li];e&&e.rootJSON===t.rootJSON||(On.length=Li+1,On.push(t),On.length>e_&&On.shift(),Li=On.length-1)}function Iu(n){Sc=!0,ho(n.uid),M.root=vo(JSON.parse(n.rootJSON)),M.path=[];let t=M.root;for(let e of n.pathIds){let i=t.id===e?t:t.type==="scene"?t.children.find(s=>s.id===e):null;if(!i)break;t=i,M.path.push(t)}M.path.length||(M.path=[M.root]),M.editObject=n.editId?ys(n.editId):null,M.selection=new Set(n.selection.filter(e=>M.context.children.some(i=>i.id===e))),M.collapsed=new Set(n.collapsed),M.drag=null,M.painting=!1,M.lastVox=null,ke(),he(),Me(),Sc=!1}function Uu(){si(),Li>0&&Iu(On[--Li])}function bc(){si(),Li<On.length-1&&Iu(On[++Li])}var Du="voxelier-v11";function Mo(n){let t={id:n.id,nm:n.name,p:n.pos,r:n.rot,vs:n.vis};return n.type==="object"?{t:"o",...t,b:n.boxes.map(e=>[e.x0,e.y0,e.z0,e.x1,e.y1,e.z1,e.c])}:{t:"s",...t,c:n.children.map(Mo)}}function vo(n){let t={id:n.id,name:n.nm||"",pos:n.p,rot:n.r,vis:n.vs||"visible"};return n.t==="o"?{type:"object",...t,boxes:n.b.map(e=>({x0:e[0],y0:e[1],z0:e[2],x1:e[3],y1:e[4],z1:e[5],c:e[6]}))}:{type:"scene",...t,children:n.c.map(vo)}}var yo;function si(){clearTimeout(yo),yo=void 0;let n=JSON.stringify(Mo(M.root));Lu(n);try{localStorage.setItem(Du,`{"uid":${xs()},"root":${n}}`)}catch{}}function Me(){clearTimeout(yo),yo=setTimeout(si,250)}function Ec(n){return!n||!n.root?!1:(ho(n.uid||1),M.root=vo(n.root),!0)}function Nu(){try{return Ec(JSON.parse(localStorage.getItem(Du)))}catch{return!1}}var Ii=()=>{ke(),he(),Me()},Ou=n=>n<0?-Math.round(-n):Math.round(n);function Fu(n){n.vis=nu[n.vis],Ii()}function Tc(n){let t=prompt("Name",n.name||"");t!=null&&(n.name=t.trim(),he(),Me())}var wc=[],zu=()=>[...M.selection].map(n=>Ti(n)).filter(n=>!!n),Ac=n=>{let t=mo(n);return t.pos={x:n.pos.x+5,y:n.pos.y,z:n.pos.z+5},t},Bu=(n,t)=>{let e=po();e.pos={x:Math.round(Jt.target.x),y:0,z:Math.round(Jt.target.z)},n.children.push(e),M.collapsed.delete(n.id),ws(e,t),Me()};function ku(){Bu(M.context,!0)}function Rc(){M.selection.size&&(M.context.children=M.context.children.filter(n=>!M.selection.has(n.id)),M.selection.clear(),Ii())}function Vu(){let n=zu().map(Ac);n.length&&(M.context.children.push(...n),M.selection=new Set(n.map(t=>t.id)),Ii())}function Cc(){wc=zu().map(mo)}function Hu(){Cc(),Rc()}function Gu(){if(!wc.length)return;let n=wc.map(Ac);M.context.children.push(...n),M.selection=new Set(n.map(t=>t.id)),Ii()}function Pc(n,t,e){if(n===t||Ms(n,t))return!1;let i=Ai(n);if(!i)return!1;let s=gs(Ks(i),{off:{...n.pos},rot:n.rot}),r=gs($h(Ks(t)),s),a=i.children.indexOf(n);return i.children.splice(a,1),i===t&&a<e&&e--,n.pos={x:Math.round(r.off.x),y:Math.round(r.off.y),z:Math.round(r.off.z)},n.rot=r.rot&3,t.children.splice(Math.max(0,Math.min(e,t.children.length)),0,n),!0}function Wu(n){let t=Ai(n);if(!t)return null;let e=t.children.indexOf(n),i=_s("Group");return i.pos={...n.pos},i.rot=n.rot,t.children.splice(e,1,i),n.pos={x:0,y:0,z:0},n.rot=0,i.children=[n],i}function Xu(n,t){if(t===n||Ms(t,n))return!1;let e=Wu(n);return e?(Pc(t,e,e.children.length),M.collapsed.delete(e.id),M.selection=new Set([e.id]),Ii(),!0):!1}function Yu(n){let t=Wu(n);t&&(M.collapsed.delete(t.id),Pi(t),Me())}function qu(n){let t=Ai(n);if(!t)return;let e=Ac(n);t.children.splice(t.children.indexOf(n)+1,0,e),Pi(e),Me()}function Zu(n){let t=Ai(n);t&&(t.children=t.children.filter(e=>e!==n),M.selection.delete(n.id),M.editObject===n&&(M.editObject=null),Ii())}function Ju(n){Bu(n,!1)}function $u(n){let t=_s("Group");n.children.push(t),M.collapsed.delete(n.id),Pi(t),Me()}function Lc(n){let t=n<0?-1:1,e=Ss(),i=s=>ei(s,Ze(e.off,ee(s.pos,e.rot)),e.rot+s.rot&3,sn());for(let s=0;s<Math.abs(n);s++)for(let r of M.selection){let a=Ti(r);if(!a)continue;let o=i(a);a.rot=a.rot+t&3;let c=i(a),l={x:(o.min.x+o.max.x)/2-(c.min.x+c.max.x)/2,z:(o.min.z+o.max.z)/2-(c.min.z+c.max.z)/2},h=ee({x:Ou(l.x),y:0,z:Ou(l.z)},-e.rot);a.pos.x+=h.x,a.pos.z+=h.z}M.selection.size&&ke()}function Ku(){M.selection.size&&(Lc(1),he(),Me())}function Ic(n){for(let t of M.selection){let e=Ti(t);e&&(e.pos.y+=n)}M.selection.size&&Ii()}function ju(){let n=JSON.stringify({uid:xs(),root:Mo(M.root)}),t=URL.createObjectURL(new Blob([n],{type:"application/json"})),e=M.root.name||"Project",i=o=>String(o).padStart(2,"0"),s=new Date,r=`${s.getFullYear()}-${i(s.getMonth()+1)}-${i(s.getDate())} ${i(s.getHours())}h${i(s.getMinutes())}m${i(s.getSeconds())}s`,a=document.createElement("a");a.href=t,a.download=`${e} -- ${r}.voxelier.json`,a.click(),URL.revokeObjectURL(t)}function Qu(){let n=document.createElement("input");n.type="file",n.accept="application/json,.json",n.onchange=()=>{let t=n.files&&n.files[0];if(!t)return;let e=new FileReader;e.onload=()=>{try{if(!Ec(JSON.parse(e.result)))throw new Error("not a Voxelier scene file");M.path=[M.root],M.editObject=null,M.selection.clear(),M.measMode=!1,vn(),ke(),he(),Nn(),si()}catch(i){alert("Import failed: "+i.message)}},e.readAsText(t)},n.click()}var Ui=null,Ve=null,Eo=null,Ts=null,ri=null;function ze(n,t={},...e){let i=document.createElement(n);return Object.assign(i,t),e.length&&i.append(...e),i}var i_=[{id:"add",ic:"\uFF0B",label:"Add"},{id:"erase",ic:"\uFF0D",label:"Erase"},{id:"paint",ic:"\u{1FAA3}",label:"Fill"},{id:"eyedropper",ic:"\u{1F4A7}",label:"Pick"},{id:"measure",ic:"\u{1F4CF}",label:"Measure"}],s_={visible:"\u25C9",transparent:"\u25D0",invisible:"\u29B0"},So=(n,t,e,i)=>ze("button",{className:"tool"+(e?" active":""),innerHTML:`<span class="ic">${n}</span>${t}`,onclick:i});function he(){let n=document.getElementById("tools");n.innerHTML="";let t=ze("div",{className:"toolgroup"});if(M.editObject){for(let i of i_)t.appendChild(So(i.ic,i.label,M.tool===i.id,()=>{M.tool=i.id,vn(),qe.visible=!1,he()}));t.appendChild(c_())}else t.appendChild(So("\u{1F4CF}","Measure",M.measMode,()=>{M.measMode=!M.measMode,M.measMode||vn(),he()}));let e=ze("div",{className:"toolgroup"});e.appendChild(So("\u{1F4C2}","Import",!1,Qu)),e.appendChild(So("\u{1F4BE}","Export",!1,ju)),n.append(t,e),nd()}var bo={ver:-1,cols:[]};function r_(){if(bo.ver===M.voxVer)return bo.cols;let n=new Map;return function t(e){e.type==="object"?Qh(e.boxes,n):e.children.forEach(t)}(M.root),bo={ver:M.voxVer,cols:[...n.entries()].sort((t,e)=>e[1]-t[1]).map(t=>t[0])},bo.cols}var Dc=[];function To(n){M.selColor=n,Dc=[n,...Dc.filter(t=>t!==n)].slice(0,4),he()}function o_(){let n=[];for(let t of[...Dc,...r_(),...fo])if(n.includes(t)||n.push(t),n.length>=4)break;return n}var a_=n=>{let t=ze("div",{className:"sw"+(n===M.selColor?" active":""),title:$s(n),onclick:()=>To(n)});return t.style.background=$s(n),t};function c_(){let n=ze("div",{className:"colorctl"}),t=ze("div",{className:"colorbtn",title:"Draw colour \u2014 hover for recent colours / picker"});t.style.background=$s(M.selColor);let e=ze("div",{className:"colorflyout"});for(let i of o_())e.appendChild(a_(i));return e.appendChild(ze("div",{className:"sw more",textContent:"\u{1F3A8}",title:"Colour picker",onclick:l_})),n.append(t,e),n}function l_(){let n=ze("input",{type:"color",value:$s(M.selColor)});n.style.cssText="position:fixed;left:-9999px;top:0";let t=()=>To(parseInt(n.value.slice(1),16)),e=()=>n.remove();n.addEventListener("input",t),n.addEventListener("change",()=>{t(),e()}),window.addEventListener("focus",e,{once:!0}),document.body.appendChild(n),n.click()}function td(n,t,e,i){if(n.type==="object")for(let s of n.boxes)i.push(mn(s,e,t));else for(let s of n.children)td(s,Ze(t,ee(s.pos,e)),e+s.rot&3,i);return i}var Uc=(n,t)=>{let e=Math.min(255,(n>>16&255)*t)|0,i=Math.min(255,(n>>8&255)*t)|0,s=Math.min(255,(n&255)*t)|0;return`rgb(${e},${i},${s})`},wo=new Map;function ed(n){return n.type==="object"?"o"+n.boxes.map(t=>`${t.x0},${t.y0},${t.z0},${t.x1},${t.y1},${t.z1},${t.c}`).join(";"):"s"+n.children.map(t=>`${t.id}@${t.pos.x},${t.pos.y},${t.pos.z}/${t.rot};${ed(t)}`).join()}function h_(n){let t=wo.get(n.id);if(n===M.editObject&&t)return t.cv;let e=ed(n);if(t&&t.sig===e)return t.cv;let i=document.createElement("canvas");i.width=i.height=52,i.style.width=i.style.height="26px";let s=i.getContext("2d");s.fillStyle="#0f1115",s.fillRect(0,0,52,52);let r=td(n,{x:0,y:0,z:0},0,[]);if(r.length){let a=sn();_n(r,a);let{x:o,y:c,z:l}=a.min,{x:h,y:u,z:f}=a.max,m=40/Math.max(h-o,u-c,f-l,1),g=26-((o+h)/2-(l+f)/2)*m*.5,x=28+(c+u)/2*m*.6-((o+h)/2+(l+f)/2)*m*.28,p=(y,_,T)=>[g+(y-T)*m*.5,x-_*m*.6+(y+T)*m*.28],d=(y,_)=>{s.fillStyle=y,s.beginPath(),s.moveTo(_[0][0],_[0][1]);for(let T=1;T<_.length;T++)s.lineTo(_[T][0],_[T][1]);s.closePath(),s.fill()};r.sort((y,_)=>y.x0+y.x1+y.y0+y.y1+y.z0+y.z1-(_.x0+_.x1+_.y0+_.y1+_.z0+_.z1));for(let y of r)d(Uc(y.c,.78),[p(y.x1,y.y0,y.z0),p(y.x1,y.y1,y.z0),p(y.x1,y.y1,y.z1),p(y.x1,y.y0,y.z1)]),d(Uc(y.c,.6),[p(y.x0,y.y0,y.z1),p(y.x1,y.y0,y.z1),p(y.x1,y.y1,y.z1),p(y.x0,y.y1,y.z1)]),d(Uc(y.c,1),[p(y.x0,y.y1,y.z0),p(y.x1,y.y1,y.z0),p(y.x1,y.y1,y.z1),p(y.x0,y.y1,y.z1)])}return wo.set(n.id,{sig:e,cv:i}),i}function u_(n){if(ri&&ri.node===n){clearTimeout(ri.timer),ri=null,yc(n);return}ri&&clearTimeout(ri.timer);let t=e=>{ri={node:n,timer:setTimeout(()=>{ri=null,e&&e()},300)}};Pu(n)?t(()=>Tc(n)):(ws(n),t())}function d_(n){let t=h_(n);if(t.className="thumb",t.onclick=null,t.title="",n!==M.root&&n.type==="scene"&&n.children.length){let e=M.collapsed.has(n.id);t.classList.add("group"),e&&t.classList.add("collapsed"),t.title=e?"Expand group":"Collapse group",t.onclick=i=>{i.stopPropagation(),e?M.collapsed.delete(n.id):M.collapsed.add(n.id),nd()}}return t}function f_(n,t){n.draggable=t!==M.root,t!==M.root&&n.addEventListener("dragstart",e=>{if(e.stopPropagation(),Ui=t.id,e.dataTransfer){e.dataTransfer.effectAllowed="move";try{e.dataTransfer.setData("text/plain",t.id)}catch{}}}),n.addEventListener("dragend",sr),n.addEventListener("dragover",e=>{e.preventDefault(),e.stopPropagation(),m_(e,t,n)}),n.addEventListener("drop",e=>{e.preventDefault(),e.stopPropagation(),sd()})}function nd(){let n=document.getElementById("tree");n.innerHTML="";let t=(i,s)=>{let r=i===M.root,a=!r&&M.context.children.includes(i)&&M.selection.has(i.id),o=i.vis,c=ze("div",{className:"trow"+(r?" root":"")+(a?" sel":"")+(i===M.context&&!M.editObject?" ctx":"")+(i===M.editObject?" edit":"")+(!r&&o!=="visible"?" dim":"")});c.style.paddingLeft=4+s*13+"px";let l=d_(i),h=ze("span",{className:"nm"});if(r?h.textContent=i.name||"Project":i.name?h.textContent=i.name:h.innerHTML='<span class="ph">'+(i.type==="scene"?"group":"object")+"</span>",c.append(l,h),r||c.append(ze("button",{className:"tb"+(o==="visible"?" on":""),textContent:s_[o],title:"visible \u2192 transparent \u2192 invisible",onclick:u=>{u.stopPropagation(),Fu(i)}})),c.onclick=()=>u_(i),c.oncontextmenu=u=>{u.preventDefault(),u.stopPropagation(),r||Pi(i),p_(i,u.clientX,u.clientY)},f_(c,i),n.appendChild(c),i.type==="scene"&&(r||!M.collapsed.has(i.id)))for(let u of i.children)t(u,s+1)};t(M.root,0);let e=new Set;(function i(s){e.add(s.id),s.type==="scene"&&s.children.forEach(i)})(M.root);for(let i of wo.keys())e.has(i)||wo.delete(i)}function Nc(){Ts&&(Ts.remove(),Ts=null,window.removeEventListener("pointerdown",id,!0))}function id(n){Ts&&!Ts.contains(n.target)&&Nc()}function p_(n,t,e){Nc();let i=ze("div",{className:"ctxmenu"}),s=(o,c,l)=>i.appendChild(ze("div",{className:"ctxitem"+(l?" "+l:""),textContent:o,onclick:()=>{Nc(),c()}})),r=()=>i.appendChild(ze("div",{className:"ctxdiv"}));s("Rename",()=>Tc(n)),s("Fit",()=>yc(n)),r(),n!==M.root&&(s("Duplicate",()=>qu(n)),s("Delete",()=>Zu(n),"danger"),r()),n.type==="scene"?(s("New object",()=>Ju(n)),s("New group",()=>$u(n))):s("New group",()=>Yu(n)),document.body.appendChild(i),Ts=i;let a=i.getBoundingClientRect();i.style.left=Math.min(t,innerWidth-a.width-4)+"px",i.style.top=Math.min(e,innerHeight-a.height-4)+"px",setTimeout(()=>window.addEventListener("pointerdown",id,!0),0)}function sr(){Eo&&Eo.classList.remove("drop-into","drop-before","drop-after"),Eo=null,Ve=null}function m_(n,t,e){let i=Ui&&ys(Ui);if(!i||i===t||Ms(i,t)){sr();return}if(sr(),Eo=e,t===M.root){Ve={parent:M.root,index:M.root.children.length},e.classList.add("drop-into");return}let s=e.getBoundingClientRect(),r=n.clientY-s.top,a=s.height,o=Ai(t),c=o?o.children.indexOf(t):0;r>a*.28&&r<a*.72?(t.type==="scene"?Ve={parent:t,index:t.children.length}:Ve={wrap:t},e.classList.add("drop-into")):r<a*.5?(Ve={parent:o,index:c},e.classList.add("drop-before")):(Ve={parent:o,index:c+1},e.classList.add("drop-after"))}function sd(){let n=Ui&&ys(Ui);n&&Ve&&(Ve.wrap?Xu(Ve.wrap,n):Ve.parent&&Pc(n,Ve.parent,Ve.index)&&(M.collapsed.delete(Ve.parent.id),Pi(n),Me())),sr(),Ui=null}{let n=document.getElementById("tree");n.addEventListener("dragover",t=>{t.target===n&&Ui&&(t.preventDefault(),sr(),Ve={parent:M.root,index:M.root.children.length})}),n.addEventListener("drop",t=>{t.target===n&&(t.preventDefault(),sd())})}window.addEventListener("keydown",n=>{if(n.target.tagName==="INPUT")return;let t=n.key.toLowerCase();if(n.ctrlKey||n.metaKey){if(t==="z"){n.preventDefault(),n.shiftKey?bc():Uu();return}if(t==="y"){n.preventDefault(),bc();return}let i={c:Cc,x:Hu,v:Gu,d:Vu}[t];i&&!M.editObject&&(i(),n.preventDefault());return}switch(t){case"f":Nn();break;case"escape":Cu();break;case"n":M.editObject||ku();break;case"r":M.editObject||Ku();break;case"[":M.editObject||Ic(-1);break;case"]":M.editObject||Ic(1);break;case"delete":case"backspace":M.editObject||(n.preventDefault(),Rc());break}});var Yt=n=>Math.floor(n/10),re=fo,As=(n,t)=>{let e=po();return e.name=n,e.boxes=t,e},Oc=(n,t,e,i,s,r)=>({x0:n,y0:t,z0:e,x1:i,y1:s,z1:r});function rd(){let n=Yt(4465),t=Yt(2985),e=Yt(2700),i=Yt(150),s=As("Floor",[ne(0,0,0,n,1,t,re[9])]),r=Yt(800),a=Yt(2100),o=n-Yt(515)-r,c=n-Yt(900)-r,l=[ne(0,1,0,n,e+1,i,re[5]),ne(0,1,t-i,n,e+1,t,re[5]),ne(0,1,i,i,e+1,t-i,re[5]),ne(n-i,1,i,n,e+1,t-i,re[5])];l=wi(l,Oc(o,1,0,o+r,a+1,i)),l=wi(l,Oc(c,1,t-i,c+r,a+1,t)),l=wi(l,Oc(0,Yt(900),Yt(600),i,Yt(2100),t-Yt(600)));let h=As("Walls",l);h.vis="transparent";let u=Yt(1500),f=Yt(2e3),m=As("Bed",[ne(0,0,0,8,14,8,re[7]),ne(u-8,0,0,u,14,8,re[7]),ne(0,0,f-8,8,14,f,re[7]),ne(u-8,0,f-8,u,14,f,re[7]),ne(0,14,0,u,20,f,re[6]),ne(2,20,0,u-2,24,f-Yt(400),re[10])]);m.pos={x:i+3,y:1,z:t-i-f};let g=Yt(1400),x=Yt(700),p=Yt(740),d=As("Desk",[ne(0,p-4,0,g,p,x,re[8]),ne(0,0,0,6,p-4,6,re[7]),ne(g-6,0,0,g,p-4,6,re[7]),ne(0,0,x-6,6,p-4,x,re[7]),ne(g-6,0,x-6,g,p-4,x,re[7])]),y=Yt(600),_=y-30>>1,T=y>>1,P=As("Computer",[ne(_,0,0,_+30,2,18,re[11]),ne(T-2,2,7,T+2,Yt(160),11,re[11]),ne(0,Yt(160),6,y,Yt(520),9,re[13])]);P.pos={x:Yt(400),y:p,z:Yt(420)};let A=_s();A.name="Desk + Computer",A.pos={x:n-i,y:1,z:Yt(900)},A.rot=1,A.children=[d,P];let R=H=>As(H,[ne(-10,0,-10,11,30,11,re[4]),ne(-2,30,-2,3,54,3,re[14]),ne(-16,54,-16,17,78,17,re[14]),ne(-12,78,-12,13,92,13,re[14])]),Z=R("Plant"),b=R("Plant");Z.pos={x:n-i-Yt(300),y:1,z:i+Yt(300)},b.pos={x:i+Yt(300),y:1,z:i+Yt(300)};let w=_s();return w.children=[s,h,m,A,Z,b],w}var od=n=>Math.abs(n.clientX-M.drag.sx)+Math.abs(n.clientY-M.drag.sy)>3,ad=-1e9;function ld(){let n=(Xt.top-Xt.bottom)/le.h,t=Math.abs(Xt.matrixWorldInverse.elements[5]);return n/Math.max(t,.15)}function cd(n){let t=M.drag;if(!t||t.mode!=="pan"&&t.mode!=="orbit")return!1;let e=n.clientX-t.x,i=n.clientY-t.y;return t.x=n.clientX,t.y=n.clientY,(t.mode==="pan"?Eu:wu)(e,i),!0}function g_(){let n=[],t=[];ni(M.root,{x:0,y:0,z:0},0,null,0,(s,r,a,o)=>{let c=o&&M.selection.has(o)?t:n;for(let l of s.boxes)c.push(mn(l,a,r))});let e=1/0,i=-1/0;for(let s of t)s.y0<e&&(e=s.y0),s.y1>i&&(i=s.y1);return{occ:n,sel:t,minY:e,hgt:t.length?i-e:0}}var x_=(n,t,e,i)=>{if(lc(n.sel??[],n.occ??[],t,e,i))return!0;let s=n.minY??1/0;return s+e<Math.min(0,s)};function __(n){let t=M.drag,e=(i,s,r)=>n.altKey||!x_(t,i,s,r);if(n.shiftKey){t.shiftAnchorY==null&&(t.shiftAnchorY=n.clientY,t.dyBase=t.dyUser??0);let i=t.dyBase+Math.round((t.shiftAnchorY-n.clientY)*ld());e(t.dx,i,t.dz)&&(t.dyUser=i,t.dy=i)}else{t.shiftAnchorY=null;let i=t.dx,s=t.dz,r=js(0);r&&t.start&&(i=r.x-t.start.x,s=r.z-t.start.z);let a=t.dyUser??0,o=Math.floor(.1*(t.hgt??0)),c=!1;for(let l=0;l<=o;l++)if(e(i,a+l,s)){t.dx=i,t.dz=s,t.dy=a+l,c=!0;break}c||(e(i,a,t.dz)&&(t.dx=i),e(t.dx,a,s)&&(t.dz=s),t.dy=a)}for(let i of M.selection)for(let s of M.childMeshes[i]||[])s.position.set(t.dx,t.dy,t.dz);Un.position.set(t.dx,t.dy,t.dz)}function v_(){let n=M.drag,t=Ss(),e=ee({x:Math.round(n.dx),y:0,z:Math.round(n.dz)},-t.rot),i=Math.round(n.dy);for(let s of M.selection){let r=Ti(s);r&&(r.pos.x+=e.x,r.pos.y+=i,r.pos.z+=e.z)}Un.position.set(0,0,0),ke(),Me()}function y_(n){let t=M.drag,e=Math.round((t.sx-n.clientX)/70);e!==t.steps&&(Lc(e-t.steps),t.steps=e,t.dirty=!0)}function M_(){let n=Su();n!=null&&To(n)}function hd(){let n=Ri(),t=dc(n);if(!t)return;let e=Jh(t.x,t.y,t.z);e!==M.lastVox&&(Mu(t,M.selColor),M.lastVox=e),ud(n)}function ud(n=Ri()){let t=dc(n);if(!t){qe.visible=!1;return}let e=Ze(ee(t,M.editXform.rot),M.editXform.off);qe.visible=!0,qe.material.color.set(M.tool==="erase"?11895693:10994876),qe.position.set(e.x+.5,e.y+.5,e.z+.5)}var Fc=n=>n===0?[1,2]:n===1?[0,2]:[0,1];function dd(n,t,e,i){let[s,r]=Fc(n.na),a=[0,0,0],o=[0,0,0],c=(l,h,u)=>{a[l]=Math.min(h,u),o[l]=Math.max(h,u)};return c(n.na,n.s[n.na],n.s[n.na]+i),c(s,n.s[s],t),c(r,n.s[r],e),{x0:a[0],y0:a[1],z0:a[2],x1:o[0]+1,y1:o[1]+1,z1:o[2]+1,c:0}}var fd=n=>{let[t,e]=Fc(n.na);return dd(n,n.c[t],n.c[e],n.hy)};function S_(n){let t=Ri(),e,i;if(t)i=t.addCell.x!==t.cell.x?0:t.addCell.y!==t.cell.y?1:2,e=M.tool==="add"?t.addCell:t.cell;else{let s=Qs(0);if(!s)return;e=s,i=1}M.drag={...n,mode:"box",shiftAnchorY:null,box:{s:[e.x,e.y,e.z],c:[e.x,e.y,e.z],na:i,hy:0},occ:M.tool==="add"?M.editObject.boxes.slice():void 0},qe.visible=!1,pd()}function b_(n){let t=M.drag,e=t.box,[i,s]=Fc(e.na),r=M.tool==="add"&&!n.altKey,a=(o,c,l)=>!r||!lc([dd(e,o,c,l)],t.occ??[],0,0,0);if(n.shiftKey){t.shiftAnchorY===null&&(t.shiftAnchorY=n.clientY,t.hyBase=e.hy);let o=t.hyBase+Math.round((t.shiftAnchorY-n.clientY)*ld());a(e.c[i],e.c[s],o)&&(e.hy=o)}else{t.shiftAnchorY=null;let o=cu(e.na,e.s[e.na]);if(o){let c=[o.x,o.y,o.z];a(c[i],e.c[s],e.hy)&&(e.c[i]=c[i]),a(e.c[i],c[s],e.hy)&&(e.c[s]=c[s])}}pd()}function E_(){let n=fd(M.drag.box);M.tool==="add"?vu(n,M.selColor):yu(n),M.liveMeas=null,Ci(),he(),Me()}function pd(){let n=fd(M.drag.box),t=n.x0,e=n.x1,i=n.y0,s=n.y1,r=n.z0,a=n.z1,o=e-t,c=s-i,l=a-r,h=(f,m,g,x,p,d,y,_)=>({a:bs(f,m,g),b:bs(x,p,d),mid:bs((f+x)/2,(m+p)/2,(g+d)/2),len:y,filled:!0,nolabel:!_}),u=[];u.push(h(t,i,r,e,i,r,o,o>=2)),u.push(h(t,i,r,t,i,a,l,l>=2)),u.push(h(t,i,r,t,s,r,c,c>=2)),u.push(h(e,i,r,e,i,a,0,!1),h(t,i,a,e,i,a,0,!1)),u.push(h(t,s,r,e,s,r,0,!1),h(t,s,r,t,s,a,0,!1),h(e,s,r,e,s,a,0,!1),h(t,s,a,e,s,a,0,!1)),u.push(h(e,i,r,e,s,r,0,!1),h(t,i,a,t,s,a,0,!1),h(e,i,a,e,s,a,0,!1)),M.liveMeas=u,Ci()}Re.addEventListener("pointerdown",n=>{if(M.drag||M.painting)return;Re.setPointerCapture(n.pointerId),go(n.clientX,n.clientY);let t={x:n.clientX,y:n.clientY,sx:n.clientX,sy:n.clientY};if(_o()){n.button===0?M.drag={...t,mode:"pan",meas:"freeze"}:n.button===2?M.drag={...t,mode:"orbit",meas:"clear"}:n.button===1&&(M.drag={...t,mode:"pan",sx:ad});return}if(M.editObject){n.button===0?M.tool==="add"||M.tool==="erase"?S_(t):M.tool==="eyedropper"?M_():(M.painting=!0,M.lastVox=null,hd()):n.button===2?M.drag={...t,mode:"orbit"}:n.button===1&&(M.drag={...t,mode:"pan"});return}let e=uc(),i=e&&M.selection.has(e);n.button===0?i?M.drag={...t,mode:"move",start:js(0),dx:0,dy:0,dz:0,shiftAnchorY:null,...g_()}:M.drag={...t,mode:"pan",clickId:e}:n.button===2?i?M.drag={...t,mode:"rotobj",steps:0}:M.drag={...t,mode:"orbit"}:n.button===1&&(M.drag={...t,mode:"pan",sx:ad})});Re.addEventListener("pointermove",n=>{if(go(n.clientX,n.clientY),_o()){cd(n),hu();return}if(M.editObject&&M.painting){hd();return}if(!M.drag){M.editObject?ud():qe.visible=!1;return}cd(n)||(M.drag.mode==="move"?__(n):M.drag.mode==="rotobj"?y_(n):M.drag.mode==="box"&&b_(n))});Re.addEventListener("pointerup",n=>{try{Re.releasePointerCapture(n.pointerId)}catch{}if(_o()){M.drag&&!od(n)&&(M.drag.meas==="freeze"?uu():M.drag.meas==="clear"&&vn()),M.drag=null;return}if(M.editObject){M.painting?(M.painting=!1,he(),Me()):M.drag&&M.drag.mode==="box"&&E_(),M.drag=null;return}if(M.drag)if(M.drag.mode==="pan"&&!od(n)){let t=M.drag.clickId;t?n.shiftKey?M.selection.has(t)?M.selection.delete(t):M.selection.add(t):M.selection=new Set([t]):n.shiftKey||M.selection.clear(),xc(),he()}else M.drag.mode==="move"?v_():M.drag.mode==="rotobj"&&M.drag.dirty&&(he(),Me());M.drag=null});Re.addEventListener("pointercancel",()=>{if(!M.drag&&!M.painting)return;let n=M.painting;M.drag=null,M.painting=!1,M.liveMeas=null,Ci(),ke(),n&&(he(),Me())});Re.addEventListener("pointerleave",()=>{qe.visible=!1});Re.addEventListener("contextmenu",n=>n.preventDefault());Re.addEventListener("wheel",n=>{n.preventDefault(),Jt.zoom*=n.deltaY>0?1/.95:.95,Jt.zoom=Math.max(6,Math.min(ao,Jt.zoom))},{passive:!1});Re.addEventListener("dblclick",n=>{if(M.editObject)return;go(n.clientX,n.clientY);let t=uc();t&&ws(Ti(t),!0)});for(let n of["pointerdown","pointermove","pointerup","pointerleave","wheel","keydown","dblclick"])window.addEventListener(n,ms,{passive:!0,capture:!0});var w_=()=>Math.abs(Jt.azim-Gt.azim)<.001&&Math.abs(Jt.elev-Gt.elev)<.001&&Math.abs(Jt.zoom-Gt.zoom)<.001&&Gt.target.distanceToSquared(Jt.target)<1e-6;function md(){let n=Re.getBoundingClientRect();le.w=n.width,le.h=n.height,le.x=n.left,le.y=n.top}function gd(){let n=Math.max(1,Math.round(le.w)),t=Math.max(1,Math.round(le.h)),e=Math.min(devicePixelRatio,2);$n.getPixelRatio()!==e&&$n.setPixelRatio(e),(Re.width!==Math.floor(n*e)||Re.height!==Math.floor(t*e))&&($n.setSize(n,t,!1),ms())}window.addEventListener("resize",()=>{md(),gd()});function xd(){requestAnimationFrame(xd),gd(),Au(),(qs.tail>0||!w_())&&($n.render(Ee,Xt),du(),qs.tail>0&&qs.tail--)}function T_(){Nu()||(M.root=rd()),M.path=[M.root],M.editObject=null,M.selection.clear(),ke(),he(),Nn(),si(),md(),xd()}T_();
/**
 * @license
