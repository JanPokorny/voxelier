...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function Pl(){return new ln({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ka(),fragmentShader:`
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function Ll(){return new ln({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ka(),fragmentShader:`
...
`)}function g0(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(Hi).join(`
`)}function x0(n){let t=[];for(let e in n){let i=n[e];i!==!1&&t.push("#define "+e+" "+i)}return t.join(`
`)}function _0(n,t){let e={},i=n.getProgramParameter(t,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){let r=n.getActiveAttrib(t,s),a=r.name,o=1;r.type===n.FLOAT_MAT2&&(o=2),r.type===n.FLOAT_MAT3&&(o=3),r.type===n.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:n.getAttribLocation(t,a),locationSize:o}}return e}function Hi(n){return n!==""}function kl(n,t){let e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Vl(n,t){return n.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}var v0=/^[ \t]*#include +<([\w\d./]+)>/gm;function da(n){return n.replace(v0,M0)}var y0=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function M0(n,t){let e=Ut[t];if(e===void 0){let i=y0.get(t);if(i!==void 0)e=Ut[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,i);else throw new Error("Can not resolve #include <"+t+">")}return da(e)}var S0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Hl(n){return n.replace(S0,b0)}function b0(n,t,e,i){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Gl(n){let t="precision "+n.precision+` float;
precision `+n.precision+" int;";return n.precision==="highp"?t+=`
#define HIGH_PRECISION`:n.precision==="mediump"?t+=`
#define MEDIUM_PRECISION`:n.precision==="lowp"&&(t+=`
#define LOW_PRECISION`),t}function E0(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===eh?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===Na?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===En&&(t="SHADOWMAP_TYPE_VSM"),t}function w0(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case qi:case Zi:t="ENVMAP_TYPE_CUBE";break;case jr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function T0(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Zi:t="ENVMAP_MODE_REFRACTION";break}return t}function A0(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Oa:t="ENVMAP_BLENDING_MULTIPLY";break;case gd:t="ENVMAP_BLENDING_MIX";break;case xd:t="ENVMAP_BLENDING_ADD";break}return t}function R0(n){let t=n.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function C0(n,t,e,i){let s=n.getContext(),r=e.defines,a=e.vertexShader,o=e.fragmentShader,c=E0(e),l=w0(e),h=T0(e),u=A0(e),f=R0(e),m=e.isWebGL2?"":m0(e),x=g0(e),_=x0(r),p=s.createProgram(),d,M,v=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      }`}));Ga.frustumCulled=!1;Ga.renderOrder=-1e9;Ee.add(Ga);function Ah(){Th.uGround.value=Math.max(0,Math.min(1,(Gt.elev+.05)/.1))}Ee.add(new $r(16777215,.62));var Xe=new Vs(16777215,.78);Xe.castShadow=!0;Xe.shadow.mapSize.set(4096,4096);Xe.shadow.normalBias=.15;Xe.shadow.bias=-2e-4;Ee.add(Xe);Ee.add(Xe.target);var Rh=new Vs(16777215,.16);Rh.position.set(-6,5,-7);Ee.add(Rh);var Gs={tail:60},rs=()=>{Gs.tail=30},Wa=new Pn(1,1,1),Ws=new I,no=new I,ax=new At("#0f1115"),bh=new Map,Eh=new Map;function Xs(n){let t=bh.get(n);return t||(t=new At().setHex(n),bh.set(n,t)),t}function Xa(n){let t=Eh.get(n);return t||(t=new At().setHex(n).lerp(ax,.62),Eh.set(n,t)),t}var Ya=new Bs({vertexColors:!0,side:je}),cx=.42,qa=new Bs({vertexColors:!0,transparent:!0,opacity:cx,side:je,depthWrite:!1});qa.shadowSide=rn;var Ch=new Ki({colorWrite:!1,side:je}),pi=new be(new Qi(8e3,8e3),new Zr({opacity:.32}));pi.rotation.x=-Math.PI/2;pi.position.y=0;pi.receiveShadow=!0;pi.renderOrder=-1;Ee.add(pi);var Zn=new Tn;Ee.add(Zn);var Ln=new Tn;Ee.add(Ln);var Ye=new ui(new es(Wa),new Yn({color:10994876,depthTest:!1}));Ye.visible=!1;Ye.renderOrder=999;Ee.add(Ye);var mi=new ui(new Oe,new Yn({vertexColors:!0,transparent:!0,depthTest:!1}));mi.renderOrder=998;mi.visible=!1;Ee.add(mi);var mn=new Kr,Jn=new Ht,io=new I,Ys=new I;var Za=(n,t,e)=>n+65536+(t+65536)*131072+(e+65536)*131072*131072,un=(n,t)=>({x:n.x+t.x,y:n.y+t.y,z:n.z+t.z});function le(n,t){let{x:e,y:i,z:s}=n;switch(t&3){case 1:return{x:-s,y:i,z:e};case 2:return{x:-e,y:i,z:-s};case 3:return{x:s,y:i,z:-e};default:return{x:e,y:i,z:s}}}var os=(n,t)=>({rot:n.rot+t.rot&3,off:un(le(t.off,n.rot),n.off)}),Ph=n=>{let t=4-(n.rot&3)&3,e=le(n.off,t);return{rot:t,off:{x:-e.x,y:-e.y,z:-e.z}}},Ja=n=>n.slice(1).reduce((t,e)=>os(t,{off:e.pos,rot:e.rot}),{off:{x:0,y:0,z:0},rot:0}),as=n=>"#"+(n>>>0).toString(16).padStart(6,"0").slice(-6),$a=1,so=()=>"n"+$a++,cs=()=>$a,ls=n=>{$a=n};var ne=(n,t,e,i,s,r,a)=>({x0:n,y0:t,z0:e,x1:i,y1:s,z1:r,c:a}),Lh=(n,t)=>n.x0<t.x1&&t.x0<n.x1&&n.y0<t.y1&&t.y0<n.y1&&n.z0<t.z1&&t.z0<n.z1;function Ih(n,t,e){let i=Math.max(n.x0,t.x0),s=Math.max(n.y0,t.y0),r=Math.max(n.z0,t.z0),a=Math.min(n.x1,t.x1),o=Math.min(n.y1,t.y1),c=Math.min(n.z1,t.z1);if(i>=a||s>=o||r>=c){e.push(n);return}let l=n.c;n.x0<i&&e.push({...n,x1:i}),a<n.x1&&e.push({...n,x0:a}),n.y0<s&&e.push({x0:i,y0:n.y0,z0:n.z0,x1:a,y1:s,z1:n.z1,c:l}),o<n.y1&&e.push({x0:i,y0:o,z0:n.z0,x1:a,y1:n.y1,z1:n.z1,c:l}),n.z0<r&&e.push({x0:i,y0:s,z0:n.z0,x1:a,y1:o,z1:r,c:l}),c<n.z1&&e.push({x0:i,y0:s,z0:c,x1:a,y1:o,z1:n.z1,c:l})}function Uh(n,t,e){let i=[];for(let s of n)Lh(s,t)?Ih(s,t,i):i.push(s);return i.push({...t,c:e}),i}function hs(n,t){let e=[];for(let i of n)Lh(i,t)?Ih(i,t,e):e.push(i);return e}function Dh(n,t,e,i,s){let r=-1;for(let h=0;h<n.length;h++){let u=n[h];if(t>=u.x0&&t<u.x1&&e>=u.y0&&e<u.y1&&i>=u.z0&&i<u.z1){r=h;break}}if(r===-1)return null;let a=n[r].c;if(a===s)return null;let o=(h,u)=>{let f=h.x0<u.x1&&u.x0<h.x1,m=h.y0<u.y1&&u.y0<h.y1,x=h.z0<u.z1&&u.z0<h.z1;return m&&x&&(h.x1===u.x0||u.x1===h.x0)||f&&x&&(h.y1===u.y0||u.y1===h.y0)||f&&m&&(h.z1===u.z0||u.z1===h.z0)},c=new Set([r]),l=[r];for(;l.length;){let h=n[l.pop()];for(let u=0;u<n.length;u++)!c.has(u)&&n[u].c===a&&o(h,n[u])&&(c.add(u),l.push(u))}return n.map((h,u)=>c.has(u)?{...h,c:s}:h)}function Nh(n,t){for(let e of n){let i=(e.x1-e.x0)*(e.y1-e.y0)*(e.z1-e.z0);t.set(e.c,(t.get(e.c)||0)+i)}}function gn(n,t){for(let e of n)e.x0<t.min.x&&(t.min.x=e.x0),e.y0<t.min.y&&(t.min.y=e.y0),e.z0<t.min.z&&(t.min.z=e.z0),e.x1>t.max.x&&(t.max.x=e.x1),e.y1>t.max.y&&(t.max.y=e.y1),e.z1>t.max.z&&(t.max.z=e.z1)}function xn(n,t,e){let i=le({x:n.x0,y:n.y0,z:n.z0},t),s=le({x:n.x1-1,y:n.y1-1,z:n.z1-1},t);return{x0:Math.min(i.x,s.x)+e.x,y0:Math.min(i.y,s.y)+e.y,z0:Math.min(i.z,s.z)+e.z,x1:Math.max(i.x,s.x)+e.x+1,y1:Math.max(i.y,s.y)+e.y+1,z1:Math.max(i.z,s.z)+e.z+1,c:n.c}}var Fe=16,ze=Math.floor;function ro(n){if(!n.length)return()=>!1;let t=1/0,e=1/0,i=1/0,s=-1/0,r=-1/0,a=-1/0;for(let _ of n)_.x0<t&&(t=_.x0),_.y0<e&&(e=_.y0),_.z0<i&&(i=_.z0),_.x1>s&&(s=_.x1),_.y1>r&&(r=_.y1),_.z1>a&&(a=_.z1);let o=ze(t/Fe),c=ze(e/Fe),l=ze(i/Fe),h=ze((s-1)/Fe)-o+1,u=ze((r-1)/Fe)-c+1,f=ze((a-1)/Fe)-l+1,m=Array.from({length:h*u*f},()=>[]),x=(_,p,d)=>((_-o)*u+(p-c))*f+(d-l);for(let _ of n)for(let p=ze(_.x0/Fe);p<=ze((_.x1-1)/Fe);p++)for(let d=ze(_.y0/Fe);d<=ze((_.y1-1)/Fe);d++)for(let M=ze(_.z0/Fe);M<=ze((_.z1-1)/Fe);M++)m[x(p,d,M)].push(_);return(_,p,d)=>{let M=ze(_/Fe),v=ze(p/Fe),T=ze(d/Fe);if(M<o||v<c||T<l||M-o>=h||v-c>=u||T-l>=f)return!1;for(let L of m[x(M,v,T)])if(_>=L.x0&&_<L.x1&&p>=L.y0&&p<L.y1&&d>=L.z0&&d<L.z1)return!0;return!1}}var Oh=(n,t,e,i)=>{for(let s of n)if(t>=s.x0&&t<s.x1&&e>=s.y0&&e<s.y1&&i>=s.z0&&i<s.z1)return!0;return!1};var Ka=(n,t,e,i,s)=>n.some(r=>t.some(a=>r.x0+e<a.x1&&a.x0<r.x1+e&&r.y0+i<a.y1&&a.y0<r.y1+i&&r.z0+s<a.z1&&a.z0<r.z1+s));var Fh=[7041116,10855821,12040100,14472900,13343102,14532265,15787730,9268835,13935475,10249796,11895693,7170165,8226199,6055805,6986062,10994876],zh={visible:0,transparent:1,invisible:2},Bh={visible:"transparent",transparent:"invisible",invisible:"visible"},qs=()=>({type:"object",id:so(),name:"",pos:{x:0,y:0,z:0},rot:0,vis:"visible",boxes:[]}),us=()=>({type:"scene",id:so(),name:"",pos:{x:0,y:0,z:0},rot:0,vis:"visible",children:[]});function oo(n){let t={id:so(),name:n.name,pos:{...n.pos},rot:n.rot,vis:n.vis};return n.type==="object"?{type:"object",...t,boxes:n.boxes.map(e=>({...e}))}:{type:"scene",...t,children:n.children.map(oo)}}var gi=n=>g.context.children.find(t=>t.id===n);function ds(n,t=g.root,e=[]){if(e.push(t),t===n)return e.slice();if(t.type==="scene")for(let i of t.children){let s=ds(n,i,e);if(s)return s}return e.pop(),null}function fs(n,t=g.root){if(t.id===n)return t;if(t.type==="scene")for(let e of t.children){let i=fs(n,e);if(i)return i}return null}function xi(n){let t=ds(n);return t&&t.length>1?t[t.length-2]:null}function ps(n,t){return n===t?!0:n.type!=="scene"?!1:n.children.some(e=>ps(e,t))}var ms=()=>Ja(g.path),Zs=n=>Ja(ds(n)||[g.root]),Qe=()=>({min:{x:1e9,y:1e9,z:1e9},max:{x:-1e9,y:-1e9,z:-1e9}});function $n(n,t,e,i){if(n.type==="object")gn(n.boxes.map(s=>xn(s,e,t)),i);else for(let s of n.children)$n(s,un(t,le(s.pos,e)),e+s.rot&3,i);return i}function ao(n,t){let e=ee.getBoundingClientRect();Jn.x=(n-e.left)/e.width*2-1,Jn.y=-((t-e.top)/e.height)*2+1}function ja(){mn.setFromCamera(Jn,Yt);let n=mn.intersectObjects(g.pickMeshes,!1);return n.length?n[0].object.userData.childId??null:null}var kh=new sn(new I(0,1,0),0);function gs(n){return mn.setFromCamera(Jn,Yt),kh.constant=-n,mn.ray.intersectPlane(kh,io)?{x:Math.floor(io.x),y:n,z:Math.floor(io.z)}:null}function xs(){if(!g.pickMeshes.length)return null;mn.setFromCamera(Jn,Yt);let n=mn.intersectObjects(g.pickMeshes,!1);if(!n.length)return null;let t=n[0],e=g.editXform.off,i=le({x:t.point.x-e.x,y:t.point.y-e.y,z:t.point.z-e.z},-g.editXform.rot),s=t.face?t.face.normal:{x:0,y:1,z:0},r=Math.floor(i.x-s.x*.5),a=Math.floor(i.y-s.y*.5),o=Math.floor(i.z-s.z*.5);return{cell:{x:r,y:a,z:o},addCell:{x:r+Math.round(s.x),y:a+Math.round(s.y),z:o+Math.round(s.z)}}}function Js(n){let t=gs(n+g.editXform.off.y);if(!t)return null;let e=le({x:t.x-g.editXform.off.x,y:0,z:t.z-g.editXform.off.z},-g.editXform.rot);return{x:Math.round(e.x),y:n,z:Math.round(e.z)}}var _s=(n,t,e)=>{let i=le({x:n,y:t,z:e},g.editXform.rot);return new I(i.x+g.editXform.off.x,i.y+g.editXform.off.y,i.z+g.editXform.off.z)};function co(n=xs()){return g.tool==="add"?n?n.addCell:Js(0):n?n.cell:null}var lx=new At(10994876),hx=new At(6055805),vs=()=>g.editObject?g.tool==="measure":g.measMode,Qa=()=>{g.measFieldCache=null};function dn(){g.liveMeas=null,g.frozenMeas=[],_i()}function Vh(){if(g.measFieldCache)return g.measFieldCache;let n=[],t;g.editObject?(n.push(...g.editObject.boxes),t=_s):(vi(g.root,{x:0,y:0,z:0},0,null,0,(o,c,l,h)=>{if(h)for(let u of o.boxes)n.push(xn(u,l,c))}),t=(o,c,l)=>new I(o,c,l));let e=Qe();gn(n,e);let i=n.length===0,s={x:e.min.x,y:e.min.y,z:e.min.z},r={x:e.max.x-1,y:e.max.y-1,z:e.max.z-1},a=n.length>64?ro(n):(o,c,l)=>Oh(n,o,c,l);return g.measFieldCache={has:a,mn:s,mx:r,toW:t,empty:i},g.measFieldCache}function ux(){let n=Vh();if(n.empty)return null;let t=null;if(g.editObject){let e=xs();t=e?{...e.cell}:Js(0)}else{mn.setFromCamera(Jn,Yt);let e=g.pickMeshes.length?mn.intersectObjects(g.pickMeshes,!1):[];if(e.length){let i=e[0],s=i.face?i.face.normal:{x:0,y:0,z:0};t={x:Math.floor(i.point.x-s.x*.5),y:Math.floor(i.point.y-s.y*.5),z:Math.floor(i.point.z-s.z*.5)}}else t=gs(0)}return t?{x:Math.max(n.mn.x,Math.min(n.mx.x,t.x)),y:Math.max(n.mn.y,Math.min(n.mx.y,t.y)),z:Math.max(n.mn.z,Math.min(n.mx.z,t.z))}:null}function dx(n){let t=Vh(),e=["x","y","z"],i=[];for(let s=0;s<3;s++){let r=e[s],a=e[(s+1)%3],o=e[(s+2)%3],c=t.mn[r],l=t.mx[r],h=[n.x,n.y,n.z],u=m=>(h[s]=m,t.has(h[0],h[1],h[2])),f=c;for(;f<=l;){let m=u(f),x=f;for(;x+1<=l&&u(x+1)===m;)x++;let _=p=>{let d={};return d[r]=p,d[a]=n[a]+.5,d[o]=n[o]+.5,t.toW(d.x,d.y,d.z)};i.push({a:_(f),b:_(x+1),mid:_((f+x+1)/2),len:x-f+1,filled:m}),f=x+1}}return i}function Hh(){let n=ux();g.liveMeas=n?dx(n):null,_i()}function Gh(){g.liveMeas&&g.liveMeas.length&&(g.frozenMeas.push(g.liveMeas),_i())}function _i(){let n=document.getElementById("measure");n.innerHTML="",g.measLabels=[];let t=[];g.liveMeas&&t.push({s:g.liveMeas,fz:!1});for(let r of g.frozenMeas)t.push({s:r,fz:!0});let e=[],i=[];for(let r of t)for(let a of r.s){let o=a.filled?lx:hx;if(e.push(a.a.x,a.a.y,a.a.z,a.b.x,a.b.y,a.b.z),i.push(o.r,o.g,o.b,o.r,o.g,o.b),a.nolabel)continue;let c=document.createElement("div");c.className="mlab"+(a.filled?"":" empty")+(r.fz?" frozen":""),c.textContent=String(a.len),n.appendChild(c),g.measLabels.push({el:c,w:a.mid})}mi.geometry.dispose();let s=new Oe;s.setAttribute("position",new me(e,3)),s.setAttribute("color",new me(i,3)),mi.geometry=s,mi.visible=e.length>0}function Wh(){if(!g.measLabels.length)return;let n=ee.getBoundingClientRect();for(let t of g.measLabels){if(Ys.copy(t.w).project(Yt),Ys.z>1){t.el.style.display="none";continue}t.el.style.display="",t.el.style.left=(Ys.x*.5+.5)*n.width+"px",t.el.style.top=(-Ys.y*.5+.5)*n.height+"px"}}var tc=new I(40,150,30).normalize();function fx(n){if(n.max.x<n.min.x)return;let t=(n.min.x+n.max.x)/2,e=(n.min.y+n.max.y)/2,i=(n.min.z+n.max.z)/2,s=.5*Math.hypot(n.max.x-n.min.x,n.max.y-n.min.y,n.max.z-n.min.z)+8,r=s+130;Xe.position.set(t+tc.x*r,e+tc.y*r,i+tc.z*r),Xe.target.position.set(t,e,i),Xe.target.updateMatrixWorld();let a=Xe.shadow.camera;a.left=-s,a.right=s,a.top=s,a.bottom=-s,a.near=Math.max(1,r-s-20),a.far=r+s+20,a.updateProjectionMatrix(),Xe.shadow.normalBias=4*s/Xe.shadow.mapSize.x}function px(){let n=new Set;for(let t of g.meshes){Ee.remove(t);let e=t.geometry;e&&e!==Wa&&!n.has(e)&&(e.dispose(),n.add(e))}g.meshes=[],Zn.clear(),g.editRemesh&&(cancelAnimationFrame(g.editRemesh),g.editRemesh=0),g.editMesh=null}var mx=[{a:0,hi:!0,u:1,v:2,n:[1,0,0]},{a:0,hi:!1,u:2,v:1,n:[-1,0,0]},{a:1,hi:!0,u:2,v:0,n:[0,1,0]},{a:1,hi:!1,u:0,v:2,n:[0,-1,0]},{a:2,hi:!0,u:0,v:1,n:[0,0,1]},{a:2,hi:!1,u:1,v:0,n:[0,0,-1]}],gx=[1,.86,.72,.6,.5];function Yh(n,t,e){let i=[],s=[],r=[],a=n.map(u=>[u.x0,u.y0,u.z0]),o=n.map(u=>[u.x1,u.y1,u.z1]),c=e?ro(n):null,l=[0,0,0];for(let u=0;u<n.length;u++){let f=t(n[u].c),m=f.r,x=f.g,_=f.b,p=a[u],d=o[u];for(let M of mx){let{a:v,u:T,v:L}=M,A=M.hi?d[v]:p[v],R=M.hi?A:A-1,Y=[];for(let C=0;C<n.length;C++){if(C===u||(M.hi?a[C][v]:o[C][v])!==A)continue;let U=Math.max(a[C][T],p[T]),N=Math.min(o[C][T],d[T]),G=Math.max(a[C][L],p[L]),W=Math.min(o[C][L],d[L]);U<N&&G<W&&Y.push([U,G,N,W])}let b=[[p[T],p[L],d[T],d[L]]];for(let C of Y){let U=[];for(let N of b){let G=Math.max(N[0],C[0]),W=Math.max(N[1],C[1]),k=Math.min(N[2],C[2]),q=Math.min(N[3],C[3]);if(G>=k||W>=q){U.push(N);continue}N[0]<G&&U.push([N[0],N[1],G,N[3]]),k<N[2]&&U.push([k,N[1],N[2],N[3]]),N[1]<W&&U.push([G,N[1],k,W]),q<N[3]&&U.push([G,q,k,N[3]])}if(b=U,!b.length)break}let w=[0,0,0],H=(C,U)=>(w[v]=A,w[T]=C,w[L]=U,[w[0],w[1],w[2]]),Z=(C,U)=>{if(!c)return 1;let N=0,G=l;G[v]=R;for(let W=-1;W<=0;W++)for(let k=-1;k<=0;k++)G[T]=C+W,G[L]=U+k,c(G[0],G[1],G[2])&&N++;return gx[N]},et=(C,U,N,G)=>{let W=H(C,U),k=H(N,U),q=H(N,G),Q=H(C,G),ct=Z(C,U),X=Z(N,U),J=Z(N,G),at=Z(C,G),pt=[[W,ct],[k,X],[q,J],[W,ct],[q,J],[Q,at]];for(let[dt,Et]of pt)i.push(dt[0],dt[1],dt[2]),s.push(M.n[0],M.n[1],M.n[2]),r.push(m*Et,x*Et,_*Et)};for(let C of b){let[U,N,G,W]=C;if(!c){et(U,N,G,W);continue}for(let k=U;k<G;k++)et(k,N,k+1,N+1),W-1>N&&et(k,W-1,k+1,W);for(let k=N+1;k<W-1;k++)et(U,k,U+1,k+1),G-1>U&&et(G-1,k,G,k+1);U+1<G-1&&N+1<W-1&&et(U+1,N+1,G-1,W-1)}}}if(!i.length)return null;let h=new Oe;return h.setAttribute("position",new me(i,3)),h.setAttribute("normal",new me(s,3)),h.setAttribute("color",new me(r,3)),h}function $s(n,t,{transparent:e=!1,pick:i=!1,childId:s=null}={}){if(!n.length)return null;let r=Yh(n,t,!e);if(!r)return null;let a=new be(r,e?qa:Ya);if(a.castShadow=!0,a.receiveShadow=!0,Ee.add(a),g.meshes.push(a),e){a.renderOrder=2;let o=new be(r,Ch);o.renderOrder=1,o.castShadow=!1,o.receiveShadow=!1,Ee.add(o),g.meshes.push(o)}return i&&(a.userData.childId=s,g.pickMeshes.push(a),(g.childMeshes[s]||(g.childMeshes[s]=[])).push(a)),a}function vi(n,t,e,i,s,r){let a=Math.max(s,zh[n.vis||"visible"]);if(!(n===g.editObject||a>=2))if(n.type==="object")r(n,t,e,i,a===1);else for(let o of n.children)vi(o,un(t,le(o.pos,e)),e+o.rot&3,n===g.context?o.id:i,a,r)}var Xh=(n,t,e,i)=>{for(let s of n.boxes)i.push(xn(s,e,t));return i};function qh(){let{off:n,rot:t}=g.editXform;if(Zn.position.set(n.x,n.y,n.z),Zn.rotation.set(0,-t*Math.PI/2,0),Zn.updateMatrixWorld(!0),g.editMesh){Zn.remove(g.editMesh),g.editMesh.geometry.dispose();let i=g.meshes.indexOf(g.editMesh);i>=0&&g.meshes.splice(i,1)}let e=Yh(g.editObject.boxes,Xs,!0);g.editMesh=e?new be(e,Ya):null,g.editMesh&&(g.editMesh.castShadow=g.editMesh.receiveShadow=!0,Zn.add(g.editMesh),g.meshes.push(g.editMesh)),g.pickMeshes=g.editMesh?[g.editMesh]:[]}function xx(){g.editRemesh||(g.editRemesh=requestAnimationFrame(()=>{g.editRemesh=0,qh(),rs()}))}function ec(){g.voxVer++,Qa(),xx()}function Zh(n,t){g.editObject.boxes=Uh(g.editObject.boxes,n,t),ec()}function Jh(n){g.editObject.boxes=hs(g.editObject.boxes,n),ec()}function $h(n,t){let e=Dh(g.editObject.boxes,n.x,n.y,n.z,t);e&&(g.editObject.boxes=e,ec())}function ke(){px(),g.pickMeshes=[],g.childMeshes={},g.childBox={},g.voxVer++,Qa();let n={x:0,y:0,z:0},t=Qe();if(g.editObject){g.editXform=os(ms(),{off:g.editObject.pos,rot:g.editObject.rot});let e=[];vi(g.root,n,0,null,0,(i,s,r)=>Xh(i,s,r,e)),gn(e,t),$s(e,i=>Xs(i),{transparent:!0}),qh(),$n(g.editObject,g.editXform.off,g.editXform.rot,t)}else{let e=new Map,i=new Map,s=[],r=[];vi(g.root,n,0,null,0,(a,o,c,l,h)=>{let u=Xh(a,o,c,[]);if(gn(u,t),l){let f=h?i:e,m=f.get(l);m?m.push(...u):f.set(l,u),gn(u,g.childBox[l]||(g.childBox[l]=Qe()))}else(h?r:s).push(...u)}),$s(s,a=>Xa(a)),$s(r,a=>Xa(a),{transparent:!0});for(let a of new Set([...e.keys(),...i.keys()])){let o=e.get(a);o&&$s(o,l=>Xs(l),{pick:!0,childId:a});let c=i.get(a);c&&$s(c,l=>Xs(l),{transparent:!0})}}g.sceneBox=t,fx(t),nc(),rs()}function _x(n,t,e){let i=new Pn(t.x-n.x,t.y-n.y,t.z-n.z),s=new ui(new es(i),new Yn({color:e,depthTest:!1}));return s.position.set((n.x+t.x)/2,(n.y+t.y)/2,(n.z+t.z)/2),s.renderOrder=999,i.dispose(),s}function nc(){for(let n of Ln.children)n.geometry?.dispose?.();if(Ln.clear(),Ln.position.set(0,0,0),!g.editObject)for(let n of g.selection){let t=g.childBox[n];t&&t.max.x>=t.min.x&&Ln.add(_x(t.min,t.max,15787730))}}var Ks=new I,ic=new I,sc=new I,Kh=new I,vx=new I(0,1,0);function jh(n,t){let e=ee.getBoundingClientRect(),i=(Yt.top-Yt.bottom)/e.height;Yt.getWorldDirection(ic),sc.crossVectors(ic,vx).normalize(),Kh.crossVectors(sc,ic).normalize(),Wt.target.addScaledVector(sc,-n*i),Wt.target.addScaledVector(Kh,t*i)}function Qh(n,t){Wt.azim-=n*.012,Wt.elev=Math.max(-.35,Math.min(Math.PI/2,Wt.elev+t*.012))}function tu(n){n.max.x<n.min.x||(Wt.target.set((n.min.x+n.max.x)/2,(n.min.y+n.max.y)/2,(n.min.z+n.max.z)/2),Wt.zoom=Math.max(8,Math.min(eo,Math.max(n.max.x-n.min.x,n.max.y-n.min.y,n.max.z-n.min.z)*1.5+8)))}function In(){let n=Qe();if(g.editObject){if($n(g.editObject,g.editXform.off,g.editXform.rot,n),n.max.x<n.min.x){let t=g.editXform.off;Wt.target.set(t.x,t.y+6,t.z),Wt.zoom=41;return}}else for(let t in g.childBox){let e=g.childBox[t];n.min.x=Math.min(n.min.x,e.min.x),n.min.y=Math.min(n.min.y,e.min.y),n.min.z=Math.min(n.min.z,e.min.z),n.max.x=Math.max(n.max.x,e.max.x),n.max.y=Math.max(n.max.y,e.max.y),n.max.z=Math.max(n.max.z,e.max.z)}if(n.max.x<n.min.x){Wt.target.set(0,1,0),Wt.zoom=23;return}tu(n)}function rc(n){if(n===g.root){In();return}let t=Zs(n);tu($n(n,t.off,t.rot,Qe()))}function eu(){Gt.azim+=(Wt.azim-Gt.azim)*.22,Gt.elev+=(Wt.elev-Gt.elev)*.22,Gt.zoom+=(Wt.zoom-Gt.zoom)*.25,Gt.target.lerp(Wt.target,.25);let n=Math.cos(Gt.elev),t=Math.sin(Gt.elev);Ks.set(n*Math.sin(Gt.azim),t,n*Math.cos(Gt.azim)),Yt.position.copy(Gt.target).addScaledVector(Ks,wh);let e=fh.clamp((Gt.elev-1.45)/(Math.PI/2-1.45),0,1);no.set(-Math.sin(Gt.azim),0,-Math.cos(Gt.azim)),Ws.set(0,1,0).lerp(no,e),Ws.lengthSq()<1e-6&&Ws.copy(no),Yt.up.copy(Ws.normalize()),Yt.lookAt(Gt.target);let i=ee.getBoundingClientRect(),s=i.width/i.height,r=Gt.zoom,a=r*s;Yt.left=-a/2,Yt.right=a/2,Yt.top=r/2,Yt.bottom=-r/2;let o=Yt.position,c=1/0,l=-1/0,h=(_,p,d)=>{let M=(o.x-_)*Ks.x+(o.y-p)*Ks.y+(o.z-d)*Ks.z;M<c&&(c=M),M>l&&(l=M)},u=g.sceneBox;if(u&&u.max.x>=u.min.x)for(let _ of[u.min.x,u.max.x])for(let p of[u.min.y,u.max.y])for(let d of[u.min.z,u.max.z])h(_,p,d);let f=Gt.target.x,m=Gt.target.z,x=4e3;for(let _ of[-x,x])for(let p of[-x,x])h(f+_,0,m+p);c>l&&(c=.1,l=4e3),Yt.near=c-10,Yt.far=l+10,Yt.zoom=1,Yt.updateProjectionMatrix(),pi.position.set(Gt.target.x,0,Gt.target.z),Ah()}var lo=()=>{ke(),fe()};function yx(){if(g.path.length>1){let n=g.path.pop();g.context=g.path[g.path.length-1],g.selection=new Set([n.id]),g.editObject=null,dn(),lo()}}function Mx(){let n=g.editObject;g.editObject=null,g.selection=new Set([n.id]),dn(),lo()}function nu(){g.editObject?Mx():yx()}function yi(n){let t=ds(n);t&&(g.path=t.slice(0,-1),g.context=g.path[g.path.length-1],g.selection=new Set([n.id]),g.editObject=null,lo())}function iu(n){return n.type==="object"?g.editObject===n:g.context===n&&!g.editObject}function Mi(n,t){let e=ds(n);e&&(n.type==="scene"?(g.path=e,g.context=n,g.selection.clear(),g.editObject=null,g.tool="add"):(g.path=e.slice(0,-1),g.context=g.path[g.path.length-1],g.editObject=n,g.selection.clear(),g.tool="add"),dn(),lo(),t&&In())}var Sx=200,Un=[],Si=-1,oc=!1,bx=n=>({rootJSON:n,uid:cs(),pathIds:g.path.map(t=>t.id),selection:[...g.selection],editId:g.editObject?g.editObject.id:null,collapsed:[...g.collapsed]});function su(n){if(oc)return;let t=bx(n),e=Un[Si];e&&e.rootJSON===t.rootJSON&&e.editId===t.editId||(Un.length=Si+1,Un.push(t),Un.length>Sx&&Un.shift(),Si=Un.length-1)}function ru(n){oc=!0,ls(n.uid),g.root=ys(JSON.parse(n.rootJSON)),g.path=[];let t=g.root;for(let e of n.pathIds){let i=t.id===e?t:t.type==="scene"?t.children.find(s=>s.id===e):null;if(!i)break;t=i,g.path.push(t)}g.path.length||(g.path=[g.root]),g.context=g.path[g.path.length-1],g.editObject=n.editId?fs(n.editId):null,g.selection=new Set(n.selection.filter(e=>g.context.children.some(i=>i.id===e))),g.collapsed=new Set(n.collapsed),g.drag=null,g.painting=!1,g.lastVox=null,ke(),fe(),he(),oc=!1}function ou(){Ms(),Si>0&&ru(Un[--Si])}function ac(){Ms(),Si<Un.length-1&&ru(Un[++Si])}var au="voxelier-v11";function ho(n){let t={id:n.id,nm:n.name||"",p:n.pos,r:n.rot,vs:n.vis||"visible"};return n.type==="object"?{t:"o",...t,b:n.boxes.map(e=>[e.x0,e.y0,e.z0,e.x1,e.y1,e.z1,e.c])}:{t:"s",...t,c:n.children.map(ho)}}function ys(n){let t={id:n.id,name:n.nm||"",pos:n.p,rot:n.r,vis:n.vs||"visible"};return n.t==="o"?{type:"object",...t,boxes:n.b.map(e=>({x0:e[0],y0:e[1],z0:e[2],x1:e[3],y1:e[4],z1:e[5],c:e[6]}))}:{type:"scene",...t,children:n.c.map(ys)}}function Ms(){clearTimeout(g.saveT??void 0),g.saveT=null;let n=JSON.stringify(ho(g.root));su(n);try{localStorage.setItem(au,`{"uid":${cs()},"root":${n}}`)}catch{}}function he(){clearTimeout(g.saveT??void 0),g.saveT=setTimeout(Ms,250)}function cu(){try{let n=JSON.parse(localStorage.getItem(au));return!n||!n.root?!1:(ls(n.uid||1),g.root=ys(n.root),!0)}catch{return!1}}var bi=()=>{ke(),fe(),he()},lu=n=>n<0?-Math.round(-n):Math.round(n);function hu(n){n.vis=Bh[n.vis||"visible"],bi()}function cc(n){let t=prompt("Name",n.name||"");t!=null&&(n.name=t.trim(),fe(),he())}var uu=()=>[...g.selection].map(n=>gi(n)).filter(n=>!!n),lc=n=>{let t=oo(n);return t.pos={x:n.pos.x+5,y:n.pos.y,z:n.pos.z+5},t};function du(){let n=qs();n.pos={x:Math.round(Wt.target.x),y:0,z:Math.round(Wt.target.z)},g.context.children.push(n),Mi(n,!0),he()}function hc(){g.selection.size&&(g.context.children=g.context.children.filter(n=>!g.selection.has(n.id)),g.selection.clear(),bi())}function fu(){let n=uu().map(lc);n.length&&(g.context.children.push(...n),g.selection=new Set(n.map(t=>t.id)),bi())}function uc(){g.clipboard=uu().map(oo)}function pu(){uc(),hc()}function mu(){if(!g.clipboard.length)return;let n=g.clipboard.map(lc);g.context.children.push(...n),g.selection=new Set(n.map(t=>t.id)),bi()}function dc(n,t,e){if(n===t||ps(n,t))return!1;let i=xi(n);if(!i)return!1;let s=os(Zs(i),{off:{...n.pos},rot:n.rot}),r=os(Ph(Zs(t)),s),a=i.children.indexOf(n);return i.children.splice(a,1),i===t&&a<e&&e--,n.pos={x:Math.round(r.off.x),y:Math.round(r.off.y),z:Math.round(r.off.z)},n.rot=r.rot&3,t.children.splice(Math.max(0,Math.min(e,t.children.length)),0,n),!0}function fc(n){let t=xi(n);if(!t)return null;let e=t.children.indexOf(n),i=us();return i.name="Group",i.pos={...n.pos},i.rot=n.rot,t.children.splice(e,1,i),n.pos={x:0,y:0,z:0},n.rot=0,i.children=[n],i}function gu(n,t){if(t===n||ps(t,n))return!1;let e=fc(n);return e?(dc(t,e,e.children.length),g.collapsed.delete(e.id),g.selection=new Set([e.id]),bi(),!0):!1}function xu(n){let t=xi(n);if(!t)return;let e=lc(n);t.children.splice(t.children.indexOf(n)+1,0,e),yi(e),he()}function _u(n){let t=xi(n);t&&(t.children=t.children.filter(e=>e!==n),g.selection.delete(n.id),g.editObject===n&&(g.editObject=null),bi())}function vu(n){let t=qs();t.pos={x:Math.round(Wt.target.x),y:0,z:Math.round(Wt.target.z)},n.children.push(t),g.collapsed.delete(n.id),Mi(t),he()}function yu(n){let t=us();t.name="Group",n.children.push(t),g.collapsed.delete(n.id),yi(t),he()}function pc(n){let t=n<0?-1:1;for(let e=0;e<Math.abs(n);e++){let i=ms(),s=r=>$n(r,un(i.off,le(r.pos,i.rot)),i.rot+r.rot&3,Qe());for(let r of g.selection){let a=gi(r);if(!a)continue;let o=s(a);a.rot=a.rot+t&3;let c=s(a),l={x:(o.min.x+o.max.x)/2-(c.min.x+c.max.x)/2,z:(o.min.z+o.max.z)/2-(c.min.z+c.max.z)/2},h=le({x:lu(l.x),y:0,z:lu(l.z)},-i.rot);a.pos.x+=h.x,a.pos.z+=h.z}}g.selection.size&&ke()}function Mu(){g.selection.size&&(pc(1),fe(),he())}function mc(n){for(let t of g.selection){let e=gi(t);e&&(e.pos.y+=n)}g.selection.size&&bi()}function Su(){let n=JSON.stringify({uid:cs(),root:ho(g.root)}),t=URL.createObjectURL(new Blob([n],{type:"application/json"})),e=g.root.name||"Project",i=new Date,[s,r]=new Date(i.getTime()-i.getTimezoneOffset()*6e4).toISOString().slice(0,19).split("T"),a=`${s} ${r.replace(/:/,"h").replace(/:/,"m")}s`,o=document.createElement("a");o.href=t,o.download=`${e} -- ${a}.voxelier.json`,o.click(),URL.revokeObjectURL(t)}function bu(){let n=document.createElement("input");n.type="file",n.accept="application/json,.json",n.onchange=()=>{let t=n.files&&n.files[0];if(!t)return;let e=new FileReader;e.onload=()=>{try{let i=JSON.parse(e.result);if(!i||!i.root)throw new Error("not a Voxelier scene file");ls(i.uid||1),g.root=ys(i.root),g.path=[g.root],g.context=g.root,g.editObject=null,g.selection.clear(),dn(),ke(),fe(),In(),he()}catch(i){alert("Import failed: "+i.message)}},e.readAsText(t)},n.click()}function ue(n,t={},...e){let i=document.createElement(n);return Object.assign(i,t),e.length&&i.append(...e),i}var Ex=[{id:"add",ic:"\uFF0B",label:"Add"},{id:"erase",ic:"\uFF0D",label:"Erase"},{id:"paint",ic:"\u{1FAA3}",label:"Fill"},{id:"measure",ic:"\u{1F4CF}",label:"Measure"}],wx={visible:"\u25C9",transparent:"\u25D0",invisible:"\u29B0"};function fe(){let n=document.getElementById("tools");if(n.innerHTML="",g.editObject)for(let e of Ex)n.appendChild(ue("button",{className:"tool"+(g.tool===e.id?" active":""),innerHTML:`<span class="ic">${e.ic}</span>${e.label}`,onclick:()=>{g.tool=e.id,dn(),Ye.visible=!1,fe()}}));else n.appendChild(ue("button",{className:"tool"+(g.measMode?" active":""),innerHTML:'<span class="ic">\u{1F4CF}</span>Measure',onclick:()=>{g.measMode=!g.measMode,g.measMode||dn(),fe()}}));let t=ue("div");t.style.flex="1",n.appendChild(t);for(let[e,i,s]of[["\u{1F4C2}","Import",bu],["\u{1F4BE}","Export",Su]])n.appendChild(ue("button",{className:"tool",innerHTML:`<span class="ic">${e}</span>${i}`,onclick:s}));Au(),Ss(),document.getElementById("statHint").textContent=vs()?"Measure \u2014 hover to read voxel/gap runs on all 3 axes \xB7 left-click freezes \xB7 right-click clears":g.editObject?g.tool==="paint"?"Fill \u2014 click a voxel to flood-fill its connected same-colour region \xB7 right-drag orbits \xB7 middle-drag pans \xB7 Esc to finish":`${g.tool==="add"?"Add":"Erase"} \u2014 drag a box in the floor plane (Shift = height) \xB7 right-drag orbits \xB7 middle-drag pans \xB7 Esc to finish`:g.selection.size?`${g.selection.size} selected \u2014 drag to move (Shift: up/down \xB7 Alt: allow overlap) \xB7 right-drag rotate \xB7 R rotate \xB7 Del`:"Tree: click a row to enter it \xB7 double-click to fit \xB7 right-click for actions \xB7 N new object"}var uo={ver:-1,cols:[]};function Eu(){if(uo.ver===g.voxVer)return uo.cols;let n=new Map;return function t(e){e.type==="object"?Nh(e.boxes,n):e.children.forEach(t)}(g.root),uo={ver:g.voxVer,cols:[...n.entries()].sort((t,e)=>e[1]-t[1]).map(t=>t[0])},uo.cols}function Ss(){let n=document.getElementById("swatches");n.innerHTML="";let t=Eu().slice();t.includes(g.selColor)||t.unshift(g.selColor);let e=i=>{let s=ue("div",{className:"sw"+(i===g.selColor?" active":""),title:as(i),onclick:()=>{g.selColor=i,Ss()}});return s.style.background=as(i),s};if(t.length>15){for(let i=0;i<14;i++)n.appendChild(e(t[i]));n.appendChild(ue("div",{className:"sw more",textContent:"\u2026",title:"All used colours",onclick:Ax}))}else for(let i=0;i<15;i++)n.appendChild(i<t.length?e(t[i]):ue("div",{className:"sw empty"}));n.appendChild(ue("div",{className:"sw more",textContent:"\u{1F3A8}",title:"Use colour picker",onclick:Tx}))}function Tx(){let n=ue("input",{type:"color",value:as(g.selColor)});n.style.cssText="position:fixed;left:-9999px;top:0";let t=()=>{g.selColor=parseInt(n.value.slice(1),16),Ss()},e=()=>n.remove();n.addEventListener("input",t),n.addEventListener("change",()=>{t(),e()}),window.addEventListener("focus",e,{once:!0}),document.body.appendChild(n),n.click()}function Ax(){fo();let n=ue("div",{id:"palback"});n.onclick=s=>{s.target===n&&fo()};let t=ue("div",{id:"palpop"});t.appendChild(ue("div",{className:"pophead",textContent:"Used colours"}));let e=ue("div",{className:"popgrid"}),i=Eu();if(!i.length){let s=ue("div",{textContent:"No colours yet."});s.style.cssText="color:var(--ink-dim);font-size:12px",e.appendChild(s)}for(let s of i){let r=ue("div",{className:"sw"+(s===g.selColor?" active":""),title:as(s),onclick:()=>{g.selColor=s,Ss(),fo()}});r.style.background=as(s),e.appendChild(r)}t.appendChild(e),n.appendChild(t),document.body.appendChild(n)}function fo(){let n=document.getElementById("palback");return n?(n.remove(),!0):!1}function wu(n,t,e,i){if(n.type==="object")for(let s of n.boxes)i.push(xn(s,e,t));else for(let s of n.children)wu(s,un(t,le(s.pos,e)),e+s.rot&3,i);return i}var gc=(n,t)=>{let e=Math.min(255,(n>>16&255)*t)|0,i=Math.min(255,(n>>8&255)*t)|0,s=Math.min(255,(n&255)*t)|0;return`rgb(${e},${i},${s})`},po=new Map;function Tu(n){return n.type==="object"?"o"+n.boxes.map(t=>`${t.x0},${t.y0},${t.z0},${t.x1},${t.y1},${t.z1},${t.c}`).join(";"):"s"+n.children.map(t=>`${t.id}@${t.pos.x},${t.pos.y},${t.pos.z}/${t.rot};${Tu(t)}`).join()}function Rx(n){let t=po.get(n.id);if(n===g.editObject&&t)return t.cv;let e=Tu(n);if(t&&t.sig===e)return t.cv;let i=document.createElement("canvas");i.width=i.height=52,i.style.width=i.style.height="26px";let s=i.getContext("2d");s.fillStyle="#0f1115",s.fillRect(0,0,52,52);let r=wu(n,{x:0,y:0,z:0},0,[]);if(r.length){let a=Qe();gn(r,a);let{x:o,y:c,z:l}=a.min,{x:h,y:u,z:f}=a.max,m=40/Math.max(h-o,u-c,f-l,1),x=26-((o+h)/2-(l+f)/2)*m*.5,_=28+(c+u)/2*m*.6-((o+h)/2+(l+f)/2)*m*.28,p=(M,v,T)=>[x+(M-T)*m*.5,_-v*m*.6+(M+T)*m*.28],d=(M,v)=>{s.fillStyle=M,s.beginPath(),s.moveTo(v[0][0],v[0][1]);for(let T=1;T<v.length;T++)s.lineTo(v[T][0],v[T][1]);s.closePath(),s.fill()};r.sort((M,v)=>M.x0+M.x1+M.y0+M.y1+M.z0+M.z1-(v.x0+v.x1+v.y0+v.y1+v.z0+v.z1));for(let M of r)d(gc(M.c,.78),[p(M.x1,M.y0,M.z0),p(M.x1,M.y1,M.z0),p(M.x1,M.y1,M.z1),p(M.x1,M.y0,M.z1)]),d(gc(M.c,.6),[p(M.x0,M.y0,M.z1),p(M.x1,M.y0,M.z1),p(M.x1,M.y1,M.z1),p(M.x0,M.y1,M.z1)]),d(gc(M.c,1),[p(M.x0,M.y1,M.z0),p(M.x1,M.y1,M.z0),p(M.x1,M.y1,M.z1),p(M.x0,M.y1,M.z1)])}return po.set(n.id,{sig:e,cv:i}),i}function Cx(n){if(g.pending&&g.pending.node===n){clearTimeout(g.pending.timer),g.pending=null,rc(n);return}g.pending&&clearTimeout(g.pending.timer);let t=e=>{g.pending={node:n,timer:setTimeout(()=>{g.pending=null,e&&e()},300)}};iu(n)?t(()=>cc(n)):(Mi(n),t())}function Au(){let n=document.getElementById("tree");n.innerHTML="";let t=(i,s)=>{let r=i===g.root,a=!r&&g.context.children.includes(i)&&g.selection.has(i.id),o=i.vis||"visible",c=ue("div",{className:"trow"+(r?" root":"")+(a?" sel":"")+(i===g.context&&!g.editObject?" ctx":"")+(i===g.editObject?" edit":"")+(!r&&o!=="visible"?" dim":"")});c.style.paddingLeft=4+s*13+"px";let l=Rx(i);if(l.className="thumb",l.onclick=null,l.title="",!r&&i.type==="scene"&&i.children.length){let u=g.collapsed.has(i.id);l.classList.add("group"),u&&l.classList.add("collapsed"),l.title=u?"Expand group":"Collapse group",l.onclick=f=>{f.stopPropagation(),u?g.collapsed.delete(i.id):g.collapsed.add(i.id),Au()}}let h=ue("span",{className:"nm"});if(r?h.textContent=i.name||"Project":i.name?h.textContent=i.name:h.innerHTML='<span class="ph">'+(i.type==="scene"?"group":"object")+"</span>",c.append(l,h),r||c.append(ue("button",{className:"tb"+(o==="visible"?" on":""),textContent:wx[o],title:"visible \u2192 transparent \u2192 invisible",onclick:u=>{u.stopPropagation(),hu(i)}})),c.onclick=()=>Cx(i),c.oncontextmenu=u=>{u.preventDefault(),u.stopPropagation(),r||yi(i),Px(i,u.clientX,u.clientY)},c.draggable=!r,r||c.addEventListener("dragstart",u=>{if(u.stopPropagation(),g.dragId=i.id,u.dataTransfer){u.dataTransfer.effectAllowed="move";try{u.dataTransfer.setData("text/plain",i.id)}catch{}}}),c.addEventListener("dragend",js),c.addEventListener("dragover",u=>{u.preventDefault(),u.stopPropagation(),Lx(u,i,c)}),c.addEventListener("drop",u=>{u.preventDefault(),u.stopPropagation(),Cu()}),n.appendChild(c),i.type==="scene"&&(r||!g.collapsed.has(i.id)))for(let u of i.children)t(u,s+1)};t(g.root,0);let e=new Set;(function i(s){e.add(s.id),s.type==="scene"&&s.children.forEach(i)})(g.root);for(let i of po.keys())e.has(i)||po.delete(i)}function xc(){g.ctxMenuEl&&(g.ctxMenuEl.remove(),g.ctxMenuEl=null,window.removeEventListener("pointerdown",Ru,!0))}function Ru(n){g.ctxMenuEl&&!g.ctxMenuEl.contains(n.target)&&xc()}function Px(n,t,e){xc();let i=ue("div",{className:"ctxmenu"}),s=(o,c,l)=>i.appendChild(ue("div",{className:"ctxitem"+(l?" "+l:""),textContent:o,onclick:()=>{xc(),c()}})),r=()=>i.appendChild(ue("div",{className:"ctxdiv"}));s("Rename",()=>cc(n)),s("Fit",()=>rc(n)),r(),n!==g.root&&(s("Duplicate",()=>xu(n)),s("Delete",()=>_u(n),"danger"),r()),n.type==="scene"?(s("New object",()=>vu(n)),s("New group",()=>yu(n))):s("New group",()=>{let o=fc(n);o&&(g.collapsed.delete(o.id),yi(o),he())}),document.body.appendChild(i),g.ctxMenuEl=i;let a=i.getBoundingClientRect();i.style.left=Math.min(t,innerWidth-a.width-4)+"px",i.style.top=Math.min(e,innerHeight-a.height-4)+"px",setTimeout(()=>window.addEventListener("pointerdown",Ru,!0),0)}function js(){g.dropRow&&g.dropRow.classList.remove("drop-into","drop-before","drop-after"),g.dropRow=null,g.dropInfo=null}function Lx(n,t,e){let i=g.dragId&&fs(g.dragId);if(!i||i===t||ps(i,t)){js();return}if(js(),g.dropRow=e,t===g.root){g.dropInfo={parent:g.root,index:g.root.children.length},e.classList.add("drop-into");return}let s=e.getBoundingClientRect(),r=n.clientY-s.top,a=s.height,o=xi(t),c=o?o.children.indexOf(t):0;r>a*.28&&r<a*.72?(t.type==="scene"?g.dropInfo={parent:t,index:t.children.length}:g.dropInfo={wrap:t},e.classList.add("drop-into")):r<a*.5?(g.dropInfo={parent:o,index:c},e.classList.add("drop-before")):(g.dropInfo={parent:o,index:c+1},e.classList.add("drop-after"))}function Cu(){let n=g.dragId&&fs(g.dragId);n&&g.dropInfo&&(g.dropInfo.wrap?gu(g.dropInfo.wrap,n):g.dropInfo.parent&&dc(n,g.dropInfo.parent,g.dropInfo.index)&&(g.collapsed.delete(g.dropInfo.parent.id),yi(n),he())),js(),g.dragId=null}{let n=document.getElementById("tree");n.addEventListener("dragover",t=>{t.target===n&&g.dragId&&(t.preventDefault(),js(),g.dropInfo={parent:g.root,index:g.root.children.length})}),n.addEventListener("drop",t=>{t.target===n&&(t.preventDefault(),Cu())})}window.addEventListener("keydown",n=>{if(n.target.tagName==="INPUT")return;let t=n.key.toLowerCase(),e=n.ctrlKey||n.metaKey;if(!(t==="escape"&&fo())){if(e){if(t==="z"){n.preventDefault(),n.shiftKey?ac():ou();return}if(t==="y"){n.preventDefault(),ac();return}let i={c:uc,x:pu,v:mu,d:fu}[t];i&&!g.editObject&&(i(),n.preventDefault());return}switch(t){case"f":In();break;case"escape":nu();break;case"n":g.editObject||du();break;case"r":g.editObject||Mu();break;case"[":g.editObject||mc(-1);break;case"]":g.editObject||mc(1);break;case"delete":case"backspace":g.editObject||(n.preventDefault(),hc());break}}});var qt=n=>Math.floor(n/10),re=Fh,bs=(n,t)=>{let e=qs();return e.name=n,e.boxes=t,e},_c=(n,t,e,i,s,r)=>({x0:n,y0:t,z0:e,x1:i,y1:s,z1:r});function Pu(){let n=qt(4465),t=qt(2985),e=qt(2700),i=qt(150),s=bs("Floor",[ne(0,0,0,n,1,t,re[9])]),r=qt(800),a=qt(2100),o=n-qt(515)-r,c=n-qt(900)-r,l=[ne(0,1,0,n,e+1,i,re[5]),ne(0,1,t-i,n,e+1,t,re[5]),ne(0,1,i,i,e+1,t-i,re[5]),ne(n-i,1,i,n,e+1,t-i,re[5])];l=hs(l,_c(o,1,0,o+r,a+1,i)),l=hs(l,_c(c,1,t-i,c+r,a+1,t)),l=hs(l,_c(0,qt(900),qt(600),i,qt(2100),t-qt(600)));let h=bs("Walls",l);h.vis="transparent";let u=qt(1500),f=qt(2e3),m=bs("Bed",[ne(0,0,0,8,14,8,re[7]),ne(u-8,0,0,u,14,8,re[7]),ne(0,0,f-8,8,14,f,re[7]),ne(u-8,0,f-8,u,14,f,re[7]),ne(0,14,0,u,20,f,re[6]),ne(2,20,0,u-2,24,f-qt(400),re[10])]);m.pos={x:i+3,y:1,z:t-i-f};let x=qt(1400),_=qt(700),p=qt(740),d=bs("Desk",[ne(0,p-4,0,x,p,_,re[8]),ne(0,0,0,6,p-4,6,re[7]),ne(x-6,0,0,x,p-4,6,re[7]),ne(0,0,_-6,6,p-4,_,re[7]),ne(x-6,0,_-6,x,p-4,_,re[7])]),M=qt(600),v=M-30>>1,T=M>>1,L=bs("Computer",[ne(v,0,0,v+30,2,18,re[11]),ne(T-2,2,7,T+2,qt(160),11,re[11]),ne(0,qt(160),6,M,qt(520),9,re[13])]);L.pos={x:qt(400),y:p,z:qt(420)};let A=us();A.name="Desk + Computer",A.pos={x:n-i,y:1,z:qt(900)},A.rot=1,A.children=[d,L];let R=H=>bs(H,[ne(-10,0,-10,11,30,11,re[4]),ne(-2,30,-2,3,54,3,re[14]),ne(-16,54,-16,17,78,17,re[14]),ne(-12,78,-12,13,92,13,re[14])]),Y=R("Plant"),b=R("Plant");Y.pos={x:n-i-qt(300),y:1,z:i+qt(300)},b.pos={x:i+qt(300),y:1,z:i+qt(300)};let w=us();return w.children=[s,h,m,A,Y,b],w}var Lu=n=>Math.abs(n.clientX-g.drag.sx)+Math.abs(n.clientY-g.drag.sy)>3;function Uu(){let n=(Yt.top-Yt.bottom)/ee.getBoundingClientRect().height,t=Math.abs(Yt.matrixWorldInverse.elements[5]);return n/Math.max(t,.15)}function Iu(n){let t=g.drag;if(!t||t.mode!=="pan"&&t.mode!=="orbit")return!1;let e=n.clientX-t.x,i=n.clientY-t.y;return t.x=n.clientX,t.y=n.clientY,(t.mode==="pan"?jh:Qh)(e,i),!0}function Ix(){let n=[],t=[];vi(g.root,{x:0,y:0,z:0},0,null,0,(i,s,r,a)=>{let o=a&&g.selection.has(a)?t:n;for(let c of i.boxes)o.push(xn(c,r,s))});let e=1/0;for(let i of t)i.y0<e&&(e=i.y0);return{occ:n,sel:t,minY:e}}var Ux=(n,t,e,i)=>{if(Ka(n.sel??[],n.occ??[],t,e,i))return!0;let s=n.minY??1/0;return s+e<Math.min(0,s)};function Dx(n){let t=g.drag,e=t.dx,i=t.dy,s=t.dz;if(n.shiftKey)t.shiftAnchorY==null&&(t.shiftAnchorY=n.clientY,t.dyBase=t.dy),i=t.dyBase+Math.round((t.shiftAnchorY-n.clientY)*Uu());else{t.shiftAnchorY=null;let a=gs(0);a&&t.start&&(e=a.x-t.start.x,s=a.z-t.start.z)}let r=(a,o,c)=>n.altKey||!Ux(t,a,o,c);r(e,t.dy,t.dz)&&(t.dx=e),r(t.dx,i,t.dz)&&(t.dy=i),r(t.dx,t.dy,s)&&(t.dz=s);for(let a of g.selection)for(let o of g.childMeshes[a]||[])o.position.set(t.dx,t.dy,t.dz);Ln.position.set(t.dx,t.dy,t.dz)}function Nx(){let n=g.drag,t=ms(),e=le({x:Math.round(n.dx),y:0,z:Math.round(n.dz)},-t.rot),i=Math.round(n.dy);for(let s of g.selection){let r=gi(s);r&&(r.pos.x+=e.x,r.pos.y+=i,r.pos.z+=e.z)}Ln.position.set(0,0,0),ke(),he()}function Ox(n){let t=Math.round((g.drag.sx-n.clientX)/70);t!==g.drag.steps&&(pc(t-g.drag.steps),g.drag.steps=t,g.drag.dirty=!0)}function Du(){let n=xs(),t=co(n);if(!t)return;let e=Za(t.x,t.y,t.z);e!==g.lastVox&&($h(t,g.selColor),g.lastVox=e),Nu(n)}function Nu(n=xs()){let t=null;if(g.tool==="add"?t=n?n.addCell:co(n):t=n?n.cell:null,!t){Ye.visible=!1;return}let e=un(le(t,g.editXform.rot),g.editXform.off);Ye.visible=!0,Ye.material.color.set(g.tool==="erase"?11895693:10994876),Ye.position.set(e.x+.5,e.y+.5,e.z+.5)}function Fx(n,t){let e=co();e&&(g.drag={...t,mode:"box",shiftAnchorY:null,hyBase:0,box:{x0:e.x,y0:e.y,z0:e.z,x1:e.x,z1:e.z,hy:0},occ:g.tool==="add"?g.editObject.boxes.slice():void 0},Ye.visible=!1,Fu())}function zx(n){let t=g.drag,e=t.box,i=g.tool==="add"&&!n.altKey,s=(r,a,o)=>{if(!i)return!0;let c={x0:Math.min(e.x0,r),y0:Math.min(e.y0,e.y0+o),z0:Math.min(e.z0,a),x1:Math.max(e.x0,r)+1,y1:Math.max(e.y0,e.y0+o)+1,z1:Math.max(e.z0,a)+1,c:0};return!Ka([c],t.occ??[],0,0,0)};if(n.shiftKey){t.shiftAnchorY===null&&(t.shiftAnchorY=n.clientY,t.hyBase=e.hy);let r=t.hyBase+Math.round((t.shiftAnchorY-n.clientY)*Uu());s(e.x1,e.z1,r)&&(e.hy=r)}else{t.shiftAnchorY=null;let r=Js(e.y0);r&&(s(r.x,e.z1,e.hy)&&(e.x1=r.x),s(e.x1,r.z,e.hy)&&(e.z1=r.z))}Fu()}function Ou(){let n=g.drag.box;return{x0:Math.min(n.x0,n.x1),x1:Math.max(n.x0,n.x1),z0:Math.min(n.z0,n.z1),z1:Math.max(n.z0,n.z1),y0:Math.min(n.y0,n.y0+n.hy),y1:Math.max(n.y0,n.y0+n.hy)}}function Bx(){let n=Ou(),t={x0:n.x0,y0:n.y0,z0:n.z0,x1:n.x1+1,y1:n.y1+1,z1:n.z1+1};g.tool==="add"?Zh(t,g.selColor):Jh(t),g.liveMeas=null,_i(),fe(),he()}function Fu(){let n=Ou(),t=n.x0,e=n.x1+1,i=n.y0,s=n.y1+1,r=n.z0,a=n.z1+1,o=e-t,c=s-i,l=a-r,h=(f,m,x,_,p,d,M,v)=>({a:_s(f,m,x),b:_s(_,p,d),mid:_s((f+_)/2,(m+p)/2,(x+d)/2),len:M,filled:!0,nolabel:!v}),u=[];u.push(h(t,i,r,e,i,r,o,o>=2)),u.push(h(t,i,r,t,i,a,l,l>=2)),u.push(h(t,i,r,t,s,r,c,c>=2)),u.push(h(e,i,r,e,i,a,0,!1),h(t,i,a,e,i,a,0,!1)),u.push(h(t,s,r,e,s,r,0,!1),h(t,s,r,t,s,a,0,!1),h(e,s,r,e,s,a,0,!1),h(t,s,a,e,s,a,0,!1)),u.push(h(e,i,r,e,s,r,0,!1),h(t,i,a,t,s,a,0,!1),h(e,i,a,e,s,a,0,!1)),g.liveMeas=u,_i()}ee.addEventListener("pointerdown",n=>{if(g.drag||g.painting)return;ee.setPointerCapture(n.pointerId),ao(n.clientX,n.clientY);let t={x:n.clientX,y:n.clientY,sx:n.clientX,sy:n.clientY};if(vs()){n.button===0?g.drag={...t,mode:"pan",meas:"freeze"}:n.button===2?g.drag={...t,mode:"orbit",meas:"clear"}:n.button===1&&(g.drag={...t,mode:"pan",sx:-1e9});return}if(g.editObject){n.button===0?g.tool==="add"||g.tool==="erase"?Fx(n,t):(g.painting=!0,g.lastVox=null,Du()):n.button===2?g.drag={...t,mode:"orbit"}:n.button===1&&(g.drag={...t,mode:"pan"});return}let e=ja(),i=e&&g.selection.has(e);n.button===0?i?g.drag={...t,mode:"move",start:gs(0),dx:0,dy:0,dz:0,shiftAnchorY:null,...Ix()}:g.drag={...t,mode:"pan",clickId:e}:n.button===2?i?g.drag={...t,mode:"rotobj",steps:0}:g.drag={...t,mode:"orbit"}:n.button===1&&(g.drag={...t,mode:"pan",clickId:null,sx:-1e9})});ee.addEventListener("pointermove",n=>{if(ao(n.clientX,n.clientY),vs()){Iu(n),Hh();return}if(g.editObject&&g.painting){Du();return}if(!g.drag){g.editObject?Nu():Ye.visible=!1;return}Iu(n)||(g.drag.mode==="move"?Dx(n):g.drag.mode==="rotobj"?Ox(n):g.drag.mode==="box"&&zx(n))});ee.addEventListener("pointerup",n=>{try{ee.releasePointerCapture(n.pointerId)}catch{}if(vs()){g.drag&&!Lu(n)&&(g.drag.meas==="freeze"?Gh():g.drag.meas==="clear"&&dn()),g.drag=null;return}if(g.editObject){g.painting?(g.painting=!1,fe(),he()):g.drag&&g.drag.mode==="box"&&Bx(),g.drag=null;return}if(g.drag)if(g.drag.mode==="pan"&&!Lu(n)){let t=g.drag.clickId;t?n.shiftKey?g.selection.has(t)?g.selection.delete(t):g.selection.add(t):g.selection=new Set([t]):n.shiftKey||g.selection.clear(),nc(),fe()}else g.drag.mode==="move"?Nx():g.drag.mode==="rotobj"&&g.drag.dirty&&(fe(),he());g.drag=null});ee.addEventListener("pointercancel",()=>{if(!g.drag&&!g.painting)return;let n=g.painting;g.drag=null,g.painting=!1,g.liveMeas=null,_i(),ke(),n&&(fe(),he())});ee.addEventListener("pointerleave",()=>{Ye.visible=!1});ee.addEventListener("contextmenu",n=>n.preventDefault());ee.addEventListener("wheel",n=>{n.preventDefault(),Wt.zoom*=n.deltaY>0?1/.95:.95,Wt.zoom=Math.max(6,Math.min(eo,Wt.zoom))},{passive:!1});ee.addEventListener("dblclick",n=>{if(g.editObject)return;ao(n.clientX,n.clientY);let t=ja();t&&Mi(gi(t),!0)});for(let n of["pointerdown","pointermove","pointerup","pointerleave","wheel","keydown","dblclick"])window.addEventListener(n,rs,{passive:!0,capture:!0});var kx=()=>Math.abs(Wt.azim-Gt.azim)<.001&&Math.abs(Wt.elev-Gt.elev)<.001&&Math.abs(Wt.zoom-Gt.zoom)<.001&&Gt.target.distanceToSquared(Wt.target)<1e-6;function zu(){let n=ee.getBoundingClientRect(),t=Math.max(1,Math.round(n.width)),e=Math.max(1,Math.round(n.height)),i=Math.min(devicePixelRatio,2);qn.getPixelRatio()!==i&&qn.setPixelRatio(i),(ee.width!==Math.floor(t*i)||ee.height!==Math.floor(e*i))&&(qn.setSize(t,e,!1),rs())}window.addEventListener("resize",zu);function Bu(){requestAnimationFrame(Bu),zu(),eu(),(Gs.tail>0||!kx())&&(qn.render(Ee,Yt),Wh(),Gs.tail>0&&Gs.tail--)}function Vx(){cu()||(g.root=Pu()),g.path=[g.root],g.context=g.root,g.editObject=null,g.selection.clear(),Ss(),ke(),fe(),In(),Ms(),Bu()}Vx();
/**
 * @license
