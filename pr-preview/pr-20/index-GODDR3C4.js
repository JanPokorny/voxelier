...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xr,depthTest:!1,depthWrite:!1})}function Kx(){return new ti({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Sf(),fragmentShader:`
		...
		`,blending:xr,depthTest:!1,depthWrite:!1})}function Zx(){return new ti({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Sf(),fragmentShader:`
		...
		`,blending:xr,depthTest:!1,depthWrite:!1})}function Sf(){return`
...
`].filter(po).join(`
`)),o=$d(o),o=a0(o,t),o=c0(o,t),a=$d(a),a=a0(a,t),a=c0(a,t),o=l0(o),a=l0(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(_=`#version 300 es
