...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:li,depthTest:!1,depthWrite:!1})}function Fh(){return new mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ic(),fragmentShader:`
		...
		`,blending:li,depthTest:!1,depthWrite:!1})}function Bh(){return new mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ic(),fragmentShader:`
	...
	`}function Jx(n){let t=new WeakMap,e=null;function i(o){if(o&&o.isTexture){let c=o.mapping,l=c===Xa||c===qa,h=c===Es||c===ws;if(l||h)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let u=t.get(o);return e===null&&(e=new Eo(n)),u=l?e.fromEquirectangular(o,u):e.fromCubemap(o,u),t.set(o,u),u.texture}else{if(t.has(o))return t.get(o).texture;{let u=o.image;if(l&&u&&u.height>0||h&&u&&s(u)){e===null&&(e=new Eo(n));let d=l?e.fromEquirectangular(o):e.fromCubemap(o);return t.set(o,d),o.addEventListener("dispose",r),d.texture}else return null}}}return o}function s(o){let c=0,l=6;for(let h=0;h<l;h++)o[h]!==void 0&&c++;return c===l}function r(o){let c=o.target;c.removeEventListener("dispose",r);let l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:i,dispose:a}}function Zx(n){let t={};function e(i){if(t[i]!==void 0)return t[i];let s;switch(i){case"WEBGL_depth_texture":s=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=n.getExtension(i)}return t[i]=s,s}return{has:function(i){return e(i)!==null},init:function(i){i.isWebGL2?(e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance")):(e("WEBGL_depth_texture"),e("OES_texture_float"),e("OES_texture_half_float"),e("OES_texture_half_float_linear"),e("OES_standard_derivatives"),e("OES_element_index_uint"),e("OES_vertex_array_object"),e("ANGLE_instanced_arrays")),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture")},get:function(i){let s=e(i);return s===null&&console.warn("THREE.WebGLRenderer: "+i+" extension not supported."),s}}}function $x(n,t,e,i){let s={},r=new WeakMap;function a(u){let d=u.target;d.index!==null&&t.remove(d.index);for(let x in d.attributes)t.remove(d.attributes[x]);for(let x in d.morphAttributes){let _=d.morphAttributes[x];for(let p=0,f=_.length;p<f;p++)t.remove(_[p])}d.removeEventListener("dispose",a),delete s[d.id];let m=r.get(d);m&&(t.remove(m),r.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,e.memory.geometries++),d}function c(u){let d=u.attributes;for(let x in d)t.update(d[x],n.ARRAY_BUFFER);let m=u.morphAttributes;for(let x in m){let _=m[x];for(let p=0,f=_.length;p<f;p++)t.update(_[p],n.ARRAY_BUFFER)}}function l(u){let d=[],m=u.index,x=u.attributes.position,_=0;if(m!==null){let v=m.array;_=m.version;for(let y=0,T=v.length;y<T;y+=3){let C=v[y+0],R=v[y+1],A=v[y+2];d.push(C,R,R,A,A,C)}}else if(x!==void 0){let v=x.array;_=x.version;for(let y=0,T=v.length/3-1;y<T;y+=3){let C=y+0,R=y+1,A=y+2;d.push(C,R,R,A,A,C)}}else return;let p=new(Su(d)?Mo:vo)(d,1);p.version=_;let f=r.get(u);f&&t.remove(f),r.set(u,p)}function h(u){let d=r.get(u);if(d){let m=u.index;m!==null&&d.version<m.version&&l(u)}else l(u);return r.get(u)}return{get:o,update:c,getWireframeAttribute:h}}function Kx(n,t,e,i){let s=i.isWebGL2,r;function a(m){r=m}let o,c;function l(m){o=m.type,c=m.bytesPerElement}function h(m,x){n.drawElements(r,x,o,m*c),e.update(x,r,1)}function u(m,x,_){if(_===0)return;let p,f;if(s)p=n,f="drawElementsInstanced";else if(p=t.get("ANGLE_instanced_arrays"),f="drawElementsInstancedANGLE",p===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}p[f](r,x,o,m*c,_),e.update(x,r,_)}function d(m,x,_){if(_===0)return;let p=t.get("WEBGL_multi_draw");if(p===null)for(let f=0;f<_;f++)this.render(m[f]/c,x[f]);else{p.multiDrawElementsWEBGL(r,x,0,o,m,0,_);let f=0;for(let v=0;v<_;v++)f+=x[v];e.update(f,r,1)}}this.setMode=a,this.setIndex=l,this.render=h,this.renderInstances=u,this.renderMultiDraw=d}function jx(n){let t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,a,o){switch(e.calls++,a){case n.TRIANGLES:e.triangles+=o*(r/3);break;case n.LINES:e.lines+=o*(r/2);break;case n.LINE_STRIP:e.lines+=o*(r-1);break;case n.LINE_LOOP:e.lines+=o*r;break;case n.POINTS:e.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:i}}function Qx(n,t){return n[0]-t[0]}function t0(n,t){return Math.abs(t[1])-Math.abs(n[1])}function e0(n,t,e){let i={},s=new Float32Array(8),r=new WeakMap,a=new Me,o=[];for(let l=0;l<8;l++)o[l]=[l,0];function c(l,h,u){let d=l.morphTargetInfluences;if(t.isWebGL2===!0){let m=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,x=m!==void 0?m.length:0,_=r.get(h);if(_===void 0||_.count!==x){let L=function(){X.dispose(),r.delete(h),h.removeEventListener("dispose",L)};_!==void 0&&_.texture.dispose();let v=h.morphAttributes.position!==void 0,y=h.morphAttributes.normal!==void 0,T=h.morphAttributes.color!==void 0,C=h.morphAttributes.position||[],R=h.morphAttributes.normal||[],A=h.morphAttributes.color||[],H=0;v===!0&&(H=1),y===!0&&(H=2),T===!0&&(H=3);let S=h.attributes.position.count*H,w=1;S>t.maxTextureSize&&(w=Math.ceil(S/t.maxTextureSize),S=t.maxTextureSize);let N=new Float32Array(S*w*4*x),X=new _o(N,S,w,x);X.type=ci,X.needsUpdate=!0;let rt=H*4;for(let B=0;B<x;B++){let W=C[B],Y=R[B],q=A[B],G=S*w*4*B;for(let Z=0;Z<W.count;Z++){let $=Z*rt;v===!0&&(a.fromBufferAttribute(W,Z),N[G+$+0]=a.x,N[G+$+1]=a.y,N[G+$+2]=a.z,N[G+$+3]=0),y===!0&&(a.fromBufferAttribute(Y,Z),N[G+$+4]=a.x,N[G+$+5]=a.y,N[G+$+6]=a.z,N[G+$+7]=0),T===!0&&(a.fromBufferAttribute(q,Z),N[G+$+8]=a.x,N[G+$+9]=a.y,N[G+$+10]=a.z,N[G+$+11]=q.itemSize===4?a.w:1)}}_={count:x,texture:X,size:new Gt(S,w)},r.set(h,_),h.addEventListener("dispose",L)}let p=0;for(let v=0;v<d.length;v++)p+=d[v];let f=h.morphTargetsRelative?1:1-p;u.getUniforms().setValue(n,"morphTargetBaseInfluence",f),u.getUniforms().setValue(n,"morphTargetInfluences",d),u.getUniforms().setValue(n,"morphTargetsTexture",_.texture,e),u.getUniforms().setValue(n,"morphTargetsTextureSize",_.size)}else{let m=d===void 0?0:d.length,x=i[h.id];if(x===void 0||x.length!==m){x=[];for(let y=0;y<m;y++)x[y]=[y,0];i[h.id]=x}for(let y=0;y<m;y++){let T=x[y];T[0]=y,T[1]=d[y]}x.sort(t0);for(let y=0;y<8;y++)y<m&&x[y][1]?(o[y][0]=x[y][0],o[y][1]=x[y][1]):(o[y][0]=Number.MAX_SAFE_INTEGER,o[y][1]=0);o.sort(Qx);let _=h.morphAttributes.position,p=h.morphAttributes.normal,f=0;for(let y=0;y<8;y++){let T=o[y],C=T[0],R=T[1];C!==Number.MAX_SAFE_INTEGER&&R?(_&&h.getAttribute("morphTarget"+y)!==_[C]&&h.setAttribute("morphTarget"+y,_[C]),p&&h.getAttribute("morphNormal"+y)!==p[C]&&h.setAttribute("morphNormal"+y,p[C]),s[y]=R,f+=R):(_&&h.hasAttribute("morphTarget"+y)===!0&&h.deleteAttribute("morphTarget"+y),p&&h.hasAttribute("morphNormal"+y)===!0&&h.deleteAttribute("morphNormal"+y),s[y]=0)}let v=h.morphTargetsRelative?1:1-f;u.getUniforms().setValue(n,"morphTargetBaseInfluence",v),u.getUniforms().setValue(n,"morphTargetInfluences",s)}}return{update:c}}function n0(n,t,e,i){let s=new WeakMap;function r(c){let l=i.render.frame,h=c.geometry,u=t.get(c,h);if(s.get(u)!==l&&(t.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),s.get(c)!==l&&(e.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,n.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){let d=c.skeleton;s.get(d)!==l&&(d.update(),s.set(d,l))}return u}function a(){s=new WeakMap}function o(c){let l=c.target;l.removeEventListener("dispose",o),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:a}}var wo=class extends pn{constructor(t,e,i,s,r,a,o,c,l,h){if(h=h!==void 0?h:Fi,h!==Fi&&h!==Ts)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&h===Fi&&(i=ai),i===void 0&&h===Ts&&(i=zi),super(null,s,r,a,o,c,h,i,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=o!==void 0?o:Oe,this.minFilter=c!==void 0?c:Oe,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){let e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}},Tu=new pn,Au=new wo(1,1);Au.compareFunction=vu;var Ru=new _o,Cu=new ja,Pu=new bo,kh=[],Vh=[],Hh=new Float32Array(16),Gh=new Float32Array(9),Wh=new Float32Array(4);function Us(n,t,e){let i=n[0];if(i<=0||i>0)return n;let s=t*e,r=kh[s];if(r===void 0&&(r=new Float32Array(s),kh[s]=r),t!==0){i.toArray(r,0);for(let a=1,o=0;a!==t;++a)o+=e,n[a].toArray(r,o)}return r}function ge(n,t){if(n.length!==t.length)return!1;for(let e=0,i=n.length;e<i;e++)if(n[e]!==t[e])return!1;return!0}function xe(n,t){for(let e=0,i=t.length;e<i;e++)n[e]=t[e]}function Do(n,t){let e=Vh[t];e===void 0&&(e=new Int32Array(t),Vh[t]=e);for(let i=0;i!==t;++i)e[i]=n.allocateTextureUnit();return e}function i0(n,t){let e=this.cache;e[0]!==t&&(n.uniform1f(this.addr,t),e[0]=t)}function s0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ge(e,t))return;n.uniform2fv(this.addr,t),xe(e,t)}}function r0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(n.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ge(e,t))return;n.uniform3fv(this.addr,t),xe(e,t)}}function o0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ge(e,t))return;n.uniform4fv(this.addr,t),xe(e,t)}}function a0(n,t){let e=this.cache,i=t.elements;if(i===void 0){if(ge(e,t))return;n.uniformMatrix2fv(this.addr,!1,t),xe(e,t)}else{if(ge(e,i))return;Wh.set(i),n.uniformMatrix2fv(this.addr,!1,Wh),xe(e,i)}}function c0(n,t){let e=this.cache,i=t.elements;if(i===void 0){if(ge(e,t))return;n.uniformMatrix3fv(this.addr,!1,t),xe(e,t)}else{if(ge(e,i))return;Gh.set(i),n.uniformMatrix3fv(this.addr,!1,Gh),xe(e,i)}}function l0(n,t){let e=this.cache,i=t.elements;if(i===void 0){if(ge(e,t))return;n.uniformMatrix4fv(this.addr,!1,t),xe(e,t)}else{if(ge(e,i))return;Hh.set(i),n.uniformMatrix4fv(this.addr,!1,Hh),xe(e,i)}}function h0(n,t){let e=this.cache;e[0]!==t&&(n.uniform1i(this.addr,t),e[0]=t)}function u0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ge(e,t))return;n.uniform2iv(this.addr,t),xe(e,t)}}function d0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ge(e,t))return;n.uniform3iv(this.addr,t),xe(e,t)}}function f0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ge(e,t))return;n.uniform4iv(this.addr,t),xe(e,t)}}function p0(n,t){let e=this.cache;e[0]!==t&&(n.uniform1ui(this.addr,t),e[0]=t)}function m0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ge(e,t))return;n.uniform2uiv(this.addr,t),xe(e,t)}}function g0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ge(e,t))return;n.uniform3uiv(this.addr,t),xe(e,t)}}function x0(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ge(e,t))return;n.uniform4uiv(this.addr,t),xe(e,t)}}function _0(n,t,e){let i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r=this.type===n.SAMPLER_2D_SHADOW?Au:Tu;e.setTexture2D(t||r,s)}function y0(n,t,e){let i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTexture3D(t||Cu,s)}function v0(n,t,e){let i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTextureCube(t||Pu,s)}function M0(n,t,e){let i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTexture2DArray(t||Ru,s)}function S0(n){switch(n){case 5126:return i0;case 35664:return s0;case 35665:return r0;case 35666:return o0;case 35674:return a0;case 35675:return c0;case 35676:return l0;case 5124:case 35670:return h0;case 35667:case 35671:return u0;case 35668:case 35672:return d0;case 35669:case 35673:return f0;case 5125:return p0;case 36294:return m0;case 36295:return g0;case 36296:return x0;case 35678:case 36198:case 36298:case 36306:case 35682:return _0;case 35679:case 36299:case 36307:return y0;case 35680:case 36300:case 36308:case 36293:return v0;case 36289:case 36303:case 36311:case 36292:return M0}}function b0(n,t){n.uniform1fv(this.addr,t)}function E0(n,t){let e=Us(t,this.size,2);n.uniform2fv(this.addr,e)}function w0(n,t){let e=Us(t,this.size,3);n.uniform3fv(this.addr,e)}function T0(n,t){let e=Us(t,this.size,4);n.uniform4fv(this.addr,e)}function A0(n,t){let e=Us(t,this.size,4);n.uniformMatrix2fv(this.addr,!1,e)}function R0(n,t){let e=Us(t,this.size,9);n.uniformMatrix3fv(this.addr,!1,e)}function C0(n,t){let e=Us(t,this.size,16);n.uniformMatrix4fv(this.addr,!1,e)}function P0(n,t){n.uniform1iv(this.addr,t)}function L0(n,t){n.uniform2iv(this.addr,t)}function I0(n,t){n.uniform3iv(this.addr,t)}function D0(n,t){n.uniform4iv(this.addr,t)}function U0(n,t){n.uniform1uiv(this.addr,t)}function N0(n,t){n.uniform2uiv(this.addr,t)}function O0(n,t){n.uniform3uiv(this.addr,t)}function z0(n,t){n.uniform4uiv(this.addr,t)}function F0(n,t,e){let i=this.cache,s=t.length,r=Do(e,s);ge(i,r)||(n.uniform1iv(this.addr,r),xe(i,r));for(let a=0;a!==s;++a)e.setTexture2D(t[a]||Tu,r[a])}function B0(n,t,e){let i=this.cache,s=t.length,r=Do(e,s);ge(i,r)||(n.uniform1iv(this.addr,r),xe(i,r));for(let a=0;a!==s;++a)e.setTexture3D(t[a]||Cu,r[a])}function k0(n,t,e){let i=this.cache,s=t.length,r=Do(e,s);ge(i,r)||(n.uniform1iv(this.addr,r),xe(i,r));for(let a=0;a!==s;++a)e.setTextureCube(t[a]||Pu,r[a])}function V0(n,t,e){let i=this.cache,s=t.length,r=Do(e,s);ge(i,r)||(n.uniform1iv(this.addr,r),xe(i,r));for(let a=0;a!==s;++a)e.setTexture2DArray(t[a]||Ru,r[a])}function H0(n){switch(n){case 5126:return b0;case 35664:return E0;case 35665:return w0;case 35666:return T0;case 35674:return A0;case 35675:return R0;case 35676:return C0;case 5124:case 35670:return P0;case 35667:case 35671:return L0;case 35668:case 35672:return I0;case 35669:case 35673:return D0;case 5125:return U0;case 36294:return N0;case 36295:return O0;case 36296:return z0;case 35678:case 36198:case 36298:case 36306:case 35682:return F0;case 35679:case 36299:case 36307:return B0;case 35680:case 36300:case 36308:case 36293:return k0;case 36289:case 36303:case 36311:case 36292:return V0}}var ec=class{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.setValue=S0(e.type)}},nc=class{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=H0(e.type)}},ic=class{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,i){let s=this.seq;for(let r=0,a=s.length;r!==a;++r){let o=s[r];o.setValue(t,e[o.id],i)}}},Ba=/(\w+)(\])?(\[|\.)?/g;function Xh(n,t){n.seq.push(t),n.map[t.id]=t}function G0(n,t,e){let i=n.name,s=i.length;for(Ba.lastIndex=0;;){let r=Ba.exec(i),a=Ba.lastIndex,o=r[1],c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){Xh(e,l===void 0?new ec(o,n,t):new nc(o,n,t));break}else{let u=e.map[o];u===void 0&&(u=new ic(o),Xh(e,u)),e=u}}}var bs=class{constructor(t,e){this.seq=[],this.map={};let i=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<i;++s){let r=t.getActiveUniform(e,s),a=t.getUniformLocation(e,r.name);G0(r,a,this)}}setValue(t,e,i,s){let r=this.map[e];r!==void 0&&r.setValue(t,i,s)}setOptional(t,e,i){let s=e[i];s!==void 0&&this.setValue(t,i,s)}static upload(t,e,i,s){for(let r=0,a=e.length;r!==a;++r){let o=e[r],c=i[o.id];c.needsUpdate!==!1&&o.setValue(t,c.value,s)}}static seqWithValue(t,e){let i=[];for(let s=0,r=t.length;s!==r;++s){let a=t[s];a.id in e&&i.push(a)}return i}};function qh(n,t,e){let i=n.createShader(t);return n.shaderSource(i,e),n.compileShader(i),i}var W0=37297,X0=0;function q0(n,t){let e=n.split(`
`),i=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let a=s;a<r;a++){let o=a+1;i.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return i.join(`
`)}function Y0(n){let t=$t.getPrimaries($t.workingColorSpace),e=$t.getPrimaries(n),i;switch(t===e?i="":t===uo&&e===ho?i="LinearDisplayP3ToLinearSRGB":t===ho&&e===uo&&(i="LinearSRGBToLinearDisplayP3"),n){case Bn:case Io:return[i,"LinearTransferOETF"];case be:case Pc:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[i,"LinearTransferOETF"]}}function Yh(n,t,e){let i=n.getShaderParameter(t,n.COMPILE_STATUS),s=n.getShaderInfoLog(t).trim();if(i&&s==="")return"";let r=/ERROR: 0:(\d+)/.exec(s);if(r){let a=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+q0(n.getShaderSource(t),a)}else return s}function J0(n,t){let e=Y0(t);return`vec4 ${n}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function Z0(n,t){let e;switch(t){case tp:e="Linear";break;case ep:e="Reinhard";break;case np:e="OptimizedCineon";break;case ip:e="ACESFilmic";break;case rp:e="AgX";break;case sp:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function $0(n){return[n.extensionDerivatives||n.envMapCubeUVHeight||n.bumpMap||n.normalMapTangentSpace||n.clearcoatNormalMap||n.flatShading||n.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(n.extensionFragDepth||n.logarithmicDepthBuffer)&&n.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",n.extensionDrawBuffers&&n.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(n.extensionShaderTextureLOD||n.envMap||n.transmission)&&n.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(ys).join(`
`)}function K0(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(ys).join(`
`)}function j0(n){let t=[];for(let e in n){let i=n[e];i!==!1&&t.push("#define "+e+" "+i)}return t.join(`
`)}function Q0(n,t){let e={},i=n.getProgramParameter(t,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){let r=n.getActiveAttrib(t,s),a=r.name,o=1;r.type===n.FLOAT_MAT2&&(o=2),r.type===n.FLOAT_MAT3&&(o=3),r.type===n.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:n.getAttribLocation(t,a),locationSize:o}}return e}function ys(n){return n!==""}function Jh(n,t){let e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Zh(n,t){return n.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}var t_=/^[ \t]*#include +<([\w\d./]+)>/gm;function sc(n){return n.replace(t_,n_)}var e_=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function n_(n,t){let e=Nt[t];if(e===void 0){let i=e_.get(t);if(i!==void 0)e=Nt[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,i);else throw new Error("Can not resolve #include <"+t+">")}return sc(e)}var i_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function $h(n){return n.replace(i_,s_)}function s_(n,t,e,i){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Kh(n){let t="precision "+n.precision+` float;
precision `+n.precision+" int;";return n.precision==="highp"?t+=`
#define HIGH_PRECISION`:n.precision==="mediump"?t+=`
#define MEDIUM_PRECISION`:n.precision==="lowp"&&(t+=`
#define LOW_PRECISION`),t}function r_(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===lu?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===Ac?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===On&&(t="SHADOWMAP_TYPE_VSM"),t}function o_(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Es:case ws:t="ENVMAP_TYPE_CUBE";break;case Lo:t="ENVMAP_TYPE_CUBE_UV";break}return t}function a_(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case ws:t="ENVMAP_MODE_REFRACTION";break}return t}function c_(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Rc:t="ENVMAP_BLENDING_MULTIPLY";break;case jf:t="ENVMAP_BLENDING_MIX";break;case Qf:t="ENVMAP_BLENDING_ADD";break}return t}function l_(n){let t=n.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function h_(n,t,e,i){let s=n.getContext(),r=e.defines,a=e.vertexShader,o=e.fragmentShader,c=r_(e),l=o_(e),h=a_(e),u=c_(e),d=l_(e),m=e.isWebGL2?"":$0(e),x=K0(e),_=j0(r),p=s.createProgram(),f,v,y=e.glslVersion?"#version "+e.glslVersion+`
`:"";e.isRawShaderMaterial?(f=["#define SHADER_TYPE "+e.shaderType,"#define SHADER_NAME "+e.shaderName,_].filter(ys).join(`
`),f.length>0&&(f+=`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      }`}));Nc.frustumCulled=!1;Nc.renderOrder=-1e9;we.add(Nc);function Uu(){Du.uGround.value=Math.max(0,Math.min(1,(Wt.elev+.05)/.1))}we.add(new Co(16777215,.62));var $e=new ur(16777215,.78);$e.castShadow=!0;$e.shadow.mapSize.set(4096,4096);$e.shadow.normalBias=.15;$e.shadow.bias=-2e-4;we.add($e);we.add($e.target);var Nu=new ur(16777215,.16);Nu.position.set(-6,5,-7);we.add(Nu);var dr={tail:0},Ns=()=>{dr.tail=30},Oc=new I,No=new I,Lu=new Map;function gi(n){let t=Lu.get(n);return t||(t=new It().setHex(n),Lu.set(n,t)),t}var zc=new lr({vertexColors:!0,side:rn}),Ou=n=>{let t=new lr({vertexColors:!0,transparent:!0,opacity:n,side:rn,depthWrite:!1});return t.shadowSide=un,t},zu=Ou(.24),Fu=Ou(.55),Bu=new Rs({colorWrite:!1,side:rn}),Wi=new Ee(new Ps(8e3,8e3),new Ao({opacity:.32}));Wi.rotation.x=-Math.PI/2;Wi.position.y=-.1;Wi.receiveShadow=!0;Wi.renderOrder=-1;we.add(Wi);var vn=new Fn;we.add(vn);var Wn=new Fn;we.add(Wn);var Ke=new pi(new ki(new yn(1,1,1)),new Gn({color:10994876,depthTest:!1}));Ke.visible=!1;Ke.renderOrder=999;we.add(Ke);var Xi=new pi(new ke,new Gn({vertexColors:!0,transparent:!0,depthTest:!1}));Xi.renderOrder=998;Xi.visible=!1;we.add(Xi);var We=new Po,Mn=new Gt,xi=new I,fr=new I;var qi=(n,t,e)=>n+65536+(t+65536)*131072+(e+65536)*131072*131072,Sn=(n,t)=>({x:n.x+t.x,y:n.y+t.y,z:n.z+t.z});function Kt(n,t){let{x:e,y:i,z:s}=n;switch(t&3){case 1:return{x:-s,y:i,z:e};case 2:return{x:-e,y:i,z:-s};case 3:return{x:s,y:i,z:-e};default:return{x:e,y:i,z:s}}}var Xn=(n,t)=>({rot:n.rot+t.rot&3,off:Sn(Kt(t.off,n.rot),n.off)}),Fc=n=>{let t=4-(n.rot&3)&3,e=Kt(n.off,t);return{rot:t,off:{x:-e.x,y:-e.y,z:-e.z}}},Bc=n=>n.slice(1).reduce((t,e)=>Xn(t,{off:e.pos,rot:e.rot}),{off:{x:0,y:0,z:0},rot:0}),qn=n=>"#"+(n&16777215).toString(16).padStart(6,"0"),_i=n=>n<0?-Math.round(-n):Math.round(n),kc=1,Oo=()=>"n"+kc++,Os=()=>kc,zo=n=>{kc=n};var re=(n,t,e,i,s,r,a)=>({x0:n,y0:t,z0:e,x1:i,y1:s,z1:r,c:a}),pr=(n,t,e,i)=>t>=n.x0&&t<n.x1&&e>=n.y0&&e<n.y1&&i>=n.z0&&i<n.z1,mr=(n,t,e,i)=>({x0:n.x0+t,y0:n.y0+e,z0:n.z0+i,x1:n.x1+t,y1:n.y1+e,z1:n.z1+i,c:n.c});function H_(n,t,e){let i=Math.max(n.x0,t.x0),s=Math.max(n.y0,t.y0),r=Math.max(n.z0,t.z0),a=Math.min(n.x1,t.x1),o=Math.min(n.y1,t.y1),c=Math.min(n.z1,t.z1);if(i>=a||s>=o||r>=c){e.push(n);return}let l=n.c;n.x0<i&&e.push({...n,x1:i}),a<n.x1&&e.push({...n,x0:a}),n.y0<s&&e.push({x0:i,y0:n.y0,z0:n.z0,x1:a,y1:s,z1:n.z1,c:l}),o<n.y1&&e.push({x0:i,y0:o,z0:n.z0,x1:a,y1:n.y1,z1:n.z1,c:l}),n.z0<r&&e.push({x0:i,y0:s,z0:n.z0,x1:a,y1:o,z1:r,c:l}),c<n.z1&&e.push({x0:i,y0:s,z0:c,x1:a,y1:o,z1:n.z1,c:l})}function Yi(n,t){let e=[];for(let i of n)H_(i,t,e);return e}function G_(n,t){for(let e=0;e<n.length;){let i=n[e];if(i.c!==t.c){e++;continue}let s=i.y0===t.y0&&i.y1===t.y1,r=i.z0===t.z0&&i.z1===t.z1,a=i.x0===t.x0&&i.x1===t.x1;if(s&&r&&(i.x1===t.x0||t.x1===i.x0))t.x0=Math.min(t.x0,i.x0),t.x1=Math.max(t.x1,i.x1);else if(a&&r&&(i.y1===t.y0||t.y1===i.y0))t.y0=Math.min(t.y0,i.y0),t.y1=Math.max(t.y1,i.y1);else if(a&&s&&(i.z1===t.z0||t.z1===i.z0))t.z0=Math.min(t.z0,i.z0),t.z1=Math.max(t.z1,i.z1);else{e++;continue}n.splice(e,1),e=0}n.push(t)}function Vc(n,t,e){let i=Yi(n,t);return G_(i,{...t,c:e}),i}function ku(n,t,e,i,s){let r=-1;for(let h=0;h<n.length;h++)if(pr(n[h],t,e,i)){r=h;break}if(r===-1)return null;let a=n[r].c;if(a===s)return null;let o=(h,u)=>{let d=h.x0<u.x1&&u.x0<h.x1,m=h.y0<u.y1&&u.y0<h.y1,x=h.z0<u.z1&&u.z0<h.z1;return m&&x&&(h.x1===u.x0||u.x1===h.x0)||d&&x&&(h.y1===u.y0||u.y1===h.y0)||d&&m&&(h.z1===u.z0||u.z1===h.z0)},c=new Set([r]),l=[r];for(;l.length;){let h=n[l.pop()];for(let u=0;u<n.length;u++)!c.has(u)&&n[u].c===a&&o(h,n[u])&&(c.add(u),l.push(u))}return n.map((h,u)=>c.has(u)?{...h,c:s}:h)}function Hc(n,t){let e=[];for(let i of n){let s=Math.max(i.x0,t.x0),r=Math.max(i.y0,t.y0),a=Math.max(i.z0,t.z0),o=Math.min(i.x1,t.x1),c=Math.min(i.y1,t.y1),l=Math.min(i.z1,t.z1);s<o&&r<c&&a<l&&e.push({x0:s,y0:r,z0:a,x1:o,y1:c,z1:l,c:i.c})}return e}function Vu(n,t){for(let e of n){let i=(e.x1-e.x0)*(e.y1-e.y0)*(e.z1-e.z0);t.set(e.c,(t.get(e.c)||0)+i)}}function Xe(n,t){for(let e of n)e.x0<t.min.x&&(t.min.x=e.x0),e.y0<t.min.y&&(t.min.y=e.y0),e.z0<t.min.z&&(t.min.z=e.z0),e.x1>t.max.x&&(t.max.x=e.x1),e.y1>t.max.y&&(t.max.y=e.y1),e.z1>t.max.z&&(t.max.z=e.z1)}function Yn(n,t,e){let i=Kt({x:n.x0,y:n.y0,z:n.z0},t),s=Kt({x:n.x1-1,y:n.y1-1,z:n.z1-1},t);return{x0:Math.min(i.x,s.x)+e.x,y0:Math.min(i.y,s.y)+e.y,z0:Math.min(i.z,s.z)+e.z,x1:Math.max(i.x,s.x)+e.x+1,y1:Math.max(i.y,s.y)+e.y+1,z1:Math.max(i.z,s.z)+e.z+1,c:n.c}}var W_=16,Ve=n=>Math.floor(n/W_);function Hu(n){if(!n.length)return()=>!1;let t=1/0,e=1/0,i=1/0,s=-1/0,r=-1/0,a=-1/0;for(let _ of n)_.x0<t&&(t=_.x0),_.y0<e&&(e=_.y0),_.z0<i&&(i=_.z0),_.x1>s&&(s=_.x1),_.y1>r&&(r=_.y1),_.z1>a&&(a=_.z1);let o=Ve(t),c=Ve(e),l=Ve(i),h=Ve(s-1)-o+1,u=Ve(r-1)-c+1,d=Ve(a-1)-l+1,m=Array.from({length:h*u*d},()=>[]),x=(_,p,f)=>((_-o)*u+(p-c))*d+(f-l);for(let _ of n)for(let p=Ve(_.x0);p<=Ve(_.x1-1);p++)for(let f=Ve(_.y0);f<=Ve(_.y1-1);f++)for(let v=Ve(_.z0);v<=Ve(_.z1-1);v++)m[x(p,f,v)].push(_);return(_,p,f)=>{let v=Ve(_),y=Ve(p),T=Ve(f);if(v<o||y<c||T<l||v-o>=h||y-c>=u||T-l>=d)return!1;for(let C of m[x(v,y,T)])if(pr(C,_,p,f))return!0;return!1}}var Gu=(n,t,e,i)=>n.some(s=>pr(s,t,e,i));function Gc(n,t,e,i,s){if(!n.length||!t.length)return!1;let r={min:{x:1e9,y:1e9,z:1e9},max:{x:-1e9,y:-1e9,z:-1e9}};Xe(n,r);let a=r.min.x+e,o=r.min.y+i,c=r.min.z+s,l=r.max.x+e,h=r.max.y+i,u=r.max.z+s;for(let d of t)if(a<d.x1&&d.x0<l&&o<d.y1&&d.y0<h&&c<d.z1&&d.z0<u&&n.some(m=>m.x0+e<d.x1&&d.x0<m.x1+e&&m.y0+i<d.y1&&d.y0<m.y1+i&&m.z0+s<d.z1&&d.z0<m.z1+s))return!0;return!1}var X_=[{a:0,hi:!0,u:1,v:2,n:[1,0,0]},{a:0,hi:!1,u:2,v:1,n:[-1,0,0]},{a:1,hi:!0,u:2,v:0,n:[0,1,0]},{a:1,hi:!1,u:0,v:2,n:[0,-1,0]},{a:2,hi:!0,u:0,v:1,n:[0,0,1]},{a:2,hi:!1,u:1,v:0,n:[0,0,-1]}],qu=3,gr=2,yi=qu*gr,Wu=.5,xr=class{a=new Float32Array(4096);n=0;push3(t,e,i){if(this.n+3>this.a.length){let s=new Float32Array(this.a.length*2);s.set(this.a),this.a=s}this.a[this.n++]=t,this.a[this.n++]=e,this.a[this.n++]=i}get length(){return this.n}trimmed(){return this.a.slice(0,this.n)}};function Xu(n,t,e,i,s,r){let a=2*gr+1;for(let o=0;o<e;o++){let c=o*s,l=0;for(let h=0;h<=gr&&h<i;h++)l+=n[c+h*r];for(let h=0;h<i;h++){t[c+h*r]=l/a;let u=h+gr+1,d=h-gr;u<i&&(l+=n[c+u*r]),d>=0&&(l-=n[c+d*r])}}}function Wc(n,t,e){let i=new xr,s=new xr,r=new xr,a=n.map(v=>[v.x0,v.y0,v.z0]),o=n.map(v=>[v.x1,v.y1,v.z1]),c=[0,1,2].map(()=>new Map),l=[0,1,2].map(()=>new Map),h=(v,y,T)=>{let C=v.get(y);C?C.push(T):v.set(y,[T])};for(let v=0;v<n.length;v++)for(let y=0;y<3;y++)h(c[y],a[v][y],v),h(l[y],o[v][y],v);let u=[],d=16,m=v=>Math.floor(v/d),x=[],_=[0,0,0],p=[0,0,0];if(e&&n.length){let v=[1/0,1/0,1/0],y=[-1/0,-1/0,-1/0];for(let T=0;T<n.length;T++)for(let C=0;C<3;C++)a[T][C]<v[C]&&(v[C]=a[T][C]),o[T][C]>y[C]&&(y[C]=o[T][C]);p=v.map(m),_=y.map((T,C)=>m(T-1)-p[C]+1),x=Array.from({length:_[0]*_[1]*_[2]},()=>[]);for(let T=0;T<n.length;T++)for(let C=m(a[T][0]);C<=m(o[T][0]-1);C++)for(let R=m(a[T][1]);R<=m(o[T][1]-1);R++)for(let A=m(a[T][2]);A<=m(o[T][2]-1);A++)x[((C-p[0])*_[1]+(R-p[1]))*_[2]+(A-p[2])].push(T)}for(let v=0;v<n.length;v++){let y=t(n[v].c),T=y.r,C=y.g,R=y.b,A=a[v],H=o[v];for(let S of X_){let{a:w,u:N,v:X}=S,rt=S.hi?H[w]:A[w],L=S.hi?rt:rt-1,B=[];for(let it of(S.hi?c:l)[w].get(rt)??u){let nt=Math.max(a[it][N],A[N]),st=Math.min(o[it][N],H[N]),ft=Math.max(a[it][X],A[X]),gt=Math.min(o[it][X],H[X]);nt<st&&ft<gt&&B.push([nt,ft,st,gt])}let W=[[A[N],A[X],H[N],H[X]]];for(let it of B){let nt=[];for(let st of W){let ft=Math.max(st[0],it[0]),gt=Math.max(st[1],it[1]),vt=Math.min(st[2],it[2]),U=Math.min(st[3],it[3]);if(ft>=vt||gt>=U){nt.push(st);continue}st[0]<ft&&nt.push([st[0],st[1],ft,st[3]]),vt<st[2]&&nt.push([vt,st[1],st[2],st[3]]),st[1]<gt&&nt.push([ft,st[1],vt,gt]),U<st[3]&&nt.push([ft,U,vt,st[3]])}if(W=nt,!W.length)break}let Y=[0,0,0];Y[w]=rt;let q=null,G=0,Z=0,$=0,dt=()=>{G=A[N]-yi,Z=A[X]-yi;let it=H[N]-A[N]+2*yi+1;$=H[X]-A[X]+2*yi+1;let nt=new Float32Array(it*$),st=m(L)-p[w],ft=!1;if(st>=0&&st<_[w]){let vt=[0,0,0];vt[w]=st;let U=Math.min(m(G+it-1)-p[N],_[N]-1),ie=Math.min(m(Z+$-1)-p[X],_[X]-1);for(let yt=Math.max(m(G)-p[N],0);yt<=U;yt++){vt[N]=yt;for(let mt=Math.max(m(Z)-p[X],0);mt<=ie;mt++){vt[X]=mt;for(let et of x[(vt[0]*_[1]+vt[1])*_[2]+vt[2]]){if(a[et][w]>L||o[et][w]<=L)continue;let jt=Math.max(a[et][N],G),Pt=Math.min(o[et][N],G+it),E=Math.max(a[et][X],Z),M=Math.min(o[et][X],Z+$);for(let O=jt;O<Pt;O++)nt.fill(1,(O-G)*$+(E-Z),(O-G)*$+(M-Z));ft=ft||jt<Pt&&E<M}}}}if(!ft)return q=nt;let gt=new Float32Array(it*$);for(let vt=0;vt<qu;vt++)Xu(nt,gt,it,$,$,1),Xu(gt,nt,$,it,1,$);return q=nt},V=(it,nt)=>{if(!e)return 1;let ft=(q??dt())[(it-G)*$+(nt-Z)];return Wu+(1-Wu)*(1-ft)},J=(it,nt,st)=>{Y[N]=it,Y[X]=nt,i.push3(Y[0],Y[1],Y[2]),s.push3(S.n[0],S.n[1],S.n[2]),r.push3(T*st,C*st,R*st)},ct=(it,nt,st,ft)=>{let gt=V(it,nt),vt=V(st,nt),U=V(st,ft),ie=V(it,ft);J(it,nt,gt),J(st,nt,vt),J(st,ft,U),J(it,nt,gt),J(st,ft,U),J(it,ft,ie)};for(let it of W){let[nt,st,ft,gt]=it;if(!e){ct(nt,st,ft,gt);continue}let vt=nt+yi,U=ft-yi,ie=st+yi,yt=gt-yi;if(vt>=U||ie>=yt){for(let mt=nt;mt<ft;mt++)for(let et=st;et<gt;et++)ct(mt,et,mt+1,et+1);continue}for(let mt=nt;mt<ft;mt++){for(let et=st;et<ie;et++)ct(mt,et,mt+1,et+1);for(let et=yt;et<gt;et++)ct(mt,et,mt+1,et+1)}for(let mt=ie;mt<yt;mt++){for(let et=nt;et<vt;et++)ct(et,mt,et+1,mt+1);for(let et=U;et<ft;et++)ct(et,mt,et+1,mt+1)}ct(vt,ie,U,yt)}}}if(!i.length)return null;let f=new ke;return f.setAttribute("position",new Pe(i.trimmed(),3)),f.setAttribute("normal",new Pe(s.trimmed(),3)),f.setAttribute("color",new Pe(r.trimmed(),3)),f}var Fo=[7041116,10855821,12040100,14472900,13343102,14532265,15787730,9268835,13935475,10249796,11895693,7170165,8226199,6055805,6986062,10994876],Yu={visible:0,deemphasized:1,hidden:2},Ju={visible:"deemphasized",deemphasized:"hidden",hidden:"visible"},_r=()=>({type:"object",id:Oo(),name:"",pos:{x:0,y:0,z:0},rot:0,vis:"visible",boxes:[]}),Ji=(n="")=>({type:"scene",id:Oo(),name:n,pos:{x:0,y:0,z:0},rot:0,vis:"visible",children:[]});function vi(n){let t={id:Oo(),name:n.name,pos:{...n.pos},rot:n.rot,vis:n.vis};return n.type==="object"?{type:"object",...t,boxes:n.boxes.map(e=>({...e}))}:{type:"scene",...t,children:n.children.map(vi)}}var Jn=n=>g.context.children.find(t=>t.id===n);function bn(n,t=g.root,e=[]){if(e.push(t),t===n)return e.slice();if(t.type==="scene")for(let i of t.children){let s=bn(n,i,e);if(s)return s}return e.pop(),null}function Zn(n,t=g.root){if(t.id===n)return t;if(t.type==="scene")for(let e of t.children){let i=Zn(n,e);if(i)return i}return null}function on(n){let t=bn(n);return t&&t.length>1?t[t.length-2]:null}function Zi(n,t){return n===t?!0:n.type!=="scene"?!1:n.children.some(e=>Zi(e,t))}var zs=()=>Bc(g.path),Fs=n=>Bc(bn(n)||[g.root]),He=()=>({min:{x:1e9,y:1e9,z:1e9},max:{x:-1e9,y:-1e9,z:-1e9}}),Mi=n=>n.max.x<n.min.x;function yr(n,t,e,i){if(n.type==="object")for(let s of n.boxes)i.push(Yn(s,e,t));else for(let s of n.children)yr(s,Sn(t,Kt(s.pos,e)),e+s.rot&3,i);return i}function Si(n,t,e,i){if(n.type==="object")Xe(n.boxes.map(s=>Yn(s,e,t)),i);else for(let s of n.children)Si(s,Sn(t,Kt(s.pos,e)),e+s.rot&3,i);return i}function Bo(n,t){Mn.x=(n-ue.x)/ue.w*2-1,Mn.y=-((t-ue.y)/ue.h)*2+1}var Xc=()=>g.pickMeshes.length?(We.setFromCamera(Mn,Ht),We.intersectObjects(g.pickMeshes,!1)[0]??null):null;function qc(){let n=Xc();return n?n.object.userData.childId??null:null}var Zu=new nn(new I(0,1,0),0);function vr(n){return We.setFromCamera(Mn,Ht),Zu.constant=-n,We.ray.intersectPlane(Zu,xi)?{x:Math.floor(xi.x),y:n,z:Math.floor(xi.z)}:null}var ju=(n,t)=>({x:Math.floor(n.x-t.x*.5),y:Math.floor(n.y-t.y*.5),z:Math.floor(n.z-t.z*.5)}),q_=new I;function $i(){let n=Xc();if(!n)return null;let t=g.editXform.off,e=Kt({x:n.point.x-t.x,y:n.point.y-t.y,z:n.point.z-t.z},-g.editXform.rot),i={x:0,y:1,z:0};if(n.face){let r=q_.copy(n.face.normal).transformDirection(n.object.matrixWorld);i=Kt({x:r.x,y:r.y,z:r.z},-g.editXform.rot)}let s=ju(e,i);return{cell:s,addCell:{x:s.x+Math.round(i.x),y:s.y+Math.round(i.y),z:s.z+Math.round(i.z)}}}function Qu(){let n=Xc();return n?ju(n.point,n.face?n.face.normal:{x:0,y:1,z:0}):vr(0)}function Ki(n){let t=vr(n+g.editXform.off.y);if(!t)return null;let e=Kt({x:t.x-g.editXform.off.x,y:0,z:t.z-g.editXform.off.z},-g.editXform.rot);return{x:Math.round(e.x),y:n,z:Math.round(e.z)}}var $u=(n,t)=>({x:n===0?t:0,y:n===1?t:0,z:n===2?t:0}),Ku=new nn;function td(n,t){let e=g.editXform.off,i=g.editXform.rot,s=Kt($u(n,1),i),r=Sn(Kt($u(n,t),i),e);if(We.setFromCamera(Mn,Ht),Ku.setComponents(s.x,s.y,s.z,-(s.x*r.x+s.y*r.y+s.z*r.z)),!We.ray.intersectPlane(Ku,xi))return null;let a=Kt({x:xi.x-e.x,y:xi.y-e.y,z:xi.z-e.z},-i),o={x:Math.round(a.x),y:Math.round(a.y),z:Math.round(a.z)};return n===0?o.x=t:n===1?o.y=t:o.z=t,o}var $n=(n,t,e)=>{let i=Kt({x:n,y:t,z:e},g.editXform.rot);return new I(i.x+g.editXform.off.x,i.y+g.editXform.off.y,i.z+g.editXform.off.z)};function Yc(n=$i()){return g.tool==="add"?n?n.addCell:Ki(0):n?n.cell:null}var Y_=new It(10994876),J_=new It(6055805),Z_=new It(13619151),Mr=null,ko=[],Jc=()=>{Mr=null};function ji(){En=null,g.liveMeas=null,bi()}function Zc(){if(Mr)return Mr;let n=[],t;g.editObject?(n.push(...g.editObject.boxes),t=$n):(Ei(g.root,{x:0,y:0,z:0},0,null,0,(o,c,l,h)=>{if(h)for(let u of o.boxes)n.push(Yn(u,l,c))}),t=(o,c,l)=>new I(o,c,l));let e=He();Xe(n,e);let i=n.length===0,s={x:e.min.x,y:e.min.y,z:e.min.z},r={x:e.max.x-1,y:e.max.y-1,z:e.max.z-1};return Mr={has:n.length>64?Hu(n):(o,c,l)=>Gu(n,o,c,l),mn:s,mx:r,toW:t,empty:i},Mr}function ed(){let n=Zc();if(n.empty)return null;let t=null;if(g.editObject){let e=$i();t=e?{...e.cell}:Ki(0)}else t=Qu();return t?{x:Math.max(n.mn.x,Math.min(n.mx.x,t.x)),y:Math.max(n.mn.y,Math.min(n.mx.y,t.y)),z:Math.max(n.mn.z,Math.min(n.mx.z,t.z))}:null}function $_(n){let t=Zc(),e=["x","y","z"],i=[];for(let s=0;s<3;s++){let r=e[s],a=e[(s+1)%3],o=e[(s+2)%3],c=t.mn[r],l=t.mx[r],h=[n.x,n.y,n.z],u=m=>(h[s]=m,t.has(h[0],h[1],h[2])),d=c;for(;d<=l;){let m=u(d),x=d;for(;x+1<=l&&u(x+1)===m;)x++;let _=p=>{let f={};return f[r]=p,f[a]=n[a]+.5,f[o]=n[o]+.5,t.toW(f.x,f.y,f.z)};i.push({a:_(d),b:_(x+1),mid:_((d+x+1)/2),len:x-d+1,filled:m}),d=x+1}}return i}function $c(n,t,e,i,s,r,a,o,c=!1){let l=i-n,h=s-t,u=r-e,d=(m,x,_,p,f,v,y,T)=>({a:a(m,x,_),b:a(p,f,v),mid:a((m+p)/2,(x+f)/2,(_+v)/2),len:y,filled:!0,nolabel:!T,gray:c});return[d(n,t,e,i,t,e,l,l>=o),d(n,t,e,n,t,r,u,u>=o),d(n,t,e,n,s,e,h,h>=o),d(i,t,e,i,t,r,0,!1),d(n,t,r,i,t,r,0,!1),d(n,s,e,i,s,e,0,!1),d(n,s,e,n,s,r,0,!1),d(i,s,e,i,s,r,0,!1),d(n,s,r,i,s,r,0,!1),d(i,t,e,i,s,e,0,!1),d(n,t,r,n,s,r,0,!1),d(i,t,r,i,s,r,0,!1)]}var En=null;function nd(){let n=ed();n&&(En=En&&En.x===n.x&&En.y===n.y&&En.z===n.z?null:n,Vo())}function id(){En&&(En=null,Vo())}function K_(n,t){let e=Zc();return $c(Math.min(n.x,t.x),Math.min(n.y,t.y),Math.min(n.z,t.z),Math.max(n.x,t.x)+1,Math.max(n.y,t.y)+1,Math.max(n.z,t.z)+1,e.toW,1,!0)}function Vo(){let n=ed();g.liveMeas=n?En?K_(En,n):$_(n):null,bi()}function bi(){let n=document.getElementById("measure");n.innerHTML="",ko=[];let t=[],e=[];if(g.liveMeas)for(let s of g.liveMeas){let r=s.gray?Z_:s.filled?Y_:J_;if(t.push(s.a.x,s.a.y,s.a.z,s.b.x,s.b.y,s.b.z),e.push(r.r,r.g,r.b,r.r,r.g,r.b),s.nolabel)continue;let a=document.createElement("div");a.className="mlab"+(s.filled?"":" empty"),a.textContent=String(s.len),n.appendChild(a),ko.push({el:a,w:s.mid})}Xi.geometry.dispose();let i=new ke;i.setAttribute("position",new Fe(t,3)),i.setAttribute("color",new Fe(e,3)),Xi.geometry=i,Xi.visible=t.length>0}function sd(){if(ko.length)for(let n of ko){if(fr.copy(n.w).project(Ht),fr.z>1){n.el.style.display="none";continue}n.el.style.display="",n.el.style.left=(fr.x*.5+.5)*ue.w+"px",n.el.style.top=(-fr.y*.5+.5)*ue.h+"px"}}var Kc=new I(40,150,30).normalize();function j_(n){if(Mi(n))return;let t=(n.min.x+n.max.x)/2,e=(n.min.y+n.max.y)/2,i=(n.min.z+n.max.z)/2,s=.5*Math.hypot(n.max.x-n.min.x,n.max.y-n.min.y,n.max.z-n.min.z)+8,r=s+130;$e.position.set(t+Kc.x*r,e+Kc.y*r,i+Kc.z*r),$e.target.position.set(t,e,i),$e.target.updateMatrixWorld();let a=$e.shadow.camera;a.left=-s,a.right=s,a.top=s,a.bottom=-s,a.near=Math.max(1,r-s-20),a.far=r+s+20,a.updateProjectionMatrix(),$e.shadow.normalBias=4*s/$e.shadow.mapSize.x}var Kn=[];function Q_(){let n=new Set;for(let t of Kn){we.remove(t);let e=t.geometry;e&&!n.has(e)&&(e.dispose(),n.add(e))}Kn=[],Ho=[],Qc(),vn.clear(),Vs&&(cancelAnimationFrame(Vs),Vs=0),je=null}var Ho=[],je=null,Vs=0,ks=null;function Qc(){ks&&(vn.remove(ks),ks.geometry.dispose(),ks.material.dispose(),ks=null)}function Bs(n,t,{tier:e="opaque",childId:i}={}){if(!n.length)return null;let s=e!=="opaque",r=Wc(n,t,!s);if(!r)return null;let a=new Ee(r,e==="deemph"?zu:e==="temp"?Fu:zc);if(a.castShadow=!0,a.receiveShadow=!0,we.add(a),Kn.push(a),s){a.renderOrder=2;let o=new Ee(r,Bu);o.renderOrder=1,o.castShadow=!1,o.receiveShadow=!1,we.add(o),Kn.push(o)}return i!=null&&(a.userData.childId=i,g.pickMeshes.push(a),(g.childMeshes[i]||(g.childMeshes[i]=[])).push(a)),a}function Ei(n,t,e,i,s,r){let a=Math.max(s,Yu[n.vis]);if(!(n===g.editObject||a>=2))if(n.type==="object")r(n,t,e,i,a===1);else for(let o of n.children)Ei(o,Sn(t,Kt(o.pos,e)),e+o.rot&3,n===g.context?o.id:i,a,r)}var rd=(n,t,e,i)=>{for(let s of n.boxes)i.push(Yn(s,e,t));return i};function od(){let{off:n,rot:t}=g.editXform;if(vn.position.set(n.x,n.y,n.z),vn.rotation.set(0,-t*Math.PI/2,0),vn.updateMatrixWorld(!0),je){vn.remove(je),je.geometry.dispose();let r=Kn.indexOf(je);r>=0&&Kn.splice(r,1)}let e=g.sel3d,i=e&&e.lifted?g.editObject.boxes.concat(e.boxes):g.editObject.boxes,s=Wc(i,gi,!0);je=s?new Ee(s,zc):null,je&&(je.castShadow=je.receiveShadow=!0,vn.add(je),Kn.push(je)),g.pickMeshes=je?[je,...Ho]:[...Ho],e?ty(e.region):Qc()}function ty(n){Qc();let t=new yn(n.x1-n.x0,n.y1-n.y0,n.z1-n.z0),e=new pi(new ki(t),new Gn({color:16766073,depthTest:!1}));t.dispose(),e.position.set((n.x0+n.x1)/2,(n.y0+n.y1)/2,(n.z0+n.z1)/2),e.renderOrder=1e3,vn.add(e),ks=e}function wi(){Vs||(Vs=requestAnimationFrame(()=>{Vs=0,od(),Ns()}))}function Go(){g.voxVer++,Jc(),wi()}function tl(n,t){g.editObject.boxes=Vc(g.editObject.boxes,n,t),Go()}function Sr(n){g.editObject.boxes=Yi(g.editObject.boxes,n),Go()}function Wo(n){let t=g.editObject.boxes;for(let e of n)t=Vc(t,e,e.c);g.editObject.boxes=t,Go()}function ad(n,t){let e=ku(g.editObject.boxes,n.x,n.y,n.z,t);return e?(g.editObject.boxes=e,Go(),!0):!1}function cd(){if(!Kn.length)return null;We.setFromCamera(Mn,Ht);let n=We.intersectObjects(Kn,!1)[0];if(!n)return null;let t=We.ray.direction,e=Math.floor(n.point.x+t.x*.5),i=Math.floor(n.point.y+t.y*.5),s=Math.floor(n.point.z+t.z*.5),r=(o,c,l)=>{let h=Kt({x:e-c.x,y:i-c.y,z:s-c.z},-l);for(let u of o)if(pr(u,h.x,h.y,h.z))return u.c;return null};if(g.editObject){let o=r(g.editObject.boxes,g.editXform.off,g.editXform.rot);if(o!=null)return o}let a=null;return Ei(g.root,{x:0,y:0,z:0},0,null,0,(o,c,l)=>{a==null&&(a=r(o.boxes,c,l))}),a}var jc=new Set;function Ti(n){for(let t of jc)if(n.has(t)!==g.selection.has(t)){Se();return}ld()}function Se(){Q_(),g.pickMeshes=[],g.childMeshes={},g.childBox={},jc.clear(),g.voxVer++,Jc();let n={x:0,y:0,z:0},t=He();if(g.editObject){g.editXform=Xn(zs(),{off:g.editObject.pos,rot:g.editObject.rot});let e=[],i=[];Ei(g.root,n,0,null,0,(r,a,o,c,l)=>rd(r,a,o,l?i:e)),Xe(e,t),Xe(i,t),Bs(i,gi,{tier:"deemph"});let s=Bs(e,gi,{tier:"temp"});Ho=s?[s]:[],od(),Si(g.editObject,g.editXform.off,g.editXform.rot,t)}else{let e=new Map,i=new Map,s=[],r=[];Ei(g.root,n,0,null,0,(a,o,c,l,h)=>{let u=rd(a,o,c,[]);if(Xe(u,t),l){h&&jc.add(l);let m=!h||g.selection.has(l)?e:i,x=m.get(l);x?x.push(...u):m.set(l,u),Xe(u,g.childBox[l]||(g.childBox[l]=He()))}else(h?r:s).push(...u)}),Bs(s,gi,{tier:"temp"}),Bs(r,gi,{tier:"deemph"});for(let a of new Set([...e.keys(),...i.keys()])){let o=e.get(a);o&&Bs(o,gi,{childId:a});let c=i.get(a);c&&Bs(c,gi,{tier:"deemph"})}}g.sceneBox=t,j_(t),ld(),Ns()}function ey(n,t,e){let i=new yn(t.x-n.x,t.y-n.y,t.z-n.z),s=new pi(new ki(i),new Gn({color:e,depthTest:!1}));return s.position.set((n.x+t.x)/2,(n.y+t.y)/2,(n.z+t.z)/2),s.renderOrder=999,i.dispose(),s}function ld(){for(let n of Wn.children)n.geometry?.dispose?.();if(Wn.clear(),Wn.position.set(0,0,0),!g.editObject)for(let n of g.selection){let t=g.childBox[n];t&&!Mi(t)&&Wn.add(ey(t.min,t.max,15787730))}}function de(n,t={},...e){let i=document.createElement(n);return Object.assign(i,t),e.length&&i.append(...e),i}var br=new I,el=new I,nl=new I,hd=new I,ny=new I(0,1,0);function ud(n,t){let e=(Ht.top-Ht.bottom)/ue.h;Ht.getWorldDirection(el),nl.crossVectors(el,ny).normalize(),hd.crossVectors(nl,el).normalize(),Xt.target.addScaledVector(nl,-n*e),Xt.target.addScaledVector(hd,t*e)}function dd(n,t){Xt.azim-=n*.012,Xt.elev=Math.max(-Math.PI/2,Math.min(Math.PI/2,Xt.elev+t*.012))}function fd(n){Mi(n)||(Xt.target.set((n.min.x+n.max.x)/2,(n.min.y+n.max.y)/2,(n.min.z+n.max.z)/2),Xt.zoom=Math.max(8,Math.min(Uo,Math.max(n.max.x-n.min.x,n.max.y-n.min.y,n.max.z-n.min.z)*1.5+8)))}function jn(){let n=He();if(g.editObject){if(Si(g.editObject,g.editXform.off,g.editXform.rot,n),Mi(n)){let t=g.editXform.off;Xt.target.set(t.x,t.y+6,t.z),Xt.zoom=41;return}}else for(let t in g.childBox){let e=g.childBox[t];n.min.x=Math.min(n.min.x,e.min.x),n.min.y=Math.min(n.min.y,e.min.y),n.min.z=Math.min(n.min.z,e.min.z),n.max.x=Math.max(n.max.x,e.max.x),n.max.y=Math.max(n.max.y,e.max.y),n.max.z=Math.max(n.max.z,e.max.z)}if(Mi(n)){Xt.target.set(0,1,0),Xt.zoom=23;return}fd(n)}function pd(n){if(n===g.root){jn();return}let t=Fs(n);fd(Si(n,t.off,t.rot,He()))}function md(){Wt.azim+=(Xt.azim-Wt.azim)*.22,Wt.elev+=(Xt.elev-Wt.elev)*.22,Wt.zoom+=(Xt.zoom-Wt.zoom)*.25,Wt.target.lerp(Xt.target,.25);let n=Math.cos(Wt.elev),t=Math.sin(Wt.elev);br.set(n*Math.sin(Wt.azim),t,n*Math.cos(Wt.azim)),Ht.position.copy(Wt.target).addScaledVector(br,Iu);let e=Mu.clamp((Math.abs(Wt.elev)-1.45)/(Math.PI/2-1.45),0,1);No.set(-Math.sin(Wt.azim),0,-Math.cos(Wt.azim)),Wt.elev<0&&No.negate(),Oc.set(0,1,0).lerp(No,e),Ht.up.copy(Oc.normalize()),Ht.lookAt(Wt.target);let i=ue.w/ue.h,s=Wt.zoom,r=s*i;Ht.left=-r/2,Ht.right=r/2,Ht.top=s/2,Ht.bottom=-s/2;let a=Ht.position,o=1/0,c=-1/0,l=(x,_,p)=>{let f=(a.x-x)*br.x+(a.y-_)*br.y+(a.z-p)*br.z;f<o&&(o=f),f>c&&(c=f)},h=g.sceneBox;if(h&&!Mi(h))for(let x of[h.min.x,h.max.x])for(let _ of[h.min.y,h.max.y])for(let p of[h.min.z,h.max.z])l(x,_,p);let u=Wt.target.x,d=Wt.target.z,m=4e3;for(let x of[-m,m])for(let _ of[-m,m])l(u+x,0,d+_);o>c&&(o=.1,c=4e3),Ht.near=o-10,Ht.far=c+10,Ht.updateProjectionMatrix(),Wi.position.set(Wt.target.x,-.1,Wt.target.z),Uu()}var iy={0:["y","z"],1:["x","z"],2:["x","y"]};function sy(n){let t=[];for(let e of n)for(let i=e.x0;i<e.x1;i++)for(let s=e.y0;s<e.y1;s++)for(let r=e.z0;r<e.z1;r++)t.push({x:i,y:s,z:r,c:e.c});return t}function ry(n,t,e,i,s){let r=(e%360+360)%360;if(r>180&&(r-=360),r===0)return;let a=Math.round(r/90),o=(r-a*90)*Math.PI/180,c=(a%4+4)%4,l=Math.tan(o/2),h=Math.sin(o),[u,d]=iy[t];for(let m of n){let x=m[u]-i,_=m[d]-s;for(let p=0;p<c;p++){let f=-_,v=x;x=f,_=v}o&&(x-=Math.round(_*l),_+=Math.round(x*h),x-=Math.round(_*l)),m[u]=i+x,m[d]=s+_}}function oy(n){let t=new Map;for(let o of n)t.set(qi(o.x,o.y,o.z),o.c);let e=(o,c,l,h)=>t.get(qi(o,c,l))===h,i=(o,c,l,h,u)=>{for(let d=o;d<c;d++)if(!e(d,l,h,u))return!1;return!0},s=(o,c,l,h,u,d)=>{for(let m=l;m<h;m++)if(!i(o,c,u,m,d))return!1;return!0},r=n.slice().sort((o,c)=>o.y-c.y||o.z-c.z||o.x-c.x),a=[];for(let o of r){let c=o.x,l=o.y,h=o.z,u=o.c;if(!t.has(qi(c,l,h)))continue;let d=c+1;for(;e(d,l,h,u);)d++;let m=h+1;for(;i(c,d,l,m,u);)m++;let x=l+1;for(;s(c,d,h,m,x,u);)x++;for(let _=l;_<x;_++)for(let p=h;p<m;p++)for(let f=c;f<d;f++)t.delete(qi(f,_,p));a.push({x0:c,y0:l,z0:h,x1:d,y1:x,z1:m,c:u})}return a}function gd(n,t,e,i,s,r){let a=sy(n);ry(a,e,t,Math.round(i),Math.round(s));for(let o of a){let c=r(o.x,o.y,o.z);o.x=c.x,o.y=c.y,o.z=c.z}return oy(a)}var il=null,xd=[],_d=[],Hs=()=>il;function yd(n){xd=n,n.length&&(il="node")}var Xo=()=>xd;function vd(n){_d=n,n.length&&(il="vox")}var qo=()=>_d;var ay=200,wn=[],Qn=-1,Yo=!1,Md=n=>({rootJSON:n,uid:Os(),pathIds:g.path.map(t=>t.id),selection:[...g.selection],editId:g.editObject?g.editObject.id:null,collapsed:[...g.collapsed]});function Sd(n){if(Yo)return;let t=Md(n),e=wn[Qn];e&&e.rootJSON===t.rootJSON||(wn.length=Qn+1,wn.push(t),wn.length>ay&&wn.shift(),Qn=wn.length-1)}function bd(n){Yo||Qn<0||(wn[Qn]=Md(n))}function Ed(n){Yo=!0,zo(n.uid),g.root=Jo(JSON.parse(n.rootJSON)),g.path=[];let t=g.root;for(let e of n.pathIds){let i=t.id===e?t:t.type==="scene"?t.children.find(s=>s.id===e):null;if(!i)break;t=i,g.path.push(t)}g.path.length||(g.path=[g.root]),g.editObject=n.editId?Zn(n.editId):null,g.selection=new Set(n.selection.filter(e=>g.context.children.some(i=>i.id===e))),g.collapsed=new Set(n.collapsed),g.drag=null,g.sel3d=null,g.painting=!1,g.lastVox=null,Se(),qt(),oe(),Yo=!1}function wd(){Tn(),Qn>0&&Ed(wn[--Qn])}function sl(){Tn(),Qn<wn.length-1&&Ed(wn[++Qn])}var Td="voxelier-v11";function wr(n){let t={id:n.id,nm:n.name,p:n.pos,r:n.rot,vs:n.vis};return n.type==="object"?{t:"o",...t,b:n.boxes.map(e=>[e.x0,e.y0,e.z0,e.x1,e.y1,e.z1,e.c])}:{t:"s",...t,c:n.children.map(wr)}}var cy={transparent:"deemphasized",invisible:"hidden"};function Jo(n){let t={id:n.id,name:n.nm||"",pos:n.p,rot:n.r,vis:cy[n.vs]||n.vs||"visible"};return n.t==="o"?{type:"object",...t,boxes:n.b.map(e=>({x0:e[0],y0:e[1],z0:e[2],x1:e[3],y1:e[4],z1:e[5],c:e[6]}))}:{type:"scene",...t,children:n.c.map(Jo)}}var Er;function Ad(n){try{let t=JSON.stringify([...g.collapsed]);localStorage.setItem(Td,`{"uid":${Os()},"root":${n},"collapsed":${t}}`)}catch{}}function Tn(){clearTimeout(Er),Er=void 0;let n=JSON.stringify(wr(g.root));Sd(n),Ad(n)}function Rd(){if(Er!==void 0)return;let n=JSON.stringify(wr(g.root));bd(n),Ad(n)}function oe(){clearTimeout(Er),Er=setTimeout(Tn,250)}function rl(n){return!n||!n.root?!1:(zo(n.uid||1),g.root=Jo(n.root),g.collapsed=new Set(n.collapsed??[]),!0)}function Cd(){try{return rl(JSON.parse(localStorage.getItem(Td)))}catch{return!1}}var ly=2;function Tr(n){let t=He();return Xe(n,t),{mn:t.min,mx:t.max}}var Zo=n=>{let{mn:t,mx:e}=Tr(n);return{x0:t.x,y0:t.y,z0:t.z,x1:e.x,y1:e.y,z1:e.z}};function Ld(n){if(!n.length)return[];let{mn:t}=Tr(n);return n.map(e=>mr(e,-t.x,-t.y,-t.z))}function Id(n){let t=Hc(g.editObject.boxes,n);g.sel3d={region:t.length?Zo(t):{...n},boxes:t,lifted:!1},wi()}function ol(){let n=g.sel3d;!n||n.lifted||(Tn(),n.lifted=!0,Sr(n.region))}function al(){uy();let n=g.sel3d;!n||!n.lifted||(n.lifted=!1,Wo(n.boxes),n.boxes=Hc(g.editObject.boxes,n.region),oe())}function ti(){let n=g.sel3d;n&&(g.sel3d=null,n.lifted?(Wo(n.boxes),oe()):wi())}function cl(){let n=g.sel3d;if(!n)return;let t=n.region,e=n.lifted;g.sel3d=null,e?wi():Sr(t),oe()}function ll(){g.sel3d&&g.sel3d.boxes.length&&vd(Ld(g.sel3d.boxes))}function Dd(){ll(),cl()}function Ud(n){if(!n.length)return;ti();let t=Ld(n),e=0,i=0,s=0,r=g.editObject.boxes;if(r.length){let{mn:o,mx:c}=Tr(r);e=c.x+ly,i=o.y,s=o.z}let a=t.map(o=>mr(o,e,i,s));g.sel3d={region:Zo(a),boxes:a,lifted:!1},Wo(a),oe()}function Nd(n,t,e){let i=g.sel3d;if(!i||!n&&!t&&!e)return;let s=i.region;s.x0+=n,s.x1+=n,s.y0+=t,s.y1+=t,s.z0+=e,s.z1+=e,i.boxes=i.boxes.map(r=>mr(r,n,t,e)),wi()}function Pd(n,t,e){let{x:i,y:s,z:r}=n;for(let a=(e%4+4)%4;a>0;a--)if(t===0){let o=-r,c=s;s=o,r=c}else if(t===1){let o=-r,c=i;i=o,r=c}else{let o=-s,c=i;i=o,s=c}return{x:i,y:s,z:r}}function hy(n,t,e){let i=Pd({x:n.x0,y:n.y0,z:n.z0},t,e),s=Pd({x:n.x1-1,y:n.y1-1,z:n.z1-1},t,e);return{x0:Math.min(i.x,s.x),y0:Math.min(i.y,s.y),z0:Math.min(i.z,s.z),x1:Math.max(i.x,s.x)+1,y1:Math.max(i.y,s.y)+1,z1:Math.max(i.z,s.z)+1,c:n.c}}function Od(){let n=Ht.matrixWorld.elements,t=Kt({x:n[0],y:0,z:n[2]},-g.editXform.rot);return Math.abs(t.x)>=Math.abs(t.z)?0:2}var $o=null;function hl(){let n=g.sel3d;if(!n)return;let t=Tr(n.boxes);$o={boxes:n.boxes.map(e=>({...e})),cx:(t.mn.x+t.mx.x)/2,cy:(t.mn.y+t.mx.y)/2,cz:(t.mn.z+t.mx.z)/2}}function uy(){$o=null}function zd(n,t){let e=g.sel3d,i=$o;if(!e||!i||!i.boxes.length)return;let s=(n%4+4)%4,r;if(!s)r=i.boxes.map(a=>({...a}));else{let a=t?Od():1;r=i.boxes.map(u=>hy(u,a,s));let o=Tr(r),c=_i(i.cx-(o.mn.x+o.mx.x)/2),l=_i(i.cy-(o.mn.y+o.mx.y)/2),h=_i(i.cz-(o.mn.z+o.mx.z)/2);r=r.map(u=>mr(u,c,l,h))}e.boxes=r,e.region=Zo(r),wi()}function Fd(n,t){let e=g.sel3d,i=$o;if(!e||!i||!i.boxes.length)return;let s=t?Od():1,[r,a]=s===0?[i.cy,i.cz]:s===1?[i.cx,i.cz]:[i.cx,i.cy];e.boxes=gd(i.boxes,n,s,r,a,(o,c,l)=>({x:o,y:c,z:l})),e.region=Zo(e.boxes),wi()}function dy(){let n=g.sel3d;if(!n)return null;let t=n.region,e=new Vn;for(let i of[t.x0,t.x1])for(let s of[t.y0,t.y1])for(let r of[t.z0,t.z1])e.expandByPoint($n(i,s,r));return e}function ul(){let n=dy();return n?(We.setFromCamera(Mn,Ht),We.ray.intersectsBox(n)):!1}function Bd(n){let i=(x,_,p)=>x+65536+(_+65536)*131072+(p+65536)*131072*131072,s=[],r=[],a=[],o=[];for(let x of n)for(let _=x.x0;_<x.x1;_++)for(let p=x.y0;p<x.y1;p++)for(let f=x.z0;f<x.z1;f++)s.push(_),r.push(p),a.push(f),o.push(x.c);let c=s.length,l=new Map;for(let x=0;x<c;x++)l.set(i(s[x],r[x],a[x]),o[x]);let h=[s,r,a],u=x=>{let _=Array.from({length:c},(T,C)=>C).sort((T,C)=>h[x[2]][T]-h[x[2]][C]||h[x[1]][T]-h[x[1]][C]||h[x[0]][T]-h[x[0]][C]),p=new Map(l),f=[0,0,0],v=(T,C,R,A)=>{let H=(R+1)%3,S=(R+2)%3;f[R]=C[R];for(let w=T[H];w<C[H];w++){f[H]=w;for(let N=T[S];N<C[S];N++)if(f[S]=N,p.get(i(f[0],f[1],f[2]))!==A)return!1}return!0},y=[];for(let T of _){let C=p.get(i(s[T],r[T],a[T]));if(C===void 0)continue;let R=[s[T],r[T],a[T]],A=[s[T]+1,r[T]+1,a[T]+1];for(let H of x)for(;v(R,A,H,C);)A[H]++;for(let H=R[0];H<A[0];H++)for(let S=R[1];S<A[1];S++)for(let w=R[2];w<A[2];w++)p.delete(i(H,S,w));y.push({x0:R[0],y0:R[1],z0:R[2],x1:A[0],y1:A[1],z1:A[2],c:C})}return y},d=c>25e4?[[0,2,1],[2,0,1]]:[[0,2,1],[2,0,1],[1,0,2],[0,1,2],[2,1,0],[1,2,0]],m=null;for(let x of d){let _=u(x);(!m||_.length<m.length)&&(m=_)}return m??[]}var fy=24,py=1e6,dl=n=>n.reduce((t,e)=>t+(e.x1-e.x0)*(e.y1-e.y0)*(e.z1-e.z0),0),my=null,kd=!1,gy=0,Ko=new Map,jo=new WeakSet;function xy(){let n=`"use strict";
const repack = (${Bd.toString()});
onmessage = (e) => {
  const { reqId, boxes } = e.data;
  postMessage({ reqId, boxes: repack(boxes) });
};`,t=URL.createObjectURL(new Blob([n],{type:"text/javascript"})),e=new Worker(t);return URL.revokeObjectURL(t),e.onmessage=i=>{let s=i.data;_y(s.reqId,s.boxes)},e.onerror=()=>{kd=!0,e.terminate(),Ko.clear()},e}function fl(n){if(kd||typeof Worker>"u"||n.boxes.length<fy||jo.has(n.boxes))return;if(dl(n.boxes)>py){jo.add(n.boxes);return}let t=++gy;Ko.set(t,{nodeId:n.id,sent:n.boxes}),(my??=xy()).postMessage({reqId:t,boxes:n.boxes})}function _y(n,t){let e=Ko.get(n);if(Ko.delete(n),!e)return;let i=Zn(e.nodeId);!i||i.type!=="object"||i.boxes!==e.sent||(t.length<i.boxes.length&&dl(t)===dl(i.boxes)?(i.boxes=t,jo.add(t),Rd()):jo.add(e.sent))}var pl=(n,t,e)=>{let i=new Set(g.selection);ti(),g.selection=new Set([n]),g.editObject=null,ji(),g.context!==t||e?Se():Ti(i),qt(),e&&fl(e)};function yy(){if(g.path.length<=1)return;let n=g.context,t=g.editObject;pl(g.path.pop().id,n,t)}function vy(){pl(g.editObject.id,g.context,g.editObject)}function Vd(){g.editObject?vy():yy()}function An(n){let t=bn(n);if(!t)return;let e=g.context,i=g.editObject;g.path=t.slice(0,-1),pl(n.id,e,i)}function Qi(n,t){let e=bn(n);if(!e)return;let i=g.editObject;ti(),n.type==="scene"?(g.path=e,g.editObject=null):(g.path=e.slice(0,-1),g.editObject=n),g.selection.clear(),g.tool="view",ji(),Se(),qt(),t&&jn(),i&&i!==n&&fl(i)}var Rn=null,Te=null,Ar=null,Gs=null,an=null,My={visible:"\u25C9",deemphasized:"\u25D0",hidden:"\u29B0"},ml=(n,t)=>{let e=Math.min(255,(n>>16&255)*t)|0,i=Math.min(255,(n>>8&255)*t)|0,s=Math.min(255,(n&255)*t)|0;return`rgb(${e},${i},${s})`},Qo=new Map;function Hd(n){return n.type==="object"?"o"+n.boxes.map(t=>`${t.x0},${t.y0},${t.z0},${t.x1},${t.y1},${t.z1},${t.c}`).join(";"):"s"+n.children.map(t=>`${t.id}@${t.pos.x},${t.pos.y},${t.pos.z}/${t.rot};${Hd(t)}`).join()}function Sy(n){let t=Qo.get(n.id);if(n===g.editObject&&t)return t.cv;let e=Hd(n);if(t&&t.sig===e)return t.cv;let i=document.createElement("canvas");i.width=i.height=52,i.style.width=i.style.height="26px";let s=i.getContext("2d");s.fillStyle="#0f1115",s.fillRect(0,0,52,52);let r=yr(n,{x:0,y:0,z:0},0,[]);if(r.length){let a=He();Xe(r,a);let{x:o,y:c,z:l}=a.min,{x:h,y:u,z:d}=a.max,m=40/Math.max(h-o,u-c,d-l,1),x=26-((o+h)/2-(l+d)/2)*m*.5,_=28+(c+u)/2*m*.6-((o+h)/2+(l+d)/2)*m*.28,p=(v,y,T)=>[x+(v-T)*m*.5,_-y*m*.6+(v+T)*m*.28],f=(v,y)=>{s.fillStyle=v,s.beginPath(),s.moveTo(y[0][0],y[0][1]);for(let T=1;T<y.length;T++)s.lineTo(y[T][0],y[T][1]);s.closePath(),s.fill()};r.sort((v,y)=>v.x0+v.x1+v.y0+v.y1+v.z0+v.z1-(y.x0+y.x1+y.y0+y.y1+y.z0+y.z1));for(let v of r)f(ml(v.c,.78),[p(v.x1,v.y0,v.z0),p(v.x1,v.y1,v.z0),p(v.x1,v.y1,v.z1),p(v.x1,v.y0,v.z1)]),f(ml(v.c,.6),[p(v.x0,v.y0,v.z1),p(v.x1,v.y0,v.z1),p(v.x1,v.y1,v.z1),p(v.x0,v.y1,v.z1)]),f(ml(v.c,1),[p(v.x0,v.y1,v.z0),p(v.x1,v.y1,v.z0),p(v.x1,v.y1,v.z1),p(v.x0,v.y1,v.z1)])}return Qo.set(n.id,{sig:e,cv:i}),i}var ts=null;function gl(n){ts=n}function by(n){if(n===g.root||on(n)!==g.context||g.editObject)An(n);else{let t=new Set(g.selection);g.selection.has(n.id)?g.selection.delete(n.id):g.selection.add(n.id),Ti(t),qt()}ts=n.id}function Ey(n){let t=g.context.children,e=ts?t.findIndex(o=>o.id===ts):-1,i=t.findIndex(o=>o.id===n.id);if(n===g.root||g.editObject||e<0||i<0){An(n),ts=n.id;return}let s=new Set(g.selection),r=Math.min(e,i),a=Math.max(e,i);g.selection=new Set(t.slice(r,a+1).map(o=>o.id)),Ti(s),qt()}function wy(n,t){if(t.shiftKey||t.ctrlKey||t.metaKey){an&&(clearTimeout(an.timer),an=null),t.shiftKey?Ey(n):by(n);return}if(an&&an.node===n){clearTimeout(an.timer),an=null,Qi(n,!0);return}an&&clearTimeout(an.timer),n===g.root?Qi(n):An(n),ts=n===g.root?null:n.id,an={node:n,timer:setTimeout(()=>an=null,300)}}function qs(n){ta();let e=document.querySelector(`#tree .trow[data-id="${n.id}"]`)?.querySelector(".nm");if(!e)return;let i=de("input",{className:"nminput",value:n.name});i.placeholder=n===g.root?"Project":n.type==="scene"?"group":"object";let s=!1,r=a=>{s||(s=!0,a&&(n.name=i.value.trim(),oe()),qt())};i.addEventListener("keydown",a=>{a.stopPropagation(),a.key==="Enter"?r(!0):a.key==="Escape"&&r(!1)}),i.addEventListener("blur",()=>r(!0)),e.replaceWith(i),i.focus(),i.select()}function Ty(n){let t=Sy(n);if(t.className="thumb",t.onclick=null,t.title="",n!==g.root&&n.type==="scene"&&n.children.length){let e=g.collapsed.has(n.id);t.classList.add("group"),e&&t.classList.add("collapsed"),t.title=e?"Expand group":"Collapse group",t.onclick=i=>{i.stopPropagation(),e?g.collapsed.delete(n.id):g.collapsed.add(n.id),xl()}}return t}function Ay(n,t){n.draggable=t!==g.root,t!==g.root&&n.addEventListener("dragstart",e=>{if(e.stopPropagation(),Rn=t.id,e.dataTransfer){e.dataTransfer.effectAllowed="move";try{e.dataTransfer.setData("text/plain",t.id)}catch{}}}),n.addEventListener("dragend",Ws),n.addEventListener("dragover",e=>{e.preventDefault(),e.stopPropagation(),Ry(e,t,n)}),n.addEventListener("drop",e=>{e.preventDefault(),e.stopPropagation(),qd()})}function xl(){let n=document.getElementById("tree");n.innerHTML="";let t=(i,s)=>{let r=i===g.root,a=!r&&g.context.children.includes(i)&&g.selection.has(i.id),o=i.vis,c=de("div",{className:"trow"+(r?" root":"")+(a?" sel":"")+(i===g.context&&!g.editObject?" ctx":"")+(i===g.editObject?" edit":"")+(!r&&o!=="visible"?" dim":"")});c.style.paddingLeft=4+s*13+"px",c.dataset.id=i.id;let l=Ty(i),h=de("span",{className:"nm"});if(r?h.textContent=i.name||"Project":i.name?h.textContent=i.name:h.innerHTML='<span class="ph">'+(i.type==="scene"?"group":"object")+"</span>",h.onclick=u=>{!an&&!g.editObject&&!r&&g.selection.size===1&&g.selection.has(i.id)&&(u.stopPropagation(),qs(i))},c.append(l,h),r||c.append(de("button",{className:"tb"+(o==="visible"?" on":""),textContent:My[o],title:"visible \u2192 deemphasized \u2192 hidden",onclick:u=>{u.stopPropagation(),Yd(i)}})),c.onclick=u=>wy(i,u),c.oncontextmenu=u=>{u.preventDefault(),u.stopPropagation();let d=!r&&!g.editObject&&on(i)===g.context&&g.selection.has(i.id);!r&&!d&&An(i),Wd(i,u.clientX,u.clientY)},Ay(c,i),n.appendChild(c),i.type==="scene"&&(r||!g.collapsed.has(i.id)))for(let u of i.children)t(u,s+1)};t(g.root,0);let e=new Set;(function i(s){e.add(s.id),s.type==="scene"&&s.children.forEach(i)})(g.root);for(let i of Qo.keys())e.has(i)||Qo.delete(i)}function ta(){Gs&&(Gs.remove(),Gs=null,window.removeEventListener("pointerdown",Gd,!0))}function Gd(n){Gs&&!Gs.contains(n.target)&&ta()}function Wd(n,t,e){ta();let i=de("div",{className:"ctxmenu"}),s=(c,l,h)=>i.appendChild(de("div",{className:"ctxitem"+(h?" "+h:""),textContent:c,onclick:()=>{ta(),l()}})),r=()=>i.appendChild(de("div",{className:"ctxdiv"})),a=n!==g.root&&on(n)===g.context&&g.selection.size>1&&g.selection.has(n.id);a||(s("Rename",()=>qs(n)),s("Locate",()=>pd(n)),r()),n!==g.root&&(s("Copy",()=>Cr()),s("Duplicate",()=>a?ea():Kd(n)),s("Delete objects",()=>a?Rr():jd(n),"danger"),r()),a?s("Group",()=>$d(n)):n.type==="scene"?(n!==g.root&&s("Ungroup",()=>Qd(n)),Hs()&&s("Paste",()=>na(n)),s("New object",()=>tf(n)),s("New group",()=>ef(n))):s("New group",()=>Zd(n)),document.body.appendChild(i),Gs=i;let o=i.getBoundingClientRect();i.style.left=Math.min(t,innerWidth-o.width-4)+"px",i.style.top=Math.min(e,innerHeight-o.height-4)+"px",setTimeout(()=>window.addEventListener("pointerdown",Gd,!0),0)}function Ws(){Ar&&Ar.classList.remove("drop-into","drop-before","drop-after"),Ar=null,Te=null}function Xd(){let n=Rn&&Zn(Rn);return!n||g.editObject||on(n)!==g.context||!g.selection.has(n.id)||g.selection.size<=1?null:g.context.children.filter(t=>g.selection.has(t.id))}function Ry(n,t,e){let i=Rn&&Zn(Rn);if(!i||i===t){Ws();return}let s=Xd();if(s?s.some(u=>u===t||Zi(u,t)):Zi(i,t)){Ws();return}if(Ws(),Ar=e,t===g.root){Te={parent:g.root,index:g.root.children.length},e.classList.add("drop-into");return}let a=e.getBoundingClientRect(),o=n.clientY-a.top,c=a.height,l=on(t),h=l?l.children.indexOf(t):0;o>c*.28&&o<c*.72&&(t.type==="scene"||!s)?(t.type==="scene"?Te={parent:t,index:t.children.length}:Te={wrap:t},e.classList.add("drop-into")):o<c*.5?(Te={parent:l,index:h},e.classList.add("drop-before")):(Te={parent:l,index:h+1},e.classList.add("drop-after"))}function qd(){let n=Rn&&Zn(Rn);if(n&&Te){let t=Te.parent?Xd():null;if(t){let e=Te.parent,i=Te.index,s=!1;for(let r of t)Xs(r,e,i)&&(i=e.children.indexOf(r)+1,s=!0);if(s){g.collapsed.delete(e.id);let r=bn(e);r&&(g.path=r),g.editObject=null,g.selection=new Set(t.map(a=>a.id)),Se(),qt(),oe()}}else Te.wrap?Jd(Te.wrap,n):Te.parent&&Xs(n,Te.parent,Te.index)&&(g.collapsed.delete(Te.parent.id),An(n),oe())}Ws(),Rn=null}{let n=document.getElementById("tree");n.addEventListener("dragover",t=>{if(t.target===n&&Rn){t.preventDefault(),Ws(),Te={parent:g.root,index:g.root.children.length};let e=[...n.querySelectorAll(".trow")].filter(s=>s.dataset.id!==Rn),i=e[e.length-1];i&&(i.classList.add("drop-after"),Ar=i)}}),n.addEventListener("drop",t=>{t.target===n&&(t.preventDefault(),qd())})}document.getElementById("side").addEventListener("click",n=>{if(n.target.closest(".trow, button, input")||!g.selection.size)return;let t=new Set(g.selection);g.selection.clear(),ts=null,Ti(t),qt()});document.getElementById("side").addEventListener("contextmenu",n=>{n.target.closest(".trow, button, input")||(n.preventDefault(),Wd(g.root,n.clientX,n.clientY))});var Cn=()=>{Se(),qt(),oe()};function Yd(n){n.vis=Ju[n.vis],Cn()}var _l=()=>[...g.selection].map(n=>Jn(n)).filter(n=>!!n),nf=(n,t)=>{let e=_r();e.pos={x:Math.round(Xt.target.x),y:0,z:Math.round(Xt.target.z)},n.children.push(e),g.collapsed.delete(n.id),Qi(e,t),oe(),qs(e)};function sf(){nf(g.context,!0)}function Rr(){g.selection.size&&(g.context.children=g.context.children.filter(n=>!g.selection.has(n.id)),g.selection.clear(),Cn())}function ea(){let n=_l().map(vi);n.length&&(g.context.children.push(...n),g.selection=new Set(n.map(t=>t.id)),Cn())}function Cr(){let n=_l().map(vi);n.length&&yd(n)}function rf(){Cr(),Rr()}function na(n=g.context){if(Hs()==="vox"){Cy(n);return}let t=Xo().map(vi);t.length&&(n.children.push(...t),of(n),g.selection=new Set(t.map(e=>e.id)),Cn())}function Cy(n){let t=qo();if(!t.length)return;let e=_r();e.boxes=t.map(r=>({...r}));let i=Fs(n),s=Kt({x:Xt.target.x-i.off.x,y:0,z:Xt.target.z-i.off.z},-i.rot);e.pos={x:Math.round(s.x),y:0,z:Math.round(s.z)},n.children.push(e),of(n),g.selection=new Set([e.id]),Cn()}function of(n){g.collapsed.delete(n.id),n!==g.context&&(g.path=bn(n)??g.path,g.editObject=null)}function Xs(n,t,e){if(n===t||Zi(n,t))return!1;let i=on(n);if(!i)return!1;let s=Xn(Fs(i),{off:{...n.pos},rot:n.rot}),r=Xn(Fc(Fs(t)),s),a=i.children.indexOf(n);return i.children.splice(a,1),i===t&&a<e&&e--,n.pos={x:Math.round(r.off.x),y:Math.round(r.off.y),z:Math.round(r.off.z)},n.rot=r.rot&3,t.children.splice(Math.max(0,Math.min(e,t.children.length)),0,n),!0}function af(n){let t=on(n);if(!t)return null;let e=t.children.indexOf(n),i=Ji("Group");return i.pos={...n.pos},i.rot=n.rot,t.children.splice(e,1,i),n.pos={x:0,y:0,z:0},n.rot=0,i.children=[n],i}function Jd(n,t){if(t===n||Zi(t,n))return!1;let e=af(n);return e?(Xs(t,e,e.children.length),g.collapsed.delete(e.id),g.selection=new Set([e.id]),Cn(),!0):!1}function Zd(n){let t=af(n);t&&(g.collapsed.delete(t.id),An(t),oe(),qs(t))}function $d(n){let t=_l();if(t.length<2)return;let e=Ji("Group");e.pos={...n.pos},e.rot=n.rot;let i=g.context.children.indexOf(n);g.context.children.splice(Math.max(0,i),0,e);for(let s of t)Xs(s,e,e.children.length);g.collapsed.delete(e.id),g.selection=new Set([e.id]),Cn()}function Kd(n){let t=on(n);if(!t)return;let e=vi(n);t.children.splice(t.children.indexOf(n)+1,0,e),An(e),oe()}function jd(n){let t=on(n);t&&(t.children=t.children.filter(e=>e!==n),g.selection.delete(n.id),g.editObject===n&&(g.editObject=null),Cn())}function Qd(n){let t=on(n);if(!t)return;let e=[...n.children],i=t.children.indexOf(n);for(let s of e)Xs(s,t,i),i=t.children.indexOf(s)+1;t.children=t.children.filter(s=>s!==n),g.selection=new Set(e.map(s=>s.id)),Cn()}function tf(n){nf(n,!1)}function ef(n){let t=Ji("Group");n.children.push(t),g.collapsed.delete(n.id),An(t),oe(),qs(t)}function yl(n){let t=[...g.selection];if(!t.length)return;let e=n<0?3:1,i=zs(),s=Fc(i),r=a=>Si(a,Sn(i.off,Kt(a.pos,i.rot)),i.rot+a.rot&3,He());for(let a=0;a<Math.abs(n);a++){let o=He();for(let d of t){let m=r(Jn(d));m.min.x<o.min.x&&(o.min.x=m.min.x),m.min.z<o.min.z&&(o.min.z=m.min.z),m.max.x>o.max.x&&(o.max.x=m.max.x),m.max.z>o.max.z&&(o.max.z=m.max.z)}let c=(o.min.x+o.max.x)/2,l=(o.min.z+o.max.z)/2,h=Kt({x:c,y:0,z:l},e),u={rot:e,off:{x:c-h.x,y:0,z:l-h.z}};for(let d of t){let m=Jn(d);if(!m)continue;let x=Xn(i,{off:m.pos,rot:m.rot}),_=Xn(s,Xn(u,x));m.pos={x:_i(_.off.x),y:_i(_.off.y),z:_i(_.off.z)},m.rot=_.rot&3}}Se()}function cf(){g.selection.size&&(yl(1),qt(),oe())}function vl(n){for(let t of g.selection){let e=Jn(t);e&&(e.pos.y+=n)}g.selection.size&&Cn()}function lf(){let n=JSON.stringify({uid:Os(),root:wr(g.root),collapsed:[...g.collapsed]}),t=URL.createObjectURL(new Blob([n],{type:"application/json"})),e=g.root.name||"Project",i=o=>String(o).padStart(2,"0"),s=new Date,r=`${s.getFullYear()}-${i(s.getMonth()+1)}-${i(s.getDate())} ${i(s.getHours())}h${i(s.getMinutes())}m${i(s.getSeconds())}s`,a=document.createElement("a");a.href=t,a.download=`${e} -- ${r}.voxelier.json`,a.click(),URL.revokeObjectURL(t)}function hf(){let n=document.createElement("input");n.type="file",n.accept="application/json,.json",n.onchange=()=>{let t=n.files&&n.files[0];if(!t)return;let e=new FileReader;e.onload=()=>{try{if(!rl(JSON.parse(e.result)))throw new Error("not a Voxelier scene file");g.path=[g.root],g.editObject=null,g.sel3d=null,g.selection.clear(),g.tool==="measure"&&(g.tool="view"),ji(),Se(),qt(),jn(),Tn()}catch(i){alert("Import failed: "+i.message)}},e.readAsText(t)},n.click()}var sa={view:"\u{1F441}",add:"\uFF0B",erase:"\uFF0D",paint:"\u{1FAA3}",eyedropper:"\u{1F4A7}",select:"\u2B1A",measure:"\u{1F4CF}"},Py=[{id:"view",label:"View"},{id:"add",label:"Add"},{id:"erase",label:"Erase"},{id:"paint",label:"Fill"},{id:"select",label:"Select"}],uf=(n,t,e,i)=>de("button",{className:"tool"+(e?" active":""),innerHTML:`<span class="ic">${n}</span>${t}`,onclick:i});function df(n){g.tool!==n&&(ti(),g.tool=n,g.eyedropReturn=null,Ke.visible=!1,ji(),qt())}function qt(){let n=document.getElementById("tools");n.innerHTML="",!g.editObject&&g.tool!=="measure"&&(g.tool="view");let t=de("div",{className:"toolgroup"}),e=g.editObject?Py:[{id:"view",label:"View"}];for(let i of e)t.appendChild(uf(sa[i.id],i.label,g.tool===i.id,()=>df(i.id)));if(t.appendChild(uf(sa.measure,"Measure",g.tool==="measure",()=>df("measure"))),g.editObject&&t.appendChild(zy()),n.append(t),g.tool==="view"){let i=document.getElementById("toolcursor");i&&(i.style.display="none")}xl()}document.getElementById("btn-save").onclick=lf;document.getElementById("btn-load").onclick=hf;var ia={ver:-1,cols:[]};function Ly(){if(ia.ver===g.voxVer)return ia.cols;let n=new Map;return function t(e){e.type==="object"?Vu(e.boxes,n):e.children.forEach(t)}(g.root),ia={ver:g.voxVer,cols:[...n.entries()].sort((t,e)=>e[1]-t[1]).map(t=>t[0])},ia.cols}var Ml=[];function ra(n){Ml=[n,...Ml.filter(t=>t!==n)].slice(0,6)}function Sl(n){g.selColor=n,qt()}function Iy(){let n=[];for(let t of[...Ml,...Ly(),...Fo])if(n.includes(t)||n.push(t),n.length>=6)break;return n}var Dy=n=>{let t=de("div",{className:"sw"+(n===g.selColor?" active":""),title:qn(n),onclick:()=>Sl(n)});return t.style.background=qn(n),t};function Uy(){g.tool!=="eyedropper"&&(g.eyedropReturn=g.tool,ti(),g.tool="eyedropper",qt())}function Ny(n){let t=(n>>16&255)/255,e=(n>>8&255)/255,i=(n&255)/255,s=Math.max(t,e,i),r=Math.min(t,e,i),a=s-r,o=0;return a&&(s===t?o=(e-i)/a%6:s===e?o=(i-t)/a+2:o=(t-e)/a+4,o=(o*60+360)%360),[Math.round(o),Math.round((s?a/s:0)*100),Math.round(s*100)]}function Pr(n,t,e){t/=100,e/=100;let i=e*t,s=i*(1-Math.abs(n/60%2-1)),r=e-i,[a,o,c]=n<60?[i,s,0]:n<120?[s,i,0]:n<180?[0,i,s]:n<240?[0,s,i]:n<300?[s,0,i]:[i,0,s],l=h=>Math.round((h+r)*255);return l(a)<<16|l(o)<<8|l(c)}var Oy=[{key:"h",max:360,label:"H",title:"Hue"},{key:"s",max:100,label:"S",title:"Saturation"},{key:"v",max:100,label:"V",title:"Value"}];function zy(){let n=de("div",{className:"colorctl"}),t=de("div",{className:"colorbtn",title:"Draw colour \u2014 hover for recent colours / sliders"});t.style.background=qn(g.selColor);let e=de("div",{className:"colorflyout"}),i=de("div",{className:"sliders"}),s={},[r,a,o]=Ny(g.selColor),c={h:r,s:a,v:o},l=()=>{s.s.style.background=`linear-gradient(to right,${qn(Pr(c.h,0,c.v))},${qn(Pr(c.h,100,c.v))})`,s.v.style.background=`linear-gradient(to right,${qn(Pr(c.h,c.s,0))},${qn(Pr(c.h,c.s,100))})`},h=()=>{c.h=+s.h.value,c.s=+s.s.value,c.v=+s.v.value,g.selColor=Pr(c.h,c.s,c.v),t.style.background=qn(g.selColor),l()};for(let m of Oy){let x=de("div",{className:"sliderline"}),_=de("input",{type:"range",className:"csl",title:m.title});_.min="0",_.max=String(m.max),_.value=String(c[m.key]),s[m.key]=_,_.addEventListener("input",h),x.append(de("span",{className:"lbl",textContent:m.label,title:m.title}),_),i.appendChild(x)}s.h.style.background="linear-gradient(to right,#f00,#ff0,#0f0,#0ff,#00f,#f0f,#f00)",l();let u=de("div",{className:"sliderrow"});u.append(i,de("div",{className:"sw more",textContent:"\u{1F4A7}",title:"Pick a colour from a voxel (eyedropper)",onclick:Uy}));let d=de("div",{className:"swrow"});for(let m of Iy())d.appendChild(Dy(m));return e.append(u,d),n.append(t,e),n}{let n=document.getElementById("app"),t=e=>{n.classList.toggle("side-hidden",e),window.dispatchEvent(new Event("resize"))};document.getElementById("btn-hide-side").onclick=()=>t(!0),document.getElementById("btn-show-side").onclick=()=>t(!1)}window.addEventListener("keydown",n=>{if(n.target.tagName==="INPUT"||g.drag||g.painting)return;let t=n.key.toLowerCase();if(n.ctrlKey||n.metaKey){if(t==="z"){n.preventDefault(),n.shiftKey?sl():wd();return}if(t==="y"){n.preventDefault(),sl();return}if(g.editObject){t==="c"?(ll(),n.preventDefault()):t==="x"?(Dd(),n.preventDefault()):t==="v"&&(Fy(),n.preventDefault());return}let i={c:Cr,x:rf,v:na,d:ea}[t];i&&(i(),n.preventDefault());return}switch(t){case"f":jn();break;case"escape":Vd();break;case"n":g.editObject||sf();break;case"r":g.editObject||cf();break;case"[":g.editObject||vl(-1);break;case"]":g.editObject||vl(1);break;case"delete":case"backspace":n.preventDefault(),g.editObject?cl():Rr();break}});function Fy(){let n=[];if(Hs()==="node")for(let t of Xo())yr(t,t.pos,t.rot,n);else n.push(...qo());n.length&&(g.tool="select",Ud(n),qt())}var Jt=n=>Math.floor(n/10),ce=Fo,Ys=(n,t)=>{let e=_r();return e.name=n,e.boxes=t,e},bl=(n,t,e,i,s,r)=>({x0:n,y0:t,z0:e,x1:i,y1:s,z1:r});function ff(){let n=Jt(4465),t=Jt(2985),e=Jt(2700),i=Jt(150),s=Ys("Floor",[re(0,0,0,n,1,t,ce[9])]),r=Jt(800),a=Jt(2100),o=n-Jt(515)-r,c=n-Jt(900)-r,l=[re(0,1,0,n,e+1,i,ce[5]),re(0,1,t-i,n,e+1,t,ce[5]),re(0,1,i,i,e+1,t-i,ce[5]),re(n-i,1,i,n,e+1,t-i,ce[5])];l=Yi(l,bl(o,1,0,o+r,a+1,i)),l=Yi(l,bl(c,1,t-i,c+r,a+1,t)),l=Yi(l,bl(0,Jt(900),Jt(600),i,Jt(2100),t-Jt(600)));let h=Ys("Walls",l);h.vis="deemphasized";let u=Jt(1500),d=Jt(2e3),m=Ys("Bed",[re(0,0,0,8,14,8,ce[7]),re(u-8,0,0,u,14,8,ce[7]),re(0,0,d-8,8,14,d,ce[7]),re(u-8,0,d-8,u,14,d,ce[7]),re(0,14,0,u,20,d,ce[6]),re(2,20,0,u-2,24,d-Jt(400),ce[10])]);m.pos={x:i+3,y:1,z:t-i-d};let x=Jt(1400),_=Jt(700),p=Jt(740),f=Ys("Desk",[re(0,p-4,0,x,p,_,ce[8]),re(0,0,0,6,p-4,6,ce[7]),re(x-6,0,0,x,p-4,6,ce[7]),re(0,0,_-6,6,p-4,_,ce[7]),re(x-6,0,_-6,x,p-4,_,ce[7])]),v=Jt(600),y=v-30>>1,T=v>>1,C=Ys("Computer",[re(y,0,0,y+30,2,18,ce[11]),re(T-2,2,7,T+2,Jt(160),11,ce[11]),re(0,Jt(160),6,v,Jt(520),9,ce[13])]);C.pos={x:Jt(400),y:p,z:Jt(420)};let R=Ji();R.name="Desk + Computer",R.pos={x:n-i,y:1,z:Jt(900)},R.rot=1,R.children=[f,C];let A=N=>Ys(N,[re(-10,0,-10,11,30,11,ce[4]),re(-2,30,-2,3,54,3,ce[14]),re(-16,54,-16,17,78,17,ce[14]),re(-12,78,-12,13,92,13,ce[14])]),H=A("Plant"),S=A("Plant");H.pos={x:n-i-Jt(300),y:1,z:i+Jt(300)},S.pos={x:i+Jt(300),y:1,z:i+Jt(300)};let w=Ji();return w.children=[s,h,m,R,H,S],w}var oa=n=>Math.abs(n.clientX-g.drag.sx)+Math.abs(n.clientY-g.drag.sy)>3,ei=document.createElement("div");ei.id="toolcursor";ei.style.display="none";document.body.appendChild(ei);function By(n){if(g.tool==="view"){ei.style.display="none";return}ei.textContent=sa[g.tool],ei.style.left=n.clientX+"px",ei.style.top=n.clientY+"px",ei.style.display="block"}function ky(){g.tool!=="measure"||g.painting||g.drag&&g.drag.mode==="box"||Vo()}function El(){let n=(Ht.top-Ht.bottom)/ue.h,t=Math.abs(Ht.matrixWorldInverse.elements[5]);return n/Math.max(t,.15)}function Vy(n){let t=g.drag;if(!t||t.mode!=="pan"&&t.mode!=="orbit")return!1;let e=n.clientX-t.x,i=n.clientY-t.y;return t.x=n.clientX,t.y=n.clientY,(t.mode==="pan"?ud:dd)(e,i),!0}function Hy(){let n=[],t=[];Ei(g.root,{x:0,y:0,z:0},0,null,0,(s,r,a,o)=>{let c=o&&g.selection.has(o)?t:n;for(let l of s.boxes)c.push(Yn(l,a,r))});let e=1/0,i=-1/0;for(let s of t)s.y0<e&&(e=s.y0),s.y1>i&&(i=s.y1);return{occ:n,sel:t,minY:e,hgt:t.length?i-e:0}}var Gy=(n,t,e,i)=>{if(Gc(n.sel??[],n.occ??[],t,e,i))return!0;let s=n.minY??1/0;return s+e<Math.min(0,s)};function Wy(n){let t=g.drag,e=(i,s,r)=>n.altKey||!Gy(t,i,s,r);if(n.shiftKey){t.shiftAnchorY==null&&(t.shiftAnchorY=n.clientY,t.dyBase=t.dyUser??0);let i=t.dyBase+Math.round((t.shiftAnchorY-n.clientY)*El());e(t.dx,i,t.dz)&&(t.dyUser=i,t.dy=i)}else{t.shiftAnchorY=null;let i=t.dx,s=t.dz,r=vr(0);r&&t.start&&(i=r.x-t.start.x,s=r.z-t.start.z);let a=t.dyUser??0,o=Math.floor(.1*(t.hgt??0)),c=!1;for(let l=0;l<=o;l++)if(e(i,a+l,s)){t.dx=i,t.dz=s,t.dy=a+l,c=!0;break}c||(e(i,a,t.dz)&&(t.dx=i),e(t.dx,a,s)&&(t.dz=s),t.dy=a)}for(let i of g.selection)for(let s of g.childMeshes[i]||[])s.position.set(t.dx,t.dy,t.dz),s.castShadow=!1;Wn.position.set(t.dx,t.dy,t.dz)}function Xy(n){let t=g.drag,e=zs(),i=Kt({x:Math.round(t.dx),y:0,z:Math.round(t.dz)},-e.rot),s=Math.round(t.dy);if(n){let r=[];for(let a of g.selection){let o=Jn(a);if(!o)continue;let c=vi(o);c.pos={x:o.pos.x+i.x,y:o.pos.y+s,z:o.pos.z+i.z},r.push(c)}g.context.children.push(...r),g.selection=new Set(r.map(a=>a.id))}else for(let r of g.selection){let a=Jn(r);a&&(a.pos.x+=i.x,a.pos.y+=s,a.pos.z+=i.z)}Wn.position.set(0,0,0),Se(),qt(),oe()}function qy(n){let t=g.drag,e=Math.round((t.sx-n.clientX)/70);e!==t.steps&&(yl(e-t.steps),t.steps=e,t.dirty=!0)}function Yy(){let n=cd();n!=null&&(g.eyedropReturn!=null&&(g.tool=g.eyedropReturn,g.eyedropReturn=null),Sl(n))}function mf(n){let t=$i(),e=Yc(t);if(!e)return;let i=qi(e.x,e.y,e.z);i!==g.lastVox&&(n?(tl({x0:e.x,y0:e.y,z0:e.z,x1:e.x+1,y1:e.y+1,z1:e.z+1},g.selColor),ra(g.selColor)):ad(e,g.selColor)&&ra(g.selColor),g.lastVox=i),gf(t)}function gf(n=$i()){let t=Yc(n);if(!t){Ke.visible=!1;return}let e=$n(t.x+.5,t.y+.5,t.z+.5);Ke.visible=!0,Ke.material.color.set(g.tool==="erase"?11895693:10994876),Ke.position.copy(e)}var wl=n=>n===0?[1,2]:n===1?[0,2]:[0,1];function xf(n,t,e,i){let[s,r]=wl(n.na),a=[0,0,0],o=[0,0,0],c=(l,h,u)=>{a[l]=Math.min(h,u),o[l]=Math.max(h,u)};return c(n.na,n.s[n.na],n.s[n.na]+i),c(s,n.s[s],t),c(r,n.s[r],e),{x0:a[0],y0:a[1],z0:a[2],x1:o[0]+1,y1:o[1]+1,z1:o[2]+1,c:0}}var Tl=n=>{let[t,e]=wl(n.na);return xf(n,n.c[t],n.c[e],n.hy)};function pf(n){let t=$i(),e,i;if(t)i=t.addCell.x!==t.cell.x?0:t.addCell.y!==t.cell.y?1:2,e=g.tool==="add"?t.addCell:t.cell;else{let s=Ki(0);if(!s)return;e=s,i=1}g.drag={...n,mode:"box",shiftAnchorY:null,box:{s:[e.x,e.y,e.z],c:[e.x,e.y,e.z],na:i,hy:0},occ:g.tool==="add"?g.editObject.boxes.slice():void 0},Ke.visible=!1,_f()}function Jy(n){let t=g.drag,e=t.box,[i,s]=wl(e.na),r=g.tool==="add"&&!n.altKey,a=(o,c,l)=>!r||!Gc([xf(e,o,c,l)],t.occ??[],0,0,0);if(n.shiftKey){t.shiftAnchorY===null&&(t.shiftAnchorX=n.clientX,t.shiftAnchorY=n.clientY,t.hyBase=e.hy);let o=$n(e.s[0],e.s[1],e.s[2]),c=e.s.slice();c[e.na]+=1;let l=$n(c[0],c[1],c[2]),h=l.x-o.x,u=l.y-o.y,d=l.z-o.z,m=Ht.matrixWorld.elements,x=h*m[0]+u*m[1]+d*m[2],_=h*m[4]+u*m[5]+d*m[6],p=x*x+_*_,f=ue.h/(Ht.top-Ht.bottom),v=x*f,y=-_*f,T=n.clientX-t.shiftAnchorX,C=n.clientY-t.shiftAnchorY,R=t.hyBase+(p>.02?Math.round((T*v+C*y)/(v*v+y*y)):Math.round((t.shiftAnchorY-n.clientY)*El()));a(e.c[i],e.c[s],R)&&(e.hy=R)}else{t.shiftAnchorY=null;let o=td(e.na,e.s[e.na]);if(o){let c=[o.x,o.y,o.z];a(c[i],e.c[s],e.hy)&&(e.c[i]=c[i]),a(e.c[i],c[s],e.hy)&&(e.c[s]=c[s])}}_f()}function Zy(){let n=Tl(g.drag.box);g.tool==="add"?(tl(n,g.selColor),ra(g.selColor)):Sr(n),g.liveMeas=null,bi(),qt(),oe()}function _f(){let n=Tl(g.drag.box);g.liveMeas=$c(n.x0,n.y0,n.z0,n.x1,n.y1,n.z1,$n,2),bi()}function $y(n){let t=g.sel3d.region.y0;g.drag={...n,mode:"selmove",start:Ki(t)??{x:0,y:t,z:0},dx:0,dy:0,dz:0,shiftAnchorY:null}}function Ky(n){g.drag={...n,mode:"selrot",steps:0}}function jy(n){let t=g.drag,e=t.dx,i=t.dy,s=t.dz;if(n.shiftKey)t.shiftAnchorY==null&&(t.shiftAnchorY=n.clientY,t.dyBase=i),i=t.dyBase+Math.round((t.shiftAnchorY-n.clientY)*El());else{t.shiftAnchorY=null;let r=Ki(t.start.y);r&&(e=r.x-t.start.x,s=r.z-t.start.z)}(e!==t.dx||i!==t.dy||s!==t.dz)&&(g.sel3d.lifted||ol(),Nd(e-t.dx,i-t.dy,s-t.dz),t.dx=e,t.dy=i,t.dz=s)}function Qy(n){let t=g.drag,e=n.altKey;e!==!!t.fine&&(t.fine=e,g.sel3d.lifted&&(hl(),t.sx=n.clientX,t.steps=0,t.deg=0));let i=()=>{g.sel3d.lifted||(ol(),hl())};if(e){let s=Math.round((t.sx-n.clientX)/25)*15;if(s===(t.deg??0))return;i(),t.deg=s,Fd(s,n.shiftKey)}else{let s=Math.round((t.sx-n.clientX)/70);if(s===t.steps)return;i(),t.steps=s,zd(s,n.shiftKey)}}function tv(n){g.liveMeas=null,bi(),n&&Id(Tl(g.drag.box)),qt()}Le.addEventListener("pointerdown",n=>{if(g.drag||g.painting)return;Le.setPointerCapture(n.pointerId),Bo(n.clientX,n.clientY);let t={x:n.clientX,y:n.clientY,sx:n.clientX,sy:n.clientY};if(n.button===1){g.drag={...t,mode:"pan"};return}if(g.editObject){n.button===0?g.tool==="view"||g.tool==="measure"?g.drag={...t,mode:"pan"}:g.tool==="select"?g.sel3d&&ul()?$y(t):(ti(),pf(t)):g.tool==="add"||g.tool==="erase"?pf(t):g.tool==="eyedropper"?Yy():(g.painting=!0,g.lastVox=null,mf(n.shiftKey)):n.button===2&&(g.tool==="select"&&g.sel3d&&ul()?Ky(t):g.drag={...t,mode:"orbit"});return}let e=qc(),i=e&&g.selection.has(e);n.button===0?g.tool==="measure"?g.drag={...t,mode:"pan"}:i?g.drag={...t,mode:"move",start:vr(0),dx:0,dy:0,dz:0,shiftAnchorY:null,...Hy()}:g.drag={...t,mode:"pan",clickId:e}:n.button===2&&(i&&g.tool!=="measure"?g.drag={...t,mode:"rotobj",steps:0}:g.drag={...t,mode:"orbit"})});Le.addEventListener("pointermove",n=>{Bo(n.clientX,n.clientY),g.editObject&&g.painting?mf(n.shiftKey):g.drag?Vy(n)||(g.drag.mode==="move"?Wy(n):g.drag.mode==="rotobj"?qy(n):g.drag.mode==="box"?Jy(n):g.drag.mode==="selmove"?jy(n):g.drag.mode==="selrot"&&Qy(n)):g.editObject&&g.tool!=="select"&&g.tool!=="view"&&g.tool!=="measure"?gf():Ke.visible=!1,ky(),By(n)});Le.addEventListener("pointerup",n=>{try{Le.releasePointerCapture(n.pointerId)}catch{}if(g.tool==="measure"&&g.drag&&!oa(n)){if(n.button===0){nd(),g.drag=null;return}if(n.button===2){id(),g.drag=null;return}}if(g.editObject){g.painting?(g.painting=!1,qt(),oe()):g.drag&&g.drag.mode==="box"?g.tool==="select"?tv(oa(n)):Zy():g.drag&&(g.drag.mode==="selmove"||g.drag.mode==="selrot")&&al(),g.drag=null;return}if(g.drag)if(g.drag.mode==="pan"&&!oa(n)&&n.button===0){let t=g.drag.clickId,e=n.shiftKey||n.ctrlKey||n.metaKey,i=new Set(g.selection);t?(e?g.selection.has(t)?g.selection.delete(t):g.selection.add(t):g.selection=new Set([t]),gl(t)):e||(g.selection.clear(),gl(null)),Ti(i),qt()}else g.drag.mode==="move"?Xy(oa(n)&&(n.ctrlKey||n.metaKey)):g.drag.mode==="rotobj"&&g.drag.dirty&&(qt(),oe());g.drag=null});Le.addEventListener("pointercancel",()=>{if(!g.drag&&!g.painting)return;let n=g.painting;g.drag&&(g.drag.mode==="selmove"||g.drag.mode==="selrot")&&al(),g.drag=null,g.painting=!1,g.liveMeas=null,bi(),Se(),n&&(qt(),oe())});Le.addEventListener("pointerleave",()=>{Ke.visible=!1,ei.style.display="none",g.tool==="measure"&&!g.drag&&!g.painting&&g.liveMeas&&(g.liveMeas=null,bi())});Le.addEventListener("contextmenu",n=>n.preventDefault());Le.addEventListener("wheel",n=>{n.preventDefault(),Xt.zoom*=n.deltaY>0?1/.95:.95,Xt.zoom=Math.max(6,Math.min(Uo,Xt.zoom))},{passive:!1});Le.addEventListener("dblclick",n=>{if(g.editObject)return;Bo(n.clientX,n.clientY);let t=qc();t&&Qi(Jn(t),!0)});for(let n of["pointerdown","pointermove","pointerup","pointerleave","wheel","keydown","dblclick"])window.addEventListener(n,Ns,{passive:!0,capture:!0});var ev=()=>Math.abs(Xt.azim-Wt.azim)<.001&&Math.abs(Xt.elev-Wt.elev)<.001&&Math.abs(Xt.zoom-Wt.zoom)<.001&&Wt.target.distanceToSquared(Xt.target)<1e-6;function yf(){let n=Le.getBoundingClientRect();ue.w=n.width,ue.h=n.height,ue.x=n.left,ue.y=n.top}function vf(){let n=Math.max(1,Math.round(ue.w)),t=Math.max(1,Math.round(ue.h)),e=Math.min(devicePixelRatio,2);mi.getPixelRatio()!==e&&mi.setPixelRatio(e),(Le.width!==Math.floor(n*e)||Le.height!==Math.floor(t*e))&&(mi.setSize(n,t,!1),Ns())}window.addEventListener("resize",()=>{yf(),vf()});function Mf(){requestAnimationFrame(Mf),vf(),md(),(dr.tail>0||!ev())&&(mi.render(we,Ht),sd(),dr.tail>0&&dr.tail--)}function nv(){Cd()||(g.root=ff()),g.path=[g.root],g.editObject=null,g.sel3d=null,g.selection.clear(),Se(),qt(),jn(),Tn(),yf(),Mf()}nv();
/**
 * @license
